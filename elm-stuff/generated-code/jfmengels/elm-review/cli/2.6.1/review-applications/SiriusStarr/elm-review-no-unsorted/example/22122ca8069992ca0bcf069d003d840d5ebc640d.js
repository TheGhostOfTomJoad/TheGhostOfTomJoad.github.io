...
{
	if (region.bn.bD === region.a8.bD)
	{
		return 'on line ' + region.bn.bD;
	}
	return 'on lines ' + region.bn.bD + ' through ' + region.a8.bD;
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{B: nodeList, u: (len / $elm$core$Array$branchFactor) | 0, y: tail});
			} else {
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$RuleConfig = $elm$core$Basics$identity;
var $elm$core$Basics$compare = _Utils_compare;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$alphabetically = function (_v0) {
	var r = _v0;
				...
				F2(
					function (d1, d2) {
						return A2(
							...
							$elm$core$Set$toList(d1.bF),
							$elm$core$Set$toList(d2.bF));
					}),
				r.x)
		});
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$RuleConfig = $elm$core$Basics$identity;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$alphabetically = function (_v0) {
	var r = _v0;
	return _Utils_update(
		r,
		{
				...
				F2(
					function (d1, d2) {
						return A2(
							$elm$core$Basics$compare,
							$elm$core$Set$toList(
								A2($elm$core$Set$map, $elm_community$string_extra$String$Extra$decapitalize, d1.bF)),
							$elm$core$Set$toList(
								A2($elm$core$Set$map, $elm_community$string_extra$String$Extra$decapitalize, d2.bF)));
					}),
				r.x)
		});
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$DeclarationOrder = 0;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$Elementwise = 0;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$RuleConfig = $elm$core$Basics$identity;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$defaults = {
	cE: true,
	cT: 0,
	cU: true,
	bL: 0,
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$Alphabetically = 0;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$GenericFieldsFirst = 0;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RuleConfig = $elm$core$Basics$identity;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$defaults = {cd: 0, cS: 0, ce: 0};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$exposedOrderWithPrivateLast = function (_v0) {
	var r = _v0;
	return _Utils_update(
		r,
		{
			x: A2(
				...
				F2(
					function (d1, d2) {
						var _v1 = _Utils_Tuple2(d1.L, d2.L);
						if (!_v1.a.$) {
							if (!_v1.b.$) {
								var i1 = _v1.a.a;
								var i2 = _v1.b.a;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$portsFirst = function (_v0) {
	var r = _v0;
	return _Utils_update(
		r,
		{
			x: A2(
				...
				F2(
					function (d1, d2) {
						var _v1 = _Utils_Tuple2(d1.eW, d2.eW);
						if (_v1.a === 1) {
							if (_v1.b === 1) {
								var _v2 = _v1.a;
								var _v3 = _v1.b;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$ReportOnly = 1;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$reportAmbiguousRecordsWithoutFix = function (_v0) {
	var r = _v0;
	return _Utils_update(
		r,
		{cd: 1});
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$DoNotSort = 2;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$dependencyVisitor = F3(
					...
					if (_v3.b === 1) {
						...
						return $elm$core$Maybe$Just(
							_Utils_Tuple2(
								name,
								{
									d6: $elm$core$Set$fromList(constructors),
									bQ: A2($elm_community$list_extra$List$Extra$stableSortWith, $elm$core$Basics$compare, constructors)
								}));
					} else {
						return $elm$core$Maybe$Just(
							_Utils_Tuple2(
				...
				function (_v1, dep, acc) {
					return function (types) {
						return _Utils_update(
							acc,
							{
								D: A2($elm$core$Dict$union, types, acc.D)
							});
					}(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$foldProjectContexts = F2(
	function (newContext, prevContext) {
		return {
			D: A2($elm$core$Dict$union, newContext.D, prevContext.D)
		};
	});
...
var $jfmengels$elm_review$Review$Rule$moduleNameFromMetadata = function (_v0) {
	var metadata = _v0;
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(metadata.b9);
};
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$fromModuleToProject = $jfmengels$elm_review$Review$Rule$withMetadata(
				...
				return {
					D: A2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							$elm$core$Dict$empty,
							A2($elm$core$Dict$get, _List_Nil, moduleContext.D)))
				};
			})));
...
var $jfmengels$elm_review$Review$Rule$functionToExpression = function (_function) {
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d8).bY;
};
	...
	switch (_v0.$) {
		...
		case 4:
			...
			return _List_fromArray(
				[cond, then_, else_]);
		case 15:
			var expression = _v0.a.bY;
			var declarations = _v0.a.c5;
			return _Utils_ap(
				A2(
					$elm$core$List$map,
			...
			if (!nodesToVisit.b) {
				...
				switch (_v1.$) {
					...
					case 4:
						...
						continue expressionChildrenTCO;
					case 15:
						var expression = _v1.a.bY;
						var declarations = _v1.a.c5;
						var $temp$nodesToVisit = A2(
							$elm$core$List$append,
							A2(
								$elm$core$List$map,
...
var $jfmengels$elm_review$Review$Rule$createExpressionVisitor = function (schema) {
	if ((!$elm$core$List$isEmpty(schema.aj)) || ((!$elm$core$List$isEmpty(schema.ak)) || ((!$elm$core$List$isEmpty(schema.ac)) || (!$elm$core$List$isEmpty(schema.ad))))) {
		...
		if (!$elm$core$List$isEmpty(schema.H)) {
			var exitVisitors = schema.H;
...
var $jfmengels$elm_review$Review$Rule$shouldVisitDeclarations = function (schema) {
	return (!$elm$core$List$isEmpty(schema.ae)) || (!$elm$core$List$isEmpty(schema.af));
};
	...
	function (declarationVisitorsOnEnter, declarationVisitorsOnExit, expressionVisitor, node, errorsAndContext) {
		...
		if (!_v0.$) {
			...
			return A3(
				...
				A2(
					expressionVisitor,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d8).bY,
					A3($jfmengels$elm_review$Review$Rule$visitWithListOfVisitors, declarationVisitorsOnEnter, node, errorsAndContext)));
		} else {
				...
				function (nodes, initialErrorsAndContext) {
					return A3(
						...
						A3(
							...
							$elm$core$List$reverse(schema.ae),
							schema.af,
							expressionVisitor),
						initialErrorsAndContext,
						nodes);
...
var $jfmengels$elm_review$Review$Rule$fromModuleRuleSchemaToRunnableModuleVisitor = function (_v0) {
	var schema = _v0;
	return {
		al: $elm$core$List$reverse(schema.al),
		cl: $jfmengels$elm_review$Review$Rule$createDeclarationAndExpressionVisitor(schema),
		an: $elm$core$List$reverse(schema.an),
		r: $elm$core$List$reverse(schema.r),
		ao: $elm$core$List$reverse(schema.ao),
		ap: $elm$core$List$reverse(schema.ap)
	};
};
		...
		if (_v0.a.$ === 1) {
			...
			if (_v0.b) {
				...
				var dummyAvailableData = {
					bZ: $elm$core$Basics$always('dummy'),
					b4: $jfmengels$elm_review$Review$Rule$createMetadata(
						{
							cD: true,
							b9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, _List_Nil)
						}),
					b7: 'dummy',
					aq: $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$empty
				};
				...
				var emptyModuleVisitor = {
					...
					r: _List_Nil,
					ao: _List_Nil,
					bB: $elm$core$Maybe$Just(initialModuleContext),
					aj: _List_Nil,
					ak: _List_Nil,
					S: $jfmengels$elm_review$Review$Rule$initContextCreator(
...
var $jfmengels$elm_review$Review$Rule$fromProjectRuleSchemaToRunnableProjectVisitor = function (_v0) {
	...
	return {
		...
		F: $elm$core$List$reverse(schema.F),
		r: $elm$core$List$reverse(schema.r),
		aJ: schema.aJ,
		cG: A3($jfmengels$elm_review$Review$Rule$mergeModuleVisitors, schema.aJ, schema.S, schema.bf),
		...
		aa: function () {
			...
			if (!_v1.$) {
				...
				return {aq: false, bm: false};
			}
		}(),
		aP: function () {
			var _v3 = _Utils_Tuple2(schema.bO, schema.aV);
			if (!_v3.a) {
				var _v4 = _v3.a;
				return $jfmengels$elm_review$Review$Rule$TraverseAllModulesInParallel(schema.aV);
			} else {
				if (!_v3.b.$) {
					var _v5 = _v3.a;
					var folder = _v3.b.a;
...
var $jfmengels$elm_review$Review$Exceptions$init = {aS: _List_Nil, aU: $elm$core$Set$empty};
...
var $jfmengels$elm_review$Review$Exceptions$shouldBeIgnored = F2(
	function (exceptions, path) {
		...
		return A2($elm$core$Set$member, cleanedPath, exceptions.aU) || A2($jfmengels$elm_review$Review$Exceptions$isInAnIgnoredDirectory, exceptions.aS, cleanedPath);
	});
var $jfmengels$elm_review$Review$Exceptions$apply = F3(
	function (_v0, getPath, items) {
		var exceptions = _v0;
		return ($elm$core$Set$isEmpty(exceptions.aU) && $elm$core$List$isEmpty(exceptions.aS)) ? items : A2(
...
var $stil4m$elm_syntax$Elm$Syntax$Module$moduleName = function (m) {
	switch (m.$) {
		case 0:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.b8);
		case 1:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.b8);
		default:
...
var $jfmengels$elm_review$Review$Rule$getModuleName = function (module_) {
	return $stil4m$elm_syntax$Elm$Syntax$Module$moduleName(
		$stil4m$elm_syntax$Elm$Syntax$Node$value(module_.dY.ep));
};
...
var $jfmengels$elm_review$Vendor$IntDict$prefixMatches = F2(
	function (p, n) {
		return _Utils_eq(
			n & $jfmengels$elm_review$Vendor$IntDict$higherBitMask(p.a5),
			p.as);
	});
	...
	function (key, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return _Utils_eq(l.f, key) ? $elm$core$Maybe$Just(l.K) : $elm$core$Maybe$Nothing;
				default:
					var i = dict.a;
					if (!A2($jfmengels$elm_review$Vendor$IntDict$prefixMatches, i.h, key)) {
						return $elm$core$Maybe$Nothing;
					} else {
						if (A2($jfmengels$elm_review$Vendor$IntDict$isBranchingBitSet, i.h, key)) {
							var $temp$key = key,
								$temp$dict = i.e;
							key = $temp$key;
							dict = $temp$dict;
...
var $jfmengels$elm_review$Review$Rule$computeModuleAndCacheResult = F6(
	function (traversalAndFolder, modules, graph, computeModule, _v0, _v1) {
		...
		var _v2 = A2($elm$core$Dict$get, node.Y, modules);
		if (_v2.$ === 1) {
						...
						function (key) {
							return A2(
								...
								function (nodeContext) {
									return A2($elm$core$Dict$get, nodeContext.et.Y, modules);
								},
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					A2($elm$core$String$slice, 0, range.a8.ay - 1),
					A2(
						$elm$core$List$take,
						(range.a8.aN - range.bn.aN) + 1,
						A2($elm$core$List$drop, range.bn.aN - 1, lines)))));
	});
...
var $jfmengels$elm_review$Vendor$Graph$NodeContext = F3(
	function (node, incoming, outgoing) {
		return {j: incoming, et: node, i: outgoing};
	});
				...
				return $jfmengels$elm_review$Vendor$IntDict$Inner(
					{
						...
						h: p,
						e: r,
						cR: $jfmengels$elm_review$Vendor$IntDict$size(l) + $jfmengels$elm_review$Vendor$IntDict$size(r)
					});
			}
		}
	});
var $jfmengels$elm_review$Vendor$IntDict$lcp = F2(
	function (x, y) {
		...
		return {a5: branchingBit, as: prefixBits};
	});
...
var $jfmengels$elm_review$Vendor$IntDict$update = F3(
	function (key, alter, dict) {
		...
		switch (dict.$) {
			...
			case 1:
				var l = dict.a;
				return _Utils_eq(l.f, key) ? alteredNode(
					$elm$core$Maybe$Just(l.K)) : A2(
					join,
					_Utils_Tuple2(
						key,
						alteredNode($elm$core$Maybe$Nothing)),
					_Utils_Tuple2(l.f, dict));
			default:
				var i = dict.a;
				return A2($jfmengels$elm_review$Vendor$IntDict$prefixMatches, i.h, key) ? (A2($jfmengels$elm_review$Vendor$IntDict$isBranchingBitSet, i.h, key) ? A3(
...
var $jfmengels$elm_review$Vendor$Graph$fromNodesAndEdges = F2(
	function (nodes_, edges_) {
			...
			function (edge, rep) {
				var updateOutgoing = function (ctx) {
					return _Utils_update(
						ctx,
						{
							i: A3($jfmengels$elm_review$Vendor$IntDict$insert, edge.Q, edge.Y, ctx.i)
						});
				};
				var updateIncoming = function (ctx) {
					return _Utils_update(
						ctx,
						{
							j: A3($jfmengels$elm_review$Vendor$IntDict$insert, edge.O, edge.Y, ctx.j)
						});
				};
				return A3(
					$jfmengels$elm_review$Vendor$IntDict$update,
		...
		var addEdgeIfValid = F2(
			function (edge, rep) {
				return (A2($jfmengels$elm_review$Vendor$IntDict$member, edge.O, rep) && A2($jfmengels$elm_review$Vendor$IntDict$member, edge.Q, rep)) ? A2(addEdge, edge, rep) : rep;
			});
...
var $jfmengels$elm_review$Vendor$Graph$Edge = F3(
	function (from, to, label) {
		return {O: from, Y: label, Q: to};
	});
var $jfmengels$elm_review$Vendor$Graph$Node = F2(
	function (id, label) {
		return {aH: id, Y: label};
	});
...
var $jfmengels$elm_review$Review$Project$Internal$moduleGraph = function (_v0) {
	...
	if (!_v1.$) {
		...
		return $jfmengels$elm_review$Review$Project$Internal$buildModuleGraph(
			$elm$core$Dict$values(project.ar));
	}
};
var $jfmengels$elm_review$Review$Project$Internal$moduleNameLookupTables = function (_v0) {
	var project = _v0;
	return A2($elm$core$Maybe$withDefault, $elm$core$Dict$empty, project.eq);
};
...
var $jfmengels$elm_review$Review$Project$modules = function (_v0) {
	var project = _v0;
	return $elm$core$Dict$values(project.ar);
};
...
var $jfmengels$elm_review$Review$Rule$computeModules = F7(
	function (projectVisitor, _v0, project, exceptions, initialProjectContext, nodeContexts, startCache) {
		...
		var computeModule = F3(
			function (cache, importedModules, module_) {
				...
				var metadata = $jfmengels$elm_review$Review$Rule$createMetadata(
					{
						cD: module_.cD,
						b9: $jfmengels$elm_review$Review$Rule$moduleNameNode(module_.dY.ep)
					});
				var availableData = {
					bZ: function () {
						var _v4 = projectVisitor.aa;
						var requestedData = _v4;
						return requestedData.bm ? $jfmengels$elm_review$Review$Rule$extractSourceCode(
				...
				return {
					t: function () {
						var _v2 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aP);
						if (!_v2.$) {
							var fromModuleToProject = _v2.a.eg;
		...
		return A3(
			$elm$core$List$foldl,
			A4($jfmengels$elm_review$Review$Rule$computeModuleAndCacheResult, projectVisitor.aP, modules, graph, computeModule),
...
var $jfmengels$elm_review$Review$Rule$computeProjectContext = F3(
	function (projectVisitor, project, maybePreviousCache) {
		...
		var elmJsonCacheEntry = function () {
			var computeElmJson = function (_v9) {
				var _v8 = A3(
					...
					projectVisitor.F,
					elmJsonData,
					_Utils_Tuple2(_List_Nil, projectVisitor.aJ));
				var errorsForVisitor = _v8.a;
				var contextForVisitor = _v8.b;
				return {t: contextForVisitor, aD: errorsForVisitor, K: projectElmJson};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return _Utils_eq(previousCache.cp.K, projectElmJson) ? previousCache.cp : computeElmJson(0);
			} else {
		...
		var readmeCacheEntry = function () {
			var computeReadme = function (_v6) {
				var _v5 = A3(
					...
					projectVisitor.J,
					readmeData,
					_Utils_Tuple2(_List_Nil, elmJsonCacheEntry.t));
				var errorsForVisitor = _v5.a;
				var contextForVisitor = _v5.b;
				return {t: contextForVisitor, aD: errorsForVisitor, K: readmeData};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return (_Utils_eq(previousCache.cp.t, elmJsonCacheEntry.t) && _Utils_eq(previousCache.cN.K, readmeData)) ? previousCache.cN : computeReadme(0);
			} else {
		...
		var _v0 = function () {
			...
			var computeDependencies = function (_v3) {
				var _v2 = A3(
					...
					projectVisitor.E,
					dependencies,
					_Utils_Tuple2(_List_Nil, readmeCacheEntry.t));
				var errorsForVisitor = _v2.a;
				var contextForVisitor = _v2.b;
				return {t: contextForVisitor, aD: errorsForVisitor, K: dependencies};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return (_Utils_eq(previousCache.cN.t, readmeCacheEntry.t) && _Utils_eq(previousCache.aR.K, dependencies)) ? _Utils_Tuple2(previousCache.aR, false) : _Utils_Tuple2(
		...
		return _Utils_Tuple2(
			{aR: dependenciesCacheEntry, cp: elmJsonCacheEntry, bw: _List_Nil, bE: $elm$core$Dict$empty, cN: readmeCacheEntry},
			hasAnythingChanged);
	});
	...
	return $elm$core$List$concat(
		_List_fromArray(
			[
				...
				$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
				function (cacheEntry) {
					return cacheEntry.aD;
				},
				$elm$core$Dict$values(cache.bE)),
				cache.bw
			]));
};
var $jfmengels$elm_review$Review$Rule$errorsFromFinalEvaluationForProject = F3(
	function (projectVisitor, initialContext, contextsPerModule) {
		if ($elm$core$List$isEmpty(projectVisitor.r)) {
			return _List_Nil;
		} else {
			var finalContext = function () {
				var _v0 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aP);
				if (!_v0.$) {
					var foldProjectContexts = _v0.a.ef;
...
var $jfmengels$elm_review$Review$Rule$runProjectVisitor = F6(
	function (name, projectVisitor, maybePreviousCache, exceptions, project, nodeContexts) {
		...
		var initialContext = cacheWithInitialContext.aR.t;
		var previousModuleContexts = function () {
			if (hasInitialContextChanged) {
				return $elm$core$Dict$empty;
			} else {
				if (!maybePreviousCache.$) {
					var moduleContexts = maybePreviousCache.a.bE;
		...
		var contextsAndErrorsPerModule = A2(
			$elm$core$List$map,
			function (cacheEntry) {
				return _Utils_Tuple2(cacheEntry.aD, cacheEntry.t);
			},
		...
		var errorsFromFinalEvaluation = function () {
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return _Utils_eq(allModulesContext, previousAllModulesContext) ? previousCache.bw : A3($jfmengels$elm_review$Review$Rule$errorsFromFinalEvaluationForProject, projectVisitor, initialContext, allModulesContext);
			} else {
		...
		var newCache = {aR: cacheWithInitialContext.aR, cp: cacheWithInitialContext.cp, bw: errorsFromFinalEvaluation, bE: newCachedModuleContexts, cN: cacheWithInitialContext.cN};
		var errors = A3(
			$jfmengels$elm_review$Review$Exceptions$apply,
			exceptions,
			A2(
		...
		return {
			...
			aD: A2(
				...
				errors),
			a9: function () {
				var _v1 = projectVisitor.aA;
				if (!_v1.$) {
					var dataExtractor = _v1.a;
					var contextToAnalyze = function () {
						var _v2 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aP);
						if (!_v2.$) {
							var foldProjectContexts = _v2.a.ef;
				...
				aO: F3(
					function (newExceptions, newProject, newNodeContexts) {
						var result = A6(
							...
							newProject,
							newNodeContexts);
						return _Utils_Tuple2(result.aD, result.cO);
					})
			}
		};
	});
var $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema = function (projectRuleSchema) {
	...
	return {
		az: $elm$core$Maybe$Nothing,
		aE: $jfmengels$elm_review$Review$Exceptions$init,
		a1: schema.a1,
		aa: function () {
			var _v0 = schema.S;
			if (!_v0.$) {
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$fromProjectToModule = $jfmengels$elm_review$Review$Rule$withMetadata(
	$jfmengels$elm_review$Review$Rule$withSourceCodeExtractor(
		$jfmengels$elm_review$Review$Rule$withModuleNameLookupTable(
			$jfmengels$elm_review$Review$Rule$initContextCreator(
				F4(
					function (lookupTable, extractSource, metadata, projectContext) {
						return {
							D: projectContext.D,
							ct: extractSource,
							cF: lookupTable,
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$initialProjectContext = {D: $elm$core$Dict$empty};
...
var $SiriusStarr$elm_review_no_unsorted$Util$validate = F2(
	function (pred, x) {
		return pred(x) ? $elm$core$Maybe$Just(x) : $elm$core$Maybe$Nothing;
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$declarationListVisitor = F3(
	function (_v0, declarations, context) {
		var config = _v0;
		var typeConstructors = function (type_) {
			return function (cs) {
				return {
					d6: $elm$core$Set$fromList(cs),
					bQ: cs
				};
			}(
				A2(
		...
		var getCustomType = function (node) {
			...
			if (_v1.$ === 2) {
				...
				return A2(
					config.cf,
					context.b8,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(name)) ? $elm$core$Maybe$Just(type_) : $elm$core$Maybe$Nothing;
			} else {
				return $elm$core$Maybe$Nothing;
			}
		};
		return _Utils_update(
			context,
			{
				D: A3(
					...
					context.D,
					function (v) {
						return A3($elm$core$Dict$insert, _List_Nil, v, context.D);
					},
					A2(
						$elm$core$Maybe$map,
						$elm$core$Dict$fromList,
						A2(
							$SiriusStarr$elm_review_no_unsorted$Util$validate,
							A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$List$isEmpty),
							A2(
								$elm$core$List$map,
								function (type_) {
									return _Utils_Tuple2(
										$stil4m$elm_syntax$Elm$Syntax$Node$value(type_.a1),
										typeConstructors(type_));
								},
								A2($elm$core$List$filterMap, getCustomType, declarations)))))
			});
	});
var $SiriusStarr$elm_review_no_unsorted$Util$fallbackCompareFor = F2(
...
var $SiriusStarr$elm_review_no_unsorted$Util$compareByOrderings = F3(
	function (orderings, d1, d2) {
		var go = function (os) {
			if (!os.b) {
				...
				var os_ = os.b;
				return A2(
					$SiriusStarr$elm_review_no_unsorted$Util$fallbackCompareFor,
					A2(o, d1, d2),
					function (_v1) {
						return go(os_);
					});
...
var $SiriusStarr$elm_review_no_unsorted$Util$createFix = F2(
...
var $jfmengels$elm_review$Review$Rule$error = F2(
	function (_v0, range) {
		...
		var details = _v0.bR;
		return $jfmengels$elm_review$Review$Rule$UnspecifiedError(
			{bR: details, cw: '', cy: $elm$core$Maybe$Nothing, aw: message, cM: range, cP: '', dN: 0});
	});
...
var $SiriusStarr$elm_review_no_unsorted$Util$unsortedError = function (errorConcerns) {
	return $jfmengels$elm_review$Review$Rule$errorWithFix(
		{
			...
			aw: errorConcerns + ' are not sorted.'
		});
};
var $SiriusStarr$elm_review_no_unsorted$Util$checkSorting = F5(
	function (extractSource, errorConcerns, orderings, errorRange, ds) {
		var indexed = A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, ds);
		return function (sorted) {
			return (!_Utils_eq(
				A2($elm$core$List$map, $elm$core$Tuple$first, sorted),
				A2($elm$core$List$map, $elm$core$Tuple$first, indexed))) ? $elm$core$List$singleton(
				A3(
					$SiriusStarr$elm_review_no_unsorted$Util$unsortedError,
					errorConcerns,
					errorRange,
					A2(
						$SiriusStarr$elm_review_no_unsorted$Util$createFix,
						extractSource,
						A2(
							$elm$core$List$map,
			...
			A2(
				...
				F2(
					function (_v0, _v1) {
						...
						return A2(
							$SiriusStarr$elm_review_no_unsorted$Util$fallbackCompareFor,
							A3($SiriusStarr$elm_review_no_unsorted$Util$compareByOrderings, orderings, d1, d2),
							function (_v2) {
								return A2($elm$core$Basics$compare, i1, i2);
							});
					}),
...
var $stil4m$elm_syntax$Elm$Syntax$Range$compareLocations = F2(
	function (left, right) {
		return (_Utils_cmp(left.aN, right.aN) < 0) ? 0 : ((_Utils_cmp(left.aN, right.aN) > 0) ? 2 : A2($elm$core$Basics$compare, left.ay, right.ay));
	});
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$LengthFirst = 1;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$compareLiteral = F2(
	function (l1, l2) {
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var c1 = _v0.a.a;
						var c2 = _v0.b.a;
						return A2($elm$core$Basics$compare, c1, c2);
					} else {
						break _v0$4;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var s1 = _v0.a.a;
						var s2 = _v0.b.a;
						return A2($elm$core$Basics$compare, s1, s2);
					} else {
						break _v0$4;
					}
				case 2:
				...
				default:
					if (_v0.b.$ === 3) {
						var f1 = _v0.a.a;
						var f2 = _v0.b.a;
						return A2($elm$core$Basics$compare, f1, f2);
					} else {
						break _v0$4;
					}
			}
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$comparePatternListLengths = F2(
	function (p1s, p2s) {
		var _v0 = _Utils_Tuple2(p1s.a3, p2s.a3);
		if (!_v0.a) {
			if (!_v0.b) {
				return A2(
					$elm$core$Basics$compare,
					$elm$core$List$length(p2s.P),
					$elm$core$List$length(p1s.P));
			} else {
				return 2;
			}
		} else {
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$comparePatterns = F3(
	function (ruleConfig, pat1, pat2) {
		var config = ruleConfig;
		var go = F2(
			function (p1, p2) {
				return A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$comparePatterns, ruleConfig, p1, p2);
			});
					...
					case 2:
						switch (_v0.b.$) {
							...
							case 2:
								var l1 = _v0.a.a;
								var l2 = _v0.b.a;
								return A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$compareLiteral, l1, l2);
							default:
								break _v0$5;
						}
					case 0:
						switch (_v0.b.$) {
							...
							case 0:
								...
								var c2 = _v0.b.a;
								var goSubs = F3(
									function (pat1s, pat2s, _v3) {
										goSubs:
										while (true) {
											var _v4 = _Utils_Tuple3(pat1s, pat2s, config.cE);
											_v4$2:
											while (true) {
												if (_v4.a.b) {
													if (!_v4.a.a.$) {
								...
								return A2(
									$SiriusStarr$elm_review_no_unsorted$Util$fallbackCompareFor,
									A2($elm$core$Basics$compare, c1.cJ, c2.cJ),
									A2(goSubs, c1.P, c2.P));
							default:
								break _v0$5;
						}
						...
						switch (_v0.b.$) {
							...
							case 1:
								...
								var _v11 = _Utils_Tuple2(
									_Utils_Tuple2(r1.P, r1.a3),
									_Utils_Tuple2(r2.P, r2.a3));
								_v11$2:
								while (true) {
									if (_v11.a.a.b) {
										if (!_v11.b.a.b) {
											...
											var _v31 = _v11.b;
											var p2s = _v31.a;
											return (config.cT === 1) ? A2(
												$SiriusStarr$elm_review_no_unsorted$Util$fallbackCompareFor,
												A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$comparePatternListLengths, r1, r2),
												function (_v32) {
													return A2(
														$elm$core$Maybe$withDefault,
														1,
														A2(
															...
															A3($elm$core$List$map2, go, p1s, p2s)));
												}) : A2(
												$elm$core$Maybe$withDefault,
												1,
												A2(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$CharLiteral = function (a) {
	return {$: 0, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$Constructor = function (a) {
	return {$: 0, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$FloatLiteral = function (a) {
	return {$: 3, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$IntLiteral = function (a) {
	return {$: 2, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$ListTupleOrUncons = function (a) {
	return {$: 1, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$Literal = function (a) {
	return {$: 2, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$StringLiteral = function (a) {
	return {$: 1, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$Wildcard = {$: 3};
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$getActualPattern = function (node) {
	getActualPattern:
	while (true) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		switch (_v0.$) {
...
var $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$toRangeLike = function (_v0) {
	...
	var end = _v0.a8;
	return _Utils_Tuple2(
		_Utils_Tuple2(start.aN, start.ay),
		_Utils_Tuple2(end.aN, end.ay));
};
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$getSortablePattern = F3(
	function (ruleConfig, context, node) {
		var config = ruleConfig;
		var n = $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$getActualPattern(node);
		var makeLiteral = F2(
			function (l, a) {
				return config.cU ? $elm$core$Maybe$Just(
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$Literal(
						l(a))) : $elm$core$Maybe$Nothing;
			});
		var go = A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$getSortablePattern, ruleConfig, context);
			...
			function (constructor, ps, moduleName) {
				return A2(
					...
					function (_v4) {
						...
						var declarationOrder = _v4.b.bQ;
						return A2(
							$elm$core$Maybe$map,
							function (order) {
								return $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$Constructor(
									{
										cJ: order,
										P: A2($elm$core$List$map, go, ps),
										eW: _Utils_Tuple2(moduleName, matchedType)
									});
							},
					...
					A2(
						...
						$elm_community$dict_extra$Dict$Extra$find(
							F2(
								function (_v2, _v3) {
									var constructors = _v3.d6;
									return A2($elm$core$Set$member, constructor, constructors);
								})),
						A2($elm$core$Dict$get, moduleName, context.D)));
			});
		...
		switch (_v0.$) {
			case 12:
				...
				return A2(
					...
					A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameFor, context.cF, n));
			case 7:
				var ps = _v0.a;
				return A2(
					$elm$core$Maybe$map,
					function (subpatterns) {
						return $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$ListTupleOrUncons(
							{P: subpatterns, a3: true});
					},
			...
			case 9:
				...
				var cons = F2(
					function (x, xs) {
						switch (xs.$) {
							case 3:
								return $elm$core$Maybe$Just(
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$ListTupleOrUncons(
										{
											P: _List_fromArray(
												[x]),
											a3: false
				...
				return $elm_community$maybe_extra$Maybe$Extra$join(
					A3(
						...
						go(p2)));
			case 0:
				return $elm$core$Maybe$Just($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$Wildcard);
			case 11:
				return $elm$core$Maybe$Just($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$Wildcard);
			case 2:
				var c = _v0.a;
				return A2(makeLiteral, $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$CharLiteral, c);
			case 3:
				var s = _v0.a;
				return A2(makeLiteral, $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$StringLiteral, s);
			case 4:
				var i = _v0.a;
				return A2(makeLiteral, $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$IntLiteral, i);
			case 5:
				var i = _v0.a;
				return A2(makeLiteral, $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$IntLiteral, i);
			case 6:
				var f = _v0.a;
				return A2(makeLiteral, $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$FloatLiteral, f);
			default:
				return $elm$core$Maybe$Nothing;
		}
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$expressionVisitor = F3(
		...
		if (_v0.$ === 16) {
			...
			return A2(
				...
				A2(
					$elm$core$Maybe$map,
					A4(
						$SiriusStarr$elm_review_no_unsorted$Util$checkSorting,
						context.ct,
						'Case patterns',
						_List_fromArray(
							[
								F2(
								function (c1, c2) {
									return A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$comparePatterns, config, c1.cK, c2.cK);
								})
							]),
						errorRange),
					A2(
						...
						function (_v1) {
							...
							return A2(
								...
								function (sP) {
									return {
										cK: sP,
										cM: $stil4m$elm_syntax$Elm$Syntax$Range$combine(
											_List_fromArray(
												[
								...
								A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$getSortablePattern, config, context, p));
						},
						cases)));
		} else {
			return _List_Nil;
...
var $jfmengels$elm_review$Review$Rule$withDeclarationListVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				an: A2($elm$core$List$cons, visitor, schema.an)
			});
	});
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$moduleVisitor = F2(
	function (config, schema) {
		return A2(
			...
			F2(
				function (e, c) {
					return _Utils_Tuple2(
						A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$expressionVisitor, config, e, c),
						c);
				}),
			A2(
				...
				F2(
					function (ds, c) {
						return _Utils_Tuple2(
							_List_Nil,
							A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$declarationListVisitor, config, ds, c));
					}),
				schema));
	});
...
var $jfmengels$elm_review$Review$Rule$newProjectRuleSchema = F2(
	function (name, initialProjectContext) {
		return {aA: $elm$core$Maybe$Nothing, E: _List_Nil, F: _List_Nil, r: _List_Nil, aV: $elm$core$Maybe$Nothing, aJ: initialProjectContext, S: $elm$core$Maybe$Nothing, bf: _List_Nil, a1: name, J: _List_Nil, bO: 0};
	});
		...
		return _Utils_update(
			schema,
			{
				aV: $elm$core$Maybe$Just(
					{ef: functions.ef, eg: functions.eg}),
				S: $elm$core$Maybe$Just(functions.eh)
			});
	});
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$rule = function (config) {
	return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
		$jfmengels$elm_review$Review$Rule$withContextFromImportedModules(
			A2(
				...
				{ef: $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$foldProjectContexts, eg: $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$fromModuleToProject, eh: $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$fromProjectToModule},
				A2(
					$jfmengels$elm_review$Review$Rule$withModuleVisitor,
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$moduleVisitor(config),
					A2(
						...
						F2(
							function (d, c) {
								return _Utils_Tuple2(
									_List_Nil,
									A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$dependencyVisitor, config, d, c));
							}),
						A2($jfmengels$elm_review$Review$Rule$newProjectRuleSchema, 'NoUnsortedCases', $SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$initialProjectContext))))));
};
...
var $SiriusStarr$elm_review_no_unsorted$Util$allBindingsInPattern = function (pattern) {
	var go = $elm$core$List$concatMap($SiriusStarr$elm_review_no_unsorted$Util$allBindingsInPattern);
				...
				return $elm_community$intdict$IntDict$Inner(
					{
						...
						h: p,
						e: r,
						cR: $elm_community$intdict$IntDict$size(l) + $elm_community$intdict$IntDict$size(r)
					});
			}
		}
	});
...
var $elm_community$graph$Graph$fromNodesAndEdges = F2(
	function (nodes_, edges_) {
			...
			function (edge, rep) {
				var updateOutgoing = function (ctx) {
					return _Utils_update(
						ctx,
						{
							i: A3($elm_community$intdict$IntDict$insert, edge.Q, edge.Y, ctx.i)
						});
				};
				var updateIncoming = function (ctx) {
					return _Utils_update(
						ctx,
						{
							j: A3($elm_community$intdict$IntDict$insert, edge.O, edge.Y, ctx.j)
						});
				};
				return A3(
					$elm_community$intdict$IntDict$update,
		...
		var addEdgeIfValid = F2(
			function (edge, rep) {
				return (A2($elm_community$intdict$IntDict$member, edge.O, rep) && A2($elm_community$intdict$IntDict$member, edge.Q, rep)) ? A2(addEdge, edge, rep) : rep;
			});
		return A3($elm$core$List$foldl, addEdgeIfValid, nodeRep, edges_);
	});
var $SiriusStarr$elm_review_no_unsorted$Util$gluedTo = function (g) {
	switch (g.$) {
		case 0:
			var ns = g.a;
			return ns;
...
var $elm_community$intdict$IntDict$determineBranchRelation = F2(
	function (l, r) {
		...
		var modifiedRightPrefix = A3($elm_community$intdict$IntDict$combineBits, rp.as, ~lp.as, mask);
		var prefix = A2($elm_community$intdict$IntDict$lcp, lp.as, modifiedRightPrefix);
		var childEdge = F2(
			function (branchPrefix, c) {
				return A2($elm_community$intdict$IntDict$isBranchingBitSet, branchPrefix, c.h.as) ? 1 : 0;
			});
	...
	function (l, r) {
		...
		while (true) {
			...
			while (true) {
					...
					switch (_v0.a.$) {
						...
						default:
							switch (_v0.b.$) {
								...
								case 1:
									var lr = _v0.b.a;
									var _v3 = A2($elm_community$intdict$IntDict$get, lr.f, l);
									if (!_v3.$) {
										var v = _v3.a;
										return A2($elm_community$intdict$IntDict$leaf, lr.f, v);
									} else {
										return $elm_community$intdict$IntDict$Empty;
									}
								default:
				...
				var ll = _v0.a.a;
				return A2($elm_community$intdict$IntDict$member, ll.f, r) ? l : $elm_community$intdict$IntDict$Empty;
			}
			var _v2 = _v0.b;
			return $elm_community$intdict$IntDict$Empty;
		}
	...
	function (ordering, graph) {
		...
		var check = F2(
			function (id, _v2) {
				...
				var backEdges = A2($elm_community$intdict$IntDict$intersect, ctx.i, backSetWithId);
...
var $elm_community$graph$Graph$alongOutgoingEdges = function (ctx) {
	return $elm_community$intdict$IntDict$keys(ctx.i);
};
		...
		var updateIncomingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						j: A3($elm_community$intdict$IntDict$update, nodeId, upd, node.j)
					});
			});
		var flippedFoldl = F3(
			function (f, dict, acc) {
...
var $elm_community$graph$Graph$emptyDiff = {j: $elm_community$intdict$IntDict$empty, i: $elm_community$intdict$IntDict$empty};
	...
	function (old, _new) {
		...
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				...
				var ins = _v0.b.a;
				return {
					j: A3(collect, $elm_community$graph$Graph$Insert, ins.i, $elm_community$intdict$IntDict$empty),
					i: A3(collect, $elm_community$graph$Graph$Insert, ins.j, $elm_community$intdict$IntDict$empty)
				};
			}
		} else {
			if (_v0.b.$ === 1) {
				...
				var _v3 = _v0.b;
				return {
					j: A3(collect, $elm_community$graph$Graph$Remove, rem.i, $elm_community$intdict$IntDict$empty),
					i: A3(collect, $elm_community$graph$Graph$Remove, rem.j, $elm_community$intdict$IntDict$empty)
				};
			} else {
				var rem = _v0.a.a;
				var ins = _v0.b.a;
				return _Utils_eq(rem, ins) ? $elm_community$graph$Graph$emptyDiff : {
					...
					i: A3(
						...
						$elm_community$graph$Graph$Insert,
						ins.j,
						A3(collect, $elm_community$graph$Graph$Remove, rem.j, $elm_community$intdict$IntDict$empty))
				};
			}
		}
	});
		...
		var wrappedUpdater = function (rep) {
			...
			var filterInvalidEdges = function (ctx) {
				return $elm_community$intdict$IntDict$filter(
					F2(
						function (id, _v0) {
							return _Utils_eq(id, ctx.et.aH) || A2($elm_community$intdict$IntDict$member, id, rep);
						}));
			};
			var cleanUpEdges = function (ctx) {
				return _Utils_update(
					ctx,
					{
						j: A2(filterInvalidEdges, ctx, ctx.j),
...
var $SiriusStarr$elm_review_no_unsorted$Util$gluedListToDAG = function (ds) {
		...
		A2(
			...
			function (_v4) {
				...
				return A2(
					...
					$elm$core$Set$toList(label.bF));
			},
			ds));
	var eliminateCycles = function (g) {
		return A2(
							...
							A2(
								...
								A2(
									...
									function (_v2) {
										var from = _v2.a;
										var to = _v2.b;
										return {O: from, Y: 0, Q: to};
									},
									$elm$core$Set$toList(
										function (initEdges) {
											return A2($elm$core$Set$diff, initEdges, toRemove);
										}(
											$elm$core$Set$fromList(
												A2(
													$elm$core$List$map,
		...
		function (_v3) {
			...
			return A2(
				...
				A3(
					$elm_community$maybe_extra$Maybe$Extra$unwrap,
					_List_Nil,
					A2($elm$core$Basics$composeL, $elm$core$Set$toList, $SiriusStarr$elm_review_no_unsorted$Util$gluedTo),
					label.b$));
		},
		ds);
	return eliminateCycles(
				...
				while (true) {
					...
					if (!maybeContext.$) {
						...
						var $temp$acc1 = A2(f, ctx, acc1),
							$temp$graph1 = A2($elm_community$graph$Graph$remove, ctx.et.aH, graph1);
						acc1 = $temp$acc1;
						graph1 = $temp$graph1;
						continue go;
					} else {
...
var $elm_community$graph$Graph$heightLevels = function (_v0) {
	...
	var isSource = function (ctx) {
		return $elm_community$intdict$IntDict$isEmpty(ctx.j);
	};
	var sources = A3(
		...
		function (currentLevel, nextLevel, indegrees, graph) {
			...
			if (!_v1.a.b) {
				...
				var _v4 = A4(
					...
					nextLevel1,
					indegrees1,
					A2($elm_community$graph$Graph$remove, source.et.aH, graph));
				if (!_v4.b) {
	...
	var countIndegrees = A2(
		...
		function (ctx) {
			return A2(
				$elm_community$intdict$IntDict$insert,
				ctx.et.aH,
				$elm_community$intdict$IntDict$size(ctx.j));
		},
		$elm_community$intdict$IntDict$empty);
	return A4(
		go,
...
var $SiriusStarr$elm_review_no_unsorted$Util$isGluedBefore = function (g) {
	switch (g.$) {
		case 0:
			return true;
		case 1:
...
var $SiriusStarr$elm_review_no_unsorted$Util$isGluedToFirst = function (g) {
	switch (g.$) {
		case 0:
			return true;
		case 1:
...
var $SiriusStarr$elm_review_no_unsorted$Util$checkSortingWithGlue = F5(
	function (extractSource, errorConcerns, orderings, errorRange, ds) {
		var sort = $elm$core$List$sortWith(
			F2(
				function (d1, d2) {
					return A2(
						$SiriusStarr$elm_review_no_unsorted$Util$fallbackCompareFor,
						A3($SiriusStarr$elm_review_no_unsorted$Util$compareByOrderings, orderings, d1.Y, d2.Y),
						function (_v7) {
							return A2($elm$core$Basics$compare, d1.aH, d2.aH);
						});
				}));
		var insertGlued = F2(
			function (glued, dec) {
					...
					A2(
						...
						$elm$core$List$partition(
							A2(
								...
								A2(
									$elm$core$Basics$composeL,
									A2($elm_community$maybe_extra$Maybe$Extra$unwrap, false, $SiriusStarr$elm_review_no_unsorted$Util$isGluedBefore),
									function ($) {
										return $.b$;
									}),
								function ($) {
									...
									A2(
										...
										A2(
											...
											A2(
												...
												$elm$core$Set$intersect(label.bF)),
											$SiriusStarr$elm_review_no_unsorted$Util$gluedTo)))),
							glued)));
			});
		var indexed = A2(
			$elm$core$List$indexedMap,
									...
									function (d, _v3) {
										...
										return function (r) {
											return _Utils_update(
												r,
												{
													ah: _Utils_ap(r.ah, inserted)
												});
										}(
											A2(insertGlued, toGlue, d));
									}),
								{ah: _List_Nil, bN: toLast},
								A3(
									$elm$core$List$foldl,
									F2(
										function (d, _v2) {
											...
											return function (r) {
												return _Utils_update(
													r,
													{
														ah: _Utils_ap(inserted, r.ah)
													});
											}(
												A2(insertGlued, toGlue, d));
										}),
									{ah: _List_Nil, bN: toFirst},
									sorted).ah).ah;
						}(
							A2(
								$elm$core$List$partition,
								A2(
									...
									A2(
										$elm$core$Basics$composeL,
										A2($elm_community$maybe_extra$Maybe$Extra$unwrap, false, $SiriusStarr$elm_review_no_unsorted$Util$isGluedToFirst),
										function ($) {
											return $.b$;
										}),
									function ($) {
					...
					A2(
						...
						A2(
							...
							function (_v4) {
								var id = _v4.aH;
								var label = _v4.Y;
								return _Utils_Tuple2(id, label.cM);
							},
							sorted)))) : _List_Nil;
		}(
			A2(
				...
				$elm_community$graph$Graph$heightLevels(
					$SiriusStarr$elm_review_no_unsorted$Util$gluedListToDAG(indexed))));
	});
...
var $SiriusStarr$elm_review_no_unsorted$Util$subexpressions = function (expr) {
	...
	switch (_v0.$) {
		case 15:
			...
			var subExprs = function (n) {
				...
				if (!_v1.$) {
					var declaration = _v1.a.d8;
					return $stil4m$elm_syntax$Elm$Syntax$Node$value(declaration).bY;
				} else {
					var e = _v1.b;
					return e;
				}
			...
			return A2(
				$elm$core$List$cons,
				letBlock.bY,
				A2($elm$core$List$map, subExprs, letBlock.c5));
		case 19:
			var es = _v0.a;
			return es;
		case 13:
		...
		case 16:
			...
			return A2(
				$elm$core$List$cons,
				caseBlock.bY,
				A2($elm$core$List$map, $elm$core$Tuple$second, caseBlock.d1));
		case 2:
			var e1 = _v0.c;
			var e2 = _v0.d;
			return _List_fromArray(
...
var $SiriusStarr$elm_review_no_unsorted$Util$countUsesIn = F2(
	function (expr, name) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(expr);
		if ((_v0.$ === 3) && (!_v0.a.b)) {
			var n = _v0.b;
			...
			return A3(
				...
				function (e) {
					return $elm$core$Basics$add(
						A2($SiriusStarr$elm_review_no_unsorted$Util$countUsesIn, e, name));
				},
				0,
				$SiriusStarr$elm_review_no_unsorted$Util$subexpressions(expr));
		}
	});
...
var $SiriusStarr$elm_review_no_unsorted$Util$findAllNamesIn = function (expr) {
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(expr);
	if ((_v0.$ === 3) && (!_v0.a.b)) {
		var n = _v0.b;
		...
		return A3(
			...
			function (e) {
				return $elm$core$Set$union(
					$SiriusStarr$elm_review_no_unsorted$Util$findAllNamesIn(e));
			},
			$elm$core$Set$empty,
			$SiriusStarr$elm_review_no_unsorted$Util$subexpressions(expr));
	}
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$expressionVisitor = F3(
		...
		if (_v1.$ === 15) {
			...
			var step = F2(
				function (d, _v5) {
					...
					if (!_v3.$) {
						var declaration = _v3.a.d8;
						var name = $stil4m$elm_syntax$Elm$Syntax$Node$value(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(declaration).a1);
						var _v4 = $stil4m$elm_syntax$Elm$Syntax$Node$value(declaration);
						var expression = _v4.bY;
						var _arguments = _v4.c_;
						return _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								function (es) {
									return {
										dW: A2($elm$core$List$concatMap, $SiriusStarr$elm_review_no_unsorted$Util$allBindingsInPattern, _arguments),
										cm: $SiriusStarr$elm_review_no_unsorted$Util$findAllNamesIn(expression),
										b$: $elm$core$Maybe$Nothing,
										bF: $elm$core$Set$singleton(name),
										cM: $stil4m$elm_syntax$Elm$Syntax$Node$range(d),
										V: A2($SiriusStarr$elm_review_no_unsorted$Util$countUsesIn, lb.bY, name) >= 1,
										a4: A2(
											$elm$core$List$any,
											function (e) {
												return A2($SiriusStarr$elm_review_no_unsorted$Util$countUsesIn, e, name) >= 1;
											},
											es)
									};
								},
						...
						var bs = $SiriusStarr$elm_review_no_unsorted$Util$allBindingsInPattern(p);
						return _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								function (es) {
									return {
										...
										V: A2(
											...
											A2(
												...
												$SiriusStarr$elm_review_no_unsorted$Util$countUsesIn(lb.bY)),
											bs),
										a4: A2(
											$elm$core$List$any,
											function (e) {
												return A2(
													...
													A2(
														$elm$core$Basics$composeL,
														$elm$core$Basics$lt(0),
														$SiriusStarr$elm_review_no_unsorted$Util$countUsesIn(e)),
													bs);
											},
											es)
									};
			...
			var exprs = _v2.b;
			return A5(
				$SiriusStarr$elm_review_no_unsorted$Util$checkSortingWithGlue,
				context.ct,
				'Let declarations',
				sortBy,
				errorRange,
		...
		return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
			{
				...
				E: A2($jfmengels$elm_review$Review$Rule$compactProjectDataVisitors, $elm$core$Basics$identity, schema.E),
				F: A2(
		...
		return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
			{
				...
				aV: $elm$core$Maybe$Nothing,
				aJ: 0,
				S: $elm$core$Maybe$Just(schema.S),
				bf: _List_fromArray(
					[
						$jfmengels$elm_review$Review$Rule$removeExtensibleRecordTypeVariable(
						$elm$core$Basics$always(moduleVisitor))
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$initialContext = $jfmengels$elm_review$Review$Rule$withSourceCodeExtractor(
	$jfmengels$elm_review$Review$Rule$initContextCreator(
		F2(
			function (extractSource, _v0) {
				return {ct: extractSource};
			})));
var $jfmengels$elm_review$Review$Rule$newModuleRuleSchemaUsingContextCreator = F2(
	function (name, moduleContextCreator) {
		return {ac: _List_Nil, ad: _List_Nil, al: _List_Nil, an: _List_Nil, ae: _List_Nil, af: _List_Nil, E: _List_Nil, F: _List_Nil, z: _List_Nil, H: _List_Nil, r: _List_Nil, ao: _List_Nil, bB: $elm$core$Maybe$Nothing, aj: _List_Nil, ak: _List_Nil, S: moduleContextCreator, ap: _List_Nil, a1: name, J: _List_Nil};
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$rule = function (_v0) {
	var r = _v0;
		...
		A2(
			...
			F2(
				function (e, c) {
					return _Utils_Tuple2(
						A3(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$expressionVisitor,
							_Utils_update(
								r,
								{
									I: $elm$core$List$reverse(r.I),
									x: $elm$core$List$reverse(r.x)
								}),
							e,
							c),
						c);
				}),
			A2($jfmengels$elm_review$Review$Rule$newModuleRuleSchemaUsingContextCreator, 'NoUnsortedLetDeclarations', $SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$initialContext)));
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$DereferencedType = $elm$core$Basics$identity;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$NamedType = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar = F2(
	function (a, b) {
		return {$: 6, a: a, b: b};
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeWithPositionalVars = $elm$core$Basics$identity;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$FunctionType = function (a) {
	return {$: 0, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$ListType = function (a) {
	return {$: 2, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RecordType = function (a) {
	return {$: 5, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TupleType = function (a) {
	return {$: 1, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$UnitType = {$: 3};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType = function (_v0) {
	var t = _v0;
	return t;
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignTypeVars = F2(
		...
		var go = function (t) {
			switch (t.$) {
				case 0:
					var from = t.a.O;
					var to = t.a.Q;
					return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$FunctionType(
						{
							O: go(from),
							Q: go(to)
						});
				case 1:
					var ts = t.a;
					return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TupleType(
						A2($elm$core$List$map, go, ts));
				case 2:
					var t_ = t.a;
					return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$ListType(
						go(t_));
				case 4:
					var _v1 = t.a;
					...
					var ts = t.b;
					return A2(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$NamedType,
						_Utils_Tuple2(moduleName, name),
						A2($elm$core$List$map, go, ts));
				case 5:
					var r = t.a;
					return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RecordType(
						_Utils_update(
							r,
							{
								g: A2(
									...
									r.g),
								l: A2($elm$core$Maybe$map, go, r.l)
							}));
				case 6:
					var _var = t.b;
					return A2(
				...
				default:
					return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$UnitType;
			}
		};
		return go(
			$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType(type_));
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$Appendable = 0;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$CompAppend = 3;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$Comparable = 2;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$Number = 1;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeTypeVar = F2(
	function (constrainedTypeVarsAreRespected, s) {
		return function (t) {
			return A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar, t, s);
		}(
			A2(
				$elm_community$maybe_extra$Maybe$Extra$filter,
				$elm$core$Basics$always(constrainedTypeVarsAreRespected),
				A2($elm$core$String$startsWith, 'number', s) ? $elm$core$Maybe$Just(1) : (A2($elm$core$String$startsWith, 'appendable', s) ? $elm$core$Maybe$Just(0) : (A2($elm$core$String$startsWith, 'comparable', s) ? $elm$core$Maybe$Just(2) : (A2($elm$core$String$startsWith, 'compappend', s) ? $elm$core$Maybe$Just(3) : $elm$core$Maybe$Nothing)))));
	});
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$docTypeToType = F3(
	function (currentModule, settings, type_) {
		var constrainedTypeVarsAreRespected = settings.v;
		var recordIsCanonical = settings.w;
		var go = A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$docTypeToType, currentModule, settings);
		var makeList = F3(
			function (mod, name, args) {
				var _v3 = _Utils_Tuple3(mod, name, args);
				if (((((_v3.a.b && (_v3.a.a === 'List')) && (!_v3.a.b.b)) && (_v3.b === 'List')) && _v3.c.b) && (!_v3.c.b.b)) {
					var _v4 = _v3.a;
					var _v5 = _v3.c;
					var listType = _v5.a;
					return $elm$core$Maybe$Just(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$ListType(
							go(listType)));
				} else {
					return $elm$core$Maybe$Nothing;
				}
		...
		switch (type_.$) {
			...
			case 3:
				...
				return function (_v2) {
					...
					A2(
						$elm$core$Maybe$withDefault,
						_Utils_Tuple2(currentModule, qualified),
						A2(
							$elm$core$Maybe$map,
							function (_v1) {
								var n = _v1.a;
								var m = _v1.b;
								return _Utils_eq(m, _List_Nil) ? _Utils_Tuple2(currentModule, n) : _Utils_Tuple2(m, n);
							},
				...
				return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RecordType(
					{
						...
						l: A2(
							$elm$core$Maybe$map,
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar($elm$core$Maybe$Nothing),
							generic)
					});
			default:
				var s = type_.a;
				return A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeTypeVar, constrainedTypeVarsAreRespected, s);
		}
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makePositionalArgTypeVars = A2(
	$elm$core$Basics$composeR,
	$elm$core$List$indexedMap(
		F2(
			function (i, s) {
				return _Utils_Tuple2(
					s,
					A2(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar,
						$elm$core$Maybe$Nothing,
						'positional arg ' + $elm$core$String$fromInt(i)));
			})),
	$elm$core$Dict$fromList);
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$docTypeToTypeWithPositionalVars = F3(
	function (currentModule, settings, typeArgs) {
		return A2(
			$elm$core$Basics$composeR,
			A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$docTypeToType, currentModule, settings),
			A2(
				$elm$core$Basics$composeR,
				$elm$core$Basics$identity,
				A2(
					$elm$core$Basics$composeR,
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignTypeVars(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makePositionalArgTypeVars(typeArgs)),
					A2($elm$core$Basics$composeR, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType, $elm$core$Basics$identity))));
	});
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$initialProjectContext = {o: $elm$core$Dict$empty, q: $elm$core$Dict$empty, d6: $elm$core$Dict$empty, p: $elm$core$Dict$empty};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getTypeWithPositionalVars = function (_v0) {
	var t = _v0;
	return t;
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFunctionType = F2(
	function (_return, ts) {
		if (!ts.b) {
			return _return;
		} else {
			...
			return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$FunctionType(
				{
					O: t,
					Q: A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFunctionType, _return, ts_)
				});
		}
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFunctionTypeWithPositionalVars = F2(
	function (_return, ts) {
		return A2(
			$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFunctionType,
			$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getTypeWithPositionalVars(_return),
			A2($elm$core$List$map, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getTypeWithPositionalVars, ts));
	});
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$dependencyVisitor = function () {
	var step = F2(
		function (mod, acc) {
			var aliases = mod.o;
			var binops = mod.dZ;
			var unions = mod.eY;
			var values = mod.e_;
			var moduleName = A2($elm$core$String$split, '.', mod.a1);
			var recordFromTypeAlias = function (_v16) {
				var name = _v16.a1;
				var args = _v16.dW;
				var tipe = _v16.ch;
				if (tipe.$ === 4) {
												...
												function (i, _v14) {
													...
													return A2(
														...
														_Utils_Tuple2(
															i,
															A3(
																$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$docTypeToType,
																moduleName,
																{v: false, w: true},
																t)));
												}),
							...
							_List_fromArray(
								[
									...
									name,
									{
										...
										eW: A2(
											$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFunctionTypeWithPositionalVars,
											A4(
												$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$docTypeToTypeWithPositionalVars,
												moduleName,
												{v: true, w: true},
												args,
												tipe),
			...
			var makeConstructor = F3(
				function (_return, typeVars, _v11) {
					var name = _v11.a;
					var _arguments = _v11.b;
					return _Utils_Tuple2(
						name,
						A2(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFunctionTypeWithPositionalVars,
			...
			var functionsFromCustomType = function (_v9) {
				var name = _v9.a1;
				var args = _v9.dW;
				var tags = _v9.eV;
				return A2(
					...
					A2(
						...
						A2(
							makeConstructor,
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType(
								A2(
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignTypeVars,
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makePositionalArgTypeVars(args),
									A2(
										$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$NamedType,
										_Utils_Tuple2(moduleName, name),
										A2(
			...
			var functionFromValue = function (_v8) {
				var name = _v8.a1;
				var tipe = _v8.ch;
				return A2(
					$elm$core$Tuple$pair,
			...
			var functionFromOperator = function (_v7) {
				var name = _v7.a1;
				var tipe = _v7.ch;
				return A2(
					$elm$core$Tuple$pair,
			...
			var newRecords = _v2.a;
			var newRecordConstructors = _v2.b;
			var newConstructors = A2(
				$elm$core$Maybe$map,
				$elm$core$Tuple$pair(moduleName),
				A2(
					$SiriusStarr$elm_review_no_unsorted$Util$validate,
					...
					A2(
						...
						$elm$core$Dict$fromList(
							A2($elm$core$List$concatMap, functionsFromCustomType, unions)))));
			return _Utils_update(
				acc,
				{
					o: A3(
						...
						function (_v3) {
							var k = _v3.a;
							var v = _v3.b;
							return A3($elm$core$Dict$insert, k, v, acc.o);
						},
						newAliases),
					q: A3(
						$elm_community$maybe_extra$Maybe$Extra$unwrap,
						...
						function (_v4) {
							var k = _v4.a;
							var v = _v4.b;
							return A3($elm$core$Dict$insert, k, v, acc.q);
						},
						newRecords),
					d6: A3(
						$elm_community$maybe_extra$Maybe$Extra$unwrap,
						...
						function (_v5) {
							var k = _v5.a;
							var v = _v5.b;
							return A3($elm$core$Dict$insert, k, v, acc.d6);
						},
						newConstructors),
					p: A3(
						$elm_community$maybe_extra$Maybe$Extra$unwrap,
						...
						function (_v6) {
							var k = _v6.a;
							var v = _v6.b;
							return A3($elm$core$Dict$insert, k, v, acc.p);
						},
						newFunctions)
				});
		});
	return $elm$core$Dict$foldl(
		F3(
			function (_v0, dep, acc) {
				return function (_v1) {
					var aliases = _v1.o;
					var canonicalRecords = _v1.q;
					var constructors = _v1.d6;
					var functionTypes = _v1.p;
					return _Utils_update(
						acc,
						{
							o: A2($elm$core$Dict$union, aliases, acc.o),
							q: A2($elm$core$Dict$union, canonicalRecords, acc.q),
							d6: A2($elm$core$Dict$union, constructors, acc.d6),
							p: A2($elm$core$Dict$union, functionTypes, acc.p)
						});
				}(
					A3(
						$elm$core$List$foldl,
						step,
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$initialProjectContext,
						$jfmengels$elm_review$Review$Project$Dependency$modules(dep)));
			}));
}();
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$foldProjectContexts = F2(
	function (newContext, prevContext) {
		return {
			o: A2($elm$core$Dict$union, newContext.o, prevContext.o),
			q: A2($elm$core$Dict$union, newContext.q, prevContext.q),
			d6: A2($elm$core$Dict$union, newContext.d6, prevContext.d6),
			p: A2($elm$core$Dict$union, newContext.p, prevContext.p)
		};
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$aliasIsExposed = F3(
	function (es, alias_, _v0) {
		return A2(
			$elm$core$List$any,
			function (e) {
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$constructorIsExposed = F3(
	function (es, constructor, _v0) {
		var customTypeName = _v0.bp;
		return A2(
			$elm$core$List$any,
			function (e) {
				var _v1 = _Utils_Tuple2(
					$stil4m$elm_syntax$Elm$Syntax$Node$value(e),
					customTypeName);
				_v1$2:
				while (true) {
					if (!_v1.b.$) {
						if (_v1.a.$ === 3) {
							...
							var open = _v1.a.a.eC;
							var type_ = _v1.b.a;
							return _Utils_eq(name, type_) && $elm_community$maybe_extra$Maybe$Extra$isJust(open);
						} else {
							break _v1$2;
						}
					} else {
						if (_v1.a.$ === 2) {
							var name = _v1.a.a;
							var _v2 = _v1.b;
							return _Utils_eq(name, constructor);
						} else {
							break _v1$2;
						}
					}
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$functionIsExposed = F3(
	function (es, name, _v0) {
		return A2(
			$elm$core$List$any,
			function (e) {
				var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(e);
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$fromModuleToProject = function () {
	var filterUnexposed = F2(
		function (context, isExposed) {
			return A2(
	...
	return $jfmengels$elm_review$Review$Rule$initContextCreator(
		function (moduleContext) {
			return {
				o: moduleContext.o,
				q: A3(filterUnexposed, moduleContext, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$aliasIsExposed, moduleContext.q),
				d6: A3(filterUnexposed, moduleContext, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$constructorIsExposed, moduleContext.d6),
				p: A3(filterUnexposed, moduleContext, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$functionIsExposed, moduleContext.p)
			};
		});
}();
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$fromProjectToModule = $jfmengels$elm_review$Review$Rule$withMetadata(
	$jfmengels$elm_review$Review$Rule$withSourceCodeExtractor(
		$jfmengels$elm_review$Review$Rule$withModuleNameLookupTable(
			$jfmengels$elm_review$Review$Rule$initContextCreator(
				F4(
					function (lookupTable, sourceCodeExtractor, metadata, projectContext) {
						return {
							o: projectContext.o,
							q: projectContext.q,
							d6: projectContext.d6,
							au: $jfmengels$elm_review$Review$Rule$moduleNameFromMetadata(metadata),
							cs: $elm$core$Maybe$Nothing,
							ct: sourceCodeExtractor,
							p: projectContext.p,
							cF: lookupTable
						};
					})))));
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignPositionalTypeVars = F2(
	function (ts, t) {
		return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType(
			function (vars) {
				return A2(
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignTypeVars,
					vars,
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getTypeWithPositionalVars(t));
			}(
				$elm$core$Dict$fromList(
					A2(
						$elm$core$List$indexedMap,
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$dereferenceType = F2(
					...
					return A2(
						...
						A2(
							...
							A2(
								$elm$core$Basics$composeL,
								go,
								$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignPositionalTypeVars(ts_)),
							A2(
								$elm$core$Maybe$andThen,
								$elm$core$Dict$get(name),
								A2($elm$core$Dict$get, moduleName, context.o))));
				case 5:
					var r = t.a;
					var fields = A2(
						$elm$core$List$map,
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$flattenFunctionType = function () {
	var go = function (t) {
		if (!t.$) {
			var from = t.a.O;
			var to = t.a.Q;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findFunctionType = F4(
	function (_v0, type_, moduleNode, name) {
		var context = _v0.t;
		var localFunctions = _v0.R;
		var getTypeVars = function (t) {
			var _v1 = A2($elm$core$Maybe$map, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType, t);
			if ((!_v1.$) && (_v1.a.$ === 4)) {
				var _v2 = _v1.a;
				var ts = _v2.b;
				return ts;
		...
		return A2(
			...
			A2(
				$elm$core$Basics$composeL,
				$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$flattenFunctionType,
				$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$dereferenceType(context)),
			A2(
				$elm$core$Maybe$andThen,
				function (moduleName) {
					return A3(
						...
						$elm$core$Maybe$map,
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignPositionalTypeVars(
							getTypeVars(type_)),
						A2(
							$elm$core$Maybe$map,
							function ($) {
							...
							A2(
								$elm$core$Maybe$andThen,
								$elm$core$Dict$get(name),
								A2($elm$core$Dict$get, moduleName, context.d6)))) : A2(
						$elm_community$maybe_extra$Maybe$Extra$orElse,
						A2($elm$core$Dict$get, name, localFunctions),
						A2(
							$elm$core$Maybe$andThen,
							$elm$core$Dict$get(name),
							A2($elm$core$Dict$get, moduleName, context.p)));
				},
				A2(
					$elm$core$Maybe$map,
					function (moduleName) {
						return _Utils_eq(moduleName, _List_Nil) ? context.au : moduleName;
					},
					A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameFor, context.cF, moduleNode))));
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getListType = function (assocType) {
	var _v0 = A2($elm$core$Maybe$map, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType, assocType);
	if ((!_v0.$) && (_v0.a.$ === 2)) {
		var t = _v0.a.a;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getRecordFieldTypes = function (type_) {
	var _v0 = A2($elm$core$Maybe$map, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType, type_);
	if ((!_v0.$) && (_v0.a.$ === 5)) {
		var fields = _v0.a.a.g;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getTupleTypes = F2(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$bindingsInPatternWithType = F3(
			...
			function (n, t) {
				return A2(
					...
					A2(
						...
						A2($elm$core$Maybe$map, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType, t)));
			});
		var go = $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$bindingsInPatternWithType(context);
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(pattern);
		switch (_v0.$) {
			case 10:
				var ps = _v0.a;
				return function (t) {
					...
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getListType(type_));
			case 7:
				var ps = _v0.a;
				return $elm$core$List$concat(
					function (ts) {
						return A3($elm$core$List$map2, go, ps, ts);
					}(
						A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getTupleTypes, ps, type_)));
			case 8:
				var ps = _v0.a;
				return $elm$core$List$concat(
					function (ts) {
						...
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getRecordFieldTypes(type_)));
			case 12:
				var name = _v0.a.a1;
				var ps = _v0.b;
				return A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								ps),
							A4(
								$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findFunctionType,
								{t: context, R: $elm$core$Dict$empty},
								type_,
								pattern,
								name))));
			case 9:
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkOperatorApplication = F4(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findOperatorType = F2(
	function (context, op) {
		return A2(
			$elm$core$Maybe$map,
			A2(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typeAnnotToType = F3(
	function (context, settings, annot) {
		var constrainedTypeVarsAreRespected = settings.v;
		var recordIsCanonical = settings.w;
		var go = A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typeAnnotToType, context, settings);
		var makeList = F3(
			function (moduleName, name, args) {
				var _v2 = _Utils_Tuple3(moduleName, name, args);
				if (((((_v2.a.b && (_v2.a.a === 'List')) && (!_v2.a.b.b)) && (_v2.b === 'List')) && _v2.c.b) && (!_v2.c.b.b)) {
					var _v3 = _v2.a;
					var _v4 = _v2.c;
					var listType = _v4.a;
					return $elm$core$Maybe$Just(
					...
					A2(
						...
						function (moduleName) {
							...
							A2(
								...
								A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameFor, context.cF, name)))));
			case 2:
				return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$UnitType;
			case 3:
				var ts = _v0.a;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getFunctionBinding = F2(
	function (context, _v0) {
		var signature = _v0.eM;
		return A2(
			$elm$core$Maybe$map,
			function (_v1) {
				var name = _v1.a1;
				var typeAnnotation = _v1.dS;
				return _Utils_Tuple2(
					$stil4m$elm_syntax$Elm$Syntax$Node$value(name),
					A2(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$dereferenceType,
						context,
						A3(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typeAnnotToType,
							context,
							{v: true, w: false},
							typeAnnotation)));
			},
...
var $SiriusStarr$elm_review_no_unsorted$Util$makeAccessFunc = function (accessFunc) {
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$partiallyApplyArgsAndTypes = F2(
	function (args, types) {
		return function (_v0) {
			var argTypes = _v0.a;
			var _return = _v0.b;
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Tuple$mapBoth,
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType,
							$elm$core$List$map($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType)),
						A2(
							$elm$core$Basics$composeR,
							function (_v1) {
								var r = _v1.a;
								var ts = _v1.b;
								return A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFunctionType, r, ts);
							},
							$elm$core$Basics$identity)),
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$matchesTypeClass = F2(
	function (type_, _class) {
		var typeIsNumber = function (t) {
			_v13$2:
			while (true) {
				if (((((t.$ === 4) && t.a.a.b) && (t.a.a.a === 'Basics')) && (!t.a.a.b.b)) && (!t.b.b)) {
					switch (t.a.b) {
						case 'Int':
							var _v14 = t.a;
							var _v15 = _v14.a;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typesMatch = F3(
									...
									case 5:
										...
										return A4(
											...
											A6(
												...
												$elm$core$Dict$fromList(r1.g),
												$elm$core$Dict$fromList(r2.g),
												{ax: _List_Nil, aL: _List_Nil, aM: _List_Nil}));
									default:
										break _v10$8;
								}
						}
				...
				if (!_v6.a.$) {
					...
					if (_v6.b.$ === 6) {
						...
						return A2(
							...
							A2(
								$elm$core$Maybe$map,
								$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$matchesTypeClass(type_),
								...
								F2(
									function (g, fs) {
										return A3(
											go,
											vars,
											$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RecordType(
												{N: false, g: fs, l: $elm$core$Maybe$Nothing}),
											g);
									}),
								generic1,
								A2(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$unifyTwoTypes = F2(
							...
							if (_v4.a.a.$ === 1) {
								...
								if ((_v4.b.$ === 6) && (_v4.b.a.$ === 1)) {
									...
									return A2(
										$SiriusStarr$elm_review_no_unsorted$Util$validate,
										function (t) {
											return A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$matchesTypeClass, t, tc);
										},
										type2);
								}
							}
							...
							switch (_v4.b.$) {
								...
								case 0:
									...
									return A3(
										...
										$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$cyclic$unifyTypes()(
											_List_fromArray(
												[f1.O, f2.O])),
										$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$cyclic$unifyTypes()(
											_List_fromArray(
						...
						case 1:
							switch (_v4.b.$) {
								...
								case 1:
									...
									return A2(
										$elm$core$Maybe$map,
										$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TupleType,
										A2(
											$elm_community$maybe_extra$Maybe$Extra$traverse,
											function (_v11) {
												var t1 = _v11.a;
												var t2 = _v11.b;
												return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$cyclic$unifyTypes()(
													_List_fromArray(
														[t1, t2]));
											},
											A2($elm_community$list_extra$List$Extra$zip, t1s, t2s)));
										...
										return A2(
											...
											function (both_) {
												var _v13 = _Utils_Tuple2(
													_Utils_Tuple2(r1.l, only2),
													_Utils_Tuple2(r2.l, only1));
												_v13$4:
												while (true) {
													if (!_v13.a.a.$) {
														if (_v13.a.a.a.$ === 6) {
											...
											F4(
												function (f, t1, t2, acc) {
													return _Utils_update(
														...
														{
															ax: function (x) {
																return A2($elm$core$List$cons, x, acc.ax);
															}(
																A2(
																	$elm$core$Maybe$map,
...
function $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$cyclic$unifyTypes() {
	return A2(
		$elm$core$Basics$composeR,
		A2(
			$elm$core$List$foldl,
		...
		function (ts) {
			var _v0 = _Utils_Tuple2(
				...
				A2(
					$elm$core$List$filter,
					$elm$core$Basics$neq(
						A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar, $elm$core$Maybe$Nothing, 'inferred empty list typevar')),
					ts));
			_v0$0:
			while (true) {
				if (!_v0.b.b) {
							...
							return A3(
								...
								F2(
									function (t_, acc) {
										return A2(
											$elm$core$Maybe$andThen,
											$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$unifyTwoTypes(t_),
											acc);
									}),
								$elm$core$Maybe$Just(t),
								ts_);
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$unifyTypes = $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$cyclic$unifyTypes();
$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$cyclic$unifyTypes = function () {
	return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$unifyTypes;
};
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$bindingsFromLetDeclaration = F2(
	function (local, d) {
		if (!d.$) {
			var f = d.a;
			return A2(
						...
						function (_v11) {
							...
							return A2(
								...
								A2(
									$elm$core$Maybe$map,
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType,
									A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferExprType, local, expression)));
						}(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(f.d8)),
						A2(
							$elm$core$Maybe$map,
							$elm$core$Tuple$mapSecond($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType),
							A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getFunctionBinding, local.t, f)))));
		} else {
			var p = d.a;
			var e = d.b;
			return A3(
				$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$bindingsInPatternWithType,
				local.t,
				p,
				A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferExprType, local, e));
		}
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferApplicationChain = F2(
	function (local, es) {
		inferApplicationChain:
		while (true) {
			var inferExpr = $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferExprType(local);
			var getReturnType = F2(
				function (args, _v9) {
					var argTypes = _v9.a;
					var returnType = _v9.b;
					return function (typeVars) {
						return A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignTypeVars, typeVars, returnType);
					}(
						A2(
										...
										function (_v6, typeVars) {
											...
											return A2(
												...
												A2(
													...
													A2(
														$elm$core$Maybe$map,
														A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typesMatch, typeVars, t1),
														t2)));
										}),
									$elm$core$Dict$empty,
									A2(
			...
			if (!es.b) {
				...
				if (!es.b.b) {
					...
					var func = es.a;
					var args = es.b;
					var _v5 = $stil4m$elm_syntax$Elm$Syntax$Node$value(func);
					switch (_v5.$) {
						case 3:
							var name = _v5.b;
							return A2(
								...
								A2(
									$elm$core$Maybe$andThen,
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$partiallyApplyArgsAndTypes(args),
									A2(
										$elm_community$maybe_extra$Maybe$Extra$orElse,
										A2(
											$elm$core$Maybe$map,
											$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$flattenFunctionType,
											inferExpr(func)),
										A4($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findFunctionType, local, $elm$core$Maybe$Nothing, func, name))));
						case 5:
							var op = _v5.a;
							return A2(
								$elm$core$Maybe$map,
								...
								A2(
									$elm$core$Maybe$andThen,
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$partiallyApplyArgsAndTypes(args),
									A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findOperatorType, local.t, op)));
						case 14:
							var func_ = _v5.a;
						...
						case 21:
							var accessFunc = _v5.a;
							return function (ts) {
								return function (f) {
									return A2($elm$core$Dict$get, f, ts);
								}(
									$SiriusStarr$elm_review_no_unsorted$Util$makeAccessFunc(accessFunc));
							}(
								$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getRecordFieldTypes(
									A2(
										$elm$core$Maybe$andThen,
										inferExpr,
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferExprType = function (local) {
	var makeFunc = A2(
		$elm$core$Basics$composeR,
	...
	var go = function (node) {
		...
		while (true) {
			...
			switch (_v0.$) {
				case 0:
					return $elm$core$Maybe$Just($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$UnitType);
				case 7:
					return $elm$core$Maybe$Just(
						A2(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$NamedType,
				...
				case 13:
					...
					return A2(
						$elm$core$Maybe$map,
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TupleType,
						A2($elm_community$maybe_extra$Maybe$Extra$traverse, go, es));
				case 19:
					var es = _v0.a;
					return $elm$core$List$isEmpty(es) ? $elm$core$Maybe$Just(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$ListType(
							A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar, $elm$core$Maybe$Nothing, 'inferred empty list typevar'))) : A2(
						$elm$core$Maybe$map,
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$ListType,
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$unifyTypes(
							A2($elm$core$List$filterMap, go, es)));
				case 18:
					var rs = _v0.a;
					return A2(
						$elm$core$Maybe$map,
						function (fields) {
							return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RecordType(
								{N: false, g: fields, l: $elm$core$Maybe$Nothing});
						},
				...
				case 3:
					var name = _v0.b;
					return makeFunc(
						A4($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findFunctionType, local, $elm$core$Maybe$Nothing, node, name));
				case 14:
					var e = _v0.a;
					var $temp$node = e;
					node = $temp$node;
				...
				case 5:
					var p = _v0.a;
					return makeFunc(
						A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findOperatorType, local.t, p));
				case 16:
					var cases = _v0.a.d1;
					return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$unifyTypes(
						A2(
							$elm$core$List$filterMap,
							A2($elm$core$Basics$composeL, go, $elm$core$Tuple$second),
							cases));
				case 1:
					var es = _v0.a;
					return A2(
						$elm$core$Maybe$map,
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType,
						A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferApplicationChain, local, es));
				case 17:
					var expression = _v0.a.bY;
					...
					return A2(
						...
						function (ts) {
							return function (f) {
								...
								$SiriusStarr$elm_review_no_unsorted$Util$makeAccessFunc(
				...
				case 21:
					...
					return function (f) {
						return $elm$core$Maybe$Just(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$FunctionType(
								{
									O: $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RecordType(
										{
											N: false,
											g: _List_fromArray(
												[
													_Utils_Tuple2(
													f,
													A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar, $elm$core$Maybe$Nothing, 'record access inferred field for ' + f))
												]),
											l: $elm$core$Maybe$Just(
												A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar, $elm$core$Maybe$Nothing, 'record access inferred for ' + f))
										}),
									Q: A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar, $elm$core$Maybe$Nothing, 'record access inferred field for ' + f)
								}));
					}(
						$SiriusStarr$elm_review_no_unsorted$Util$makeAccessFunc(accessFunc));
				case 6:
				...
				case 2:
					...
					return A2(
						...
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType,
						A4(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkOperatorApplication,
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferApplicationChain(local),
							op,
							e1,
							e2));
				case 15:
					...
					var newBindings = $elm$core$Dict$fromList(
						A2(
							...
							A2(
								$elm$core$Basics$composeL,
								$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$bindingsFromLetDeclaration(local),
								$stil4m$elm_syntax$Elm$Syntax$Node$value),
							declarations));
					return A2(
						$elm$core$Maybe$map,
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType,
						A2(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferExprType,
							_Utils_update(
								local,
								{
									R: A2($elm$core$Dict$union, local.R, newBindings)
								}),
							expression));
				default:
					var _var = _v0.a;
								...
								return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RecordType(
									{
										...
										g: fields,
										l: $elm$core$Maybe$Just(
											A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar, $elm$core$Maybe$Nothing, 'inferred update generic'))
									});
							},
							A2(
								$elm_community$maybe_extra$Maybe$Extra$traverse,
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$ambiguousRecordError = F2(
	function (matching, range) {
		...
		return A2(
			$jfmengels$elm_review$Review$Rule$error,
			{
				...
				aw: 'Ambiguous record encountered.'
			},
			range);
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$FieldOrder = $elm$core$Basics$identity;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$OrderedFields = function (a) {
	return {$: 1, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$UnknownFields = function (a) {
	return {$: 0, a: a};
};
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$searchOrders = F3(
	function (context, hasAllFields, fields) {
		...
		var matchFields = $elm$core$Dict$fromList(
			A2(
				$elm$core$List$map,
				function (f) {
					return _Utils_Tuple2(f.A, f);
				},
				fields));
		var checkTypes = function (_v2) {
			var order = _v2.cJ;
			return A3(
				$elm$core$List$foldl,
				F2(
					function (_v0, _v1) {
						...
						return A2(
							...
							A2(
								$elm$core$Maybe$withDefault,
								_Utils_Tuple2(varAcc, true),
								A3(
									$elm$core$Maybe$map2,
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typesMatch(varAcc),
									type_,
									A2(
										$elm$core$Maybe$map,
										A2(
		...
		var step = F4(
			function (moduleName, name, o, acc) {
				return (!checkTypes(o)) ? acc : ((_Utils_cmp(
					$elm$core$Dict$size(
						A2($elm$core$Dict$diff, o.cJ, matchFields)),
					missingFieldLimit(o)) > -1) ? acc : (o.bC ? _Utils_update(
					acc,
					{
						by: A2(
							$elm$core$List$cons,
							{
								dt: $elm$core$Dict$values(
									A2($elm$core$Dict$diff, matchFields, o.cJ)),
								eW: _Utils_Tuple2(
									_Utils_Tuple2(moduleName, name),
									o)
							},
					...
					A2($elm$core$Dict$diff, matchFields, o.cJ)) ? _Utils_update(
					acc,
					{
						bo: A2(
							$elm$core$List$cons,
		...
		return A3(
			...
			{bo: _List_Nil, by: _List_Nil},
			context.q);
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findMatchingTypes = F3(
	function (context, info, matchFields) {
		var toFieldOrder = F2(
			function (generic, _v7) {
				var order = _v7.cJ;
				return {N: order, l: generic};
			});
		...
		var getMatches = function (fs) {
			var _v4 = A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$searchOrders, context, hasAllFields, fs);
			var canonicalMatches = _v4.bo;
			var genericMatches = _v4.by;
			return _Utils_ap(
				A2(
					$elm$core$List$map,
					A2(
						$elm$core$Tuple$mapBoth,
						$elm$core$List$singleton,
						toFieldOrder($elm$core$Maybe$Nothing)),
					canonicalMatches),
			...
			return function (ls) {
				return $elm$core$List$isEmpty(ls) ? _List_fromArray(
					[
						...
						A2(
							toFieldOrder,
							$elm$core$Maybe$Just(
								$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$UnknownFields(
									A2(
										$elm$core$List$map,
										function ($) {
											return $.A;
				...
				A2(
					...
					function (_v2) {
						...
						var f = _v2.b;
						return _Utils_Tuple2(
							A2($elm$core$List$cons, n, names),
							A2(
								toFieldOrder,
								$elm$core$Maybe$Just(
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$OrderedFields(f)),
								rec));
					},
					getMatches(missing)));
		};
		if ((!info.$) && (!info.a.$)) {
			var f = info.a.a;
			return $elm$core$List$singleton(
				_Utils_Tuple2(_List_Nil, f));
		} else {
			return getMatches(matchFields);
		}
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeOrder = function (sortGenerics) {
	...
	var go = F3(
		function (offsetMult, fieldsToMake, _v0) {
			var canonical = _v0.N;
			var generic = _v0.l;
			var step = F2(
				function (f, _v6) {
					var canAcc = _v6.a;
					var genAcc = _v6.b;
					var _v4 = A2($elm$core$Dict$get, f.A, canonical);
					if (!_v4.$) {
						var _v5 = _v4.a;
						var i = _v5.a;
						return _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(f.A, i + (offsetMult * genericOffset)),
								canAcc),
							genAcc);
					} else {
						return _Utils_Tuple2(
											...
											function (f) {
												return _Utils_Tuple2(
													...
													((offsetMult + 1) * genericOffset) + A2(
														$elm$core$Maybe$withDefault,
														-1,
														A2($elm_community$list_extra$List$Extra$elemIndex, f.A, alph)));
											},
											fs)),
									true);
							}
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$unknownRecordError = function (range) {
	return A2(
		$jfmengels$elm_review$Review$Rule$error,
		{
			bR: _List_fromArray(
			...
			aw: 'Unknown record encountered.'
		},
		range);
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkRecord = F3(
	function (_v0, context, _v1) {
		var sortUnknown = _v0.ce;
		var sortAmbiguous = _v0.cd;
		var sortGenerics = _v0.cS;
		var fullRange = _v1.bx;
		var orderInfo = _v1.bG;
		var fields = _v1.g;
		if ($elm$core$List$length(fields) > 1) {
			var matchingOrders = function (os) {
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeL,
							A2($elm$core$Basics$composeL, $elm$core$Dict$toList, $elm$core$Tuple$first),
							$elm$core$Tuple$second),
						A2(
							$elm$core$List$map,
							$elm$core$Tuple$mapSecond(
								A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeOrder, sortGenerics, fields)),
							A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findMatchingTypes, context, orderInfo, fields)))));
			var fieldOrder = F3(
				function (ord, f1, f2) {
					var o = function (f) {
						return A2(
			...
			var alphabetical = F2(
				function (f1, f2) {
					return A2($elm$core$Basics$compare, f1.A, f2.A);
				});
			var _v2 = _Utils_Tuple3(matchingOrders, sortUnknown, sortAmbiguous);
			_v2$4:
			while (true) {
				_v2$7:
				while (true) {
					if (!_v2.a.b) {
						switch (_v2.b) {
							case 0:
								var _v3 = _v2.b;
								return checkSortingBy(alphabetical);
							case 1:
								var _v4 = _v2.b;
								return _List_fromArray(
									[
										$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$unknownRecordError(fullRange)
									]);
							default:
								break _v2$7;
						}
							...
							switch (_v2.c) {
								...
								case 1:
									...
									return _List_fromArray(
										[
											A2(
											$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$ambiguousRecordError,
											A2(
												$elm$core$List$map,
												function (_v20) {
													var ns = _v20.a;
			...
			var _v15 = _v14.b;
			var o = _v15.a;
			return checkSortingBy(
				fieldOrder(o));
		} else {
			return _List_Nil;
		}
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$HasFieldOrder = function (a) {
	return {$: 0, a: a};
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFieldOrder = function () {
	var go = function (type_) {
		if (type_.$ === 5) {
			var canonical = type_.a.N;
			var generic = type_.a.l;
			var fields = type_.a.g;
			return canonical ? $elm$core$Result$Ok(
				{
					...
					l: A2(
						...
						function (g) {
							...
							if (!_v2.$) {
								var o = _v2.a;
								return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$OrderedFields(o);
							} else {
								if (!_v2.a.b) {
									return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$OrderedFields(
										{N: $elm$core$Dict$empty, l: $elm$core$Maybe$Nothing});
								} else {
									var fs = _v2.a;
									return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$UnknownFields(
	...
	return A2($elm$core$Basics$composeL, go, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType);
}();
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$recordPatternToCheckable = F2(
	function (fullRange, hasType) {
		var types = $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getRecordFieldTypes(hasType);
		var orderInfo = A2(
			$elm$core$Maybe$map,
			$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$HasFieldOrder,
			A2(
				$elm$core$Maybe$andThen,
				A2($elm$core$Basics$composeL, $elm$core$Result$toMaybe, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFieldOrder),
				hasType));
		return A2(
			$elm$core$Basics$composeR,
			$elm$core$List$map(
				function (r) {
					return {
						A: $stil4m$elm_syntax$Elm$Syntax$Node$value(r),
						cM: $stil4m$elm_syntax$Elm$Syntax$Node$range(r),
						eW: A2(
							$elm$core$Dict$get,
			...
			function (fs) {
				return {g: fs, bx: fullRange, bG: orderInfo};
			});
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkPattern = F4(
	function (config, context, hasType, node) {
		var go = A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkPattern, config, context);
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		switch (_v0.$) {
			case 7:
				var ps = _v0.a;
				return $elm$core$List$concat(
					A3(
						$elm$core$List$map2,
						go,
						A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getTupleTypes, ps, hasType),
						ps));
			case 9:
				var p = _v0.a;
				var ps = _v0.b;
				var type_ = $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getListType(hasType);
				return _Utils_ap(
					A2(go, type_, p),
					A2(go, type_, ps));
			case 10:
			...
			case 8:
				var fields = _v0.a;
				return A3(
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkRecord,
					config,
					context,
					A3(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$recordPatternToCheckable,
						$stil4m$elm_syntax$Elm$Syntax$Node$range(node),
						hasType,
						fields));
			default:
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$HasAllFields = {$: 1};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$recordDefToCheckable = F4(
	function (context, fullRange, hasAllFields, fields) {
		var makeType = A2(
			$elm$core$Basics$composeR,
			A2(
				$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typeAnnotToType,
		...
		return function (fs) {
			return {
				g: fs,
				bx: fullRange,
				bG: hasAllFields ? $elm$core$Maybe$Just($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$HasAllFields) : $elm$core$Maybe$Nothing
			};
		}(
			hasAllFields ? A2(
				$elm$core$List$indexedMap,
				F2(
					function (i, f) {
						var r = $stil4m$elm_syntax$Elm$Syntax$Node$range(f);
						...
						if (!(!i)) {
							var start = r.bn;
							return {
								A: $stil4m$elm_syntax$Elm$Syntax$Node$value(field),
								cM: _Utils_update(
									r,
									{
										bn: _Utils_update(
				...
				$elm$core$List$map,
				function (f) {
					var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(f);
					var field = _v1.a;
					var type_ = _v1.b;
					return {
						A: $stil4m$elm_syntax$Elm$Syntax$Node$value(field),
						cM: $stil4m$elm_syntax$Elm$Syntax$Node$range(f),
						eW: makeType(type_)
					};
				},
				fields));
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkTypeAnnotation = F3(
	function (config, context, type_) {
		var go = A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkTypeAnnotation, config, context);
		...
		switch (_v0.$) {
			case 4:
				...
				return _Utils_ap(
					A3(
						...
						context,
						A4(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$recordDefToCheckable,
							context,
			...
			case 3:
				var types_ = _v0.a;
				return A2($elm$core$List$concatMap, go, types_);
			case 1:
				var types_ = _v0.b;
				return A2($elm$core$List$concatMap, go, types_);
			case 0:
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeRecordAccessType = F2(
					...
					return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$RecordType(
						{
							...
							g: _List_fromArray(
								[
									_Utils_Tuple2(
									f,
									$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType(t))
								]),
							l: $elm$core$Maybe$Just(
								A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$TypeVar, $elm$core$Maybe$Nothing, 'record access field ' + f))
						});
				},
				hasType);
		}(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$recordSettersToCheckable = F4(
	function (context, fullRange, hasAllFields, hasType) {
		var types = $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getRecordFieldTypes(hasType);
		var fallback = hasAllFields ? $elm$core$Maybe$Just($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$HasAllFields) : $elm$core$Maybe$Nothing;
		var orderInfo = A2(
			$elm_community$maybe_extra$Maybe$Extra$orElse,
			fallback,
			A2(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkApplicationChain = F4(
	function (config, local, hasType, es) {
		checkApplicationChain:
		while (true) {
			var checkExpr = A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkExpression, config, local);
			if (!es.b) {
				return _List_Nil;
			} else {
				if (!es.b.b) {
					...
					var func = es.a;
					var args = es.b;
					var _v9 = $stil4m$elm_syntax$Elm$Syntax$Node$value(func);
					switch (_v9.$) {
						case 3:
							var name = _v9.b;
							return A2(
												...
												return A2(
													...
													A2(
														...
														function (typeVars) {
															return A2(
																$elm$core$List$map,
																$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignTypeVars(typeVars),
																argTypes);
														},
														A2(
															$elm$core$Maybe$map,
															...
															A2(
																...
																A2(
																	...
																	A2(
																		$elm$core$Maybe$map,
																		A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typesMatch, $elm$core$Dict$empty, _return),
																		hasType))))));
											},
											A2(
												$elm$core$Maybe$andThen,
												$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$partiallyApplyArgsAndTypes(args),
												A4($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$findFunctionType, local, hasType, func, name))))));
						case 5:
							var op = _v9.a;
							return A2(
								$elm$core$Maybe$withDefault,
						...
						case 21:
							var accessFunc = _v9.a;
							return function (f) {
								return A2($elm$core$List$concatMap, f, args);
							}(
								checkExpr(
									A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeRecordAccessType, hasType, accessFunc)));
						default:
							return A2(
								$elm$core$List$concatMap,
								checkExpr($elm$core$Maybe$Nothing),
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkExpression = F4(
	function (config, local, hasType, node) {
		var go = A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkExpression, config, local);
		...
		switch (_v3.$) {
			...
			case 1:
				var es = _v3.a;
				return A4($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkApplicationChain, config, local, hasType, es);
			case 2:
				var op = _v3.a;
				var e1 = _v3.c;
				var e2 = _v3.d;
				return A4(
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkOperatorApplication,
					A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkApplicationChain, config, local, hasType),
					op,
					e1,
					e2);
			case 4:
			...
			case 13:
				...
				return $elm$core$List$concat(
					A3(
						$elm$core$List$map2,
						go,
						A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getTupleTypes, es, hasType),
						es));
			case 16:
				var expression = _v3.a.bY;
				var cases = _v3.a.d1;
				var caseType = A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferExprType, local, expression);
				return _Utils_ap(
						...
						A2(
							...
							function (_v4) {
								...
								return function (newBindings) {
									return A4(
										$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkExpression,
										config,
										_Utils_update(
											local,
											{
									...
									$elm$core$Dict$fromList(
										A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$bindingsInPatternWithType, local.t, p, caseType)));
							},
							cases),
						A2(
							$elm$core$List$concatMap,
							A2(
								$elm$core$Basics$composeL,
								A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkPattern, config, local.t, caseType),
								$elm$core$Tuple$first),
							cases)));
			case 17:
				var args = _v3.a.dW;
				var expression = _v3.a.bY;
				return A5($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkFunctionArgsAndExpr, config, local, hasType, args, expression);
			case 15:
				var declarations = _v3.a.c5;
				var expression = _v3.a.bY;
				var _v5 = A2(
					$elm$core$Tuple$mapFirst,
					A2($elm$core$Basics$composeL, $elm$core$Dict$fromList, $elm$core$List$concat),
					$elm$core$List$unzip(
						A2(
							...
							A2(
								$elm$core$Basics$composeL,
								A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkLetDeclaration, config, local),
								$stil4m$elm_syntax$Elm$Syntax$Node$value),
							declarations)));
				var newBindings = _v5.a;
				var decsToCheck = _v5.b;
				...
				return _Utils_ap(
					A4($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkExpression, config, newContext, hasType, expression),
					A2(
						$elm$core$List$concatMap,
						function (f) {
							return f(newContext);
						...
						decsToCheck));
			case 18:
				var recordSetters = _v3.a;
				var ts = $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getRecordFieldTypes(hasType);
				return _Utils_ap(
					A2(
						$elm$core$List$concatMap,
						A2(
					...
					A3(
						...
						local.t,
						A5(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$recordSettersToCheckable,
							local,
							$stil4m$elm_syntax$Elm$Syntax$Node$range(node),
							true,
							hasType,
							recordSetters)));
			case 22:
				var recordSetters = _v3.b;
				var updateType = A2(
					$elm_community$maybe_extra$Maybe$Extra$orElse,
					A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferExprType, local, node),
					hasType);
				var ts = $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getRecordFieldTypes(updateType);
				return _Utils_ap(
					A2(
						$elm$core$List$concatMap,
						A2(
			...
			case 20:
				var e = _v3.a;
				var accessFunc = _v3.b;
				return A2(
					go,
					A2(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeRecordAccessType,
						hasType,
						$stil4m$elm_syntax$Elm$Syntax$Node$value(accessFunc)),
					e);
			default:
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkFunctionArgsAndExpr = F5(
		...
		var _v2 = A2(
			...
			A2(
				...
				A2(
					$elm$core$Maybe$andThen,
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$partiallyApplyArgsAndTypes(args),
					A2($elm$core$Maybe$map, $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$flattenFunctionType, hasType))));
		var argTypes = _v2.a;
		var exprType = _v2.b;
		var newBindings = $elm$core$Dict$fromList(
			$elm$core$List$concat(
				A3(
					$elm$core$List$map2,
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$bindingsInPatternWithType(local.t),
					args,
					argTypes)));
		return _Utils_ap(
			A4(
			...
			$elm$core$List$concat(
				A3(
					$elm$core$List$map2,
					A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkPattern, config, local.t),
					argTypes,
					args)));
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkFunctionDeclaration = F3(
	function (config, local, func) {
		var hasType = A2(
			$elm$core$Maybe$map,
			$elm$core$Tuple$second,
			A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getFunctionBinding, local.t, func));
		var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(func.d8);
		var _arguments = _v1.c_;
		var expression = _v1.bY;
		return _Utils_ap(
			A5($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkFunctionArgsAndExpr, config, local, hasType, _arguments, expression),
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2(
					...
					A2(
						...
						A2(
							$elm$core$Basics$composeL,
							A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkTypeAnnotation, config, local.t),
							function ($) {
								return $.dS;
							}),
						$stil4m$elm_syntax$Elm$Syntax$Node$value),
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkLetDeclaration = F3(
	function (config, local, d) {
		return A2(
			$elm$core$Tuple$pair,
			A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$bindingsFromLetDeclaration, local, d),
			function () {
				if (!d.$) {
					var f = d.a;
					return function (local_) {
						return A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkFunctionDeclaration, config, local_, f);
					};
				} else {
					var p = d.a;
					var e = d.b;
					return function (local_) {
						return _Utils_ap(
							A4($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkExpression, config, local_, $elm$core$Maybe$Nothing, e),
							A4(
								$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkPattern,
								config,
								local.t,
								A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$inferExprType, local_, e),
								p));
					};
				}
			}());
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$declarationEnterVisitor = F3(
	function (config, context, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		if (!_v0.$) {
			var f = _v0.a;
			return A3(
				$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$checkFunctionDeclaration,
				config,
				{t: context, R: $elm$core$Dict$empty},
				f);
		} else {
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typeAnnotToTypeWithPositionalVars = F3(
	function (context, settings, typeArgs) {
		return A2(
			$elm$core$Basics$composeR,
			A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typeAnnotToType, context, settings),
			A2(
				$elm$core$Basics$composeR,
				$elm$core$Basics$identity,
				A2(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$declarationListVisitor = F2(
	function (context, declarations) {
		var makeConstructor = F3(
			function (_return, typeVars, _v10) {
				var name = _v10.a1;
				var _arguments = _v10.c_;
				return _Utils_Tuple2(
					$stil4m$elm_syntax$Elm$Syntax$Node$value(name),
					A2(
						$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makeFunctionTypeWithPositionalVars,
						...
						A2(
							$elm$core$List$map,
							A3(
								$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typeAnnotToTypeWithPositionalVars,
								context,
								{v: true, w: true},
								A2($elm$core$List$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, typeVars)),
							_arguments)));
			});
		var makeAliasInfo = function (_v9) {
			var name = _v9.a1;
			var generics = _v9.dh;
			var typeAnnotation = _v9.dS;
			return _Utils_Tuple2(
				$stil4m$elm_syntax$Elm$Syntax$Node$value(name),
				A4(
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$typeAnnotToTypeWithPositionalVars,
		...
		var getFunctionsFromDeclaration = function (node) {
			var _v7 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
			if (!_v7.$) {
				var signature = _v7.a.eM;
				return A2(
					$elm$core$Maybe$map,
					function (_v8) {
						var name = _v8.a1;
						var typeAnnotation = _v8.dS;
						return A2(
							$elm$core$Tuple$pair,
							$stil4m$elm_syntax$Elm$Syntax$Node$value(name),
							A3(
		...
		var getAlias = function (node) {
			var _v6 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
			if (_v6.$ === 1) {
				var alias_ = _v6.a;
				return $elm$core$Maybe$Just(alias_);
			} else {
				return $elm$core$Maybe$Nothing;
			}
		};
		var annotToFields = function (annot) {
			var _v5 = $stil4m$elm_syntax$Elm$Syntax$Node$value(annot);
			switch (_v5.$) {
				case 4:
					var fields = _v5.a;
					return $elm$core$Maybe$Just(
		...
		var getConstructorsFromDeclaration = function (node) {
			var _v3 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
			switch (_v3.$) {
				case 2:
					var name = _v3.a.a1;
					var generics = _v3.a.dh;
					var constructors = _v3.a.d6;
					return A2(
						$elm$core$List$map,
						A2(
							$elm$core$Basics$composeR,
								...
								A2(
									...
									function (gs) {
										return $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$getType(
											A2(
												$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$assignTypeVars,
												$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$makePositionalArgTypeVars(gs),
												A2(
													$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$NamedType,
													_Utils_Tuple2(
														_List_Nil,
		...
		var recordFromTypeAlias = function (_v2) {
			var name = _v2.a1;
			var typeAnnotation = _v2.dS;
			return A2(
				$elm$core$Maybe$map,
				$elm$core$Tuple$pair(
					$stil4m$elm_syntax$Elm$Syntax$Node$value(name)),
		...
		return _Utils_update(
			context,
			{
				o: A3(
					...
					context.o,
					function (v) {
						return A3($elm$core$Dict$insert, context.au, v, context.o);
					},
					A2(
						$elm$core$Maybe$map,
						$elm$core$Dict$fromList,
						A2(
							...
							A2(
								...
								A2(
									$elm$core$Basics$composeL,
									$elm$core$Maybe$map(makeAliasInfo),
									getAlias),
								declarations)))),
				q: A3(
					$elm_community$maybe_extra$Maybe$Extra$unwrap,
					context.q,
					function (v) {
						return A3($elm$core$Dict$insert, context.au, v, context.q);
					},
					A2(
						$elm$core$Maybe$map,
						$elm$core$Dict$fromList,
						A2(
							...
							A2(
								...
								A2(
									$elm$core$Basics$composeL,
									$elm$core$Maybe$andThen(recordFromTypeAlias),
									getAlias),
								declarations)))),
				d6: A3(
					$elm_community$maybe_extra$Maybe$Extra$unwrap,
					context.d6,
					function (v) {
						return A3($elm$core$Dict$insert, context.au, v, context.d6);
					},
					A2(
						$elm$core$Maybe$map,
						$elm$core$Dict$fromList,
						A2(
							$SiriusStarr$elm_review_no_unsorted$Util$validate,
							A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$List$isEmpty),
							A2($elm$core$List$concatMap, getConstructorsFromDeclaration, declarations)))),
				p: A3(
					$elm_community$maybe_extra$Maybe$Extra$unwrap,
					context.p,
					function (v) {
						return A3($elm$core$Dict$insert, context.au, v, context.p);
					},
					A2(
						$elm$core$Maybe$map,
						$elm$core$Dict$fromList,
						A2(
							$SiriusStarr$elm_review_no_unsorted$Util$validate,
							A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$List$isEmpty),
							A2($elm$core$List$filterMap, getFunctionsFromDeclaration, declarations))))
			});
	});
var $stil4m$elm_syntax$Elm$Syntax$Module$exposingList = function (m) {
	switch (m.$) {
		case 0:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.cs);
		case 1:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.cs);
		default:
...
var $jfmengels$elm_review$Review$Rule$withModuleDefinitionVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				ap: A2($elm$core$List$cons, visitor, schema.ap)
			});
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$moduleVisitor = F2(
	function (config, schema) {
		return A2(
			...
			F2(
				function (d, c) {
					return _Utils_Tuple2(
						A3($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$declarationEnterVisitor, config, c, d),
						c);
				}),
			A2(
				$jfmengels$elm_review$Review$Rule$withDeclarationListVisitor,
				F2(
					function (ds, c) {
						return _Utils_Tuple2(
							_List_Nil,
							A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$declarationListVisitor, c, ds));
					}),
				A2(
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$rule = function (config) {
	return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
		$jfmengels$elm_review$Review$Rule$withContextFromImportedModules(
			A2(
				$jfmengels$elm_review$Review$Rule$withModuleContextUsingContextCreator,
				{ef: $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$foldProjectContexts, eg: $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$fromModuleToProject, eh: $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$fromProjectToModule},
				A2(
					$jfmengels$elm_review$Review$Rule$withModuleVisitor,
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$moduleVisitor(config),
					A2(
						$jfmengels$elm_review$Review$Rule$withDependenciesProjectVisitor,
						F2(
							function (d, c) {
								return _Utils_Tuple2(
									_List_Nil,
									A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$dependencyVisitor, c, d));
							}),
						A2($jfmengels$elm_review$Review$Rule$newProjectRuleSchema, 'NoUnsortedRecords', $SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$initialProjectContext))))));
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$Function = 0;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$Port = 1;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$Type = 2;
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$getDecInfo = F2(
	function (exports, d) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(d);
		switch (_v0.$) {
			case 0:
				var declaration = _v0.a.d8;
				return $elm$core$Maybe$Just(
					function (_v1) {
						var name = _v1.a1;
						var expression = _v1.bY;
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$declarationVisitor = F3(
	function (_v0, decs, context) {
		...
		return A5(
			...
			function (ds) {
				...
				A2(
					$elm$core$List$filterMap,
					$SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$getDecInfo(context.bV),
					decs)));
	});
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$getModuleExports = F2(
	function (m, context) {
		...
		var errorRange = function () {
			...
			if (_v2.$ === 1) {
				return _Utils_update(
					r,
					{
						a8: {ay: r.bn.ay + 11, aN: r.bn.aN}
					});
			} else {
				return _Utils_update(
					r,
					{
						a8: {ay: r.bn.ay + 6, aN: r.bn.aN}
					});
			}
		}();
...
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$initialContext = $jfmengels$elm_review$Review$Rule$withSourceCodeExtractor(
	$jfmengels$elm_review$Review$Rule$initContextCreator(
		F2(
			function (extractSource, _v0) {
				return {bq: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, bV: $elm$core$Maybe$Nothing, ct: extractSource};
			})));
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$rule = function (_v0) {
	var r = _v0;
	return $jfmengels$elm_review$Review$Rule$fromModuleRuleSchema(
		A2(
			$jfmengels$elm_review$Review$Rule$withDeclarationListVisitor,
			F2(
				function (ds, c) {
					return _Utils_Tuple2(
						A3(
							$SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$declarationVisitor,
							_Utils_update(
								r,
								{
									I: $elm$core$List$reverse(r.I),
			...
			A2(
				...
				F2(
					function (m, c) {
						return _Utils_Tuple2(
							_List_Nil,
							A2($SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$getModuleExports, m, c));
					}),
				A2($jfmengels$elm_review$Review$Rule$newModuleRuleSchemaUsingContextCreator, 'NoUnsortedTopLevelDeclarations', $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$initialContext))));
};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$sortLetDeclarations = {I: _List_Nil, x: _List_Nil};
var $SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$sortTopLevelDeclarations = {I: _List_Nil, x: _List_Nil};
var $author$project$ReviewConfig$config = _List_fromArray(
	[
		$SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$rule($SiriusStarr$elm_review_no_unsorted$NoUnsortedCases$defaults),
		$SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$rule(
		$SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$alphabetically($SiriusStarr$elm_review_no_unsorted$NoUnsortedLetDeclarations$sortLetDeclarations)),
		$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$rule(
		$SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$reportAmbiguousRecordsWithoutFix($SiriusStarr$elm_review_no_unsorted$NoUnsortedRecords$defaults)),
		$SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$rule(
		$SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$alphabetically(
			$SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$exposedOrderWithPrivateLast(
				$SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$portsFirst($SiriusStarr$elm_review_no_unsorted$NoUnsortedTopLevelDeclarations$sortTopLevelDeclarations))))
	]);
var $author$project$Elm$Review$Main$DecodedFlags = F8(
	function (fixMode, detailsMode, reportMode, ignoreProblematicDependencies, rulesFilter, ignoredDirs, ignoredFiles, logger) {
		return {aB: detailsMode, ba: fixMode, bc: ignoreProblematicDependencies, cA: ignoredDirs, cB: ignoredFiles, av: logger, bk: reportMode, cQ: rulesFilter};
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'start',
				$author$project$Elm$Review$Main$encodePosition(range.bn)),
				_Utils_Tuple2(
				'end',
				$author$project$Elm$Review$Main$encodePosition(range.a8))
			]));
};
...
var $author$project$Elm$Review$Text$from = function (value) {
	return {d3: $elm$core$Maybe$Nothing, ej: $elm$core$Maybe$Nothing, eP: value};
};
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					$elm$core$Array$builderToArray,
					true,
					{B: nodeList, u: nodeListSize, y: jsArray});
			} else {
...
var $author$project$Elm$Review$Reporter$codeExtract = function (_v0) {
	...
	return function (_v1) {
		...
		var maxLineNumber = $elm$core$String$isEmpty(
			getRowAtLine(end.aN + 1)) ? end.aN : (end.aN + 1);
		...
		if (_Utils_eq(start.aN, end.aN)) {
			if (_Utils_eq(start.ay, end.ay)) {
				...
				var lineContent = getRowWithLineNumber(start.aN - 1);
				return A2(
					...
					A2(
						...
						_List_fromArray(
							[
								getRowWithLineNumberUnlessEmpty(start.aN - 2),
								_List_fromArray(
								[
								...
								gutterLength,
								{a8: end.ay, b1: lineContent, bn: start.ay}),
								getRowWithLineNumberUnlessEmpty(end.aN)
							])));
			}
		} else {
			var startLineNumber = start.aN - 1;
			...
			var startLineContentWithLineNumber = _Utils_ap(
				...
				startLineContent);
			var linesBetweenStartAndEnd = A2($elm$core$List$range, start.aN, end.aN - 2);
			var endLine = end.aN - 1;
				...
				A2(
					...
					_List_fromArray(
						[
							...
							gutterLength,
							{
								a8: $elm$core$List$length(
									$elm$core$String$toList(startLineContent)) + 1,
								b1: startLineContentWithLineNumber,
								bn: start.ay
							}),
							A2(
							$author$project$Elm$Review$Text$join,
							...
							{
								a8: end.ay,
								b1: endLineContentWithLineNumber,
								bn: $author$project$Elm$Review$Reporter$getIndexOfFirstNonSpace(endLineContent) + 1
							}),
	...
	function (fixProblemDict, mode, error) {
		...
		return _List_fromArray(
			[
				...
				error.dC,
				$author$project$Elm$Review$Text$inRed(
					$author$project$Elm$Review$Text$from(error.cP))),
			...
			if (!detailsMode) {
				return A2(
					...
					A2(
						$elm$core$List$intersperse,
						$author$project$Elm$Review$Text$from('\n\n'),
						A2($elm$core$List$map, $author$project$Elm$Review$Text$from, error.bR)));
			} else {
				return _List_Nil;
			}
		}();
		var codeExtract_ = function () {
			var _v0 = A2($author$project$Elm$Review$Reporter$codeExtract, source, error.cM);
			if (!_v0.b) {
				return _List_Nil;
			} else {
	...
	function (previousTexts, lastText, chunks) {
		...
		while (true) {
			if (!chunks.b) {
				...
				if (_Utils_eq(lastText.d3, newLastText.d3) && _Utils_eq(lastText.ej, newLastText.ej)) {
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'rule',
					$elm$json$Json$Encode$string(error.cP)),
					_Utils_Tuple2(
					'message',
					$elm$json$Json$Encode$string(error.aw)),
					_Utils_Tuple2(
					'details',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, error.bR)),
					_Utils_Tuple2(
					'region',
...
var $author$project$Elm$Review$Reporter$fixableErrors = function (files) {
	return A2(
		...
		A2(
			...
			$elm$core$List$filter(
				function (error) {
					return !_Utils_eq(error.df, $elm$core$Maybe$Nothing);
				})),
		files);
};
...
var $author$project$Elm$Review$Reporter$compareRange = F2(
	function (a, b) {
		return (_Utils_cmp(a.bn.aN, b.bn.aN) < 0) ? 0 : ((_Utils_cmp(a.bn.aN, b.bn.aN) > 0) ? 2 : ((_Utils_cmp(a.bn.ay, b.bn.ay) < 0) ? 0 : ((_Utils_cmp(a.bn.ay, b.bn.ay) > 0) ? 2 : ((_Utils_cmp(a.a8.aN, b.a8.aN) < 0) ? 0 : ((_Utils_cmp(a.a8.aN, b.a8.aN) > 0) ? 2 : ((_Utils_cmp(a.a8.ay, b.a8.ay) < 0) ? 0 : ((_Utils_cmp(a.a8.ay, b.a8.ay) > 0) ? 2 : 1)))))));
	});
var $author$project$Elm$Review$Reporter$compareErrorPositions = F2(
	function (a, b) {
		return A2($author$project$Elm$Review$Reporter$compareRange, a.cM, b.cM);
	});
	...
	function (isFirstError, filePath_, range) {
		var position = function () {
			switch (filePath_.$) {
				case 0:
					var str = filePath_.a;
					return ' ' + (str + (':' + ($elm$core$String$fromInt(range.bn.aN) + (':' + $elm$core$String$fromInt(range.bn.ay)))));
				case 1:
					return ' GLOBAL ERROR';
				default:
						...
						return A2(
							...
							_List_fromArray(
								[
									_List_fromArray(
									[
										A3($author$project$Elm$Review$Reporter$header, !index, file.eF, error.cM)
									]),
...
var $author$project$Elm$Review$Main$getConfigurationError = function (rule) {
	...
	if (!_v0.$) {
		...
		return $elm$core$Maybe$Just(
			{
				bR: configurationError.bR,
				df: $elm$core$Maybe$Nothing,
				aw: configurationError.aw,
				cM: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange,
				dC: $elm$core$Maybe$Nothing,
				cP: $jfmengels$elm_review$Review$Rule$ruleName(rule)
			});
	} else {
		return $elm$core$Maybe$Nothing;
	}
...
var $jfmengels$elm_review$Review$Exceptions$addDirectories = F2(
	function (directories, _v0) {
		...
		var cleanedDirectories = A2(
			...
			directories);
		return {
			aS: _Utils_ap(cleanedDirectories, exceptions.aS),
			aU: exceptions.aU
		};
	});
var $jfmengels$elm_review$Review$Rule$ignoreErrorsForDirectories = F2(
	function (directories, _v0) {
		...
		return {
			az: rule.az,
			aE: A2($jfmengels$elm_review$Review$Exceptions$addDirectories, directories, rule.aE),
			a1: rule.a1,
			aa: rule.aa,
			aO: rule.aO
		};
...
var $jfmengels$elm_review$Review$Exceptions$addFiles = F2(
	function (files, _v0) {
		...
		return {
			aS: exceptions.aS,
			aU: A2($elm$core$Set$union, cleanedFiles, exceptions.aU)
		};
	});
var $jfmengels$elm_review$Review$Rule$ignoreErrorsForFiles = F2(
	function (files, _v0) {
		...
		return {
			az: rule.az,
			aE: A2($jfmengels$elm_review$Review$Exceptions$addFiles, files, rule.aE),
			a1: rule.a1,
			aa: rule.aa,
			aO: rule.aO
		};
...
var $author$project$Elm$Review$Main$unknownRulesFilterMessage = function (_v0) {
	var ruleNames = _v0.dD;
	var filterNames = _v0.de;
...
var $author$project$Elm$Review$Main$init = function (flags) {
	var _v0 = function () {
		...
		if (!_v1.$) {
			...
			var error = _v1.a;
			return _Utils_Tuple2(
				{aB: 1, ba: 0, bc: false, cA: _List_Nil, cB: _List_Nil, av: $author$project$Elm$Review$Progress$dummy, bk: 0, cQ: $elm$core$Maybe$Nothing},
				$author$project$Elm$Review$Main$abort(
					'Problem decoding the flags when running the elm-review runner:\n  ' + $elm$json$Json$Decode$errorToString(error)));
		}
	}();
	var fixMode = _v0.a.ba;
	var reportMode = _v0.a.bk;
	var detailsMode = _v0.a.aB;
	var ignoreProblematicDependencies = _v0.a.bc;
	var rulesFilter = _v0.a.cQ;
	var ignoredDirs = _v0.a.cA;
	var ignoredFiles = _v0.a.cB;
	var logger = _v0.a.av;
	var cmd = _v0.b;
	var _v2 = function () {
		if (!rulesFilter.$) {
	...
	return _Utils_Tuple2(
		{
			...
			cx: $jfmengels$elm_review$Review$Project$new,
			ba: fixMode,
			bc: ignoreProblematicDependencies,
			a_: $elm$core$Dict$empty,
			av: logger,
			c: $jfmengels$elm_review$Review$Project$new,
			bJ: $elm$core$Maybe$Nothing,
			bj: $author$project$Elm$Review$RefusedErrorFixes$empty,
			bk: reportMode,
			bl: _List_Nil,
			bK: A2(
				$elm$core$List$map,
								...
								if (!reportMode) {
									return $author$project$Elm$Review$Main$encodeReport(
										A4(
											...
											_List_fromArray(
												[
													{aD: configurationErrors, eF: $author$project$Elm$Review$Reporter$ConfigurationError, eN: ''}
												])));
								} else {
...
var $jfmengels$elm_review$Review$Project$addElmJson = F2(
	function (elmJson_, _v0) {
		...
		var modules_ = _Utils_eq(project.cV, sourceDirectories) ? project.ar : A2(
			$elm$core$Dict$map,
			F2(
				function (_v1, value) {
		...
		return _Utils_update(
			project,
			{
				cp: $elm$core$Maybe$Just(elmJson_),
				ar: modules_,
...
var $jfmengels$elm_review$Review$Project$sanitizeModule = function (module_) {
	return _Utils_update(
		module_,
		{
			dY: $jfmengels$elm_review$Review$Project$reorderComments(module_.dY)
		});
};
...
var $stil4m$elm_syntax$Elm$Processing$addDependency = F2(
	function (dep, _v0) {
		var x = _v0;
		return A2($elm$core$Dict$union, dep.cC, x);
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'apL'),
						...
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'apR'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|>'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'or'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '||'),
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'and'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '&&'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 3)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'eq'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '=='),
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'neq'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '/='),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'lt'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'gt'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'le'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<='),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'ge'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>='),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'append'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '++'),
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'add'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '+'),
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'sub'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '-'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 6)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'mul'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '*'),
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'fdiv'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '/'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'idiv'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '//'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'pow'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '^'),
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'composeL'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<<'),
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'composeR'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>>'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 9)
						})
					])),
				...
				_List_fromArray(
					[
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'cons'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '::'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
						})
					]))
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'keeper'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|='),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'ignorer'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|.'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 6)
						})
					])),
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'slash'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '</>'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'questionMark'),
							eD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<?>'),
							eG: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 8)
						})
					]))
...
var $stil4m$elm_syntax$Elm$Parser$State$emptyState = {d5: _List_Nil, aY: _List_Nil};
var $stil4m$elm_syntax$Elm$Syntax$File$File = F4(
	function (moduleDefinition, imports, declarations, comments) {
		return {d5: comments, c5: declarations, ek: imports, ep: moduleDefinition};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$getComments = function (_v0) {
	var s = _v0;
	return $elm$core$List$reverse(s.d5);
};
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$LetBlock = F2(
	function (declarations, expression) {
		return {c5: declarations, bY: expression};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {c3: col, d7: contextStack, dx: problem, aN: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aN, s.c3, x, s.t));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.aN, s.c3, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{c3: newCol, t: s.t, k: s.k, b: newOffset, aN: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{c3: 1, t: s.t, k: s.k, b: s.b + 1, aN: s.aN + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{c3: s.c3 + 1, t: s.t, k: s.k, b: newOffset, aN: s.aN, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{c3: col, t: s0.t, k: s0.k, b: offset, aN: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.aN, s.c3, s);
	};
};
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								a8: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(end),
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {c3: col, t: context, k: indent, b: offset, aN: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
	...
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.dc));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.dm, s.b + 1, s.aN + 1, 1, s.a, s.k, s.t) : A7($elm$parser$Parser$Advanced$varHelp, i.dm, firstOffset, s.aN, s.c3 + 1, s.a, s.k, s.t);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.dB) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.dc)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{dc: $elm$parser$Parser$ExpectingVariable, dm: i.dm, dB: i.dB, bn: i.bn});
};
	...
	$elm$parser$Parser$variable(
		{
			...
			dB: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.aN, s.c3, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.aN, s.c3, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			$elm$parser$Parser$Advanced$Bad,
			false,
			A4($elm$parser$Parser$Advanced$fromInfo, newRow, newCol, expecting, s.t)) : A3(
			$elm$parser$Parser$Advanced$Good,
...
var $stil4m$elm_syntax$Elm$Parser$State$addComment = F2(
	function (pair, _v0) {
		...
		return _Utils_update(
			s,
			{
				d5: A2($elm$core$List$cons, pair, s.d5)
			});
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {c3: s.c3 + (newOffset - s.b), t: s.t, k: s.k, b: newOffset, aN: s.aN, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.aN, s.c3 - (floatOffset + s.b), invalid, s.t));
		} else {
...
var $elm$parser$Parser$number = function (i) {
	return $elm$parser$Parser$Advanced$number(
		{
			c0: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingBinary, i.c0),
			dc: $elm$parser$Parser$ExpectingNumber,
			dg: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.dg),
			dl: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.dl),
			dn: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.dn),
			en: $elm$parser$Parser$ExpectingNumber,
			dv: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingOctal, i.dv)
		});
};
		...
		return $elm$parser$Parser$number(
			{
				...
				dg: $elm$core$Maybe$Just(floatf),
				dl: $elm$core$Maybe$Just(hexf),
				dn: $elm$core$Maybe$Just(intf),
					...
					function (_v2) {
						...
						return _Utils_eq(start, end) ? $elm$parser$Parser$problem('Expected a string character or a double quote') : $elm$parser$Parser$succeed(
							$elm$parser$Parser$Loop(
								{
									G: s.G,
									s: A2($elm$core$List$cons, value, s.s)
								}));
					},
					A2(
						$elm$parser$Parser$keeper,
				...
				if (!_v0.$) {
					...
					return A2(
						...
						function (_v3) {
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d8).a1),
						A2(
							$elm$core$Maybe$map,
							function (_v1) {
								var value = _v1.b;
...
var $stil4m$elm_syntax$Elm$Syntax$Signature$Signature = F2(
	function (name, typeAnnotation) {
		return {a1: name, dS: typeAnnotation};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$popIndent = function (_v0) {
	...
	return _Utils_update(
		s,
		{
			aY: A2($elm$core$List$drop, 1, s.aY)
		});
};
var $stil4m$elm_syntax$Elm$Parser$State$pushIndent = F2(
	function (x, _v0) {
		...
		return _Utils_update(
			s,
			{
				aY: A2($elm$core$List$cons, x, s.aY)
			});
	});
															...
															F3(
																function (condition, ifTrue, ifFalse) {
																	return A2(
																		$stil4m$elm_syntax$Elm$Syntax$Node$Node,
																		{
																			a8: $stil4m$elm_syntax$Elm$Syntax$Node$range(ifFalse).a8,
																			bn: current.bn
																		},
										...
										F2(
											function (args, expr) {
												return A2(
													$stil4m$elm_syntax$Elm$Syntax$Node$Node,
													{
														a8: $stil4m$elm_syntax$Elm$Syntax$Node$range(expr).a8,
														bn: current.bn
													},
...
var $stil4m$elm_syntax$Elm$Syntax$Infix$Infix = F4(
	function (direction, precedence, operator, _function) {
		return {d9: direction, ei: _function, eD: operator, eG: precedence};
	});
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				dn: $elm$core$Result$Ok($elm$core$Basics$identity),
				en: invalid,
				...
				return A2(
					...
					$stil4m$elm_syntax$Elm$Syntax$Range$combine(
						_List_fromArray(
							[
								current,
								$stil4m$elm_syntax$Elm$Syntax$Node$range(inf.ei)
							])),
...
var $stil4m$elm_syntax$Elm$Syntax$Type$Type = F4(
	function (documentation, name, generics, constructors) {
		return {d6: constructors, co: documentation, dh: generics, a1: name};
	});
var $stil4m$elm_syntax$Elm$Syntax$TypeAlias$TypeAlias = F4(
	function (documentation, name, generics, typeAnnotation) {
		return {co: documentation, dh: generics, a1: name, dS: typeAnnotation};
	});
							...
							return A2(
								...
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
									_List_fromArray(
										[
											start,
											$stil4m$elm_syntax$Elm$Syntax$Node$range(typeAlias.dS)
										])),
								typeAlias);
						},
						A2(
...
var $stil4m$elm_syntax$Elm$Syntax$Import$Import = F3(
	function (moduleName, moduleAlias, exposingList) {
		return {cs: exposingList, eo: moduleAlias, b8: moduleName};
	});
			...
			return A2(
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								a8: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(end),
	...
	function (start, imp) {
		var allRanges = _List_fromArray(
			[
				...
				$elm$core$Maybe$Just(
				$stil4m$elm_syntax$Elm$Syntax$Node$range(imp.b8)),
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.cs),
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.eo)
			]);
		return A2(
			$stil4m$elm_syntax$Elm$Syntax$Node$Node,
			$stil4m$elm_syntax$Elm$Syntax$Range$combine(
	...
	var createEffectModule = F3(
		function (name, whereClauses, exp) {
			return $stil4m$elm_syntax$Elm$Syntax$Module$EffectModule(
				{d4: whereClauses.d4, cs: exp, b8: name, eR: whereClauses.eR});
		});
	return A2(
		$stil4m$elm_syntax$Combine$andMap,
		$stil4m$elm_syntax$Elm$Parser$Node$parser($stil4m$elm_syntax$Elm$Parser$Expose$exposeDefinition),
...
var $stil4m$elm_syntax$Elm$Syntax$Module$DefaultModuleData = F2(
	function (moduleName, exposingList) {
		return {cs: exposingList, b8: moduleName};
	});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {c3: col, dx: problem, aN: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aN, p.c3, p.dx);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{c3: 1, t: _List_Nil, k: 1, b: 0, aN: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (range, comments, previousComments) {
		...
		while (true) {
			if (!comments.b) {
				...
				var _v1 = A2($elm$core$Basics$compare, commentRange.a8.aN + 1, range.bn.aN);
				switch (_v1) {
					case 1:
			...
			return {
				c5: A2(
					...
					A2(
						...
						howToUpdate(doc)),
					file.c5),
				T: A2($elm$core$List$cons, previous, file.T),
				_: remaining
			};
		} else {
			return {
				c5: A2($elm$core$List$cons, declaration, file.c5),
				T: A2($elm$core$List$cons, previous, file.T),
				_: remaining
			};
		}
				...
				function (x) {
					return _Utils_Tuple2(
						...
						A2(
							...
							{
								d9: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
								ei: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'todo'),
				...
				A2(
					...
					function (_v0) {
						...
						return A4(
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.d9),
							A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
				...
				switch (expression.$) {
					...
					case 15:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LetExpression(
							{
								c5: A2($stil4m$elm_syntax$Elm$Processing$visitLetDeclarations, table, letBlock.c5),
								bY: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, letBlock.bY)
							});
					case 16:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$CaseExpression(
							{
								d1: A2(
									...
									$elm$core$Tuple$mapSecond(
										$stil4m$elm_syntax$Elm$Processing$visitExpression(table)),
									caseBlock.d1),
								bY: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, caseBlock.bY)
							});
					case 17:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
							_Utils_update(
								lambda,
								{
									bY: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, lambda.bY)
								}));
					case 18:
...
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDeclaration = F2(
	function (table, functionDeclaration) {
		var newExpression = A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, functionDeclaration.bY);
		return _Utils_update(
			functionDeclaration,
			{bY: newExpression});
	});
...
var $stil4m$elm_syntax$Elm$Processing$attachDocumentationAndFixOperators = F3(
	function (table, declaration, context) {
		...
		switch (_v0.$) {
			...
			case 3:
				return {
					c5: A2($elm$core$List$cons, declaration, context.c5),
					T: context.T,
					_: context._
				};
			case 4:
...
var $stil4m$elm_syntax$Elm$Processing$buildSingle = F2(
	function (moduleIndex, imp) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, imp.cs);
		if (_v0.$ === 1) {
			return _List_Nil;
		} else {
			if (!_v0.a.$) {
				var _v1 = A2(
					$elm$core$Dict$get,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(imp.b8),
					moduleIndex);
				if (!_v1.$) {
					var module_ = _v1.a;
...
var $stil4m$elm_syntax$Elm$RawFile$imports = function (_v0) {
	var file = _v0;
	return A2($elm$core$List$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, file.ek);
};
...
var $stil4m$elm_syntax$Elm$Processing$process = F2(
	function (processContext, rawFile) {
		...
		var changes = A3(
			...
			{c5: _List_Nil, T: _List_Nil, _: file.d5},
			file.c5);
		return {
			d5: $elm$core$List$concat(
				$elm$core$List$reverse(
					A2($elm$core$List$cons, changes._, changes.T))),
			c5: $elm$core$List$reverse(changes.c5),
			ek: file.ek,
			ep: file.ep
		};
	});
...
var $jfmengels$elm_review$Review$Project$precomputeModuleGraph = function (project) {
	...
	if (!_v0.$) {
		...
		var moduleGraph = $jfmengels$elm_review$Review$Project$Internal$buildModuleGraph(
			$elm$core$Dict$values(p.ar));
		return _Utils_update(
			p,
			{
				b6: $elm$core$Maybe$Just(moduleGraph)
			});
	}
};
	...
	function (path, _v0) {
		...
		return A2(
			...
			_Utils_update(
				project,
				{
					ar: A2($elm$core$Dict$remove, path, project.ar)
				}));
	});
...
var $jfmengels$elm_review$Review$Project$addReadme = F2(
	function (readme_, _v0) {
		...
		return _Utils_update(
			project,
			{
				cN: $elm$core$Maybe$Just(readme_)
			});
	});
...
var $elm$project_metadata_utils$Elm$Project$ApplicationInfo = F6(
	function (elm, dirs, depsDirect, depsIndirect, testDepsDirect, testDepsIndirect) {
		return {c8: depsDirect, c9: depsIndirect, da: dirs, bT: elm, dP: testDepsDirect, dQ: testDepsIndirect};
	});
...
var $elm$project_metadata_utils$Elm$Project$PackageInfo = F8(
	function (name, summary, license, version, exposed, deps, testDeps, elm) {
		return {c7: deps, bT: elm, dd: exposed, ds: license, a1: name, dL: summary, dO: testDeps, dT: version};
	});
...
var $jfmengels$elm_review$Review$Project$removeDependency = F2(
	function (dependencyName, _v0) {
		...
		return _Utils_update(
			project,
			{
				aR: A2($elm$core$Dict$remove, dependencyName, project.aR)
			});
	});
	...
	if (!project.$) {
		...
		return $elm$core$Set$fromList(
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Elm$Review$Main$getPackageName(application.c8),
						$author$project$Elm$Review$Main$getPackageName(application.c9),
						$author$project$Elm$Review$Main$getPackageName(application.dP),
		...
		return $elm$core$Set$fromList(
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Elm$Review$Main$getPackageName(packageInfo.c7),
						$author$project$Elm$Review$Main$getPackageName(packageInfo.dO)
					])));
	}
};
					...
					if (!_v1.$) {
						...
						return A3(
							...
							A2(
								...
								{eF: file.eF, c: newElmJson, bi: file.eN},
								project),
...
var $author$project$Elm$Review$Vendor$Serialize$build = F2(
	function (jsonEncoder, jsonDecoder) {
		return {ai: jsonDecoder, aZ: jsonEncoder};
	});
		...
		var jsonEnc = function (v) {
			return _Utils_Tuple2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$elm$json$Json$Encode$int(am.bA),
						v)));
		};
		var jsonDecoder_ = F2(
			function (tag, orElse) {
				return _Utils_eq(tag, am.bA) ? jsonDecoderPiece : A2(am.ai, tag, orElse);
			});
		return {
			bA: am.bA + 1,
			ai: jsonDecoder_,
					...
					$author$project$Elm$Review$Vendor$Serialize$record(
						F4(
							function (startRow, startColumn, endRow, endColumn) {
								return {
									a8: {ay: endColumn, aN: endRow},
									bn: {ay: startColumn, aN: startRow}
								};
							})))))));
...
var $stil4m$elm_syntax$Elm$Syntax$Module$EffectModuleData = F4(
	function (moduleName, exposingList, command, subscription) {
		return {d4: command, cs: exposingList, b8: moduleName, eR: subscription};
	});
...
var $author$project$Elm$Review$File$decode = A4(
	...
	F3(
		function (path, source, ast) {
			return {dY: ast, eF: path, eN: source};
		}),
...
var $elm$project_metadata_utils$Elm$Type$var = function (isFirst) {
	return $elm$parser$Parser$variable(
		{dm: $elm$project_metadata_utils$Elm$Type$isInnerVarChar, dB: $elm$core$Set$empty, bn: isFirst});
};
...
function $elm$project_metadata_utils$Elm$Type$cyclic$tuple() {
	return A2(
		...
		$elm$parser$Parser$sequence(
			{
				a8: ')',
				dp: $elm$project_metadata_utils$Elm$Type$cyclic$tipe(),
				dG: ',',
...
var $elm$project_metadata_utils$Elm$Docs$Binop = F5(
	function (name, comment, tipe, associativity, precedence) {
		return {dX: associativity, a6: comment, a1: name, eG: precedence, ch: tipe};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Union = F4(
	function (name, comment, args, tags) {
		return {dW: args, a6: comment, a1: name, eV: tags};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Value = F3(
	function (name, comment, tipe) {
		return {a6: comment, a1: name, ch: tipe};
	});
...
var $author$project$Elm$Review$Main$elmJsonDecoder = A4(
	...
	F3(
		function (path, raw, project) {
			return {eF: path, c: project, bi: raw};
		}),
	A2($elm$json$Json$Decode$field, 'path', $elm$json$Json$Decode$string),
...
var $jfmengels$elm_review$Review$Fix$applyReplace = F3(
	function (range, replacement, lines) {
		var startLine = A2(
			...
			range.bn.ay - 1,
			A2($jfmengels$elm_review$Review$Fix$getRowAtLine, lines, range.bn.aN - 1));
		var linesBefore = A2($elm$core$List$take, range.bn.aN - 1, lines);
		var linesAfter = A2($elm$core$List$drop, range.a8.aN, lines);
		var endLine = A2(
			$jfmengels$elm_review$Unicode$dropLeft,
			range.a8.ay - 1,
			A2($jfmengels$elm_review$Review$Fix$getRowAtLine, lines, range.a8.aN - 1));
		return $elm$core$List$concat(
			_List_fromArray(
				[
					linesBefore,
...
var $jfmengels$elm_review$Review$Fix$comparePosition = F2(
	function (a, b) {
		var _v0 = A2($elm$core$Basics$compare, a.aN, b.aN);
		if (_v0 === 1) {
...
var $jfmengels$elm_review$Review$Fix$collide = F2(
	function (a, b) {
		var _v0 = A2($jfmengels$elm_review$Review$Fix$comparePosition, a.a8, b.bn);
		switch (_v0) {
			case 0:
				return false;
			case 1:
				return false;
			default:
				var _v1 = A2($jfmengels$elm_review$Review$Fix$comparePosition, b.a8, a.bn);
				switch (_v1) {
					case 0:
						return false;
					case 1:
...
var $jfmengels$elm_review$Review$Fix$getFixRange = function (fix_) {
	switch (fix_.$) {
		...
		default:
			var position = fix_.a;
			return {a8: position, bn: position};
	}
};
...
var $author$project$Elm$Review$Reporter$hashRange = function (range) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[range.bn.aN, range.bn.ay, range.a8.aN, range.a8.ay])));
};
...
var $jfmengels$elm_review$Review$Fix$toRecord = function (fix_) {
	switch (fix_.$) {
		case 1:
			var range = fix_.a;
			var replacement = fix_.b;
			return {cM: range, eL: replacement};
		case 0:
			var range = fix_.a;
			return {cM: range, eL: ''};
		default:
...
var $author$project$Elm$Review$Main$fromReviewError = F2(
	function (links, error) {
		return {
			bR: $jfmengels$elm_review$Review$Rule$errorDetails(error),
			df: A2(
				$elm$core$Maybe$map,
			...
			cM: $jfmengels$elm_review$Review$Rule$errorRange(error),
			dC: A2($author$project$Elm$Review$Main$linkToRule, links, error),
			cP: $jfmengels$elm_review$Review$Rule$errorRuleName(error)
		};
	});
...
var $author$project$Elm$Review$Main$makeReport = F2(
	function (failedFixesDict, model) {
		var errorsByFile = A2($author$project$Elm$Review$Main$groupErrorsByFile, model.c, model.bl);
		return _Utils_Tuple2(
			model,
						...
						[
							...
							function () {
								...
								if (!_v0) {
											...
											A2(
												...
												function (file) {
													return {
														aD: A2(
															$elm$core$List$map,
															$author$project$Elm$Review$Main$fromReviewError(model.a_),
															file.aD),
														eF: file.eF,
														eN: file.eN
													};
									...
									return A2(
										$elm$json$Json$Encode$list,
										A2($author$project$Elm$Review$Main$encodeErrorByFile, model.a_, model.aB),
										errorsByFile);
								}
							}())
						]))));
						...
						[
							...
							$author$project$Elm$Review$Main$encodeReport(
								A5(
									...
									A2($author$project$Elm$Review$Main$fromReviewError, model.a_, error),
									fixedSource))),
							_Utils_Tuple2(
							'changedFiles',
							A2(
...
var $author$project$Elm$Review$Main$refuseError = F2(
	function (error, model) {
		return _Utils_update(
			model,
			{
				bj: A2($author$project$Elm$Review$RefusedErrorFixes$insert, error, model.bj)
			});
	});
	...
	function (path, error, remainingErrors, model) {
		var errorsForFile = A2(
			...
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, path, model.aF)));
		return _Utils_update(
			model,
			{
				aF: A3($elm$core$Dict$insert, path, errorsForFile, model.aF),
						...
						if (!_v2.b.$) {
							...
							return A2(
								...
								_List_fromArray(
									[
										_Utils_eq(
										$elm$core$Set$fromList(oldApp.da),
										$elm$core$Set$fromList(newApp.da)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(0),
										_Utils_eq(
...
var $jfmengels$elm_review$Review$Rule$elmReviewGlobalError = function (_v0) {
	...
	var details = _v0.bR;
	return $jfmengels$elm_review$Review$Rule$SpecifiedError(
		{bR: details, cw: 'GLOBAL ERROR', cy: $elm$core$Maybe$Nothing, aw: message, cM: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, cP: '', dN: 3});
};
var $jfmengels$elm_review$Review$Rule$duplicateModulesGlobalError = function (duplicate) {
	var paths = $elm$core$String$concat(
		A2(
			...
			$elm$core$List$sort(duplicate.dw)));
	return $jfmengels$elm_review$Review$Rule$errorToReviewError(
		$jfmengels$elm_review$Review$Rule$elmReviewGlobalError(
			{
				bR: _List_fromArray(
					[
						'I found several modules with the name `' + (A2($elm$core$String$join, '.', duplicate.b8) + '`. Depending on how I choose to resolve this, I might give you different reports. Since this is a compiler error anyway, I require this problem to be solved. Please fix this then try running `elm-review` again.'),
				...
				aw: 'Found several modules named `' + (A2($elm$core$String$join, '.', duplicate.b8) + '`')
			}));
};
...
var $jfmengels$elm_review$Review$Rule$parsingError = function (rawFile) {
	return {
		...
		cw: rawFile.eF,
		cy: $elm$core$Maybe$Nothing,
		aw: rawFile.eF + ' is not a correct Elm module',
		cM: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange,
		cP: 'ParsingError',
		dN: 0
	};
...
var $jfmengels$elm_review$Vendor$IntDict$determineBranchRelation = F2(
	function (l, r) {
		...
		var mask = $jfmengels$elm_review$Vendor$IntDict$highestBitSet(
			A2($jfmengels$elm_review$Vendor$IntDict$mostSignificantBranchingBit, lp.a5, rp.a5));
		var modifiedRightPrefix = A3($jfmengels$elm_review$Vendor$IntDict$combineBits, rp.as, ~lp.as, mask);
		var prefix = A2($jfmengels$elm_review$Vendor$IntDict$lcp, lp.as, modifiedRightPrefix);
		var childEdge = F2(
			function (branchPrefix, c) {
				return A2($jfmengels$elm_review$Vendor$IntDict$isBranchingBitSet, branchPrefix, c.h.as) ? 1 : 0;
			});
	...
	function (l, r) {
		...
		while (true) {
			...
			while (true) {
					...
					switch (_v0.a.$) {
						...
						default:
							switch (_v0.b.$) {
								...
								case 1:
									var lr = _v0.b.a;
									var _v3 = A2($jfmengels$elm_review$Vendor$IntDict$get, lr.f, l);
									if (!_v3.$) {
										var v = _v3.a;
										return A2($jfmengels$elm_review$Vendor$IntDict$leaf, lr.f, v);
									} else {
										return $jfmengels$elm_review$Vendor$IntDict$Empty;
									}
								default:
				...
				var ll = _v0.a.a;
				return A2($jfmengels$elm_review$Vendor$IntDict$member, ll.f, r) ? l : $jfmengels$elm_review$Vendor$IntDict$Empty;
			}
			var _v2 = _v0.b;
			return $jfmengels$elm_review$Vendor$IntDict$Empty;
		}
	...
	function (ordering, graph) {
		...
		var check = F2(
			function (id, _v2) {
				...
				var backEdges = A2($jfmengels$elm_review$Vendor$IntDict$intersect, ctx.i, backSetWithId);
...
var $jfmengels$elm_review$Vendor$Graph$alongOutgoingEdges = function (ctx) {
	return $jfmengels$elm_review$Vendor$IntDict$keys(ctx.i);
};
		...
		var updateOutgoingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						i: A3($jfmengels$elm_review$Vendor$IntDict$update, nodeId, upd, node.i)
					});
			});
		var updateIncomingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						j: A3($jfmengels$elm_review$Vendor$IntDict$update, nodeId, upd, node.j)
					});
			});
		var flippedFoldl = F3(
			function (f, dict, acc) {
...
var $jfmengels$elm_review$Vendor$Graph$emptyDiff = {j: $jfmengels$elm_review$Vendor$IntDict$empty, i: $jfmengels$elm_review$Vendor$IntDict$empty};
	...
	function (old, _new) {
		...
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				...
				var ins = _v0.b.a;
				return {
					j: A3(collect, $jfmengels$elm_review$Vendor$Graph$Insert, ins.i, $jfmengels$elm_review$Vendor$IntDict$empty),
					i: A3(collect, $jfmengels$elm_review$Vendor$Graph$Insert, ins.j, $jfmengels$elm_review$Vendor$IntDict$empty)
				};
			}
		} else {
			if (_v0.b.$ === 1) {
				...
				var _v3 = _v0.b;
				return {
					j: A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.i, $jfmengels$elm_review$Vendor$IntDict$empty),
					i: A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.j, $jfmengels$elm_review$Vendor$IntDict$empty)
				};
			} else {
				var rem = _v0.a.a;
				var ins = _v0.b.a;
				return _Utils_eq(rem, ins) ? $jfmengels$elm_review$Vendor$Graph$emptyDiff : {
					j: A3(
						...
						ins.i,
						A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.i, $jfmengels$elm_review$Vendor$IntDict$empty)),
					i: A3(
						collect,
						$jfmengels$elm_review$Vendor$Graph$Insert,
						ins.j,
						A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.j, $jfmengels$elm_review$Vendor$IntDict$empty))
				};
			}
		}
	});
		...
		var wrappedUpdater = function (rep) {
			...
			var filterInvalidEdges = function (ctx) {
				return $jfmengels$elm_review$Vendor$IntDict$filter(
					F2(
						function (id, _v0) {
							return _Utils_eq(id, ctx.et.aH) || A2($jfmengels$elm_review$Vendor$IntDict$member, id, rep);
						}));
			};
			var cleanUpEdges = function (ctx) {
				return _Utils_update(
...
var $jfmengels$elm_review$Vendor$Graph$alongIncomingEdges = function (ctx) {
	return $jfmengels$elm_review$Vendor$IntDict$keys(ctx.j);
};
...
var $jfmengels$elm_review$Review$Rule$reachedTarget = F2(
	function (targetNode, path) {
		...
		if (!_v0.$) {
			var node = _v0.a;
			return _Utils_eq(node.et.aH, targetNode);
		} else {
			return false;
		}
	});
	...
	function (targetNode, path, distance, acc) {
		if ($elm$core$List$isEmpty(acc)) {
			if (!distance) {
				...
				if (!_v0.$) {
					var head = _v0.a;
					return A2($jfmengels$elm_review$Vendor$IntDict$member, head.et.aH, head.j) ? _List_fromArray(
						[head.et]) : acc;
				} else {
					return acc;
				}
		...
		while (true) {
			if (!nodesToVisit.b) {
				...
				var cycle = A5(
					...
					$jfmengels$elm_review$Review$Rule$visitorDiscoverCycle(startingNode.aH),
					_List_fromArray(
						[startingNode.aH]),
					_List_Nil,
					graph).a;
...
var $jfmengels$elm_review$Review$Rule$findCycle = F2(
	function (graph, edge) {
		var initialCycle = A5(
			$jfmengels$elm_review$Vendor$Graph$guidedBfs,
			$jfmengels$elm_review$Vendor$Graph$alongIncomingEdges,
			$jfmengels$elm_review$Review$Rule$visitorDiscoverCycle(edge.Q),
			_List_fromArray(
				[edge.O]),
			_List_Nil,
			graph).a;
...
var $jfmengels$elm_review$Review$Rule$needsToComputeScope = function (rules) {
	return A2(
		$elm$core$List$any,
		function (_v0) {
			var requestedData = _v0.aa;
			var _v1 = requestedData;
			var requestedData_ = _v1;
			return requestedData_.aq;
		},
		rules);
};
...
var $jfmengels$elm_review$Review$Rule$scope_foldProjectContexts = F2(
	function (newContext, previousContext) {
		return {
			W: previousContext.W,
			a0: A2($elm$core$Dict$union, newContext.a0, previousContext.a0),
			ar: A2($elm$core$Dict$union, previousContext.ar, newContext.ar)
		};
	});
...
var $jfmengels$elm_review$Review$Rule$createFakeImport = function (_v0) {
	var moduleName = _v0.b8;
	var moduleAlias = _v0.eo;
	var exposingList = _v0.cs;
	return {
		cs: A2(
			$elm$core$Maybe$map,
		...
		eo: A2(
			...
			A2(
				...
				$stil4m$elm_syntax$Elm$Syntax$Node$Node($stil4m$elm_syntax$Elm$Syntax$Range$emptyRange)),
			moduleAlias),
		b8: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, moduleName)
	};
};
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cs: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a1: 'List', eC: $elm$core$Maybe$Nothing}),
							$stil4m$elm_syntax$Elm$Syntax$Exposing$InfixExpose('::')
						])),
				eo: $elm$core$Maybe$Nothing,
				b8: _List_fromArray(
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cs: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a1: 'String', eC: $elm$core$Maybe$Nothing})
						])),
				eo: $elm$core$Maybe$Nothing,
				b8: _List_fromArray(
					['String'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cs: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a1: 'Char', eC: $elm$core$Maybe$Nothing})
						])),
				eo: $elm$core$Maybe$Nothing,
				b8: _List_fromArray(
					['Char'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cs: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a1: 'Program', eC: $elm$core$Maybe$Nothing})
						])),
				eo: $elm$core$Maybe$Nothing,
				b8: _List_fromArray(
					['Platform'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cs: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a1: 'Cmd', eC: $elm$core$Maybe$Nothing})
						])),
				eo: $elm$core$Maybe$Just('Cmd'),
				b8: _List_fromArray(
					['Platform', 'Cmd'])
			}),
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				cs: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{a1: 'Sub', eC: $elm$core$Maybe$Nothing})
						])),
				eo: $elm$core$Maybe$Just('Sub'),
				b8: _List_fromArray(
					['Platform', 'Sub'])
			})
		]);
...
var $jfmengels$elm_review$Review$Rule$registerImportAlias = F2(
	function (import_, innerContext) {
		var _v0 = import_.eo;
		if (_v0.$ === 1) {
			var moduleName = $stil4m$elm_syntax$Elm$Syntax$Node$value(import_.b8);
					...
					aI: A3(
						...
						function (previousValue) {
							return $elm$core$Maybe$Just(
								A2(
									$elm$core$List$cons,
									$stil4m$elm_syntax$Elm$Syntax$Node$value(import_.b8),
									A2($elm$core$Maybe$withDefault, _List_Nil, previousValue)));
						},
						innerContext.aI)
				});
		...
		switch (_v0.$) {
			...
			case 2:
				...
				return A2(
					$elm$core$List$any,
					function (alias) {
						return _Utils_eq(alias.a1, name);
					},
					module_.o) ? _List_fromArray(
					[name]) : _List_Nil;
			default:
				var name = _v0.a.a1;
				var open = _v0.a.eC;
					...
					return A2(
						...
						A2(
							...
							A2(
								$elm$core$List$filter,
								function (union) {
									return _Utils_eq(union.a1, name);
								},
								module_.eY)));
				} else {
					return _List_Nil;
...
var $jfmengels$elm_review$Review$Rule$registerImportExposed = F2(
	function (import_, innerContext) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, import_.cs);
		if (_v0.$ === 1) {
			return innerContext;
		} else {
			var exposing_ = _v0.a;
			...
			var module_ = A2(
				$elm$core$Maybe$withDefault,
				{
					...
					dZ: _List_Nil,
					a6: '',
					a1: $jfmengels$elm_review$Review$Rule$joinModuleName(moduleName),
					eY: _List_Nil,
					e_: _List_Nil
				},
				function () {
					...
					if (!_v4.$) {
						...
						return A2($elm$core$Dict$get, moduleName, innerContext.ar);
					}
				}());
			if (!exposing_.$) {
					...
					$elm$core$List$concat(
						_List_fromArray(
							[
								...
								module_.eY),
								A2($elm$core$List$map, nameWithModuleName, module_.e_),
								A2($elm$core$List$map, nameWithModuleName, module_.o),
								A2($elm$core$List$map, nameWithModuleName, module_.dZ)
							])));
				var exposedTypes = $elm$core$Dict$fromList(
					A2(
						$elm$core$List$append,
						A2($elm$core$List$map, nameWithModuleName, module_.eY),
						A2($elm$core$List$map, nameWithModuleName, module_.o)));
				return _Utils_update(
					innerContext,
					{
						aW: A2($elm$core$Dict$union, exposedValues, innerContext.aW),
						aX: A2($elm$core$Dict$union, innerContext.aX, exposedTypes)
					});
			} else {
		...
		return $jfmengels$elm_review$Review$Rule$registerPrelude(
			{
				...
				cF: $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$empty,
				ar: projectContext.ar,
				n: $jfmengels$elm_review$Review$Rule$nonemptyList_fromElement($jfmengels$elm_review$Review$Rule$emptyScope)
			});
	});
var $jfmengels$elm_review$Review$Rule$scope_initialProjectContext = {W: $elm$core$Dict$empty, a0: $elm$core$Dict$empty, ar: $elm$core$Dict$empty};
		...
		var dependenciesModules = $elm$core$Dict$fromList(
			A2(
				...
				function (dependencyModule) {
					return _Utils_Tuple2(dependencyModule.a1, dependencyModule);
				},
				A2(
					$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
		...
		switch (_v0.$) {
			case 15:
				return _Utils_update(
					context,
					{
						n: $jfmengels$elm_review$Review$Rule$nonemptyList_pop(context.n)
					});
			case 16:
				return _Utils_update(
					context,
...
var $jfmengels$elm_review$Review$Rule$moduleNameForValue = F3(
	function (context, valueName, moduleName) {
		if (!moduleName.b) {
			return A2($jfmengels$elm_review$Review$Rule$isInScope, valueName, context.n) ? _List_Nil : A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, valueName, context.aW));
		} else {
			if (!moduleName.b.b) {
				var moduleNameOrAlias = moduleName.a;
				var _v1 = A2($elm$core$Dict$get, moduleNameOrAlias, context.aI);
				if (!_v1.$) {
					if (_v1.a.b && (!_v1.a.b.b)) {
						...
						var _v3 = A2(
							...
							function (aliasedModuleName) {
								var _v4 = A2($elm$core$Dict$get, aliasedModuleName, context.ar);
								if (!_v4.$) {
									var module_ = _v4.a;
...
var $jfmengels$elm_review$Review$Rule$moduleNameForType = F3(
	function (context, typeName, moduleName) {
		if (!moduleName.b) {
			return A2($elm$core$Set$member, typeName, context.a$) ? _List_Nil : A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, typeName, context.aX));
		} else {
			if (!moduleName.b.b) {
				var _v1 = A2(
					$elm$core$Dict$get,
		...
		switch (_v0.$) {
			case 0:
				...
				var newScope = _Utils_update(
					...
					{
						a2: $jfmengels$elm_review$Review$Rule$parameters(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d8).c_)
					});
				var newContext = A2(
					$jfmengels$elm_review$Review$Rule$updateScope,
					context,
					A2($jfmengels$elm_review$Review$Rule$nonemptyList_cons, newScope, context.n));
			...
			case 3:
				var signature = _v0.a;
				var moduleNamesFromSignature = A2($jfmengels$elm_review$Review$Rule$collectModuleNamesFromTypeAnnotation, context, signature.dS);
				var lookupTable = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$addMultiple, moduleNamesFromSignature, context.cF);
				return _Utils_update(
					context,
					{cF: lookupTable});
			default:
		...
		return A2(
			...
			function (scope) {
				return _Utils_update(
					scope,
					{
						a2: A3($elm$core$Dict$insert, name, variableInfo, scope.a2)
					});
			},
			scopes);
	});
var $jfmengels$elm_review$Review$Rule$addToScope = F2(
	function (variableData, innerContext) {
		var newScopes = A3(
			...
			variableData,
			$stil4m$elm_syntax$Elm$Syntax$Node$value(variableData.et),
			innerContext.n);
		return _Utils_update(
			innerContext,
			{n: newScopes});
					...
					$elm$core$List$cons,
					{
						...
						eV: A2(
							...
							function (constructor) {
								return _Utils_Tuple2(
									$stil4m$elm_syntax$Elm$Syntax$Node$value(
										$stil4m$elm_syntax$Elm$Syntax$Node$value(constructor).a1),
									_List_Nil);
							},
							constructors)
					},
			...
			innerContext,
			{
				bt: A2(
					$elm$core$List$cons,
					{
						...
						a6: '',
						a1: name,
						ch: $elm$project_metadata_utils$Elm$Type$Tuple(_List_Nil)
					},
					innerContext.bt)
			});
	});
	...
	function (innerContext, maybeSignature) {
		if (!maybeSignature.$) {
			...
			return A2(
				...
				innerContext,
				$stil4m$elm_syntax$Elm$Syntax$Node$value(signature).dS);
		} else {
			return $elm$project_metadata_utils$Elm$Type$Tuple(_List_Nil);
		}
	});
			...
			innerContext,
			{
				bv: A2(
					$elm$core$List$cons,
					{
						...
						a1: name,
						ch: A2($jfmengels$elm_review$Review$Rule$convertTypeSignatureToDocsType, innerContext, _function.eM)
					},
					innerContext.bv)
			});
	});
var $jfmengels$elm_review$Review$Rule$registerIfExposed = F3(
	function (registerFn, name, innerContext) {
		return (innerContext.bX || A2($elm$core$Dict$member, name, innerContext.bW)) ? A2(registerFn, name, innerContext) : innerContext;
	});
var $jfmengels$elm_review$Review$Rule$scope_registerDeclaration = F2(
	function (declaration, innerContext) {
		...
		switch (_v0.$) {
			case 0:
				var _function = _v0.a;
				var nameNode = $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.d8).a1;
				return A3(
			...
			case 1:
				...
				return A3(
					...
					$stil4m$elm_syntax$Elm$Syntax$Node$value(alias.a1),
					function (ctx) {
						var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(alias.dS);
						if (_v1.$ === 4) {
							return A2(
								$jfmengels$elm_review$Review$Rule$addToScope,
								{et: alias.a1, aQ: 0},
					...
					A3(
						...
						F2(
							function (constructor, innerContext_) {
								var constructorName = $stil4m$elm_syntax$Elm$Syntax$Node$value(constructor).a1;
								return A2(
									$jfmengels$elm_review$Review$Rule$addToScope,
									{et: constructorName, aQ: 1},
									innerContext_);
							}),
						_Utils_update(
							innerContext,
			...
			case 3:
				...
				return A3(
					...
					$stil4m$elm_syntax$Elm$Syntax$Node$value(signature.a1),
					A2(
						$jfmengels$elm_review$Review$Rule$addToScope,
						{et: signature.a1, aQ: 5},
						innerContext));
			case 4:
				return innerContext;
			default:
			...
			case 15:
				...
				var newContext = A2(
					...
					A3(
						...
						A2($jfmengels$elm_review$Review$Rule$nonemptyList_cons, $jfmengels$elm_review$Review$Rule$emptyScope, context.n),
						declarations));
				var moduleNames = A2(
					$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
					function (declaration) {
				...
				return _Utils_update(
					newContext,
					{
						cF: A2($jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$addMultiple, moduleNames, newContext.cF)
					});
			case 16:
				var caseBlock = _v0.a;
				var moduleNames = A2(
				...
				return _Utils_update(
					context,
					{
						cF: A2($jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$addMultiple, moduleNames, context.cF),
						n: A2(
							$jfmengels$elm_review$Review$Rule$nonemptyList_mapHead,
							function (scope) {
								return _Utils_update(
	...
	function (node, innerContext) {
		...
		if (!_v0.$) {
			...
			return _Utils_update(
				innerContext,
				{
					bW: $jfmengels$elm_review$Review$Rule$exposedElements(list)
				});
		}
	});
...
var $jfmengels$elm_review$Review$Rule$scope_popScopeEnter = F2(
	function (node, context) {
		var currentScope = $jfmengels$elm_review$Review$Rule$nonemptyList_head(context.n);
...
var $jfmengels$elm_review$Review$Rule$scope_popScopeExit = F2(
	function (node, context) {
		var currentScope = $jfmengels$elm_review$Review$Rule$nonemptyList_head(context.n);
		return _Utils_eq(node, currentScope.bP) ? _Utils_update(
			context,
			{
				n: $jfmengels$elm_review$Review$Rule$nonemptyList_pop(context.n)
			}) : context;
...
var $jfmengels$elm_review$Review$Rule$withExpressionExitVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				H: A2($elm$core$List$cons, visitor, schema.H)
			});
	});
var $jfmengels$elm_review$Review$Rule$withImportVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				ao: A2($elm$core$List$cons, visitor, schema.ao)
			});
	});
...
var $jfmengels$elm_review$Review$Rule$withDataExtractor = F2(
	function (dataExtractor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				aA: $elm$core$Maybe$Just(dataExtractor)
			});
	});
		...
		return _Utils_update(
			schema,
			{
				aV: $elm$core$Maybe$Just(
					{
						ef: functions.ef,
						eg: $jfmengels$elm_review$Review$Rule$withMetadata(
							$jfmengels$elm_review$Review$Rule$withModuleKey(
								$jfmengels$elm_review$Review$Rule$initContextCreator(
									F3(
				...
				S: $elm$core$Maybe$Just(moduleContextCreator)
			});
	});
var $jfmengels$elm_review$Review$Rule$scopeRule = $jfmengels$elm_review$Review$Rule$fromProjectRuleSchemaToRunnableProjectVisitor(
	A2(
		...
		function (projectContext) {
			return projectContext.a0;
		},
		A2(
			$jfmengels$elm_review$Review$Rule$withModuleContext,
			{ef: $jfmengels$elm_review$Review$Rule$scope_foldProjectContexts, eg: $jfmengels$elm_review$Review$Rule$scope_fromModuleToProject, eh: $jfmengels$elm_review$Review$Rule$scope_fromProjectToModule},
			A2(
				$jfmengels$elm_review$Review$Rule$withModuleVisitor,
	...
	function (project, rules, maybeProjectData, nodeContexts) {
		...
		var scopeResult = function () {
			if ($jfmengels$elm_review$Review$Rule$needsToComputeScope(rules)) {
				...
				return {
					a9: extract,
					bJ: $elm$core$Maybe$Just(cache)
				};
			} else {
				return {a9: $elm$core$Maybe$Nothing, bJ: $elm$core$Maybe$Nothing};
			}
		}();
		...
		var projectWithLookupTables = _Utils_update(
			p,
			{eq: moduleNameLookupTables});
		var _v0 = A3($jfmengels$elm_review$Review$Rule$runRules, rules, projectWithLookupTables, nodeContexts);
		var errors = _v0.a;
		var newRules = _v0.b;
		return {
			aD: A2($elm$core$List$map, $jfmengels$elm_review$Review$Rule$errorToReviewError, errors),
			bJ: scopeResult.bJ,
			bK: newRules
		};
	});
var $jfmengels$elm_review$Review$Rule$reviewV2 = F3(
	function (rules, maybeProjectData, project) {
		...
		if (!_v0.$) {
			...
			var errors = _v0.a;
			return {aD: errors, bJ: maybeProjectData, bK: rules};
		}
	});
var $author$project$Elm$Review$Main$runReview = function (model) {
	var _v0 = A3($jfmengels$elm_review$Review$Rule$reviewV2, model.bK, model.bJ, model.c);
	var errors = _v0.aD;
	var rules = _v0.bK;
	var projectData = _v0.bJ;
	return _Utils_update(
		model,
		{aC: $author$project$Elm$Review$Main$NotAwaiting, bJ: projectData, bl: errors, bK: rules});
};
	...
	function (failedFixesDict, model) {
		...
		while (true) {
			...
			if (!_v0.b.$) {
				...
				var file = _v0.b.a.cv;
				var error = _v0.b.a.cq;
				var fixedSource = _v0.b.a.aG;
				var remainingErrors = _v0.b.a.dA;
				var newProject = A2(
				...
				var _v1 = _v0.b;
				return $elm$core$Maybe$Just(
					{cu: newFailedFixesDict, cI: model});
			}
		}
	});
	...
	function (before, after) {
		...
		var afterReadme = function () {
			...
			if (!_v6.$) {
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(readme.eF, readme.a7)
					]);
			} else {
				return _List_Nil;
			}
		...
		var afterElmJson = function () {
			...
			if (!_v5.$) {
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(elmJson.eF, elmJson.bi)
					]);
			} else {
				return _List_Nil;
			}
			...
			F4(
				function (_v2, beforeModule, fixedSource, acc) {
					return (!_Utils_eq(beforeModule.eN, fixedSource)) ? A2(
						$elm$core$List$cons,
						{aG: fixedSource, eF: beforeModule.eF, eN: beforeModule.eN},
						acc) : acc;
				}),
			F3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Elm$Review$Reporter$diff, file.eN, file.aG)
			]));
};
...
var $author$project$Elm$Review$Main$fixAll = function (model) {
	...
	if (!_v0.$) {
		var failedFixesDict = _v0.a.cu;
		var newModel = _v0.a.cI;
		...
		if (!_v1.b) {
			...
			var changedFiles = A2(
				...
				function (_v2) {
					var path = _v2.eF;
					var source = _v2.eN;
					var fixedSource = _v2.aG;
					return {
						aD: A2(
							$elm$core$Maybe$withDefault,
							_List_Nil,
							A2($elm$core$Dict$get, path, newModel.aF)),
						aG: fixedSource,
			...
			return _Utils_Tuple2(
				_Utils_update(
					newModel,
					{aC: $author$project$Elm$Review$Main$AwaitingFixAll, cx: newModel.c, c: model.c}),
				$author$project$Elm$Review$Main$askConfirmationToFix(
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
							...
							_Utils_update(
								model,
								{
									c: A2(
										...
										{dY: ast, eF: rawFile.eF, eN: rawFile.eN},
										model.c)
								}),
							$author$project$Elm$Review$Main$acknowledgeFileReceipt(
								$elm$json$Json$Encode$object(
					...
					return _Utils_Tuple2(
						...
						A2(
							...
							$elm$json$Json$Decode$errorToString(decodeError)) ? $author$project$Elm$Review$Main$abortWithDetails(
							{
								...
								bM: 'FOUND PROBLEMATIC DEPENDENCIES'
							}) : $author$project$Elm$Review$Main$abortWithDetails(
							{
								...
								bM: 'PROBLEM READING DEPENDENCIES'
							}));
				} else {
						...
						return (_Utils_cmp(
							...
							$author$project$Elm$Review$Main$reportOrFix(
								$author$project$Elm$Review$Main$runReview(
									_Utils_update(
										model,
										{bU: true, aF: $elm$core$Dict$empty, c: newProject}))));
					} else {
						var _v8 = _v7.a;
						var _v9 = model.aC;
						switch (_v9.$) {
...
var $author$project$Elm$Review$Main$main = $elm$core$Platform$worker(
	{
		em: $author$project$Elm$Review$Main$init,
		eS: function (_v0) {
			return $author$project$Elm$Review$Main$subscriptions;
		},
		eZ: $author$project$Elm$Review$Main$update
	});
