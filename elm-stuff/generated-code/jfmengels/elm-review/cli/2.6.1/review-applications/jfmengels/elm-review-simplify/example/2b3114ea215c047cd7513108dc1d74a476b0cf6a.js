...
{
	if (region.be.bq === region.a_.bq)
	{
		return 'on line ' + region.be.bq;
	}
	return 'on lines ' + region.be.bq + ' through ' + region.a_.bq;
}
...
var $jfmengels$elm_review_simplify$Simplify$defaults = {bn: _List_Nil};
...
var $jfmengels$elm_review$Review$Exceptions$init = {aJ: _List_Nil, aL: $elm$core$Set$empty};
var $jfmengels$elm_review$Review$Rule$configurationError = F2(
	function (name, configurationError_) {
		return {
			as: $elm$core$Maybe$Just(configurationError_),
			ax: $jfmengels$elm_review$Review$Exceptions$init,
			aV: name,
			S: {ak: false, bd: false},
			aE: F3(
...
var $jfmengels$elm_review_simplify$Simplify$dependenciesVisitor = F3(
	function (typeNames, dict, _v0) {
		return _Utils_Tuple2(
			_List_Nil,
			{
				A: A2(
					...
					function (mod) {
						var moduleName = A2($elm$core$String$split, '.', mod.aV);
						return A2(
							$elm$core$List$map,
							function (union) {
								return {
									dK: A2($elm$core$List$map, $elm$core$Tuple$first, union.ev),
									bS: moduleName,
									aV: union.aV
								};
							},
...
var $jfmengels$elm_review$Review$Rule$globalError = function (_v0) {
	...
	return $jfmengels$elm_review$Review$Rule$SpecifiedError(
		{bA: details, b9: 'GLOBAL ERROR', cb: $elm$core$Maybe$Nothing, aq: message, cp: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, cs: '', $7: 4});
};
...
var $jfmengels$elm_review_simplify$Simplify$finalEvaluation = F2(
	function (ignoreConstructors, projectContext) {
		var list = $elm$core$Set$toList(
			A2(
				$elm$core$Set$diff,
				$elm$core$Set$fromList(ignoreConstructors),
				$elm$core$Set$fromList(
					A2(
						$elm$core$List$map,
						function (type_) {
							return A2($elm$core$String$join, '.', type_.bS) + ('.' + type_.aV);
						},
						projectContext.A))));
		return $elm$core$List$isEmpty(list) ? _List_Nil : _List_fromArray(
			[
				$jfmengels$elm_review$Review$Rule$globalError(
				{
					bA: _List_fromArray(
						['I expected to find these custom types in the code or dependencies, but I could not find them.', 'Please check whether these types and have not been removed, and if so, remove them from the configuration of this rule.', 'If you find that these types have been moved or renamed, please update your configuration.', 'Note that I may have provided fixes for things you didn\'t wish to be fixed, so you might want to undo the changes I have applied.']),
					aq: 'Could not find type names: ' + A2(
						$elm$core$String$join,
						', ',
...
var $jfmengels$elm_review_simplify$Simplify$foldProjectContexts = F2(
	function (newContext, previousContext) {
		return {
			A: _Utils_ap(newContext.A, previousContext.A)
		};
	});
...
var $jfmengels$elm_review$Review$Rule$functionToExpression = function (_function) {
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dM).bG;
};
	...
	switch (_v0.$) {
		...
		case 4:
			...
			return _List_fromArray(
				[cond, then_, else_]);
		case 15:
			var expression = _v0.a.bG;
			var declarations = _v0.a.cK;
			return _Utils_ap(
				A2(
					$elm$core$List$map,
				...
				return A3(
					...
					A3(
						...
						function (errorsAndContext_) {
							...
							A3($jfmengels$elm_review$Review$Rule$visitWithListOfVisitors, expressionRelatedVisitors.z, node, errorsAndContext))));
			case 16:
				var caseBlock = _v1.a;
				return A3(
					$jfmengels$elm_review$Review$Rule$visitWithListOfVisitors,
	...
	function (expressionRelatedVisitors, letBlockWithRange, letDeclarationWithRange, errorsAndContext) {
		...
		return A4(
			...
			A3(
				...
				expressionRelatedVisitors,
				expressionNode,
				A4($jfmengels$elm_review$Review$Rule$visitWithListOfVisitors2, expressionRelatedVisitors.aa, letBlockWithRange, letDeclarationWithRange, errorsAndContext)));
	});
			...
			if (!nodesToVisit.b) {
				...
				switch (_v1.$) {
					...
					case 4:
						...
						continue expressionChildrenTCO;
					case 15:
						var expression = _v1.a.bG;
						var declarations = _v1.a.cK;
						var $temp$nodesToVisit = A2(
							$elm$core$List$append,
							A2(
								$elm$core$List$map,
...
var $jfmengels$elm_review$Review$Rule$createExpressionVisitor = function (schema) {
	if ((!$elm$core$List$isEmpty(schema.aa)) || ((!$elm$core$List$isEmpty(schema.ab)) || ((!$elm$core$List$isEmpty(schema.U)) || (!$elm$core$List$isEmpty(schema.V))))) {
		...
		if (!$elm$core$List$isEmpty(schema.G)) {
			var exitVisitors = schema.G;
			var enterVisitors = $elm$core$List$reverse(schema.z);
			return $elm$core$Maybe$Just(
				A2($jfmengels$elm_review$Review$Rule$visitOnlyExpressions, enterVisitors, exitVisitors));
		} else {
			if (!$elm$core$List$isEmpty(schema.z)) {
				return $elm$core$Maybe$Just(
					$jfmengels$elm_review$Review$Rule$visitOnlyExpressionsOnlyOnEnter(
						$elm$core$List$reverse(schema.z)));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		}
	...
	function (declarationVisitorsOnEnter, declarationVisitorsOnExit, expressionVisitor, node, errorsAndContext) {
		...
		if (!_v0.$) {
			...
			return A3(
				...
				A2(
					expressionVisitor,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dM).bG,
					A3($jfmengels$elm_review$Review$Rule$visitWithListOfVisitors, declarationVisitorsOnEnter, node, errorsAndContext)));
		} else {
...
var $jfmengels$elm_review$Review$Rule$fromModuleRuleSchemaToRunnableModuleVisitor = function (_v0) {
	...
	return {
		...
		b0: $jfmengels$elm_review$Review$Rule$createDeclarationAndExpressionVisitor(schema),
		ag: $elm$core$List$reverse(schema.ag),
		u: $elm$core$List$reverse(schema.u),
		...
		if (_v0.a.$ === 1) {
			...
			if (_v0.b) {
				...
				var dummyAvailableData = {
					bH: $elm$core$Basics$always('dummy'),
					bO: $jfmengels$elm_review$Review$Rule$createMetadata(
						{
							ch: true,
							bT: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, _List_Nil)
						}),
					bR: 'dummy',
					ak: $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$empty
				};
				...
				var emptyModuleVisitor = {
					...
					u: _List_Nil,
					ai: _List_Nil,
					bo: $elm$core$Maybe$Just(initialModuleContext),
					aa: _List_Nil,
					ab: _List_Nil,
					L: $jfmengels$elm_review$Review$Rule$initContextCreator(
...
var $jfmengels$elm_review$Review$Rule$fromProjectRuleSchemaToRunnableProjectVisitor = function (_v0) {
	...
	return {
		...
		u: $elm$core$List$reverse(schema.u),
		aB: schema.aB,
		cl: A3($jfmengels$elm_review$Review$Rule$mergeModuleVisitors, schema.aB, schema.L, schema.a5),
		...
		S: function () {
			...
			if (!_v1.$) {
				...
				return {ak: false, bd: false};
			}
		}(),
		aF: function () {
			var _v3 = _Utils_Tuple2(schema.by, schema.aM);
			if (!_v3.a) {
				var _v4 = _v3.a;
				return $jfmengels$elm_review$Review$Rule$TraverseAllModulesInParallel(schema.aM);
			} else {
				if (!_v3.b.$) {
					var _v5 = _v3.a;
					var folder = _v3.b.a;
...
var $jfmengels$elm_review$Review$Exceptions$shouldBeIgnored = F2(
	function (exceptions, path) {
		...
		return A2($elm$core$Set$member, cleanedPath, exceptions.aL) || A2($jfmengels$elm_review$Review$Exceptions$isInAnIgnoredDirectory, exceptions.aJ, cleanedPath);
	});
var $jfmengels$elm_review$Review$Exceptions$apply = F3(
	function (_v0, getPath, items) {
		var exceptions = _v0;
		return ($elm$core$Set$isEmpty(exceptions.aL) && $elm$core$List$isEmpty(exceptions.aJ)) ? items : A2(
			$elm$core$List$filter,
			A2(
				$elm$core$Basics$composeR,
				getPath,
...
var $jfmengels$elm_review$Review$Rule$getModuleName = function (module_) {
	return $stil4m$elm_syntax$Elm$Syntax$Module$moduleName(
		$stil4m$elm_syntax$Elm$Syntax$Node$value(module_.dB.d0));
};
...
var $jfmengels$elm_review$Vendor$IntDict$prefixMatches = F2(
	function (p, n) {
		return _Utils_eq(
			n & $jfmengels$elm_review$Vendor$IntDict$higherBitMask(p.aX),
			p.am);
	});
	...
	function (key, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return _Utils_eq(l.bp, key) ? $elm$core$Maybe$Just(l.bY) : $elm$core$Maybe$Nothing;
				default:
					var i = dict.a;
	...
	function (f, acc, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return A3(f, l.bp, l.bY, acc);
				default:
					var i = dict.a;
					var $temp$f = f,
						$temp$acc = A3($jfmengels$elm_review$Vendor$IntDict$foldr, f, acc, i.j),
						$temp$dict = i.i;
					f = $temp$f;
					acc = $temp$acc;
					dict = $temp$dict;
...
var $jfmengels$elm_review$Review$Rule$computeModuleAndCacheResult = F6(
	function (traversalAndFolder, modules, graph, computeModule, _v0, _v1) {
		...
		var _v2 = A2($elm$core$Dict$get, node.ck, modules);
		if (_v2.$ === 1) {
						...
						function (key) {
							return A2(
								...
								function (nodeContext) {
									return A2($elm$core$Dict$get, nodeContext.c6.ck, modules);
								},
			...
			var compute = function (previousResult) {
				...
				return _Utils_Tuple2(
					A3($elm$core$Dict$insert, module_.ef, result, cache),
					(!_Utils_eq(
						$elm$core$Maybe$Just(result.k),
						A2(
							$elm$core$Maybe$map,
							function ($) {
								return $.k;
			...
			var _v3 = A2($elm$core$Dict$get, module_.ef, cache);
			if (_v3.$ === 1) {
				return compute($elm$core$Maybe$Nothing);
			} else {
				var cacheEntry = _v3.a;
				return (_Utils_eq(cacheEntry.en, module_.en) && A3($jfmengels$elm_review$Review$Rule$contextFromImportedModulesIsUnchanged, traversalAndFolder, importedModules, invalidatedModules)) ? _Utils_Tuple2(cache, invalidatedModules) : compute(
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					A2($elm$core$String$slice, 0, range.a_.ar - 1),
					A2(
						$elm$core$List$take,
						(range.a_.aD - range.be.aD) + 1,
						A2($elm$core$List$drop, range.be.aD - 1, lines)))));
	});
...
var $jfmengels$elm_review$Vendor$Graph$NodeContext = F3(
	function (node, incoming, outgoing) {
		return {cZ: incoming, c6: node, m: outgoing};
	});
				...
				return $jfmengels$elm_review$Vendor$IntDict$Inner(
					{
						...
						l: p,
						j: r,
						cu: $jfmengels$elm_review$Vendor$IntDict$size(l) + $jfmengels$elm_review$Vendor$IntDict$size(r)
					});
			}
		}
	});
var $jfmengels$elm_review$Vendor$IntDict$lcp = F2(
	function (x, y) {
		...
		return {aX: branchingBit, am: prefixBits};
	});
...
var $jfmengels$elm_review$Vendor$IntDict$update = F3(
	function (key, alter, dict) {
		...
		switch (dict.$) {
			...
			case 1:
				var l = dict.a;
				return _Utils_eq(l.bp, key) ? alteredNode(
					$elm$core$Maybe$Just(l.bY)) : A2(
					join,
					_Utils_Tuple2(
						key,
						alteredNode($elm$core$Maybe$Nothing)),
					_Utils_Tuple2(l.bp, dict));
			default:
				var i = dict.a;
				return A2($jfmengels$elm_review$Vendor$IntDict$prefixMatches, i.l, key) ? (A2($jfmengels$elm_review$Vendor$IntDict$isBranchingBitSet, i.l, key) ? A3(
					...
					i.l,
					i.i,
					A3($jfmengels$elm_review$Vendor$IntDict$update, key, alter, i.j)) : A3(
					$jfmengels$elm_review$Vendor$IntDict$inner,
					i.l,
					A3($jfmengels$elm_review$Vendor$IntDict$update, key, alter, i.i),
					i.j)) : A2(
					join,
					_Utils_Tuple2(
						key,
						alteredNode($elm$core$Maybe$Nothing)),
					_Utils_Tuple2(i.l.am, dict));
		}
	});
...
var $jfmengels$elm_review$Vendor$Graph$fromNodesAndEdges = F2(
	function (nodes_, edges_) {
			...
			function (edge, rep) {
				var updateOutgoing = function (ctx) {
					return _Utils_update(
						ctx,
						{
							m: A3($jfmengels$elm_review$Vendor$IntDict$insert, edge.ew, edge.ck, ctx.m)
						});
				};
				var updateIncoming = function (ctx) {
					return _Utils_update(
						ctx,
						{
							cZ: A3($jfmengels$elm_review$Vendor$IntDict$insert, edge.dT, edge.ck, ctx.cZ)
						});
				};
				return A3(
					$jfmengels$elm_review$Vendor$IntDict$update,
		...
		var addEdgeIfValid = F2(
			function (edge, rep) {
				return (A2($jfmengels$elm_review$Vendor$IntDict$member, edge.dT, rep) && A2($jfmengels$elm_review$Vendor$IntDict$member, edge.ew, rep)) ? A2(addEdge, edge, rep) : rep;
			});
...
var $jfmengels$elm_review$Vendor$Graph$Edge = F3(
	function (from, to, label) {
		return {dT: from, ck: label, ew: to};
	});
var $jfmengels$elm_review$Vendor$Graph$Node = F2(
	function (id, label) {
		return {bJ: id, ck: label};
	});
...
var $jfmengels$elm_review$Review$Project$Internal$moduleGraph = function (_v0) {
	...
	if (!_v1.$) {
		...
		return $jfmengels$elm_review$Review$Project$Internal$buildModuleGraph(
			$elm$core$Dict$values(project.al));
	}
};
...
var $jfmengels$elm_review$Review$Project$Internal$moduleNameLookupTables = function (_v0) {
	var project = _v0;
	return A2($elm$core$Maybe$withDefault, $elm$core$Dict$empty, project.d1);
};
...
var $jfmengels$elm_review$Review$Project$modules = function (_v0) {
	var project = _v0;
	return $elm$core$Dict$values(project.al);
};
	...
	function (projectVisitor, _v0, project, exceptions, initialProjectContext, nodeContexts, startCache) {
		...
		var computeModule = F3(
			function (cache, importedModules, module_) {
				var moduleKey = module_.ef;
				var metadata = $jfmengels$elm_review$Review$Rule$createMetadata(
					{
						ch: module_.ch,
						bT: $jfmengels$elm_review$Review$Rule$moduleNameNode(module_.dB.d0)
					});
				var availableData = {
					bH: function () {
						var _v4 = projectVisitor.S;
						var requestedData = _v4;
						return requestedData.bd ? $jfmengels$elm_review$Review$Rule$extractSourceCode(
							$elm$core$String$lines(module_.en)) : $elm$core$Basics$always('');
					}(),
					bO: metadata,
					bR: moduleKey,
					ak: A2(
							...
							A2(
								...
								function (importedModule) {
									return A2(
										...
										A2($elm$core$Dict$get, importedModule.ef, cache));
								},
								importedModules));
				...
				return {
					k: function () {
						var _v2 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aF);
						if (!_v2.$) {
							var fromModuleToProject = _v2.a.aN;
		...
		return A3(
			$elm$core$List$foldl,
			A4($jfmengels$elm_review$Review$Rule$computeModuleAndCacheResult, projectVisitor.aF, modules, graph, computeModule),
...
var $jfmengels$elm_review$Review$Rule$computeProjectContext = F3(
	function (projectVisitor, project, maybePreviousCache) {
		...
		var elmJsonCacheEntry = function () {
			var computeElmJson = function (_v9) {
				var _v8 = A3(
					...
					projectVisitor.E,
					elmJsonData,
					_Utils_Tuple2(_List_Nil, projectVisitor.aB));
				var errorsForVisitor = _v8.a;
				var contextForVisitor = _v8.b;
				return {k: contextForVisitor, aw: errorsForVisitor, bY: projectElmJson};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return _Utils_eq(previousCache.b3.bY, projectElmJson) ? previousCache.b3 : computeElmJson(0);
			} else {
		...
		var readmeCacheEntry = function () {
			var computeReadme = function (_v6) {
				var _v5 = A3(
					...
					projectVisitor.H,
					readmeData,
					_Utils_Tuple2(_List_Nil, elmJsonCacheEntry.k));
				var errorsForVisitor = _v5.a;
				var contextForVisitor = _v5.b;
				return {k: contextForVisitor, aw: errorsForVisitor, bY: readmeData};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return (_Utils_eq(previousCache.b3.k, elmJsonCacheEntry.k) && _Utils_eq(previousCache.cq.bY, readmeData)) ? previousCache.cq : computeReadme(0);
			} else {
		...
		var _v0 = function () {
			...
			var computeDependencies = function (_v3) {
				var _v2 = A3(
					...
					projectVisitor.D,
					dependencies,
					_Utils_Tuple2(_List_Nil, readmeCacheEntry.k));
				var errorsForVisitor = _v2.a;
				var contextForVisitor = _v2.b;
				return {k: contextForVisitor, aw: errorsForVisitor, bY: dependencies};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return (_Utils_eq(previousCache.cq.k, readmeCacheEntry.k) && _Utils_eq(previousCache.aI.bY, dependencies)) ? _Utils_Tuple2(previousCache.aI, false) : _Utils_Tuple2(
		...
		return _Utils_Tuple2(
			{aI: dependenciesCacheEntry, b3: elmJsonCacheEntry, bk: _List_Nil, bs: $elm$core$Dict$empty, cq: readmeCacheEntry},
			hasAnythingChanged);
	});
	...
	return $elm$core$List$concat(
		_List_fromArray(
			[
				...
				$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
				function (cacheEntry) {
					return cacheEntry.aw;
				},
				$elm$core$Dict$values(cache.bs)),
				cache.bk
			]));
};
var $jfmengels$elm_review$Review$Rule$errorsFromFinalEvaluationForProject = F3(
	function (projectVisitor, initialContext, contextsPerModule) {
		if ($elm$core$List$isEmpty(projectVisitor.u)) {
			return _List_Nil;
		} else {
			var finalContext = function () {
				var _v0 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aF);
				if (!_v0.$) {
					var foldProjectContexts = _v0.a.ao;
...
var $jfmengels$elm_review$Review$Rule$runProjectVisitor = F6(
	function (name, projectVisitor, maybePreviousCache, exceptions, project, nodeContexts) {
		...
		var initialContext = cacheWithInitialContext.aI.k;
		var previousModuleContexts = function () {
			if (hasInitialContextChanged) {
				return $elm$core$Dict$empty;
			} else {
				if (!maybePreviousCache.$) {
					var moduleContexts = maybePreviousCache.a.bs;
		...
		var contextsAndErrorsPerModule = A2(
			$elm$core$List$map,
			function (cacheEntry) {
				return _Utils_Tuple2(cacheEntry.aw, cacheEntry.k);
			},
		...
		var errorsFromFinalEvaluation = function () {
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return _Utils_eq(allModulesContext, previousAllModulesContext) ? previousCache.bk : A3($jfmengels$elm_review$Review$Rule$errorsFromFinalEvaluationForProject, projectVisitor, initialContext, allModulesContext);
			} else {
		...
		var newCache = {aI: cacheWithInitialContext.aI, b3: cacheWithInitialContext.b3, bk: errorsFromFinalEvaluation, bs: newCachedModuleContexts, cq: cacheWithInitialContext.cq};
		var errors = A3(
			$jfmengels$elm_review$Review$Exceptions$apply,
			exceptions,
			A2(
		...
		return {
			...
			aw: A2(
				...
				errors),
			a$: function () {
				var _v1 = projectVisitor.at;
				if (!_v1.$) {
					var dataExtractor = _v1.a;
					var contextToAnalyze = function () {
						var _v2 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.aF);
						if (!_v2.$) {
							var foldProjectContexts = _v2.a.ao;
				...
				aE: F3(
					function (newExceptions, newProject, newNodeContexts) {
						var result = A6(
							...
							newProject,
							newNodeContexts);
						return _Utils_Tuple2(result.aw, result.cr);
					})
			}
		};
	});
		...
		return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
			{
				...
				D: A2($jfmengels$elm_review$Review$Rule$compactProjectDataVisitors, $elm$core$Basics$identity, schema.D),
				E: A2(
		...
		return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
			{
				...
				aM: $elm$core$Maybe$Nothing,
				aB: 0,
				L: $elm$core$Maybe$Just(schema.L),
				a5: _List_fromArray(
					[
						$jfmengels$elm_review$Review$Rule$removeExtensibleRecordTypeVariable(
						$elm$core$Basics$always(moduleVisitor))
...
var $jfmengels$elm_review_simplify$Simplify$fromModuleToProject = $jfmengels$elm_review$Review$Rule$initContextCreator(
	function (moduleContext) {
		return {A: moduleContext.br};
	});
var $jfmengels$elm_review_simplify$Simplify$buildConstructorsToIgnore = function (constructors) {
...
var $jfmengels$elm_review$Review$Rule$moduleNameFromMetadata = function (_v0) {
	var metadata = _v0;
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(metadata.bT);
};
...
var $jfmengels$elm_review$Review$Rule$withModuleNameLookupTable = function (_v0) {
	...
	return A2(
		$jfmengels$elm_review$Review$Rule$ContextCreator,
		function (data) {
			return A2(fn, data, data.ak);
		},
		_Utils_update(
			requested,
			{ak: true}));
};
var $jfmengels$elm_review_simplify$Simplify$fromProjectToModule = $jfmengels$elm_review$Review$Rule$withMetadata(
	$jfmengels$elm_review$Review$Rule$withModuleNameLookupTable(
		$jfmengels$elm_review$Review$Rule$initContextCreator(
			F3(
				function (lookupTable, metadata, projectContext) {
					return {
						aH: $jfmengels$elm_review_simplify$Simplify$buildConstructorsToIgnore(projectContext.A),
						A: projectContext.A,
						br: _List_Nil,
						o: lookupTable,
						bS: $jfmengels$elm_review$Review$Rule$moduleNameFromMetadata(metadata),
						ac: _List_Nil,
						ad: _List_Nil
					};
				}))));
var $jfmengels$elm_review_simplify$Simplify$initialContext = {A: _List_Nil};
var $jfmengels$elm_review_simplify$Simplify$initialModuleContext = $jfmengels$elm_review$Review$Rule$withMetadata(
	$jfmengels$elm_review$Review$Rule$withModuleNameLookupTable(
		$jfmengels$elm_review$Review$Rule$initContextCreator(
			F3(
...
var $jfmengels$elm_review_simplify$Simplify$findCustomTypes = F3(
	function (constructorsToIgnore, context, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		if (_v0.$ === 2) {
			var name = _v0.a.aV;
			var constructors = _v0.a.dK;
			return A2(
				$elm$core$Set$member,
				_Utils_Tuple2(
					context.bS,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(name)),
				constructorsToIgnore) ? $elm$core$Maybe$Just(
				{
					dK: A2(
						$elm$core$List$map,
						function (constructor) {
							return $stil4m$elm_syntax$Elm$Syntax$Node$value(
								$stil4m$elm_syntax$Elm$Syntax$Node$value(constructor).aV);
						},
						constructors),
					bS: context.bS,
					aV: $stil4m$elm_syntax$Elm$Syntax$Node$value(name)
				}) : $elm$core$Maybe$Nothing;
		} else {
			return $elm$core$Maybe$Nothing;
		}
...
var $jfmengels$elm_review_simplify$Simplify$declarationListVisitor = F3(
	function (constructorsToIgnore, declarations, context) {
		var localIgnoredCustomTypes = A2(
			$elm$core$List$filterMap,
			A2($jfmengels$elm_review_simplify$Simplify$findCustomTypes, constructorsToIgnore, context),
			declarations);
		return _Utils_Tuple2(
			_List_Nil,
			_Utils_update(
				context,
				{
					aH: A2(
						$elm$core$Set$union,
						$jfmengels$elm_review_simplify$Simplify$buildConstructorsToIgnore(localIgnoredCustomTypes),
						context.aH),
					A: _Utils_ap(localIgnoredCustomTypes, context.A),
					br: localIgnoredCustomTypes
				}));
	});
var $jfmengels$elm_review$Review$Rule$withDeclarationListVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				ag: A2($elm$core$List$cons, visitor, schema.ag)
			});
	});
var $jfmengels$elm_review_simplify$Simplify$addDeclarationListVisitor = F2(
	function (typeNames, schema) {
		return $elm$core$Set$isEmpty(typeNames) ? schema : A2(
			$jfmengels$elm_review$Review$Rule$withDeclarationListVisitor,
			$jfmengels$elm_review_simplify$Simplify$declarationListVisitor(typeNames),
			schema);
	});
var $jfmengels$elm_review_simplify$Simplify$declarationVisitor = F2(
	function (_v0, context) {
		return _Utils_Tuple2(
			_List_Nil,
			_Utils_update(
				context,
				{ac: _List_Nil, ad: _List_Nil}));
	});
...
var $jfmengels$elm_review$Review$Rule$error = F2(
	function (_v0, range) {
		...
		var details = _v0.bA;
		return $jfmengels$elm_review$Review$Rule$UnspecifiedError(
			{bA: details, b9: '', cb: $elm$core$Maybe$Nothing, aq: message, cp: range, cs: '', $7: 0});
	});
...
var $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$toRangeLike = function (_v0) {
	...
	var end = _v0.a_;
	return _Utils_Tuple2(
		_Utils_Tuple2(start.aD, start.ar),
		_Utils_Tuple2(end.aD, end.ar));
};
...
var $jfmengels$elm_review_simplify$Simplify$getBooleanPattern = F2(
...
var $jfmengels$elm_review_simplify$Simplify$booleanCaseOfChecks = F3(
	function (lookupTable, parentRange, _v0) {
		var expression = _v0.bG;
		var cases = _v0.dF;
		if ((cases.b && cases.b.b) && (!cases.b.b.b)) {
			...
			var _v8 = A2($jfmengels$elm_review_simplify$Simplify$getBooleanPattern, lookupTable, firstPattern);
			if (!_v8.$) {
				...
				return _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							...
							aq: 'Replace `case..of` by an `if` condition'
						},
						...
						isTrueFirst ? _List_fromArray(
							[
								...
								{
									a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(expression).be,
									be: parentRange.be
								},
								'if '),
								A2(
								...
								{
									a_: firstRange.be,
									be: $stil4m$elm_syntax$Elm$Syntax$Node$range(expression).a_
								},
								' then '),
								A2(
								$jfmengels$elm_review$Review$Fix$replaceRangeBy,
								{a_: secondExprRange.be, be: secondPatternRange.be},
								'else ')
							]) : _List_fromArray(
							[
								A2(
...
var $jfmengels$elm_review_simplify$Simplify$firstThatReportsError = F2(
	function (remainingChecks, data) {
...
var $jfmengels$elm_review_simplify$Simplify$find = F2(
	function (predicate, nodes) {
		find:
		while (true) {
			if (!nodes.b) {
				return $elm$core$Maybe$Nothing;
...
var $jfmengels$elm_review_simplify$Simplify$allConstructorsWereUsedOfAType = F2(
	function (ignoredCustomTypes, constructorsUsed) {
		allConstructorsWereUsedOfAType:
		while (true) {
			if (!constructorsUsed.b) {
				return false;
			} else {
				var _v1 = constructorsUsed.a;
				var moduleName = _v1.a;
				var constructorName = _v1.b;
				var rest = constructorsUsed.b;
				var _v2 = A2(
					$jfmengels$elm_review_simplify$Simplify$find,
					function (type_) {
						return _Utils_eq(type_.bS, moduleName) && A2($elm$core$List$member, constructorName, type_.dK);
					},
					ignoredCustomTypes);
				if (!_v2.$) {
					var customType = _v2.a;
					return A2(
						$elm$core$List$all,
						function (constructor) {
							return A2(
								$elm$core$List$member,
								_Utils_Tuple2(moduleName, constructor),
								A2(
									$elm$core$List$cons,
									_Utils_Tuple2(moduleName, constructorName),
									rest));
						},
						customType.dK) || A2($jfmengels$elm_review_simplify$Simplify$allConstructorsWereUsedOfAType, ignoredCustomTypes, rest);
				} else {
					var $temp$ignoredCustomTypes = ignoredCustomTypes,
						$temp$constructorsUsed = rest;
					ignoredCustomTypes = $temp$ignoredCustomTypes;
					constructorsUsed = $temp$constructorsUsed;
					continue allConstructorsWereUsedOfAType;
				}
			}
		}
	});
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$normalizePattern = function (node) {
	normalizePattern:
	while (true) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		switch (_v0.$) {
			case 7:
				...
				return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
					$stil4m$elm_syntax$Elm$Syntax$Pattern$TuplePattern(
						A2($elm$core$List$map, $jfmengels$elm_review_simplify$Simplify$Normalize$normalizePattern, patterns)));
			case 8:
				var fields = _v0.a;
				return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
			...
			case 9:
				...
				return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
					A2(
						...
						$jfmengels$elm_review_simplify$Simplify$Normalize$normalizePattern(element),
						$jfmengels$elm_review_simplify$Simplify$Normalize$normalizePattern(list)));
			case 10:
				var patterns = _v0.a;
				return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
			...
			case 13:
				...
				return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
					A2(
						...
						$jfmengels$elm_review_simplify$Simplify$Normalize$normalizePattern(pattern),
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$normalize = F2(
	function (lookupTable, node) {
		normalize:
		while (true) {
			var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
				...
				case 1:
					...
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
						$stil4m$elm_syntax$Elm$Syntax$Expression$Application(
							A2(
								$elm$core$List$map,
								$jfmengels$elm_review_simplify$Simplify$Normalize$normalize(lookupTable),
								nodes)));
				case 2:
					var string = _v0.a;
					...
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
						A4(
							...
							string,
							infixDirection,
							A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, left),
							A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, right)));
				case 3:
					...
					var moduleName = A2(
						...
						A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameFor, lookupTable, node));
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
						A2($stil4m$elm_syntax$Elm$Syntax$Expression$FunctionOrValue, moduleName, string));
				case 4:
					var cond = _v0.a;
					var then_ = _v0.b;
					var else_ = _v0.c;
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
						A3(
							...
							A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, cond),
							A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, then_),
							A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, else_)));
				case 10:
					var expr = _v0.a;
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
						$stil4m$elm_syntax$Elm$Syntax$Expression$Negation(
							A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, expr)));
				case 13:
					var nodes = _v0.a;
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
						...
						$stil4m$elm_syntax$Elm$Syntax$Expression$LetExpression(
							{
								cK: A2(
									$elm$core$List$map,
									function (decl) {
										var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(decl);
										if (!_v1.$) {
											var _function = _v1.a;
											var declaration = $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dM);
											return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
												$stil4m$elm_syntax$Elm$Syntax$Expression$LetFunction(
													{
														dM: $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
															{
																cC: A2($elm$core$List$map, $jfmengels$elm_review_simplify$Simplify$Normalize$normalizePattern, declaration.cC),
																bG: A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, declaration.bG),
																aV: $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
																	$stil4m$elm_syntax$Elm$Syntax$Node$value(declaration.aV))
															}),
									...
									letBlock.cK),
								bG: A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, letBlock.bG)
							}));
				case 16:
					var caseBlock = _v0.a;
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
						$stil4m$elm_syntax$Elm$Syntax$Expression$CaseExpression(
							{
								dF: A2(
									...
									caseBlock.dF),
								bG: $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
									$stil4m$elm_syntax$Elm$Syntax$Node$value(caseBlock.bG))
							}));
				case 17:
					var lambda = _v0.a;
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
						$stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
							{
								dz: A2($elm$core$List$map, $jfmengels$elm_review_simplify$Simplify$Normalize$normalizePattern, lambda.dz),
								bG: A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, lambda.bG)
							}));
				case 19:
					var nodes = _v0.a;
					return $jfmengels$elm_review_simplify$Simplify$Normalize$toNode(
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$areAllTheSame = F3(
	function (lookupTable, first, rest) {
		var normalizedFirst = A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, first);
		return A2(
			$elm$core$List$all,
			function (node) {
				return _Utils_eq(
					A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, node),
					normalizedFirst);
			},
			rest);
	});
var $jfmengels$elm_review_simplify$Simplify$caseKeyWordRange = function (range) {
	return {
		a_: {ar: range.be.ar + 4, aD: range.be.aD},
		be: range.be
	};
};
...
var $jfmengels$elm_review_simplify$Simplify$isIgnoredConstructor2 = F3(
	function (context, range, name) {
		var _v0 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, context.o, range);
		if (!_v0.$) {
			if (!_v0.a.b) {
				return A2(
					$elm$core$Set$member,
					_Utils_Tuple2(context.bS, name),
					context.aH) ? $elm$core$Maybe$Just(context.bS) : $elm$core$Maybe$Nothing;
			} else {
				var moduleName = _v0.a;
				return A2(
					$elm$core$Set$member,
					_Utils_Tuple2(moduleName, name),
					context.aH) ? $elm$core$Maybe$Just(moduleName) : $elm$core$Maybe$Nothing;
			}
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
var $jfmengels$elm_review_simplify$Simplify$findUsedConstructors = F2(
		...
		while (true) {
			...
			switch (_v0.$) {
				case 12:
					...
					var nodes = _v0.b;
					var _v1 = A3(
						$jfmengels$elm_review_simplify$Simplify$isIgnoredConstructor2,
						context,
						$stil4m$elm_syntax$Elm$Syntax$Node$range(node),
						name);
					if (!_v1.$) {
						...
						return A2(
							...
							A2(
								$elm$core$List$concatMap,
								$jfmengels$elm_review_simplify$Simplify$findUsedConstructors(context),
								nodes));
					} else {
						return A2(
							$elm$core$List$concatMap,
...
var $jfmengels$elm_review_simplify$Simplify$introducesVariable = function (node) {
	introducesVariable:
	while (true) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		switch (_v0.$) {
			...
			case 7:
				var nodes = _v0.a;
				return A2($elm$core$List$any, $jfmengels$elm_review_simplify$Simplify$introducesVariable, nodes);
			case 9:
				var first = _v0.a;
				var rest = _v0.b;
				return A2(
					$elm$core$List$any,
					$jfmengels$elm_review_simplify$Simplify$introducesVariable,
					_List_fromArray(
						[first, rest]));
			case 10:
				var nodes = _v0.a;
...
var $jfmengels$elm_review_simplify$Simplify$sameBodyForCaseOfChecks = F3(
	function (context, parentRange, cases) {
		if (!cases.b) {
			return _List_Nil;
		} else {
			var first = cases.a;
			...
			if (A2(
				$elm$core$List$any,
				A2($elm$core$Basics$composeR, $elm$core$Tuple$first, $jfmengels$elm_review_simplify$Simplify$introducesVariable),
				A2($elm$core$List$cons, first, rest)) || (!A3(
				...
				var constructorsUsed = function (_v1) {
				...
				if ((!$elm$core$List$isEmpty(context.A)) && A2(
					$jfmengels$elm_review_simplify$Simplify$allConstructorsWereUsedOfAType,
					context.A,
					constructorsUsed(0))) {
					return _List_Nil;
				} else {
					var firstBodyRange = $stil4m$elm_syntax$Elm$Syntax$Node$range(first.b);
					return _List_fromArray(
						[
							A3(
							$jfmengels$elm_review$Review$Rule$errorWithFix,
...
var $jfmengels$elm_review_simplify$Simplify$caseOfChecks = F3(
	function (context, parentRange, caseBlock) {
		return A2(
			$jfmengels$elm_review_simplify$Simplify$firstThatReportsError,
			_List_fromArray(
				[
					function (_v0) {
					return A3($jfmengels$elm_review_simplify$Simplify$sameBodyForCaseOfChecks, context, parentRange, caseBlock.dF);
				},
					function (_v1) {
					return A3($jfmengels$elm_review_simplify$Simplify$booleanCaseOfChecks, context.o, parentRange, caseBlock);
				}
				]),
			0);
	});
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$HasBothValues = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$areTheSame = F3(
	function (lookupTable, left, right) {
		return _Utils_eq(
			A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, left),
			A2($jfmengels$elm_review_simplify$Simplify$Normalize$normalize, lookupTable, right));
	});
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$compareNumbers = F2(
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$isSameReference = F3(
	function (lookupTable, _v0, _v1) {
		var leftFnRange = _v0.a;
		var leftFnName = _v0.b;
		var rightFnRange = _v1.a;
		var rightFnName = _v1.b;
		return _Utils_eq(leftFnName, rightFnName) ? A2(
			$elm$core$Maybe$withDefault,
			false,
			A3(
				$elm$core$Maybe$map2,
				$elm$core$Basics$eq,
				A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, leftFnRange),
				A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, rightFnRange))) : false;
	});
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$compare = F3(
	function (lookupTable, leftNode, right) {
		return A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareHelp, lookupTable, leftNode, right, true);
	});
var $jfmengels$elm_review_simplify$Simplify$Normalize$compareEqualityOfAll = F3(
	function (lookupTable, leftList, rightList) {
		...
		while (true) {
			...
			if (_v25.a.b && _v25.b.b) {
				...
				var _v28 = A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareHelp, lookupTable, left, right, true);
				switch (_v28) {
					case 0:
						var $temp$lookupTable = lookupTable,
							$temp$leftList = restOfLeft,
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$compareHelp = F4(
	function (lookupTable, leftNode, right, canFlip) {
		compareHelp:
		while (true) {
			var fallback = function (rightNode) {
				return canFlip ? A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareHelp, lookupTable, rightNode, leftNode, false) : (A3($jfmengels$elm_review_simplify$Simplify$Normalize$areTheSame, lookupTable, leftNode, right) ? 0 : 2);
			};
			...
			switch (_v10.$) {
				...
				case 10:
					var left = _v10.a;
					var _v11 = $jfmengels$elm_review_simplify$Simplify$Normalize$getNumberValue(left);
					if (!_v11.$) {
						var leftValue = _v11.a;
						return A2($jfmengels$elm_review_simplify$Simplify$Normalize$compareNumbers, -leftValue, right);
					} else {
				...
				case 2:
					...
					if (A2(
						...
						_List_fromArray(
							['+', '-', '*', '/']))) {
						var _v12 = $jfmengels$elm_review_simplify$Simplify$Normalize$getNumberValue(leftNode);
						if (!_v12.$) {
							var leftValue = _v12.a;
							var _v13 = $jfmengels$elm_review_simplify$Simplify$Normalize$getNumberValue(right);
							if (!_v13.$) {
								var rightValue = _v13.a;
								return $jfmengels$elm_review_simplify$Simplify$Normalize$fromEquality(
									_Utils_eq(leftValue, rightValue));
							} else {
								return fallback(right);
						...
						if (_v14.$ === 2) {
							var rightOp = _v14.a;
							var rightLeft = _v14.c;
							var rightRight = _v14.d;
							return _Utils_eq(leftOp, rightOp) ? A3(
								$jfmengels$elm_review_simplify$Simplify$Normalize$compareEqualityOfAll,
								lookupTable,
								_List_fromArray(
									[leftLeft, leftRight]),
								_List_fromArray(
									[rightLeft, rightRight])) : fallback(right);
						} else {
							return fallback(right);
						}
					}
				...
				case 3:
					var leftName = _v10.b;
					var right_ = $jfmengels$elm_review_simplify$Simplify$Normalize$removeParens(right);
					var _v17 = $stil4m$elm_syntax$Elm$Syntax$Node$value(right_);
					if (_v17.$ === 3) {
						var rightName = _v17.b;
						return A3(
							$jfmengels$elm_review_simplify$Simplify$Normalize$isSameReference,
							lookupTable,
							_Utils_Tuple2(
								$stil4m$elm_syntax$Elm$Syntax$Node$range(leftNode),
								leftName),
							_Utils_Tuple2(
								$stil4m$elm_syntax$Elm$Syntax$Node$range(right_),
								rightName)) ? 0 : fallback(right_);
					} else {
						return fallback(right);
					}
				case 19:
					...
					if (_v18.$ === 19) {
						...
						return (!_Utils_eq(
							...
							$elm$core$List$length(rightList))) ? 1 : A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareLists, lookupTable, leftList, rightList, 0);
					} else {
						return fallback(right);
					}
				case 13:
					...
					if (_v19.$ === 13) {
						...
						return A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareLists, lookupTable, leftList, rightList, 0);
					} else {
						return fallback(right);
					}
				case 18:
					...
					var _v20 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
						$jfmengels$elm_review_simplify$Simplify$Normalize$removeParens(right));
					if (_v20.$ === 18) {
						var rightList = _v20.a;
						return A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareRecords, lookupTable, leftList, rightList, 0);
					} else {
						return fallback(right);
					}
				case 22:
					...
					var _v21 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
						$jfmengels$elm_review_simplify$Simplify$Normalize$removeParens(right));
					if (_v21.$ === 22) {
						var rightBaseValue = _v21.a;
						var rightList = _v21.b;
						return _Utils_eq(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(leftBaseValue),
							$stil4m$elm_syntax$Elm$Syntax$Node$value(rightBaseValue)) ? A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareRecords, lookupTable, leftList, rightList, 0) : A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareRecords, lookupTable, leftList, rightList, 2);
					} else {
						return fallback(right);
					}
				case 1:
					...
					var _v22 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
						$jfmengels$elm_review_simplify$Simplify$Normalize$removeParens(right));
					if (_v22.$ === 1) {
						var rightArgs = _v22.a;
						return A3($jfmengels$elm_review_simplify$Simplify$Normalize$compareEqualityOfAll, lookupTable, leftArgs, rightArgs);
					} else {
						return fallback(right);
					}
				case 20:
				...
				case 4:
					...
					var leftThen = _v10.b;
					var leftElse = _v10.c;
					var _v24 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
						$jfmengels$elm_review_simplify$Simplify$Normalize$removeParens(right));
					if (_v24.$ === 4) {
						var rightCond = _v24.a;
						var rightThen = _v24.b;
						var rightElse = _v24.c;
						return A3(
							$jfmengels$elm_review_simplify$Simplify$Normalize$compareEqualityOfAll,
							lookupTable,
							_List_fromArray(
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$compareLists = F4(
	function (lookupTable, leftList, rightList, acc) {
		compareLists:
		while (true) {
			...
			if (_v6.a.b && _v6.b.b) {
				...
				var _v9 = A4($jfmengels$elm_review_simplify$Simplify$Normalize$compareHelp, lookupTable, left, right, true);
				switch (_v9) {
					case 0:
						var $temp$lookupTable = lookupTable,
							$temp$leftList = restOfLeft,
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$compareRecordFields = F3(
	function (lookupTable, recordFieldComparisons, acc) {
		compareRecordFields:
		while (true) {
			if (!recordFieldComparisons.b) {
				...
				if (!recordFieldComparisons.a.$) {
					...
					var $temp$lookupTable = lookupTable,
						$temp$recordFieldComparisons = rest,
						$temp$acc = 2;
					lookupTable = $temp$lookupTable;
					...
					var b = _v4.b;
					var rest = recordFieldComparisons.b;
					var _v5 = A3($jfmengels$elm_review_simplify$Simplify$Normalize$compare, lookupTable, a, b);
					switch (_v5) {
						case 1:
							return 1;
						case 0:
...
var $jfmengels$elm_review_simplify$Simplify$Normalize$compareRecords = F4(
	function (lookupTable, leftList, rightList, acc) {
		var rightFields = A2(
			$elm$core$List$map,
			A2(
		...
		var recordFieldComparisons = $elm$core$Dict$values(
			A6(
				...
				$elm$core$Dict$empty));
		return A3($jfmengels$elm_review_simplify$Simplify$Normalize$compareRecordFields, lookupTable, recordFieldComparisons, acc);
	});
var $jfmengels$elm_review_simplify$Simplify$removeParens = function (node) {
	removeParens:
	while (true) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		if (_v0.$ === 14) {
...
var $jfmengels$elm_review_simplify$Simplify$isAlwaysCall = F2(
	function (lookupTable, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(node));
...
var $jfmengels$elm_review_simplify$Simplify$alwaysCompositionCheck = function (_v0) {
	var lookupTable = _v0.o;
	var fromLeftToRight = _v0.ah;
	var left = _v0.i;
	var right = _v0.j;
	var leftRange = _v0.p;
	var rightRange = _v0.t;
	return fromLeftToRight ? (A2($jfmengels$elm_review_simplify$Simplify$isAlwaysCall, lookupTable, right) ? _List_fromArray(
		[
			A3(
			$jfmengels$elm_review$Review$Rule$errorWithFix,
			{
				...
				aq: 'Function composed with always will be ignored'
			},
			rightRange,
			_List_fromArray(
				[
					$jfmengels$elm_review$Review$Fix$removeRange(
					{a_: rightRange.be, be: leftRange.be})
				]))
		]) : _List_Nil) : (A2($jfmengels$elm_review_simplify$Simplify$isAlwaysCall, lookupTable, left) ? _List_fromArray(
		[
			A3(
			$jfmengels$elm_review$Review$Rule$errorWithFix,
			{
			...
			_List_fromArray(
				[
					$jfmengels$elm_review$Review$Fix$removeRange(
					{a_: rightRange.a_, be: leftRange.a_})
				]))
		]) : _List_Nil);
};
var $jfmengels$elm_review_simplify$Simplify$getExpressionName = function (node) {
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
		$jfmengels$elm_review_simplify$Simplify$removeParens(node));
	if ((_v0.$ === 3) && (!_v0.a.b)) {
		var name = _v0.b;
...
var $jfmengels$elm_review_simplify$Simplify$getVarPattern = function (node) {
	getVarPattern:
	while (true) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		switch (_v0.$) {
...
var $jfmengels$elm_review_simplify$Simplify$isIdentity = F2(
	function (lookupTable, baseNode) {
		var node = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		_v0$2:
		while (true) {
			switch (_v0.$) {
				...
				case 17:
					...
					if (args.b && (!args.b.b)) {
						var arg = args.a;
						var _v2 = $jfmengels$elm_review_simplify$Simplify$getVarPattern(arg);
						if (!_v2.$) {
							var patternName = _v2.a;
							var _v3 = $jfmengels$elm_review_simplify$Simplify$getExpressionName(expression);
							if (!_v3.$) {
								var expressionName = _v3.a;
								return _Utils_eq(patternName, expressionName);
							} else {
								return false;
							}
						} else {
...
var $jfmengels$elm_review_simplify$Simplify$identityCompositionCheck = function (_v0) {
	var lookupTable = _v0.o;
	var left = _v0.i;
	var right = _v0.j;
	return A2($jfmengels$elm_review_simplify$Simplify$isIdentity, lookupTable, right) ? _List_fromArray(
		[
			A3(
			$jfmengels$elm_review$Review$Rule$errorWithFix,
			{
			...
			_List_fromArray(
				[
					$jfmengels$elm_review$Review$Fix$removeRange(
					{
						a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(right).a_,
						be: $stil4m$elm_syntax$Elm$Syntax$Node$range(left).a_
					})
				]))
		]) : (A2($jfmengels$elm_review_simplify$Simplify$isIdentity, lookupTable, left) ? _List_fromArray(
		[
			A3(
			$jfmengels$elm_review$Review$Rule$errorWithFix,
			{
			...
			_List_fromArray(
				[
					$jfmengels$elm_review$Review$Fix$removeRange(
					{
						a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(right).be,
						be: $stil4m$elm_syntax$Elm$Syntax$Node$range(left).be
					})
				]))
		]) : _List_Nil);
};
...
var $jfmengels$elm_review_simplify$Simplify$maybeMapCompositionChecks = function (_v0) {
	var lookupTable = _v0.o;
	var fromLeftToRight = _v0.ah;
	var parentRange = _v0.b;
	var left = _v0.i;
	var right = _v0.j;
	if (fromLeftToRight) {
		var _v1 = _Utils_Tuple2(
			$jfmengels$elm_review_simplify$Simplify$removeParens(left),
			$stil4m$elm_syntax$Elm$Syntax$Node$value(
				$jfmengels$elm_review_simplify$Simplify$removeParens(right)));
		if ((((((((_v1.a.b.$ === 3) && (_v1.a.b.b === 'Just')) && (_v1.b.$ === 1)) && _v1.b.a.b) && (_v1.b.a.a.b.$ === 3)) && (_v1.b.a.a.b.b === 'map')) && _v1.b.a.b.b) && (!_v1.b.a.b.b.b)) {
			var _v2 = _v1.a;
			var justRange = _v2.a;
			var _v3 = _v2.b;
			var _v4 = _v1.b.a;
			var _v5 = _v4.a;
			var maybeMapRange = _v5.a;
			var _v6 = _v5.b;
			var _v7 = _v4.b;
			var mapperFunction = _v7.a;
			return (_Utils_eq(
				A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, justRange),
				$elm$core$Maybe$Just(
					_List_fromArray(
						['Maybe']))) && _Utils_eq(
				A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, maybeMapRange),
				$elm$core$Maybe$Just(
					_List_fromArray(
				...
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Calling Maybe.map on a value that is Just'
					},
					maybeMapRange,
					_List_fromArray(
						[
							$jfmengels$elm_review$Review$Fix$removeRange(
							{
								a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(mapperFunction).be,
								be: parentRange.be
							}),
							A2(
							$jfmengels$elm_review$Review$Fix$insertAt,
							$stil4m$elm_syntax$Elm$Syntax$Node$range(mapperFunction).a_,
							' >> Just')
						]))
				]) : _List_Nil;
		} else {
		...
		var _v8 = _Utils_Tuple2(
			$stil4m$elm_syntax$Elm$Syntax$Node$value(
				$jfmengels$elm_review_simplify$Simplify$removeParens(left)),
			$jfmengels$elm_review_simplify$Simplify$removeParens(right));
		if ((((((((_v8.a.$ === 1) && _v8.a.a.b) && (_v8.a.a.a.b.$ === 3)) && (_v8.a.a.a.b.b === 'map')) && _v8.a.a.b.b) && (!_v8.a.a.b.b.b)) && (_v8.b.b.$ === 3)) && (_v8.b.b.b === 'Just')) {
			var _v9 = _v8.a.a;
			var _v10 = _v9.a;
			var maybeMapRange = _v10.a;
			var _v11 = _v10.b;
			var _v12 = _v9.b;
			var mapperFunction = _v12.a;
			var _v13 = _v8.b;
			var justRange = _v13.a;
			var _v14 = _v13.b;
			return (_Utils_eq(
				A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, justRange),
				$elm$core$Maybe$Just(
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								a_: parentRange.a_,
								be: $stil4m$elm_syntax$Elm$Syntax$Node$range(mapperFunction).a_
							})
						]))
				]) : _List_Nil;
		} else {
...
var $jfmengels$elm_review_simplify$Simplify$getNegateFunction = F2(
	function (lookupTable, baseNode) {
		var _v0 = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
...
var $jfmengels$elm_review_simplify$Simplify$getNegateComposition = F3(
	function (lookupTable, takeFirstFunction, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(node));
		_v0$2:
		while (true) {
...
var $jfmengels$elm_review_simplify$Simplify$negateNegateCompositionErrorMessage = {
	...
	aq: 'Unnecessary double negation'
};
var $jfmengels$elm_review_simplify$Simplify$negateCompositionCheck = function (_v0) {
	var lookupTable = _v0.o;
	var fromLeftToRight = _v0.ah;
	var parentRange = _v0.b;
	var left = _v0.i;
	...
	if (!_v1.$) {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, 'identity')
					]))
			]);
	} else {
		var _v2 = A2($jfmengels$elm_review_simplify$Simplify$getNegateFunction, lookupTable, left);
		if (!_v2.$) {
			var leftNotRange = _v2.a;
			var _v3 = A3($jfmengels$elm_review_simplify$Simplify$getNegateComposition, lookupTable, fromLeftToRight, right);
			if (!_v3.$) {
				...
				return _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						$jfmengels$elm_review_simplify$Simplify$negateNegateCompositionErrorMessage,
						{a_: rightNotRange.a_, be: leftNotRange.be},
						_List_fromArray(
							[
								$jfmengels$elm_review$Review$Fix$removeRange(
								{a_: rightRange.be, be: leftNotRange.be}),
			...
			var _v4 = A2($jfmengels$elm_review_simplify$Simplify$getNegateFunction, lookupTable, right);
			if (!_v4.$) {
				var rightNotRange = _v4.a;
				var _v5 = A3($jfmengels$elm_review_simplify$Simplify$getNegateComposition, lookupTable, !fromLeftToRight, left);
				if (!_v5.$) {
					var leftNotRange = _v5.a;
					return _List_fromArray(
						[
							A3(
							$jfmengels$elm_review$Review$Rule$errorWithFix,
							...
							_List_fromArray(
								[
									...
									$jfmengels$elm_review$Review$Fix$removeRange(
									{a_: rightNotRange.a_, be: leftRange.a_})
								]))
						]);
				} else {
					return _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$getNotFunction = F2(
	function (lookupTable, baseNode) {
		var _v0 = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
		if ((_v0.b.$ === 3) && (_v0.b.b === 'not')) {
			var notRange = _v0.a;
			var _v1 = _v0.b;
			var _v2 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, notRange);
			if ((((!_v2.$) && _v2.a.b) && (_v2.a.a === 'Basics')) && (!_v2.a.b.b)) {
				var _v3 = _v2.a;
...
var $jfmengels$elm_review_simplify$Simplify$getNotComposition = F3(
	function (lookupTable, takeFirstFunction, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(node));
		_v0$2:
				...
				switch (_v0.a) {
					case '<<':
						...
						return takeFirstFunction ? A2(
							...
							A2($jfmengels$elm_review_simplify$Simplify$getNotFunction, lookupTable, right)) : A2(
							$elm$core$Maybe$map,
							function (_v2) {
								return {
									a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(right).be,
							...
							A2($jfmengels$elm_review_simplify$Simplify$getNotFunction, lookupTable, left));
					case '>>':
						var left = _v0.c;
						var right = _v0.d;
						return takeFirstFunction ? A2(
							...
							A2($jfmengels$elm_review_simplify$Simplify$getNotFunction, lookupTable, left)) : A2(
							$elm$core$Maybe$map,
							function (_v4) {
								return {
									a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(right).a_,
							...
							A2($jfmengels$elm_review_simplify$Simplify$getNotFunction, lookupTable, right));
					default:
						break _v0$2;
				}
			} else {
...
var $jfmengels$elm_review_simplify$Simplify$notNotCompositionCheck = function (_v0) {
	var lookupTable = _v0.o;
	var fromLeftToRight = _v0.ah;
	var parentRange = _v0.b;
	var left = _v0.i;
	...
	if (!_v1.$) {
		...
		var _v2 = A2($jfmengels$elm_review_simplify$Simplify$getNotFunction, lookupTable, left);
		if (!_v2.$) {
			var leftNotRange = _v2.a;
			var _v3 = A3($jfmengels$elm_review_simplify$Simplify$getNotComposition, lookupTable, fromLeftToRight, right);
			if (!_v3.$) {
				var rightNotRange = _v3.a;
				return _List_fromArray(
					[
			...
			var _v4 = A2($jfmengels$elm_review_simplify$Simplify$getNotFunction, lookupTable, right);
			if (!_v4.$) {
				var rightNotRange = _v4.a;
				var _v5 = A3($jfmengels$elm_review_simplify$Simplify$getNotComposition, lookupTable, !fromLeftToRight, left);
				if (!_v5.$) {
					var leftNotRange = _v5.a;
					return _List_fromArray(
						[
...
var $jfmengels$elm_review_simplify$Simplify$resultMapCompositionChecks = function (_v0) {
	var lookupTable = _v0.o;
	var fromLeftToRight = _v0.ah;
	var parentRange = _v0.b;
	var left = _v0.i;
	...
	if (fromLeftToRight) {
		var _v1 = _Utils_Tuple2(
			...
			$stil4m$elm_syntax$Elm$Syntax$Node$value(
				$jfmengels$elm_review_simplify$Simplify$removeParens(right)));
		if ((((((((_v1.a.b.$ === 3) && (_v1.a.b.b === 'Ok')) && (_v1.b.$ === 1)) && _v1.b.a.b) && (_v1.b.a.a.b.$ === 3)) && (_v1.b.a.a.b.b === 'map')) && _v1.b.a.b.b) && (!_v1.b.a.b.b.b)) {
			var _v2 = _v1.a;
			var justRange = _v2.a;
			var _v3 = _v2.b;
			var _v4 = _v1.b.a;
			var _v5 = _v4.a;
			var resultMapRange = _v5.a;
			var _v6 = _v5.b;
			var _v7 = _v4.b;
			var mapperFunction = _v7.a;
			return (_Utils_eq(
				...
				$elm$core$Maybe$Just(
					_List_fromArray(
						['Result']))) && _Utils_eq(
				A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, resultMapRange),
				$elm$core$Maybe$Just(
					_List_fromArray(
				...
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Calling Result.map on a value that is Ok'
					},
					resultMapRange,
					_List_fromArray(
						[
		...
		var _v8 = _Utils_Tuple2(
			$stil4m$elm_syntax$Elm$Syntax$Node$value(
				$jfmengels$elm_review_simplify$Simplify$removeParens(left)),
			$jfmengels$elm_review_simplify$Simplify$removeParens(right));
		if ((((((((_v8.a.$ === 1) && _v8.a.a.b) && (_v8.a.a.a.b.$ === 3)) && (_v8.a.a.a.b.b === 'map')) && _v8.a.a.b.b) && (!_v8.a.a.b.b.b)) && (_v8.b.b.$ === 3)) && (_v8.b.b.b === 'Ok')) {
			var _v9 = _v8.a.a;
			var _v10 = _v9.a;
			var resultMapRange = _v10.a;
			var _v11 = _v10.b;
			var _v12 = _v9.b;
			var mapperFunction = _v12.a;
			var _v13 = _v8.b;
...
var $jfmengels$elm_review_simplify$Simplify$compositionChecks = _List_fromArray(
	[$jfmengels$elm_review_simplify$Simplify$identityCompositionCheck, $jfmengels$elm_review_simplify$Simplify$notNotCompositionCheck, $jfmengels$elm_review_simplify$Simplify$negateCompositionCheck, $jfmengels$elm_review_simplify$Simplify$alwaysCompositionCheck, $jfmengels$elm_review_simplify$Simplify$maybeMapCompositionChecks, $jfmengels$elm_review_simplify$Simplify$resultMapCompositionChecks]);
var $jfmengels$elm_review_simplify$Simplify$errorsAndRangesToIgnore = F2(
	function (errors, rangesToIgnore) {
		return {aw: errors, ac: rangesToIgnore, ad: _List_Nil};
	});
var $jfmengels$elm_review_simplify$Simplify$removeFunctionFromFunctionCall = function (_v0) {
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var usingRightPizza = _v0.I;
	return usingRightPizza ? $jfmengels$elm_review$Review$Fix$removeRange(
		{
			a_: fnRange.a_,
			be: $stil4m$elm_syntax$Elm$Syntax$Node$range(firstArg).a_
		}) : $jfmengels$elm_review$Review$Fix$removeRange(
		{
			a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(firstArg).be,
			be: fnRange.be
		});
};
var $jfmengels$elm_review_simplify$Simplify$basicsAlwaysChecks = function (checkInfo) {
	var fnRange = checkInfo.a;
	var firstArg = checkInfo.c;
	var secondArg = checkInfo.h;
	var usingRightPizza = checkInfo.I;
	if (!secondArg.$) {
		var _v1 = secondArg.a;
		...
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'Expression can be replaced by the first argument given to `always`'
				},
				fnRange,
				usingRightPizza ? _List_fromArray(
					[
						$jfmengels$elm_review$Review$Fix$removeRange(
						{
							a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(firstArg).be,
							be: secondArgRange.be
						})
					]) : _List_fromArray(
					[
...
var $stil4m$elm_syntax$Elm$Syntax$Range$compareLocations = F2(
	function (left, right) {
		return (_Utils_cmp(left.aD, right.aD) < 0) ? 0 : ((_Utils_cmp(left.aD, right.aD) > 0) ? 2 : A2($elm$core$Basics$compare, left.ar, right.ar));
	});
...
var $jfmengels$elm_review_simplify$Simplify$removeAlongWithOtherFunctionCheck = F3(
	function (errorMessage, secondFunctionCheck, checkInfo) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(checkInfo.c));
		_v0$3:
		while (true) {
			switch (_v0.$) {
				case 1:
					if (_v0.a.b && _v0.a.b.b) {
						...
						var _v3 = A2(secondFunctionCheck, checkInfo.o, secondFn);
						if (!_v3.$) {
				...
				case 2:
					switch (_v0.a) {
						case '|>':
							...
							var secondFn = _v0.d;
							var _v4 = A2(secondFunctionCheck, checkInfo.o, secondFn);
							if (!_v4.$) {
						...
						case '<|':
							...
							var _v5 = A2(secondFunctionCheck, checkInfo.o, secondFn);
							if (!_v5.$) {
...
var $jfmengels$elm_review_simplify$Simplify$boolToString = function (bool) {
	return bool ? 'True' : 'False';
};
var $jfmengels$elm_review_simplify$Simplify$getBoolean = F2(
	function (lookupTable, baseNode) {
		var node = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		_v0$2:
...
var $jfmengels$elm_review_simplify$Simplify$basicsNotChecks = function (checkInfo) {
	var _v0 = A2($jfmengels$elm_review_simplify$Simplify$getBoolean, checkInfo.o, checkInfo.c);
	if (!_v0.$) {
		var bool = _v0.a;
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'Expression is equal to ' + $jfmengels$elm_review_simplify$Simplify$boolToString(!bool)
				},
				checkInfo.b,
				_List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Fix$replaceRangeBy,
						checkInfo.b,
						$jfmengels$elm_review_simplify$Simplify$boolToString(!bool))
					]))
			]);
	} else {
		return A3($jfmengels$elm_review_simplify$Simplify$removeAlongWithOtherFunctionCheck, $jfmengels$elm_review_simplify$Simplify$notNotCompositionErrorMessage, $jfmengels$elm_review_simplify$Simplify$getNotFunction, checkInfo);
	}
};
var $jfmengels$elm_review_simplify$Simplify$isSpecificFunction = F4(
	function (moduleName, fnName, lookupTable, node) {
		var _v0 = $jfmengels$elm_review_simplify$Simplify$removeParens(node);
		if (_v0.b.$ === 3) {
			var noneRange = _v0.a;
			var _v1 = _v0.b;
...
var $jfmengels$elm_review_simplify$Simplify$cmdCollection = {
	...
	K: 'Cmd.none',
	Z: A2(
		$jfmengels$elm_review_simplify$Simplify$isSpecificFunction,
		_List_fromArray(
			['Platform', 'Cmd']),
		'none'),
	bS: 'Cmd',
...
var $jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix = F3(
	function (empty, parentRange, secondArg) {
		return _List_fromArray(
			[
				function () {
				if (!secondArg.$) {
					...
					return A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, '(always ' + (empty + ')'));
				}
			}()
			]);
	});
var $jfmengels$elm_review_simplify$Simplify$collectionDiffChecks = F2(
	function (collection, _v0) {
		...
		return A2(
			...
			_List_fromArray(
				[
					function (_v1) {
					var _v2 = A2(collection.x, lookupTable, firstArg);
					if (((!_v2.$) && (!_v2.a.$)) && (!_v2.a.a)) {
						return _List_fromArray(
							[
								...
								{
									bA: _List_fromArray(
										['You can replace this call by ' + (collection.d + '.')]),
									aq: 'Diffing ' + (collection.d + (' will result in ' + collection.d))
								},
								fnRange,
								A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, collection.d, parentRange, secondArg))
							]);
					} else {
						return _List_Nil;
					}
					...
					var _v4 = A2(
						$elm$core$Maybe$andThen,
						collection.x(lookupTable),
						secondArg);
					if (((!_v4.$) && (!_v4.a.$)) && (!_v4.a.a)) {
						return _List_fromArray(
							[
								A3(
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									bA: _List_fromArray(
										['You can replace this call by the ' + (collection.s + ' itself.')]),
									aq: 'Diffing a ' + (collection.s + (' with ' + (collection.d + (' will result in the ' + (collection.s + ' itself')))))
								},
								fnRange,
								_List_fromArray(
									[
...
var $jfmengels$elm_review_simplify$Simplify$isAlwaysBoolean = F2(
	function (lookupTable, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(node));
		_v0$2:
		while (true) {
			switch (_v0.$) {
				case 1:
					if ((((_v0.a.b && (_v0.a.a.b.$ === 3)) && (_v0.a.a.b.b === 'always')) && _v0.a.b.b) && (!_v0.a.b.b.b)) {
						...
						if ((((!_v5.$) && _v5.a.b) && (_v5.a.a === 'Basics')) && (!_v5.a.b.b)) {
							var _v6 = _v5.a;
							return A2($jfmengels$elm_review_simplify$Simplify$getBoolean, lookupTable, _boolean);
						} else {
							return $elm$core$Maybe$Nothing;
						}
					} else {
				...
				case 17:
					var expression = _v0.a.bG;
					return A2($jfmengels$elm_review_simplify$Simplify$getBoolean, lookupTable, expression);
				default:
					break _v0$2;
			}
		}
...
var $jfmengels$elm_review_simplify$Simplify$noopFix = function (_v0) {
	var fnRange = _v0.a;
	var parentRange = _v0.b;
	var secondArg = _v0.h;
	var usingRightPizza = _v0.I;
	return _List_fromArray(
		[
			function () {
			if (!secondArg.$) {
				var listArg = secondArg.a;
				return usingRightPizza ? $jfmengels$elm_review$Review$Fix$removeRange(
					{
						a_: parentRange.a_,
						be: $stil4m$elm_syntax$Elm$Syntax$Node$range(listArg).a_
					}) : $jfmengels$elm_review$Review$Fix$removeRange(
					{
						a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(listArg).be,
						be: fnRange.be
					});
			} else {
				return A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, 'identity');
			}
		}()
		]);
};
var $jfmengels$elm_review_simplify$Simplify$collectionFilterChecks = F2(
	function (collection, checkInfo) {
		var lookupTable = checkInfo.o;
		var parentRange = checkInfo.b;
		var fnRange = checkInfo.a;
		var firstArg = checkInfo.c;
		var secondArg = checkInfo.h;
		var _v0 = A2(
			$elm$core$Maybe$andThen,
			collection.x(checkInfo.o),
			checkInfo.h);
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						bA: _List_fromArray(
							['You can replace this call by ' + (collection.d + '.')]),
						aq: 'Using ' + (collection.bS + ('.filter on ' + (collection.d + (' will result in ' + collection.d))))
					},
					checkInfo.a,
					$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
				]);
		} else {
			var _v1 = A2($jfmengels$elm_review_simplify$Simplify$isAlwaysBoolean, lookupTable, firstArg);
			if (!_v1.$) {
				if (_v1.a) {
					return _List_fromArray(
						[
							...
							{
								bA: _List_fromArray(
									['You can remove this call and replace it by the ' + (collection.s + ' itself.')]),
								aq: 'Using ' + (collection.bS + ('.filter with a function that will always return True is the same as not using ' + (collection.bS + '.filter')))
							},
							fnRange,
							$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
						]);
					...
					return _List_fromArray(
						[
							...
							{
								bA: _List_fromArray(
									['You can remove this call and replace it by ' + (collection.d + '.')]),
								aq: 'Using ' + (collection.bS + ('.filter with a function that will always return False will result in ' + collection.d))
							},
							fnRange,
							A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, collection.d, parentRange, secondArg))
						]);
...
var $jfmengels$elm_review_simplify$Simplify$collectionFromListChecks = F2(
	function (collection, _v0) {
		var parentRange = _v0.b;
		var fnRange = _v0.a;
		var firstArg = _v0.c;
		var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
		if ((_v1.$ === 19) && (!_v1.a.b)) {
			return _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						bA: _List_fromArray(
							['You can replace this call by ' + (collection.d + '.')]),
						aq: 'The call to ' + (collection.bS + ('.fromList will result in ' + collection.d))
					},
					fnRange,
					_List_fromArray(
						[
							A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, collection.d)
						]))
				]);
		} else {
			return _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$collectionInsertChecks = F2(
	function (collection, _v0) {
		var lookupTable = _v0.o;
		var usingRightPizza = _v0.I;
		var parentRange = _v0.b;
		...
		if (((!_v1.$) && (!_v1.a.$)) && (!_v1.a.a)) {
			return _List_fromArray(
				[
					...
					{
						bA: _List_fromArray(
							['You can replace this call by ' + (collection.bS + '.singleton.')]),
						aq: 'Use ' + (collection.bS + ('.singleton instead of inserting in ' + collection.d))
					},
					fnRange,
					_List_fromArray(
						[
							A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, fnRange, collection.bS + '.singleton'),
							usingRightPizza ? $jfmengels$elm_review$Review$Fix$removeRange(
							{a_: fnRange.be, be: parentRange.be}) : $jfmengels$elm_review$Review$Fix$removeRange(
							{
								a_: parentRange.a_,
								be: $stil4m$elm_syntax$Elm$Syntax$Node$range(firstArg).a_
							})
...
var $jfmengels$elm_review_simplify$Simplify$collectionIntersectChecks = F2(
	function (collection, _v0) {
		var lookupTable = _v0.o;
		var parentRange = _v0.b;
		var fnRange = _v0.a;
						...
						return _List_fromArray(
							[
								...
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									bA: _List_fromArray(
										['You can replace this call by ' + (collection.d + '.')]),
									aq: 'Using ' + (collection.bS + ('.intersect on ' + (collection.d + (' will result in ' + collection.d))))
								},
								fnRange,
								A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, collection.d, parentRange, secondArg))
							]);
...
var $jfmengels$elm_review_simplify$Simplify$collectionIsEmptyChecks = F2(
	function (collection, _v0) {
		var lookupTable = _v0.o;
		var parentRange = _v0.b;
		var fnRange = _v0.a;
		var firstArg = _v0.c;
		var _v1 = A2(collection.x, lookupTable, firstArg);
		if (!_v1.$) {
			if ((!_v1.a.$) && (!_v1.a.a)) {
				return _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							...
							aq: 'The call to ' + (collection.bS + '.isEmpty will result in True')
						},
						fnRange,
						_List_fromArray(
							[
								A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, 'True')
							]))
					]);
			} else {
				return _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							...
							aq: 'The call to ' + (collection.bS + '.isEmpty will result in False')
						},
						fnRange,
						_List_fromArray(
							[
								A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, 'False')
							]))
					]);
			}
		} else {
...
var $jfmengels$elm_review_simplify$Simplify$collectionMapChecks = F2(
	function (collection, checkInfo) {
		var _v0 = A2(
			$elm$core$Maybe$map,
			collection.Z(checkInfo.o),
			checkInfo.h);
		if ((!_v0.$) && _v0.a) {
			return _List_fromArray(
				[
					...
					{
						bA: _List_fromArray(
							['You can replace this call by ' + (collection.K + '.')]),
						aq: 'Using ' + (collection.bS + ('.map on ' + (collection.K + (' will result in ' + collection.K))))
					},
					checkInfo.a,
					$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
				]);
		} else {
			return A2($jfmengels$elm_review_simplify$Simplify$isIdentity, checkInfo.o, checkInfo.c) ? _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						bA: _List_fromArray(
							['You can remove this call and replace it by the ' + (collection.s + ' itself.')]),
						aq: 'Using ' + (collection.bS + ('.map with an identity function is the same as not using ' + (collection.bS + '.map')))
					},
					checkInfo.a,
					$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
				]) : _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$replaceByBoolFix = F3(
	function (parentRange, secondArg, replacementValue) {
		return _List_fromArray(
			[
				function () {
				if (!secondArg.$) {
					return A2(
						$jfmengels$elm_review$Review$Fix$replaceRangeBy,
						parentRange,
						$jfmengels$elm_review_simplify$Simplify$boolToString(replacementValue));
				} else {
					return A2(
						$jfmengels$elm_review$Review$Fix$replaceRangeBy,
						parentRange,
						'(always ' + ($jfmengels$elm_review_simplify$Simplify$boolToString(replacementValue) + ')'));
				}
			}()
			]);
	});
var $jfmengels$elm_review_simplify$Simplify$collectionMemberChecks = F2(
	function (collection, _v0) {
		var lookupTable = _v0.o;
		var parentRange = _v0.b;
		var fnRange = _v0.a;
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						bA: _List_fromArray(
							['You can replace this call by False.']),
						aq: 'Using ' + (collection.bS + ('.member on ' + (collection.d + ' will result in False')))
					},
					fnRange,
					A3($jfmengels$elm_review_simplify$Simplify$replaceByBoolFix, parentRange, secondArg, false))
				]);
		} else {
			return _List_Nil;
		}
	});
var $jfmengels$elm_review_simplify$Simplify$collectionPartitionChecks = F2(
	function (collection, checkInfo) {
		var _v0 = A2(
			$elm$core$Maybe$andThen,
			collection.x(checkInfo.o),
		...
		if (((!_v0.$) && (!_v0.a.$)) && (!_v0.a.a)) {
			return _List_fromArray(
				[
					...
					{
						bA: _List_fromArray(
							['You can replace this call by ( ' + (collection.d + (', ' + (collection.d + ' ).')))]),
						aq: 'Using ' + (collection.bS + ('.partition on ' + (collection.d + (' will result in ( ' + (collection.d + (', ' + (collection.d + ' )')))))))
					},
					checkInfo.a,
					_List_fromArray(
						[
							A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, checkInfo.b, '( ' + (collection.d + (', ' + (collection.d + ' )'))))
						]))
				]);
		} else {
			var _v1 = A2($jfmengels$elm_review_simplify$Simplify$isAlwaysBoolean, checkInfo.o, checkInfo.c);
			if (!_v1.$) {
				if (_v1.a) {
					var _v2 = checkInfo.h;
					if (!_v2.$) {
						...
						return _List_fromArray(
							[
								...
								{
									bA: _List_fromArray(
										['Since the predicate function always returns True, the second ' + (collection.s + (' will always be ' + (collection.d + '.')))]),
									aq: 'All elements will go to the first ' + collection.s
								},
								checkInfo.a,
								_List_fromArray(
									[
										...
										A2(
										$jfmengels$elm_review$Review$Fix$insertAt,
										$stil4m$elm_syntax$Elm$Syntax$Node$range(listArg).a_,
										', ' + (collection.d + ' )'))
									]))
							]);
					} else {
					...
					return _List_fromArray(
						[
							...
							{
								bA: _List_fromArray(
									['Since the predicate function always returns False, the first ' + (collection.s + (' will always be ' + (collection.d + '.')))]),
								aq: 'All elements will go to the second ' + collection.s
							},
							checkInfo.a,
							function () {
								var _v3 = checkInfo.h;
								if (!_v3.$) {
									...
									return _List_fromArray(
										[
											A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, checkInfo.b, '(Tuple.pair ' + (collection.d + ')'))
										]);
								}
							}())
						]);
...
var $jfmengels$elm_review_simplify$Simplify$collectionRemoveChecks = F2(
	function (collection, checkInfo) {
		var lookupTable = checkInfo.o;
		var fnRange = checkInfo.a;
		var secondArg = checkInfo.h;
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						bA: _List_fromArray(
							['You can replace this call by ' + (collection.d + '.')]),
						aq: 'Using ' + (collection.bS + ('.remove on ' + (collection.d + (' will result in ' + collection.d))))
					},
					fnRange,
					$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
				]);
...
var $jfmengels$elm_review_simplify$Simplify$collectionSizeChecks = F2(
	function (collection, _v0) {
		var lookupTable = _v0.o;
		var parentRange = _v0.b;
		var fnRange = _v0.a;
		...
		if ((!_v1.$) && (!_v1.a.$)) {
			...
			return _List_fromArray(
				[
					...
					{
						bA: _List_fromArray(
							['The ' + (collection.a7 + (' of the ' + (collection.s + ' can be determined by looking at the code.')))]),
						aq: 'The ' + (collection.a7 + (' of the ' + (collection.s + (' is ' + $elm$core$String$fromInt(size)))))
					},
					fnRange,
					_List_fromArray(
						[
...
var $jfmengels$elm_review_simplify$Simplify$collectionToListChecks = F2(
	function (collection, _v0) {
		var lookupTable = _v0.o;
		var parentRange = _v0.b;
		var fnRange = _v0.a;
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'The call to ' + (collection.bS + '.toList will result in []')
					},
					fnRange,
					_List_fromArray(
						[
							A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, '[]')
						]))
				]);
		} else {
			return _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$collectionUnionChecks = F2(
	function (collection, checkInfo) {
		var lookupTable = checkInfo.o;
		var parentRange = checkInfo.b;
		var fnRange = checkInfo.a;
						...
						return _List_fromArray(
							[
								...
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									...
									aq: 'Unnecessary union with Set.empty'
								},
								fnRange,
								$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
							]);
...
var $jfmengels$elm_review_simplify$Simplify$determineIfCollectionIsEmpty = F4(
	function (moduleName, singletonNumberOfArgs, lookupTable, node) {
		if (A4($jfmengels$elm_review_simplify$Simplify$isSpecificFunction, moduleName, 'empty', lookupTable, node)) {
			return $elm$core$Maybe$Just(
							...
							if ((_v0.a.b.b && (_v0.a.b.a.b.$ === 19)) && (!_v0.a.b.b.b)) {
								...
								return _Utils_eq(
									...
									$jfmengels$elm_review_simplify$Simplify$Exactly(
										$elm$core$List$length(list))) : $elm$core$Maybe$Nothing;
							} else {
								break _v0$2;
							}
						default:
...
var $jfmengels$elm_review_simplify$Simplify$listAllChecks = function (_v0) {
	var lookupTable = _v0.o;
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	...
	var _v1 = A2(
		$elm$core$Maybe$map,
		A2($elm$core$Basics$composeR, $jfmengels$elm_review_simplify$Simplify$removeParens, $stil4m$elm_syntax$Elm$Syntax$Node$value),
		secondArg);
	if (((!_v1.$) && (_v1.a.$ === 19)) && (!_v1.a.a.b)) {
		return _List_fromArray(
			[
				A3(
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					bA: _List_fromArray(
						['You can replace this call by True.']),
					aq: 'The call to List.all will result in True'
				},
				fnRange,
				_List_fromArray(
					[
		...
		var _v2 = A2($jfmengels$elm_review_simplify$Simplify$isAlwaysBoolean, lookupTable, firstArg);
		if ((!_v2.$) && _v2.a) {
			return _List_fromArray(
				[
					A3(
					...
					fnRange,
					A3($jfmengels$elm_review_simplify$Simplify$replaceByBoolFix, parentRange, secondArg, true))
				]);
		} else {
			return _List_Nil;
		}
...
var $jfmengels$elm_review_simplify$Simplify$listAnyChecks = function (_v0) {
	var lookupTable = _v0.o;
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
		...
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					bA: _List_fromArray(
						['You can replace this call by False.']),
					aq: 'The call to List.any will result in False'
				},
				fnRange,
				_List_fromArray(
					[
...
var $jfmengels$elm_review_simplify$Simplify$determineListLength = F2(
	function (lookupTable, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(node));
		_v0$3:
...
var $jfmengels$elm_review_simplify$Simplify$isEmptyList = function (node) {
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
		$jfmengels$elm_review_simplify$Simplify$removeParens(node));
	if ((_v0.$ === 19) && (!_v0.a.b)) {
		return true;
...
var $jfmengels$elm_review_simplify$Simplify$listCollection = {
	x: $jfmengels$elm_review_simplify$Simplify$determineListLength,
	d: '[]',
	K: '[]',
	Z: function (_v0) {
		return $jfmengels$elm_review_simplify$Simplify$isEmptyList;
	},
	bS: 'List',
	a7: 'length',
	s: 'list'
};
var $jfmengels$elm_review_simplify$Simplify$findConsecutiveListLiterals = F2(
	function (firstListElement, restOfListElements) {
				...
				if ((_v0.a.b.$ === 19) && (_v0.b.a.b.$ === 19)) {
					...
					return A2(
						...
						A2(
							$jfmengels$elm_review$Review$Fix$replaceRangeBy,
							{
								a_: {ar: secondRange.be.ar + 1, aD: secondRange.be.aD},
								be: {ar: firstRange.a_.ar - 1, aD: firstRange.a_.aD}
							},
							', '),
...
var $jfmengels$elm_review_simplify$Simplify$isListLiteral = function (node) {
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
	if (_v0.$ === 19) {
		return true;
	} else {
...
var $jfmengels$elm_review_simplify$Simplify$removeBoundariesFix = function (node) {
	...
	return _List_fromArray(
		[
			$jfmengels$elm_review$Review$Fix$removeRange(
			{
				a_: {ar: start.ar + 1, aD: start.aD},
				be: {ar: start.ar, aD: start.aD}
			}),
			$jfmengels$elm_review$Review$Fix$removeRange(
			{
				a_: {ar: end.ar, aD: end.aD},
				be: {ar: end.ar - 1, aD: end.aD}
			})
		]);
};
var $jfmengels$elm_review_simplify$Simplify$listConcatChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
	if (_v1.$ === 19) {
		...
		if (list.b) {
			if (!list.b.b) {
				...
				return _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							...
							aq: 'Unnecessary use of List.concat on a list with 1 element'
						},
						parentRange,
						_List_fromArray(
							[
								$jfmengels$elm_review$Review$Fix$removeRange(
								{a_: elementRange.be, be: parentRange.be}),
								$jfmengels$elm_review$Review$Fix$removeRange(
								{a_: parentRange.a_, be: elementRange.a_})
							]))
					]);
			} else {
				var args = list;
				...
				if (A2($elm$core$List$all, $jfmengels$elm_review_simplify$Simplify$isListLiteral, list)) {
					return _List_fromArray(
						[
							A3(
							$jfmengels$elm_review$Review$Rule$errorWithFix,
							{
								...
								aq: 'Expression could be simplified to be a single List'
							},
							parentRange,
							A2(
								$elm$core$List$cons,
						...
						return _List_fromArray(
							[
								...
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									...
									aq: 'Consecutive literal lists should be merged'
								},
								fnRange,
								fixes)
							]);
...
var $jfmengels$elm_review_simplify$Simplify$isAlwaysEmptyList = F2(
	function (lookupTable, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(node));
		_v0$2:
			...
			switch (_v0.$) {
				case 1:
					if ((((_v0.a.b && (_v0.a.a.b.$ === 3)) && (_v0.a.a.b.b === 'always')) && _v0.a.b.b) && (!_v0.a.b.b.b)) {
						...
						if ((((!_v5.$) && _v5.a.b) && (_v5.a.a === 'Basics')) && (!_v5.a.b.b)) {
							var _v6 = _v5.a;
							return $jfmengels$elm_review_simplify$Simplify$isEmptyList(alwaysValue);
						} else {
							return false;
						}
					} else {
				...
				case 17:
					var expression = _v0.a.bG;
					return $jfmengels$elm_review_simplify$Simplify$isEmptyList(expression);
				default:
					break _v0$2;
			}
		}
...
var $jfmengels$elm_review_simplify$Simplify$listConcatMapChecks = function (_v0) {
	var lookupTable = _v0.o;
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var secondArg = _v0.h;
	var usingRightPizza = _v0.I;
	if (A2($jfmengels$elm_review_simplify$Simplify$isIdentity, lookupTable, firstArg)) {
		return _List_fromArray(
			[
				A3(
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'Using List.concatMap with an identity function is the same as using List.concat'
				},
				fnRange,
				_List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Fix$replaceRangeBy,
						{
							a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(firstArg).a_,
							be: fnRange.be
						},
						'List.concat')
					]))
		...
		if (A2($jfmengels$elm_review_simplify$Simplify$isAlwaysEmptyList, lookupTable, firstArg)) {
			return _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'List.concatMap will result in on an empty list'
					},
					fnRange,
					A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, '[]', parentRange, secondArg))
				]);
		} else {
			if ((((!secondArg.$) && (secondArg.a.b.$ === 19)) && secondArg.a.b.a.b) && (!secondArg.a.b.a.b.b)) {
				var _v2 = secondArg.a;
				var listRange = _v2.a;
				var _v3 = _v2.b.a;
				var _v4 = _v3.a;
				var singleElementRange = _v4.a;
				return _List_fromArray(
					[
						A3(
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							...
							aq: 'Using List.concatMap on an element with a single item is the same as calling the function directly on that lone element.'
						},
						fnRange,
						usingRightPizza ? _List_fromArray(
							[
								A2(
								$jfmengels$elm_review$Review$Fix$replaceRangeBy,
								{a_: singleElementRange.be, be: listRange.be},
								'('),
								A2(
								$jfmengels$elm_review$Review$Fix$replaceRangeBy,
								{a_: listRange.a_, be: singleElementRange.a_},
								')'),
								$jfmengels$elm_review$Review$Fix$removeRange(fnRange)
							]) : _List_fromArray(
							[
...
var $jfmengels$elm_review_simplify$Simplify$getMaybeValue = F2(
	function (lookupTable, baseNode) {
		var node = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		_v0$4:
					...
					if ((((_v0.a.b && (_v0.a.a.b.$ === 3)) && (_v0.a.a.b.b === 'Just')) && _v0.a.b.b) && (!_v0.a.b.b.b)) {
						...
						if ((((!_v5.$) && _v5.a.b) && (_v5.a.a === 'Maybe')) && (!_v5.a.b.b)) {
							...
							return $elm$core$Maybe$Just(
								$elm$core$Maybe$Just(
									{
										a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(arg).be,
										be: justRange.be
									}));
						} else {
							return $elm$core$Maybe$Nothing;
								...
								if ((((!_v9.$) && _v9.a.b) && (_v9.a.a === 'Maybe')) && (!_v9.a.b.b)) {
									...
									return $elm$core$Maybe$Just(
										$elm$core$Maybe$Just(
											{
												a_: justRange.a_,
												be: $stil4m$elm_syntax$Elm$Syntax$Node$range(arg).a_
											}));
								} else {
									return $elm$core$Maybe$Nothing;
								}
...
var $jfmengels$elm_review_simplify$Simplify$isAlwaysMaybe = F2(
	function (lookupTable, baseNode) {
		var node = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		_v0$3:
		while (true) {
			switch (_v0.$) {
				...
				case 1:
					if ((((_v0.a.b && (_v0.a.a.b.$ === 3)) && (_v0.a.a.b.b === 'always')) && _v0.a.b.b) && (!_v0.a.b.b.b)) {
						...
						if ((((!_v7.$) && _v7.a.b) && (_v7.a.a === 'Basics')) && (!_v7.a.b.b)) {
							var _v8 = _v7.a;
							return A2($jfmengels$elm_review_simplify$Simplify$getMaybeValue, lookupTable, value);
						} else {
							return $elm$core$Maybe$Nothing;
						}
					} else {
				...
				case 17:
					var args = _v0.a.dz;
					var expression = _v0.a.bG;
					var _v9 = $stil4m$elm_syntax$Elm$Syntax$Node$value(expression);
					_v9$2:
					while (true) {
						switch (_v9.$) {
							case 1:
								if ((((((_v9.a.b && (_v9.a.a.b.$ === 3)) && (_v9.a.a.b.b === 'Just')) && _v9.a.b.b) && (_v9.a.b.a.b.$ === 3)) && (!_v9.a.b.a.b.a.b)) && (!_v9.a.b.b.b)) {
									var _v10 = _v9.a;
									var _v11 = _v10.a;
									var justRange = _v11.a;
									var _v12 = _v11.b;
									...
									var argRange = _v14.a;
									var _v15 = _v14.b;
									var justArgName = _v15.b;
									var _v16 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, justRange);
									if ((((!_v16.$) && _v16.a.b) && (_v16.a.a === 'Maybe')) && (!_v16.a.b.b)) {
										var _v17 = _v16.a;
										if ((args.b && (args.a.b.$ === 11)) && (!args.b.b)) {
											var _v19 = args.a;
											var lambdaArgName = _v19.b.a;
											return _Utils_eq(lambdaArgName, justArgName) ? $elm$core$Maybe$Just(
												$elm$core$Maybe$Just(
													{a_: argRange.be, be: justRange.be})) : $elm$core$Maybe$Nothing;
										} else {
											return $elm$core$Maybe$Nothing;
										}
									} else {
							...
							case 3:
								if (_v9.b === 'Nothing') {
									var _v20 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameFor, lookupTable, expression);
									if ((((!_v20.$) && _v20.a.b) && (_v20.a.a === 'Maybe')) && (!_v20.a.b.b)) {
										var _v21 = _v20.a;
										return $elm$core$Maybe$Just($elm$core$Maybe$Nothing);
									} else {
										return $elm$core$Maybe$Nothing;
...
var $jfmengels$elm_review_simplify$Simplify$listFilterMapChecks = function (checkInfo) {
	...
	var firstArg = checkInfo.c;
	var secondArg = checkInfo.h;
	var _v0 = A2($jfmengels$elm_review_simplify$Simplify$isAlwaysMaybe, lookupTable, firstArg);
	if (!_v0.$) {
		if (!_v0.a.$) {
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Using List.filterMap with a function that will always return Just is the same as not using List.filter'
					},
					fnRange,
					$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
				]);
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Using List.filterMap with a function that will always return Nothing will result in an empty list'
					},
					fnRange,
					A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, '[]', parentRange, secondArg))
				]);
...
var $jfmengels$elm_review_simplify$Simplify$getIntValue = function (node) {
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
		$jfmengels$elm_review_simplify$Simplify$removeParens(node));
	switch (_v0.$) {
		case 7:
		...
		case 10:
			...
			return A2(
				$elm$core$Maybe$map,
				$elm$core$Basics$negate,
				$jfmengels$elm_review_simplify$Simplify$getIntValue(expr));
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $jfmengels$elm_review_simplify$Simplify$listRangeChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var secondArg = _v0.h;
	var _v1 = A3(
		$elm$core$Maybe$map2,
		$elm$core$Tuple$pair,
		$jfmengels$elm_review_simplify$Simplify$getIntValue(firstArg),
		A2($elm$core$Maybe$andThen, $jfmengels$elm_review_simplify$Simplify$getIntValue, secondArg));
	if (!_v1.$) {
		var _v2 = _v1.a;
		var first = _v2.a;
		var second = _v2.b;
		return (_Utils_cmp(first, second) > 0) ? _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'The call to List.range will result in []'
				},
				fnRange,
				A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, '[]', parentRange, secondArg))
			]) : _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$listRepeatChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var secondArg = _v0.h;
	var _v1 = $jfmengels$elm_review_simplify$Simplify$getIntValue(firstArg);
	if (!_v1.$) {
		var intValue = _v1.a;
		return (intValue < 1) ? _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'List.repeat will result in an empty list'
				},
				fnRange,
				A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, '[]', parentRange, secondArg))
			]) : _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$getSpecificFunction = F3(
	function (_v0, lookupTable, baseNode) {
		var moduleName = _v0.a;
		var name = _v0.b;
		var _v1 = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
		if (_v1.b.$ === 3) {
			var notRange = _v1.a;
			var _v2 = _v1.b;
			var foundName = _v2.b;
			return (_Utils_eq(foundName, name) && _Utils_eq(
				A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, notRange),
				$elm$core$Maybe$Just(moduleName))) ? $elm$core$Maybe$Just(notRange) : $elm$core$Maybe$Nothing;
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
var $jfmengels$elm_review_simplify$Simplify$reverseReverseCompositionErrorMessage = {
	...
	aq: 'Unnecessary double reversal'
};
var $jfmengels$elm_review_simplify$Simplify$listReverseChecks = function (checkInfo) {
	...
	var firstArg = checkInfo.c;
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
		$jfmengels$elm_review_simplify$Simplify$removeParens(firstArg));
	if ((_v0.$ === 19) && (!_v0.a.b)) {
		return _List_fromArray(
			[
				A3(
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					bA: _List_fromArray(
						['You can replace this call by [].']),
					aq: 'Using List.reverse on [] will result in []'
				},
				fnRange,
				_List_fromArray(
					[
		...
		return A3(
			...
			$jfmengels$elm_review_simplify$Simplify$getSpecificFunction(
				_Utils_Tuple2(
					_List_fromArray(
						['List']),
					'reverse')),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				var _v1 = A2(
					$elm$core$Maybe$andThen,
					$jfmengels$elm_review_simplify$Simplify$getMaybeValue(checkInfo.o),
					checkInfo.h);
				if (!_v1.$) {
					if (!_v1.a.$) {
						var justRange = _v1.a.a;
						return _List_fromArray(
							[
								A3(
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									...
									aq: 'Calling ' + ($jfmengels$elm_review_simplify$Simplify$maybeCollection.bS + '.andThen on a value that is known to be Just')
								},
								checkInfo.a,
								_List_fromArray(
									[
										$jfmengels$elm_review$Review$Fix$removeRange(
										{
											a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(checkInfo.c).be,
											be: checkInfo.a.be
										}),
										$jfmengels$elm_review$Review$Fix$removeRange(justRange)
									]))
							]);
					} else {
						var _v2 = _v1.a;
						return _List_fromArray(
							[
								...
								{
									bA: _List_fromArray(
										['You can replace this call by ' + ($jfmengels$elm_review_simplify$Simplify$maybeCollection.d + '.')]),
									aq: 'Using ' + ($jfmengels$elm_review_simplify$Simplify$maybeCollection.bS + ('.andThen on ' + ($jfmengels$elm_review_simplify$Simplify$maybeCollection.d + (' will result in ' + $jfmengels$elm_review_simplify$Simplify$maybeCollection.d))))
								},
								checkInfo.a,
								$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
							]);
				...
				function (_v3) {
				var _v4 = A2($jfmengels$elm_review_simplify$Simplify$isAlwaysMaybe, checkInfo.o, checkInfo.c);
				if (!_v4.$) {
					if (!_v4.a.$) {
						var justRange = _v4.a.a;
						return _List_fromArray(
							[
								A3(
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									bA: _List_fromArray(
										['Using ' + ($jfmengels$elm_review_simplify$Simplify$maybeCollection.bS + '.andThen with a function that always returns Just is the same thing as using Maybe.map.')]),
									aq: 'Use ' + ($jfmengels$elm_review_simplify$Simplify$maybeCollection.bS + '.map instead')
								},
								checkInfo.a,
								_List_fromArray(
									[
										A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, checkInfo.a, $jfmengels$elm_review_simplify$Simplify$maybeCollection.bS + '.map'),
										$jfmengels$elm_review$Review$Fix$removeRange(justRange)
									]))
							]);
					} else {
						...
						return _List_fromArray(
							[
								...
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									...
									aq: 'Using ' + ($jfmengels$elm_review_simplify$Simplify$maybeCollection.bS + '.andThen with a function that will always return Nothing will result in Nothing')
								},
								checkInfo.a,
								A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, $jfmengels$elm_review_simplify$Simplify$maybeCollection.d, checkInfo.b, checkInfo.h))
							]);
					}
				} else {
					return _List_Nil;
						...
						[
							...
							checkInfo.I ? _List_fromArray(
								[
									...
									A2(
									$jfmengels$elm_review$Review$Fix$insertAt,
									$stil4m$elm_syntax$Elm$Syntax$Node$range(checkInfo.c).a_,
									' |> Just')
								]) : _List_fromArray(
								[
									A2(
									...
									'Just ('),
									$jfmengels$elm_review$Review$Fix$removeRange(justRange),
									A2($jfmengels$elm_review$Review$Fix$insertAt, checkInfo.b.a_, ')')
								]))
						]);
				} else {
					return _List_Nil;
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Using Maybe.withDefault on a value that is Just will result in that value'
					},
					checkInfo.a,
					A2(
						$elm$core$List$cons,
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Using Maybe.withDefault on Nothing will result in the default value'
					},
					checkInfo.a,
					_List_fromArray(
						[
							...
							{
								a_: checkInfo.b.a_,
								be: $stil4m$elm_syntax$Elm$Syntax$Node$range(checkInfo.c).a_
							})
						]))
				]);
		}
				...
				return _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							bA: _List_fromArray(
								['You can replace this call by an empty list.']),
							aq: 'Using ' + (A2($elm$core$String$join, '.', moduleName) + ('.' + (name + ' on an empty list will result in a empty list')))
						},
						checkInfo.a,
						_List_fromArray(
							[
...
var $jfmengels$elm_review_simplify$Simplify$getResultValue = F2(
	function (lookupTable, baseNode) {
		var node = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		_v0$6:
					...
					if (((_v0.a.b && (_v0.a.a.b.$ === 3)) && _v0.a.b.b) && (!_v0.a.b.b.b)) {
						switch (_v0.a.a.b.b) {
							...
							case 'Err':
								var _v15 = _v0.a;
								var _v16 = _v15.a;
								var justRange = _v16.a;
								var _v17 = _v16.b;
								var _v18 = _v15.b;
								var arg = _v18.a;
								var _v19 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, justRange);
							...
							if (_v0.d.b.$ === 3) {
								switch (_v0.d.b.b) {
									...
									case 'Err':
										var arg = _v0.c;
										var _v21 = _v0.d;
										var justRange = _v21.a;
										var _v22 = _v21.b;
										var _v23 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, justRange);
						...
						case '<|':
							if (_v0.c.b.$ === 3) {
								switch (_v0.c.b.b) {
									...
									case 'Err':
										var _v25 = _v0.c;
										var justRange = _v25.a;
										var _v26 = _v25.b;
										var arg = _v0.d;
										var _v27 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, justRange);
...
var $jfmengels$elm_review_simplify$Simplify$isAlwaysResult = F2(
	function (lookupTable, baseNode) {
		var node = $jfmengels$elm_review_simplify$Simplify$removeParens(baseNode);
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
		_v0$4:
		while (true) {
			switch (_v0.$) {
				...
				case 1:
					if ((((_v0.a.b && (_v0.a.a.b.$ === 3)) && (_v0.a.a.b.b === 'always')) && _v0.a.b.b) && (!_v0.a.b.b.b)) {
						...
						if ((((!_v9.$) && _v9.a.b) && (_v9.a.a === 'Basics')) && (!_v9.a.b.b)) {
							var _v10 = _v9.a;
							return A2($jfmengels$elm_review_simplify$Simplify$getResultValue, lookupTable, value);
						} else {
							return $elm$core$Maybe$Nothing;
						}
					} else {
				...
				case 17:
					var args = _v0.a.dz;
					var expression = _v0.a.bG;
					var _v11 = $stil4m$elm_syntax$Elm$Syntax$Node$value(expression);
					_v11$2:
					while (true) {
						if (((((((_v11.$ === 1) && _v11.a.b) && (_v11.a.a.b.$ === 3)) && _v11.a.b.b) && (_v11.a.b.a.b.$ === 3)) && (!_v11.a.b.a.b.a.b)) && (!_v11.a.b.b.b)) {
							switch (_v11.a.a.b.b) {
								case 'Ok':
									var _v12 = _v11.a;
									var _v13 = _v12.a;
									...
									var argRange = _v16.a;
									var _v17 = _v16.b;
									var justArgName = _v17.b;
									var _v18 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, okRange);
									if ((((!_v18.$) && _v18.a.b) && (_v18.a.a === 'Result')) && (!_v18.a.b.b)) {
										var _v19 = _v18.a;
										if ((args.b && (args.a.b.$ === 11)) && (!args.b.b)) {
											var _v21 = args.a;
											var lambdaArgName = _v21.b.a;
											return _Utils_eq(lambdaArgName, justArgName) ? $elm$core$Maybe$Just(
												$elm$core$Result$Ok(
													{a_: argRange.be, be: okRange.be})) : $elm$core$Maybe$Nothing;
										} else {
											return $elm$core$Maybe$Nothing;
										}
									} else {
								...
								case 'Err':
									...
									var argRange = _v26.a;
									var _v27 = _v26.b;
									var justArgName = _v27.b;
									var _v28 = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, errRange);
									if ((((!_v28.$) && _v28.a.b) && (_v28.a.a === 'Result')) && (!_v28.a.b.b)) {
										var _v29 = _v28.a;
										if ((args.b && (args.a.b.$ === 11)) && (!args.b.b)) {
											var _v31 = args.a;
											var lambdaArgName = _v31.b.a;
											return _Utils_eq(lambdaArgName, justArgName) ? $elm$core$Maybe$Just(
												$elm$core$Result$Ok(
													{a_: argRange.be, be: errRange.be})) : $elm$core$Maybe$Nothing;
										} else {
											return $elm$core$Maybe$Nothing;
										}
									} else {
...
var $jfmengels$elm_review_simplify$Simplify$isSpecificCall = F4(
	function (moduleName, fnName, lookupTable, node) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(node));
...
var $jfmengels$elm_review_simplify$Simplify$resultCollection = {
	...
	K: 'an error',
	Z: A2(
		$jfmengels$elm_review_simplify$Simplify$isSpecificCall,
		_List_fromArray(
			['Result']),
		'Err'),
	cj: 'Ok',
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				var _v1 = A2(
					$elm$core$Maybe$andThen,
					$jfmengels$elm_review_simplify$Simplify$getResultValue(checkInfo.o),
					checkInfo.h);
				if (!_v1.$) {
					if (!_v1.a.$) {
						var okRange = _v1.a.a;
						return _List_fromArray(
							[
								...
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									...
									aq: 'Calling ' + ($jfmengels$elm_review_simplify$Simplify$resultCollection.bS + '.andThen on a value that is known to be Ok')
								},
								checkInfo.a,
								_List_fromArray(
									[
										...
										$jfmengels$elm_review$Review$Fix$removeRange(okRange)
									]))
							]);
					} else {
						return _List_fromArray(
							[
								...
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									...
									aq: 'Using ' + ($jfmengels$elm_review_simplify$Simplify$resultCollection.bS + '.andThen on an error will result in the error')
								},
								checkInfo.a,
								$jfmengels$elm_review_simplify$Simplify$noopFix(checkInfo))
							]);
				...
				function (_v2) {
				var _v3 = A2($jfmengels$elm_review_simplify$Simplify$isAlwaysResult, checkInfo.o, checkInfo.c);
				if ((!_v3.$) && (!_v3.a.$)) {
					var okRange = _v3.a.a;
					return _List_fromArray(
						[
							...
							{
								bA: _List_fromArray(
									['Using ' + ($jfmengels$elm_review_simplify$Simplify$resultCollection.bS + '.andThen with a function that always returns Ok is the same thing as using Result.map.')]),
								aq: 'Use ' + ($jfmengels$elm_review_simplify$Simplify$resultCollection.bS + '.map instead')
							},
							checkInfo.a,
							_List_fromArray(
								[
									A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, checkInfo.a, $jfmengels$elm_review_simplify$Simplify$resultCollection.bS + '.map'),
									$jfmengels$elm_review$Review$Fix$removeRange(okRange)
								]))
						]);
				} else {
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Using Result.withDefault on a value that is Ok will result in that value'
					},
					checkInfo.a,
					A2(
						$elm$core$List$cons,
			...
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						bA: _List_fromArray(
							['You can replace this call by the default value.']),
						aq: 'Using Result.withDefault on an error will result in the default value'
					},
					checkInfo.a,
					_List_fromArray(
						[
...
var $jfmengels$elm_review_simplify$Simplify$stringConcatChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
		...
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'Using String.concat on an empty list will result in a empty string'
				},
				fnRange,
				_List_fromArray(
					[
...
var $jfmengels$elm_review_simplify$Simplify$stringIsEmptyChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
	if (_v1.$ === 11) {
		var str = _v1.a;
		var replacementValue = $jfmengels$elm_review_simplify$Simplify$boolToString(str === '');
		return _List_fromArray(
			[
				A3(
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'The call to String.isEmpty will result in ' + replacementValue
				},
				fnRange,
				_List_fromArray(
					[
						A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, replacementValue)
					]))
			]);
	} else {
		return _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$stringJoinChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var secondArg = _v0.h;
	if (((!secondArg.$) && (secondArg.a.b.$ === 19)) && (!secondArg.a.b.a.b)) {
		var _v2 = secondArg.a;
		return _List_fromArray(
			[
				A3(
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					bA: _List_fromArray(
						['You can replace this call by an empty string.']),
					aq: 'Using String.join on an empty list will result in a empty string'
				},
				fnRange,
				_List_fromArray(
					[
		...
		var _v3 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
		if ((_v3.$ === 11) && (_v3.a === '')) {
			return _List_fromArray(
				[
					A3(
...
var $jfmengels$elm_review_simplify$Simplify$stringLengthChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
		...
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'The length of the string is ' + $elm$core$String$fromInt(
...
var $jfmengels$elm_review_simplify$Simplify$stringLinesChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
		...
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					bA: _List_fromArray(
						['You can replace this call by an empty list.']),
					aq: 'Using String.lines on an empty string will result in a empty list'
				},
				fnRange,
				_List_fromArray(
					[
...
var $jfmengels$elm_review_simplify$Simplify$stringRepeatChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var secondArg = _v0.h;
	if (((!secondArg.$) && (secondArg.a.b.$ === 11)) && (secondArg.a.b.a === '')) {
		var _v2 = secondArg.a;
		return _List_fromArray(
			[
				A3(
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					bA: _List_fromArray(
						['You can replace this call by an empty string.']),
					aq: 'Using String.repeat with an empty string will result in a empty string'
				},
				fnRange,
				_List_fromArray(
					[
		...
		var _v3 = $jfmengels$elm_review_simplify$Simplify$getIntValue(firstArg);
		if (!_v3.$) {
			var intValue = _v3.a;
			return (intValue === 1) ? _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'String.repeat 1 won\'t do anything'
					},
					fnRange,
					_List_fromArray(
						[
				...
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'String.repeat will result in an empty string'
					},
					fnRange,
					A3($jfmengels$elm_review_simplify$Simplify$replaceByEmptyFix, '\"\"', parentRange, secondArg))
				]) : _List_Nil);
...
var $jfmengels$elm_review_simplify$Simplify$stringReverseChecks = function (checkInfo) {
	...
	var fnRange = checkInfo.a;
	var firstArg = checkInfo.c;
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
	if ((_v0.$ === 11) && (_v0.a === '')) {
		return _List_fromArray(
			[
				A3(
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					bA: _List_fromArray(
						['You can replace this call by an empty string.']),
					aq: 'Using String.reverse on an empty string will result in a empty string'
				},
				fnRange,
				_List_fromArray(
					[
...
var $jfmengels$elm_review_simplify$Simplify$stringWordsChecks = function (_v0) {
	var parentRange = _v0.b;
	var fnRange = _v0.a;
	var firstArg = _v0.c;
	var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(firstArg);
		...
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					bA: _List_fromArray(
						['You can replace this call by an empty list.']),
					aq: 'Using String.words on an empty string will result in a empty list'
				},
				fnRange,
				_List_fromArray(
					[
...
var $jfmengels$elm_review_simplify$Simplify$subAndCmdBatchChecks = F2(
				...
				return _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							...
							aq: 'Replace by ' + (moduleName + '.batch')
						},
						fnRange,
						_List_fromArray(
							[
								A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, moduleName + '.none')
							]))
					]);
			} else {
				if (!_v1.a.b.b) {
					...
					return _List_fromArray(
						[
							...
							$jfmengels$elm_review$Review$Rule$errorWithFix,
							{
								...
								aq: 'Unnecessary ' + (moduleName + '.batch')
							},
							fnRange,
							_List_fromArray(
								[
					...
					return A2(
						...
						function (_v3) {
							...
							var arg = _v3.b;
							var next = _v3.c;
							var _v4 = $jfmengels$elm_review_simplify$Simplify$removeParens(arg);
							if ((_v4.b.$ === 3) && (_v4.b.b === 'none')) {
								var batchRange = _v4.a;
								var _v5 = _v4.b;
								return _Utils_eq(
									A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, lookupTable, batchRange),
									$elm$core$Maybe$Just(
										_List_fromArray(
									...
									A3(
										$jfmengels$elm_review$Review$Rule$errorWithFix,
										{
											...
											aq: 'Unnecessary ' + (moduleName + '.none')
										},
											...
											if (!prev.$) {
												...
												return _List_fromArray(
													[
														$jfmengels$elm_review$Review$Fix$removeRange(
														{
															a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(arg).a_,
															be: prevRange.a_
														})
													]);
											} else {
												if (!next.$) {
													...
													return _List_fromArray(
														[
															...
															{
																a_: nextRange.be,
																be: $stil4m$elm_syntax$Elm$Syntax$Node$range(arg).be
															})
														]);
												} else {
													return _List_fromArray(
		...
		[
			...
			_Utils_Tuple2(
				_List_fromArray(
					['List']),
				'map'),
			$jfmengels$elm_review_simplify$Simplify$collectionMapChecks($jfmengels$elm_review_simplify$Simplify$listCollection)),
			_Utils_Tuple2(
			_Utils_Tuple2(
				_List_fromArray(
					['List']),
			...
			_Utils_Tuple2(
				_List_fromArray(
					['Set']),
				'fromList'),
			$jfmengels$elm_review_simplify$Simplify$collectionFromListChecks($jfmengels$elm_review_simplify$Simplify$setCollection)),
			_Utils_Tuple2(
			_Utils_Tuple2(
				_List_fromArray(
					['Set']),
...
var $jfmengels$elm_review_simplify$Simplify$onlyErrors = function (errors) {
	return {aw: errors, ac: _List_Nil, ad: _List_Nil};
};
...
var $jfmengels$elm_review_simplify$Simplify$and_isLeftSimplifiableError = function (_v0) {
	var lookupTable = _v0.o;
	var parentRange = _v0.b;
	var left = _v0.i;
	var leftRange = _v0.p;
	var rightRange = _v0.t;
	var _v1 = A2($jfmengels$elm_review_simplify$Simplify$getBoolean, lookupTable, left);
	if (!_v1.$) {
		if (_v1.a) {
			return _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{bA: $jfmengels$elm_review_simplify$Simplify$unnecessaryDetails, aq: $jfmengels$elm_review_simplify$Simplify$unnecessaryMessage},
					parentRange,
					_List_fromArray(
						[
							$jfmengels$elm_review$Review$Fix$removeRange(
			...
			return _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{bA: $jfmengels$elm_review_simplify$Simplify$alwaysSameDetails, aq: 'Condition is always False'},
					parentRange,
					_List_fromArray(
						[
							$jfmengels$elm_review$Review$Fix$removeRange(
...
var $jfmengels$elm_review_simplify$Simplify$and_isRightSimplifiableError = function (_v0) {
	var lookupTable = _v0.o;
	var parentRange = _v0.b;
	var leftRange = _v0.p;
	var right = _v0.j;
	var rightRange = _v0.t;
	var _v1 = A2($jfmengels$elm_review_simplify$Simplify$getBoolean, lookupTable, right);
	if (!_v1.$) {
		if (_v1.a) {
			return _List_fromArray(
				[
...
var $jfmengels$elm_review_simplify$Simplify$rangeAndFixForRedundantCondition = F2(
	function (redundantConditionResolution, node) {
		if (!redundantConditionResolution.$) {
			var locationOfPrevElement = redundantConditionResolution.a;
			var range = {
				a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).a_,
				be: locationOfPrevElement
			};
			return _Utils_Tuple2(
				range,
				_List_fromArray(
			...
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Fix$replaceRangeBy,
						range,
						$jfmengels$elm_review_simplify$Simplify$boolToString(noopValue))
					]));
		}
	});
var $jfmengels$elm_review_simplify$Simplify$errorForRedundantCondition = F3(
	function (operator, redundantConditionResolution, node) {
		var _v0 = A2($jfmengels$elm_review_simplify$Simplify$rangeAndFixForRedundantCondition, redundantConditionResolution, node);
		var range = _v0.a;
		var fix = _v0.b;
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'Condition is redundant'
				},
				range,
				fix)
			]);
	});
var $jfmengels$elm_review_simplify$Simplify$areSimilarConditionsError = F4(
	function (lookupTable, operator, nodeToCompareTo, _v0) {
		var redundantConditionResolution = _v0.a;
		var nodeToLookAt = _v0.b;
		var _v1 = A3($jfmengels$elm_review_simplify$Simplify$Normalize$compare, lookupTable, nodeToCompareTo, nodeToLookAt);
		switch (_v1) {
			case 0:
				return A3($jfmengels$elm_review_simplify$Simplify$errorForRedundantCondition, operator, redundantConditionResolution, nodeToLookAt);
			case 1:
				return _List_Nil;
			default:
				return _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$listConditions = F3(
	function (operatorToLookFor, redundantConditionResolution, node) {
		listConditions:
		while (true) {
			var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
			switch (_v0.$) {
					...
					return _Utils_eq(operator, operatorToLookFor) ? _Utils_ap(
						...
						A3(
							...
							$jfmengels$elm_review_simplify$Simplify$RemoveFrom(
								$stil4m$elm_syntax$Elm$Syntax$Node$range(left).a_),
...
var $jfmengels$elm_review_simplify$Simplify$findSimilarConditionsError = function (operatorCheckInfo) {
	var conditionsOnTheRight = A3(
		$jfmengels$elm_review_simplify$Simplify$listConditions,
		operatorCheckInfo.ed,
		$jfmengels$elm_review_simplify$Simplify$RemoveFrom(operatorCheckInfo.p.a_),
		operatorCheckInfo.j);
	var errorsForNode = function (nodeToCompareTo) {
		return A2(
			$elm$core$List$concatMap,
			A3($jfmengels$elm_review_simplify$Simplify$areSimilarConditionsError, operatorCheckInfo.o, operatorCheckInfo.ed, nodeToCompareTo),
...
var $jfmengels$elm_review_simplify$Simplify$comparisonChecks = F2(
	function (operatorFunction, operatorCheckInfo) {
		var _v0 = A2(
			$elm$core$Maybe$map,
			$jfmengels$elm_review_simplify$Simplify$boolToString,
			A3(
				$elm$core$Maybe$map2,
				operatorFunction,
				$jfmengels$elm_review_simplify$Simplify$Normalize$getNumberValue(operatorCheckInfo.i),
				$jfmengels$elm_review_simplify$Simplify$Normalize$getNumberValue(operatorCheckInfo.j)));
		if (!_v0.$) {
			var value = _v0.a;
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Comparison is always ' + value
					},
					operatorCheckInfo.b,
					_List_fromArray(
						[
							A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, operatorCheckInfo.b, value)
						]))
				]);
		} else {
			return _List_Nil;
...
var $jfmengels$elm_review_simplify$Simplify$consChecks = function (_v0) {
	var right = _v0.j;
	var leftRange = _v0.p;
	var rightRange = _v0.t;
	var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(right);
	if (_v1.$ === 19) {
		if (!_v1.a.b) {
			return _List_fromArray(
				[
					...
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Element added to the beginning of the list could be included in the list'
					},
					leftRange,
					_List_fromArray(
						[
							A2($jfmengels$elm_review$Review$Fix$insertAt, leftRange.be, '[ '),
							A2(
							$jfmengels$elm_review$Review$Fix$replaceRangeBy,
							{a_: rightRange.a_, be: leftRange.a_},
							' ]')
				...
				[
					...
					_List_fromArray(
						[
							...
							$jfmengels$elm_review$Review$Fix$replaceRangeBy,
							{
								a_: {ar: rightRange.be.ar + 1, aD: rightRange.be.aD},
								be: leftRange.a_
							},
							',')
						]))
...
var $jfmengels$elm_review_simplify$Simplify$getUncomputedNumberValue = function (node) {
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
		$jfmengels$elm_review_simplify$Simplify$removeParens(node));
	switch (_v0.$) {
		case 7:
		...
		case 10:
			...
			return A2(
				$elm$core$Maybe$map,
				$elm$core$Basics$negate,
				$jfmengels$elm_review_simplify$Simplify$getUncomputedNumberValue(expr));
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $jfmengels$elm_review_simplify$Simplify$divisionChecks = function (_v0) {
	var leftRange = _v0.p;
	var rightRange = _v0.t;
	var right = _v0.j;
	if (_Utils_eq(
		$jfmengels$elm_review_simplify$Simplify$getUncomputedNumberValue(right),
		$elm$core$Maybe$Just(1))) {
		var range = {a_: rightRange.a_, be: leftRange.a_};
		return _List_fromArray(
			[
				A3(
				$jfmengels$elm_review$Review$Rule$errorWithFix,
...
var $jfmengels$elm_review_simplify$Simplify$getNotCall = F2(
	function (lookupTable, baseNode) {
		var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(
			$jfmengels$elm_review_simplify$Simplify$removeParens(baseNode));
...
var $jfmengels$elm_review_simplify$Simplify$sameThingOnBothSidesDetails = function (computedResult) {
	var computedResultString = computedResult ? 'True' : 'False';
	return _List_fromArray(
...
var $jfmengels$elm_review_simplify$Simplify$equalityChecks = F2(
	function (isEqual, _v0) {
		var lookupTable = _v0.o;
		var parentRange = _v0.b;
		var left = _v0.i;
		var right = _v0.j;
		...
		var rightRange = _v0.t;
		if (_Utils_eq(
			A2($jfmengels$elm_review_simplify$Simplify$getBoolean, lookupTable, right),
			$elm$core$Maybe$Just(isEqual))) {
			return _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Unnecessary comparison with boolean'
					},
					parentRange,
					_List_fromArray(
						[
			...
			if (_Utils_eq(
				A2($jfmengels$elm_review_simplify$Simplify$getBoolean, lookupTable, left),
				$elm$core$Maybe$Just(isEqual))) {
				return _List_fromArray(
					[
						A3(
				...
				var _v1 = A3(
					$elm$core$Maybe$map2,
					$elm$core$Tuple$pair,
					A2($jfmengels$elm_review_simplify$Simplify$getNotCall, lookupTable, left),
					A2($jfmengels$elm_review_simplify$Simplify$getNotCall, lookupTable, right));
				if (!_v1.$) {
					var _v2 = _v1.a;
					var notRangeLeft = _v2.a;
					var notRangeRight = _v2.b;
					return _List_fromArray(
						[
							A3(
							$jfmengels$elm_review$Review$Rule$errorWithFix,
							{
								...
								aq: 'Unnecessary negation on both sides'
							},
							parentRange,
							_List_fromArray(
								[
					...
					var _v3 = A3($jfmengels$elm_review_simplify$Simplify$Normalize$compare, lookupTable, left, right);
					switch (_v3) {
						case 0:
							return _List_fromArray(
								[
									...
									$jfmengels$elm_review$Review$Rule$errorWithFix,
									{
										bA: $jfmengels$elm_review_simplify$Simplify$sameThingOnBothSidesDetails(isEqual),
										aq: 'Condition is always ' + $jfmengels$elm_review_simplify$Simplify$boolToString(isEqual)
									},
									parentRange,
									_List_fromArray(
										[
											...
											$jfmengels$elm_review$Review$Fix$replaceRangeBy,
											parentRange,
											$jfmengels$elm_review_simplify$Simplify$boolToString(isEqual))
										]))
								]);
						case 1:
							return _List_fromArray(
...
var $jfmengels$elm_review_simplify$Simplify$minusChecks = function (_v0) {
	var leftRange = _v0.p;
	var rightRange = _v0.t;
	var left = _v0.i;
	var right = _v0.j;
	if (_Utils_eq(
		...
		return _List_fromArray(
			[
				...
				$jfmengels$elm_review$Review$Rule$errorWithFix,
				{
					...
					aq: 'Unnecessary subtraction with 0'
				},
				range,
				_List_fromArray(
					[
		...
		if (_Utils_eq(
			$jfmengels$elm_review_simplify$Simplify$getUncomputedNumberValue(left),
			$elm$core$Maybe$Just(0))) {
			var range = {a_: rightRange.be, be: leftRange.be};
			return _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aq: 'Unnecessary subtracting from 0'
					},
					range,
					_List_fromArray(
						[
...
var $jfmengels$elm_review_simplify$Simplify$findMap = F2(
...
var $jfmengels$elm_review_simplify$Simplify$multiplyChecks = function (_v0) {
	var parentRange = _v0.b;
	var leftRange = _v0.p;
	var rightRange = _v0.t;
	var left = _v0.i;
	...
	return A2(
		...
		A2(
			...
			function (_v1) {
				var node = _v1.a;
				var getRange = _v1.b;
				var _v2 = $jfmengels$elm_review_simplify$Simplify$getUncomputedNumberValue(node);
				if (!_v2.$) {
					var value = _v2.a;
					return (value === 1) ? $elm$core$Maybe$Just(
						_List_fromArray(
							[
								A3(
								$jfmengels$elm_review$Review$Rule$errorWithFix,
								{
									...
									aq: 'Unnecessary multiplication by 1'
								},
								getRange(0),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								{
									bA: _List_fromArray(
										['You can replace this value by 0.']),
									aq: 'Multiplying by 0 equals 0'
								},
								getRange(0),
								_List_fromArray(
									[
										A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, parentRange, '0')
									]))
							])) : $elm$core$Maybe$Nothing);
				} else {
					return $elm$core$Maybe$Nothing;
			...
			_List_fromArray(
				[
					...
					right,
					function (_v3) {
						return {a_: rightRange.a_, be: leftRange.a_};
					}),
					_Utils_Tuple2(
					left,
					function (_v4) {
						return {a_: rightRange.be, be: leftRange.be};
					})
				])));
};
var $jfmengels$elm_review_simplify$Simplify$or_isLeftSimplifiableError = function (_v0) {
	var lookupTable = _v0.o;
	var parentRange = _v0.b;
	var left = _v0.i;
	var leftRange = _v0.p;
		...
		if (_v1.a) {
			return _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{bA: $jfmengels$elm_review_simplify$Simplify$alwaysSameDetails, aq: 'Condition is always True'},
					parentRange,
					_List_fromArray(
						[
							$jfmengels$elm_review$Review$Fix$removeRange(
...
var $jfmengels$elm_review_simplify$Simplify$or_isRightSimplifiableError = function (_v0) {
	var lookupTable = _v0.o;
	var parentRange = _v0.b;
	var right = _v0.j;
	var leftRange = _v0.p;
...
var $jfmengels$elm_review_simplify$Simplify$plusChecks = function (_v0) {
	var leftRange = _v0.p;
	var rightRange = _v0.t;
	var left = _v0.i;
	var right = _v0.j;
	return A2(
		...
		A2(
			...
			function (_v1) {
				...
				var getRange = _v1.b;
				return _Utils_eq(
					$jfmengels$elm_review_simplify$Simplify$getUncomputedNumberValue(node),
					...
					_List_fromArray(
						[
							...
							$jfmengels$elm_review$Review$Rule$errorWithFix,
							{
								...
								aq: 'Unnecessary addition with 0'
							},
							getRange(0),
							_List_fromArray(
								[
...
var $jfmengels$elm_review_simplify$Simplify$errorForAddingEmptyLists = F2(
	function (range, rangeToRemove) {
		return A3(
			$jfmengels$elm_review$Review$Rule$errorWithFix,
			{
				bA: _List_fromArray(
					['You should remove the concatenation with the empty list.']),
				aq: 'Concatenating with a single list doesn\'t have any effect'
			},
			range,
			_List_fromArray(
				[
...
var $jfmengels$elm_review_simplify$Simplify$errorForAddingEmptyStrings = F2(
	function (range, rangeToRemove) {
		return A3(
			$jfmengels$elm_review$Review$Rule$errorWithFix,
			{
				...
				aq: 'Unnecessary concatenation with an empty string'
			},
			range,
			_List_fromArray(
				[
...
var $jfmengels$elm_review_simplify$Simplify$plusplusChecks = function (_v0) {
	var parentRange = _v0.b;
	var leftRange = _v0.p;
	var rightRange = _v0.t;
	var left = _v0.i;
	var right = _v0.j;
	var isOnTheRightSideOfPlusPlus = _v0.ci;
	var _v1 = _Utils_Tuple2(
		$stil4m$elm_syntax$Elm$Syntax$Node$value(left),
		$stil4m$elm_syntax$Elm$Syntax$Node$value(right));
	_v1$0:
	while (true) {
		_v1$1:
		while (true) {
			...
			while (true) {
				...
				while (true) {
														...
														[
															...
															_List_fromArray(
																[
																	...
																	{
																		a_: {ar: rightRange.be.ar + 1, aD: rightRange.be.aD},
																		be: {ar: leftRange.a_.ar - 1, aD: leftRange.a_.aD}
																	},
																	',')
																]))
														]);
					...
					var _v2 = _v1.a.a;
					return isOnTheRightSideOfPlusPlus ? _List_Nil : _List_fromArray(
						[
							A3(
							$jfmengels$elm_review$Review$Rule$errorWithFix,
							{
							...
							_List_fromArray(
								[
									...
									$jfmengels$elm_review$Review$Fix$replaceRangeBy,
									{
										a_: {ar: leftRange.be.ar + 1, aD: leftRange.be.aD},
										be: leftRange.be
									},
									'('),
									A2(
...
var $jfmengels$elm_review_simplify$Simplify$isUnnecessaryRecordUpdateSetter = F3(
	function (variable, field, value) {
...
var $jfmengels$elm_review_simplify$Simplify$removeRecordFields = F3(
	function (recordUpdateRange, variable, fields) {
		if (!fields.b) {
			return _List_Nil;
		} else {
			if (!fields.b.b) {
				...
				var value = $jfmengels$elm_review_simplify$Simplify$removeParens(valueWithParens);
				return A3($jfmengels$elm_review_simplify$Simplify$isUnnecessaryRecordUpdateSetter, variable, field, value) ? _List_fromArray(
					[
						...
						$jfmengels$elm_review$Review$Rule$errorWithFix,
						{
							...
							aq: 'Unnecessary field assignment'
						},
						...
						_List_fromArray(
							[
								$jfmengels$elm_review$Review$Fix$removeRange(
								{
									a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(variable).be,
									be: recordUpdateRange.be
								}),
								$jfmengels$elm_review$Review$Fix$removeRange(
								{
									a_: recordUpdateRange.a_,
									be: $stil4m$elm_syntax$Elm$Syntax$Node$range(variable).a_
								})
							]))
					]) : _List_Nil;
			} else {
									...
									if (!previousRange.$) {
										...
										return _List_fromArray(
											[
												$jfmengels$elm_review$Review$Fix$removeRange(
												{
													a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(second).be,
													be: firstRange.be
												})
											]);
									}
...
var $jfmengels$elm_review_simplify$Simplify$targetIf = function (node) {
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$range(node);
	var start = _v0.be;
	return {
		a_: _Utils_update(
...
var $jfmengels$elm_review_simplify$Simplify$expressionVisitorHelp = F2(
	function (node, context) {
			...
			while (true) {
				switch (_v0.$) {
					case 4:
						...
						var _v6 = A2($jfmengels$elm_review_simplify$Simplify$getBoolean, context.o, cond);
						if (!_v6.$) {
							if (_v6.a) {
									...
									_List_fromArray(
										[
											...
											$jfmengels$elm_review$Review$Rule$errorWithFix,
											{
												...
												aq: 'The condition will always evaluate to True'
											},
											$jfmengels$elm_review_simplify$Simplify$targetIf(node),
											_List_fromArray(
												[
													$jfmengels$elm_review$Review$Fix$removeRange(
													{
														a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(trueBranch).be,
														be: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).be
													}),
													$jfmengels$elm_review$Review$Fix$removeRange(
													{
														a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).a_,
														be: $stil4m$elm_syntax$Elm$Syntax$Node$range(trueBranch).a_
													})
												]))
										]));
							} else {
									...
									_List_fromArray(
										[
											...
											$jfmengels$elm_review$Review$Rule$errorWithFix,
											{
												...
												aq: 'The condition will always evaluate to False'
											},
											$jfmengels$elm_review_simplify$Simplify$targetIf(node),
											_List_fromArray(
												[
													$jfmengels$elm_review$Review$Fix$removeRange(
													{
														a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(falseBranch).be,
														be: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).be
													})
												]))
										]));
							...
							var _v7 = _Utils_Tuple2(
								A2($jfmengels$elm_review_simplify$Simplify$getBoolean, context.o, trueBranch),
								A2($jfmengels$elm_review_simplify$Simplify$getBoolean, context.o, falseBranch));
							_v7$2:
							while (true) {
								if (!_v7.a.$) {
									if (_v7.a.a) {
												...
												_List_fromArray(
													[
														...
														$jfmengels$elm_review$Review$Rule$errorWithFix,
														{
															...
															aq: 'The if expression\'s value is the same as the condition'
														},
														$jfmengels$elm_review_simplify$Simplify$targetIf(node),
														_List_fromArray(
															[
																$jfmengels$elm_review$Review$Fix$removeRange(
																{
																	a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(cond).be,
																	be: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).be
																}),
																$jfmengels$elm_review$Review$Fix$removeRange(
																{
																	a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).a_,
																	be: $stil4m$elm_syntax$Elm$Syntax$Node$range(cond).a_
																})
															]))
													]));
										} else {
												...
												_List_fromArray(
													[
														...
														$jfmengels$elm_review$Review$Rule$errorWithFix,
														{
															...
															aq: 'The if expression\'s value is the inverse of the condition'
														},
														$jfmengels$elm_review_simplify$Simplify$targetIf(node),
														_List_fromArray(
															[
							...
							var _v8 = A3($jfmengels$elm_review_simplify$Simplify$Normalize$compare, context.o, trueBranch, falseBranch);
							switch (_v8) {
								case 0:
									return $jfmengels$elm_review_simplify$Simplify$onlyErrors(
										_List_fromArray(
											[
												...
												$jfmengels$elm_review$Review$Rule$errorWithFix,
												{
													...
													aq: 'The values in both branches is the same.'
												},
												$jfmengels$elm_review_simplify$Simplify$targetIf(node),
												_List_fromArray(
													[
							...
							switch (_v0.a.a.b.$) {
								case 3:
									...
									var _v5 = A2(
										...
										A2($jfmengels$elm_review$Review$ModuleNameLookupTable$moduleNameAt, context.o, fnRange));
									if (!_v5.$) {
										var checkFn = _v5.a;
										return $jfmengels$elm_review_simplify$Simplify$onlyErrors(
											checkFn(
												{
													...
													h: $elm$core$List$head(restOfArguments),
													I: false
												}));
									} else {
										return $jfmengels$elm_review_simplify$Simplify$onlyErrors(_List_Nil);
								...
								case 14:
									if (_v0.a.a.b.a.b.$ === 17) {
										...
										var _v10 = _v9.a;
										var _v11 = _v10.b.a;
										var lambdaRange = _v11.a;
										var lambda = _v11.b.a;
										var _v12 = _v9.b;
										var firstArgument = _v12.a;
										var _v13 = lambda.dz;
										_v13$2:
										while (true) {
											if (_v13.b) {
												switch (_v13.a.b.$) {
													case 1:
														var _v14 = _v13.a;
														var unitRange = _v14.a;
														var _v15 = _v14.b;
														var otherPatterns = _v13.b;
														return $jfmengels$elm_review_simplify$Simplify$onlyErrors(
															_List_fromArray(
																[
																	A3(
																		...
																		if (!otherPatterns.b) {
																			return _List_fromArray(
																				[
																					$jfmengels$elm_review$Review$Fix$removeRange(
																					{
																						a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(lambda.bG).be,
																						be: lambdaRange.be
																					}),
																					$jfmengels$elm_review$Review$Fix$removeRange(
																			...
																			return _List_fromArray(
																				[
																					$jfmengels$elm_review$Review$Fix$removeRange(
																					{
																						a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(secondPattern).be,
																						be: unitRange.be
																					}),
																					$jfmengels$elm_review$Review$Fix$removeRange(
																					$stil4m$elm_syntax$Elm$Syntax$Node$range(firstArgument))
															...
															_List_fromArray(
																[
																	...
																	$jfmengels$elm_review$Review$Rule$errorWithFix,
																	{
																		...
																		aq: 'Unnecessary wildcard argument argument'
																	},
																	allRange,
																	function () {
																		if (!otherPatterns.b) {
								...
								case 5:
									if (_v0.a.b.b.b && (!_v0.a.b.b.b.b)) {
										var _v20 = _v0.a;
										var _v21 = _v20.a;
										var operatorRange = _v21.a;
										var operator = _v21.b.a;
										var _v22 = _v20.b;
										var left = _v22.a;
										var _v23 = _v22.b;
										var right = _v23.a;
											...
											_List_fromArray(
												[
													...
													$jfmengels$elm_review$Review$Rule$errorWithFix,
													{
														...
														aq: 'Use the infix form (a + b) over the prefix form ((+) a b)'
													},
													operatorRange,
													_List_fromArray(
														[
															$jfmengels$elm_review$Review$Fix$removeRange(
															{
																a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(left).be,
																be: operatorRange.be
															}),
															A2(
															$jfmengels$elm_review$Review$Fix$insertAt,
															$stil4m$elm_syntax$Elm$Syntax$Node$range(right).be,
															operator + ' ')
														]))
												]));
									} else {
						...
						switch (_v0.a) {
							case '<|':
								switch (_v0.c.b.$) {
									...
									case 1:
										if (((_v0.c.b.a.b && (_v0.c.b.a.a.b.$ === 3)) && _v0.c.b.a.b.b) && (!_v0.c.b.a.b.b.b)) {
											var _v27 = _v0.c;
											var applicationRange = _v27.a;
											var _v28 = _v27.b.a;
											var _v29 = _v28.a;
											var fnRange = _v29.a;
											var _v30 = _v29.b;
													...
													checkFn(
														{
															...
															o: context.o,
															b: $stil4m$elm_syntax$Elm$Syntax$Node$range(node),
															h: $elm$core$Maybe$Just(secondArgument),
															I: false
														}),
													_List_fromArray(
														[applicationRange]));
							...
							case '|>':
								switch (_v0.d.b.$) {
									...
									case 1:
										if (((_v0.d.b.a.b && (_v0.d.b.a.a.b.$ === 3)) && _v0.d.b.a.b.b) && (!_v0.d.b.a.b.b.b)) {
											var secondArgument = _v0.c;
											var _v36 = _v0.d;
											var applicationRange = _v36.a;
											var _v37 = _v36.b.a;
											var _v38 = _v37.a;
											var fnRange = _v38.a;
											var _v39 = _v38.b;
									...
									return $jfmengels$elm_review_simplify$Simplify$onlyErrors(
										A2(
											...
											$jfmengels$elm_review_simplify$Simplify$compositionChecks,
											{
												ah: true,
												i: left,
												p: $stil4m$elm_syntax$Elm$Syntax$Node$range(left),
												o: context.o,
												b: {
													a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(right).a_,
													be: $stil4m$elm_syntax$Elm$Syntax$Node$range(left).be
												...
												j: right,
												t: $stil4m$elm_syntax$Elm$Syntax$Node$range(right)
											}));
								} else {
									var left = _v0.c;
									var right = _v0.d;
					...
					case 10:
						var baseExpr = _v0.a;
						var _v47 = $jfmengels$elm_review_simplify$Simplify$removeParens(baseExpr);
						if (_v47.b.$ === 10) {
							var range = _v47.a;
							var doubleNegationRange = {
								a_: {ar: range.be.ar + 1, aD: range.be.aD},
								be: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).be
							};
							return $jfmengels$elm_review_simplify$Simplify$onlyErrors(
								_List_fromArray(
									[
										...
										$jfmengels$elm_review$Review$Rule$errorWithFix,
										{
											...
											aq: 'Unnecessary double number negation'
										},
										doubleNegationRange,
										_List_fromArray(
											[
												A2($jfmengels$elm_review$Review$Fix$replaceRangeBy, doubleNegationRange, '(')
											]))
									]));
						} else {
							return $jfmengels$elm_review_simplify$Simplify$onlyErrors(_List_Nil);
		...
		var left = _v0.c;
		var right = _v0.d;
		var _v46 = A2($elm$core$Dict$get, operator, $jfmengels$elm_review_simplify$Simplify$operatorChecks);
		if (!_v46.$) {
			var checkFn = _v46.a;
			return {
				aw: checkFn(
...
var $jfmengels$elm_review_simplify$Simplify$expressionVisitor = F2(
	function (node, context) {
		if (A2(
			$elm$core$List$member,
			$stil4m$elm_syntax$Elm$Syntax$Node$range(node),
			...
			var _v0 = A2($jfmengels$elm_review_simplify$Simplify$expressionVisitorHelp, node, context);
			var errors = _v0.aw;
			var rangesToIgnore = _v0.ac;
			var rightSidesOfPlusPlus = _v0.ad;
			return _Utils_Tuple2(
				errors,
				_Utils_update(
					context,
					{
						ac: _Utils_ap(rangesToIgnore, context.ac),
						ad: _Utils_ap(rightSidesOfPlusPlus, context.ad)
					}));
		}
	});
...
var $jfmengels$elm_review$Review$Rule$withExpressionEnterVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				z: A2($elm$core$List$cons, visitor, schema.z)
			});
	});
var $jfmengels$elm_review_simplify$Simplify$moduleVisitor = F2(
	function (typeNames, schema) {
		return A2(
			$jfmengels$elm_review_simplify$Simplify$addDeclarationListVisitor,
			typeNames,
			A2(
				$jfmengels$elm_review$Review$Rule$withExpressionEnterVisitor,
				$jfmengels$elm_review_simplify$Simplify$expressionVisitor,
				A2($jfmengels$elm_review$Review$Rule$withDeclarationEnterVisitor, $jfmengels$elm_review_simplify$Simplify$declarationVisitor, schema)));
	});
var $jfmengels$elm_review$Review$Rule$newModuleRuleSchemaUsingContextCreator = F2(
	function (name, moduleContextCreator) {
		return {U: _List_Nil, V: _List_Nil, ae: _List_Nil, ag: _List_Nil, W: _List_Nil, X: _List_Nil, D: _List_Nil, E: _List_Nil, z: _List_Nil, G: _List_Nil, u: _List_Nil, ai: _List_Nil, bo: $elm$core$Maybe$Nothing, aa: _List_Nil, ab: _List_Nil, L: moduleContextCreator, aj: _List_Nil, aV: name, H: _List_Nil};
	});
var $jfmengels$elm_review$Review$Rule$newProjectRuleSchema = F2(
	function (name, initialProjectContext) {
		return {at: $elm$core$Maybe$Nothing, D: _List_Nil, E: _List_Nil, u: _List_Nil, aM: $elm$core$Maybe$Nothing, aB: initialProjectContext, L: $elm$core$Maybe$Nothing, a5: _List_Nil, aV: name, H: _List_Nil, by: 0};
	});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cI: col, c9: problem, aD: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.aD, p.cI, p.c9);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cI: 1, k: _List_Nil, n: 1, f: 0, aD: 1, e: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cI: col, dL: contextStack, c9: problem, aD: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.aD, s.cI, x, s.k));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.f, s.aD, s.cI, s.e);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cI: newCol, k: s.k, n: s.n, f: newOffset, aD: newRow, e: s.e});
	};
};
	...
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cI: col, k: context, n: indent, f: offset, aD: row, e: src};
			} else {
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.be, s.f, s.e);
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.cQ));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.c_, s.f + 1, s.aD + 1, 1, s.e, s.n, s.k) : A7($elm$parser$Parser$Advanced$varHelp, i.c_, firstOffset, s.aD, s.cI + 1, s.e, s.n, s.k);
			var name = A3($elm$core$String$slice, s.f, s1.f, s.e);
			return A2($elm$core$Set$member, name, i.dc) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.cQ)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{cQ: $elm$parser$Parser$ExpectingVariable, c_: i.c_, dc: i.dc, be: i.be});
};
var $elm$project_metadata_utils$Elm$Type$var = function (isFirst) {
	return $elm$parser$Parser$variable(
		{c_: $elm$project_metadata_utils$Elm$Type$isInnerVarChar, dc: $elm$core$Set$empty, be: isFirst});
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cI: col, k: s0.k, n: s0.n, f: offset, aD: row, e: s0.e});
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.f, s.aD, s.cI, s);
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.f, s1.f, s0.e),
						a),
					s1);
			}
		};
	...
	return A2(
		...
		A2(
			...
			A5(
				...
				$elm$parser$Parser$Advanced$token(i.a_),
				i.dj,
				i.c1,
				$elm$parser$Parser$Advanced$token(i.dh),
				i.ds)));
};
...
var $elm$parser$Parser$sequence = function (i) {
	return $elm$parser$Parser$Advanced$sequence(
		{
			a_: $elm$parser$Parser$toToken(i.a_),
			c1: i.c1,
			dh: $elm$parser$Parser$toToken(i.dh),
			dj: i.dj,
...
function $elm$project_metadata_utils$Elm$Type$cyclic$tuple() {
	return A2(
		...
		$elm$parser$Parser$sequence(
			{
				a_: ')',
				c1: $elm$project_metadata_utils$Elm$Type$cyclic$tipe(),
				dh: ',',
				dj: $elm$project_metadata_utils$Elm$Type$spaces,
				be: '(',
				ds: 0
			}));
}
...
var $jfmengels$elm_review_simplify$Simplify$isValidType = function (typeAsString) {
	var _v0 = A2($elm$json$Json$Decode$decodeString, $elm$project_metadata_utils$Elm$Type$decoder, '\"' + (typeAsString + '\"'));
	if ((!_v0.$) && (_v0.a.$ === 3)) {
		var _v1 = _v0.a;
		var name = _v1.a;
		...
		if (_v2.b && _v2.b.b) {
			var functionName = _v2.a;
			var _v3 = _v2.b;
			var moduleName = _v3.a;
			var restOfModuleName = _v3.b;
			...
			return $elm$core$Result$Err(typeAsString);
		}
	} else {
		return $elm$core$Result$Err(typeAsString);
	}
...
var $jfmengels$elm_review_simplify$Simplify$parseTypeNames = function (strings) {
	var parsedTypeNames = A2($elm$core$List$map, $jfmengels$elm_review_simplify$Simplify$isValidType, strings);
	var invalidTypeNames = A2(
		$elm$core$List$filterMap,
		function (result) {
			if (result.$ === 1) {
		...
		parsedTypeNames);
	return $elm$core$List$isEmpty(invalidTypeNames) ? $elm$core$Result$Ok(
		A2($elm$core$List$filterMap, $elm$core$Result$toMaybe, parsedTypeNames)) : $elm$core$Result$Err(invalidTypeNames);
};
...
var $jfmengels$elm_review$Review$Rule$withFinalProjectEvaluation = F2(
	function (visitor, _v0) {
		var schema = _v0;
		var removeErrorPhantomTypeFromEvaluation = F2(
			function (_function, projectContext) {
				return A2(
					$elm$core$List$map,
					$jfmengels$elm_review$Review$Rule$removeErrorPhantomType,
					_function(projectContext));
			});
		return _Utils_update(
			schema,
			{
				u: A2(
					$elm$core$List$cons,
					removeErrorPhantomTypeFromEvaluation(visitor),
					schema.u)
			});
	});
		...
		return _Utils_update(
			schema,
			{
				aM: $elm$core$Maybe$Just(
					{ao: functions.ao, aN: functions.aN}),
				L: $elm$core$Maybe$Just(functions.cd)
			});
	});
...
var $jfmengels$elm_review_simplify$Simplify$rule = function (_v0) {
	var config = _v0;
	var _v1 = $jfmengels$elm_review_simplify$Simplify$parseTypeNames(config.bn);
	if (!_v1.$) {
		if (!_v1.a.b) {
			return $jfmengels$elm_review$Review$Rule$fromModuleRuleSchema(
				A2(
					...
					$elm$core$Set$empty,
					A2($jfmengels$elm_review$Review$Rule$newModuleRuleSchemaUsingContextCreator, 'Simplify', $jfmengels$elm_review_simplify$Simplify$initialModuleContext)));
		} else {
			var typeNamesList = _v1.a;
			var typeNames = $elm$core$Set$fromList(typeNamesList);
			return $jfmengels$elm_review$Review$Rule$fromProjectRuleSchema(
				A2(
					$jfmengels$elm_review$Review$Rule$withFinalProjectEvaluation,
					$jfmengels$elm_review_simplify$Simplify$finalEvaluation(config.bn),
					$jfmengels$elm_review$Review$Rule$withContextFromImportedModules(
						A2(
							...
							{ao: $jfmengels$elm_review_simplify$Simplify$foldProjectContexts, aN: $jfmengels$elm_review_simplify$Simplify$fromModuleToProject, cd: $jfmengels$elm_review_simplify$Simplify$fromProjectToModule},
							A2(
								$jfmengels$elm_review$Review$Rule$withModuleVisitor,
								$jfmengels$elm_review_simplify$Simplify$moduleVisitor(typeNames),
								A2(
									$jfmengels$elm_review$Review$Rule$withDependenciesProjectVisitor,
									$jfmengels$elm_review_simplify$Simplify$dependenciesVisitor(typeNames),
									A2($jfmengels$elm_review$Review$Rule$newProjectRuleSchema, 'Simplify', $jfmengels$elm_review_simplify$Simplify$initialContext)))))));
		}
	} else {
		var invalidTypes = _v1.a;
		return A2(
			...
			'Simplify',
			{
				...
				aq: 'Invalid type names: ' + A2(
					$elm$core$String$join,
					', ',
					A2($elm$core$List$map, $jfmengels$elm_review_simplify$Simplify$wrapInBackticks, invalidTypes))
			});
	}
};
...
var $author$project$Elm$Review$Main$DecodedFlags = F8(
	function (fixMode, detailsMode, reportMode, ignoreProblematicDependencies, rulesFilter, ignoredDirs, ignoredFiles, logger) {
		return {au: detailsMode, a0: fixMode, a2: ignoreProblematicDependencies, ce: ignoredDirs, cf: ignoredFiles, ap: logger, bb: reportMode, ct: rulesFilter};
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'line',
				$elm$json$Json$Encode$int(position.aD)),
				_Utils_Tuple2(
				'column',
				$elm$json$Json$Encode$int(position.ar))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'start',
				$author$project$Elm$Review$Main$encodePosition(range.be)),
				_Utils_Tuple2(
				'end',
				$author$project$Elm$Review$Main$encodePosition(range.a_))
			]));
};
...
var $author$project$Elm$Review$Text$from = function (value) {
	return {dH: $elm$core$Maybe$Nothing, dV: $elm$core$Maybe$Nothing, ep: value};
};
...
var $author$project$Elm$Review$Reporter$codeExtract = function (_v0) {
	...
	return function (_v1) {
		...
		var maxLineNumber = $elm$core$String$isEmpty(
			getRowAtLine(end.aD + 1)) ? end.aD : (end.aD + 1);
		...
		if (_Utils_eq(start.aD, end.aD)) {
			if (_Utils_eq(start.ar, end.ar)) {
				return _List_Nil;
			} else {
				var lineContent = getRowWithLineNumber(start.aD - 1);
				return A2(
					...
					A2(
						...
						_List_fromArray(
							[
								getRowWithLineNumberUnlessEmpty(start.aD - 2),
								_List_fromArray(
								[
								...
								gutterLength,
								{a_: end.ar, bL: lineContent, be: start.ar}),
								getRowWithLineNumberUnlessEmpty(end.aD)
							])));
			}
		} else {
			var startLineNumber = start.aD - 1;
			...
			var startLineContentWithLineNumber = _Utils_ap(
				...
				startLineContent);
			var linesBetweenStartAndEnd = A2($elm$core$List$range, start.aD, end.aD - 2);
			var endLine = end.aD - 1;
					...
					_List_fromArray(
						[
							...
							gutterLength,
							{
								...
								bL: startLineContentWithLineNumber,
								be: start.ar
							}),
							A2(
							$author$project$Elm$Review$Text$join,
							...
							{
								a_: end.ar,
								bL: endLineContentWithLineNumber,
								be: $author$project$Elm$Review$Reporter$getIndexOfFirstNonSpace(endLineContent) + 1
							}),
	...
	function (fixProblemDict, mode, error) {
		...
		return _List_fromArray(
			[
				...
				error.dd,
				$author$project$Elm$Review$Text$inRed(
					$author$project$Elm$Review$Text$from(error.cs))),
				$author$project$Elm$Review$Text$from(': ' + error.aq)
			]);
	});
			...
			if (!detailsMode) {
				return A2(
					...
					A2(
						$elm$core$List$intersperse,
						$author$project$Elm$Review$Text$from('\n\n'),
						A2($elm$core$List$map, $author$project$Elm$Review$Text$from, error.bA)));
			} else {
				return _List_Nil;
			}
		}();
		var codeExtract_ = function () {
			var _v0 = A2($author$project$Elm$Review$Reporter$codeExtract, source, error.cp);
			if (!_v0.b) {
				return _List_Nil;
			} else {
	...
	function (previousTexts, lastText, chunks) {
		...
		while (true) {
			if (!chunks.b) {
				...
				if (_Utils_eq(lastText.dH, newLastText.dH) && _Utils_eq(lastText.dV, newLastText.dV)) {
					var $temp$previousTexts = previousTexts,
						$temp$lastText = {
						dH: lastText.dH,
						dV: lastText.dV,
						ep: _Utils_ap(lastText.ep, newLastText.ep)
					},
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'rule',
					$elm$json$Json$Encode$string(error.cs)),
					_Utils_Tuple2(
					'message',
					$elm$json$Json$Encode$string(error.aq)),
					_Utils_Tuple2(
					'details',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, error.bA)),
					_Utils_Tuple2(
					'region',
...
var $author$project$Elm$Review$Reporter$fixableErrors = function (files) {
	return A2(
		...
		A2(
			...
			$elm$core$List$filter(
				function (error) {
					return !_Utils_eq(error.cT, $elm$core$Maybe$Nothing);
				})),
		files);
};
...
var $author$project$Elm$Review$Reporter$compareRange = F2(
	function (a, b) {
		return (_Utils_cmp(a.be.aD, b.be.aD) < 0) ? 0 : ((_Utils_cmp(a.be.aD, b.be.aD) > 0) ? 2 : ((_Utils_cmp(a.be.ar, b.be.ar) < 0) ? 0 : ((_Utils_cmp(a.be.ar, b.be.ar) > 0) ? 2 : ((_Utils_cmp(a.a_.aD, b.a_.aD) < 0) ? 0 : ((_Utils_cmp(a.a_.aD, b.a_.aD) > 0) ? 2 : ((_Utils_cmp(a.a_.ar, b.a_.ar) < 0) ? 0 : ((_Utils_cmp(a.a_.ar, b.a_.ar) > 0) ? 2 : 1)))))));
	});
var $author$project$Elm$Review$Reporter$compareErrorPositions = F2(
	function (a, b) {
		return A2($author$project$Elm$Review$Reporter$compareRange, a.cp, b.cp);
	});
	...
	function (isFirstError, filePath_, range) {
		var position = function () {
			switch (filePath_.$) {
				case 0:
					var str = filePath_.a;
					return ' ' + (str + (':' + ($elm$core$String$fromInt(range.be.aD) + (':' + $elm$core$String$fromInt(range.be.ar)))));
				case 1:
					return ' GLOBAL ERROR';
				default:
						...
						return A2(
							...
							_List_fromArray(
								[
									_List_fromArray(
									[
										A3($author$project$Elm$Review$Reporter$header, !index, file.ef, error.cp)
									]),
									A5($author$project$Elm$Review$Reporter$formatErrorWithExtract, fixProblemDict, detailsMode, mode, file.en, error)
								]));
					}),
				A2($elm$core$List$sortWith, $author$project$Elm$Review$Reporter$compareErrorPositions, file.aw)));
	});
				...
				return $elm$core$List$concat(
					_List_fromArray(
						[
							...
							A2($author$project$Elm$Review$Reporter$fileSeparator, firstFile.ef, secondFile.ef),
							A3(
...
var $author$project$Elm$Review$Main$getConfigurationError = function (rule) {
	...
	if (!_v0.$) {
		...
		return $elm$core$Maybe$Just(
			{
				bA: configurationError.bA,
				cT: $elm$core$Maybe$Nothing,
				aq: configurationError.aq,
				cp: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange,
				dd: $elm$core$Maybe$Nothing,
				cs: $jfmengels$elm_review$Review$Rule$ruleName(rule)
			});
	} else {
		return $elm$core$Maybe$Nothing;
	}
...
var $jfmengels$elm_review$Review$Exceptions$addDirectories = F2(
	function (directories, _v0) {
		...
		var cleanedDirectories = A2(
			...
			directories);
		return {
			aJ: _Utils_ap(cleanedDirectories, exceptions.aJ),
			aL: exceptions.aL
		};
	});
var $jfmengels$elm_review$Review$Rule$ignoreErrorsForDirectories = F2(
	function (directories, _v0) {
		...
		return {
			as: rule.as,
			ax: A2($jfmengels$elm_review$Review$Exceptions$addDirectories, directories, rule.ax),
			aV: rule.aV,
			S: rule.S,
			aE: rule.aE
		};
...
var $jfmengels$elm_review$Review$Exceptions$addFiles = F2(
	function (files, _v0) {
		...
		return {
			aJ: exceptions.aJ,
			aL: A2($elm$core$Set$union, cleanedFiles, exceptions.aL)
		};
	});
var $jfmengels$elm_review$Review$Rule$ignoreErrorsForFiles = F2(
	function (files, _v0) {
		...
		return {
			as: rule.as,
			ax: A2($jfmengels$elm_review$Review$Exceptions$addFiles, files, rule.ax),
			aV: rule.aV,
			S: rule.S,
			aE: rule.aE
		};
...
var $author$project$Elm$Review$Main$unknownRulesFilterMessage = function (_v0) {
	var ruleNames = _v0.de;
	var filterNames = _v0.cS;
	var unknownRulesMessage = A2(
		...
		A2(
			...
			filterNames));
	return {aq: 'You requested to only run several rules, but I could not find some of them.\n\n' + unknownRulesMessage, bx: 'UNKNOWN FILTERED RULE(S)'};
};
var $author$project$Elm$Review$Main$init = function (flags) {
	var _v0 = function () {
		...
		if (!_v1.$) {
			...
			var error = _v1.a;
			return _Utils_Tuple2(
				{au: 1, a0: 0, a2: false, ce: _List_Nil, cf: _List_Nil, ap: $author$project$Elm$Review$Progress$dummy, bb: 0, ct: $elm$core$Maybe$Nothing},
				$author$project$Elm$Review$Main$abort(
					'Problem decoding the flags when running the elm-review runner:\n  ' + $elm$json$Json$Decode$errorToString(error)));
		}
	}();
	var fixMode = _v0.a.a0;
	var reportMode = _v0.a.bb;
	var detailsMode = _v0.a.au;
	var ignoreProblematicDependencies = _v0.a.a2;
	var rulesFilter = _v0.a.ct;
	var ignoredDirs = _v0.a.ce;
	var ignoredFiles = _v0.a.cf;
	var logger = _v0.a.ap;
	var cmd = _v0.b;
	var _v2 = function () {
		if (!rulesFilter.$) {
	...
	return _Utils_Tuple2(
		{
			au: detailsMode,
			av: $author$project$Elm$Review$Main$NotAwaiting,
			bD: false,
			ay: $elm$core$Dict$empty,
			ca: $jfmengels$elm_review$Review$Project$new,
			a0: fixMode,
			a2: ignoreProblematicDependencies,
			aS: $elm$core$Dict$empty,
			ap: logger,
			g: $jfmengels$elm_review$Review$Project$new,
			bv: $elm$core$Maybe$Nothing,
			ba: $author$project$Elm$Review$RefusedErrorFixes$empty,
			bb: reportMode,
			bc: _List_Nil,
			bw: A2(
				$elm$core$List$map,
		...
		function () {
			if ($elm$core$List$isEmpty($author$project$ReviewConfig$config)) {
				return $author$project$Elm$Review$Main$abortWithDetails(
					{aq: 'Your configuration contains no rules. You can add rules by editing the ReviewConfig.elm file.\n\nI recommend you take a look at the following documents:\n  - How to configure elm-review: https://github.com/jfmengels/elm-review/#Configuration\n  - When to write or enable a rule: https://github.com/jfmengels/elm-review/#when-to-write-or-enable-a-rule', bx: 'CONFIGURATION IS EMPTY'});
			} else {
								...
								if (!reportMode) {
									return $author$project$Elm$Review$Main$encodeReport(
										A4(
											...
											_List_fromArray(
												[
													{aw: configurationErrors, ef: $author$project$Elm$Review$Reporter$ConfigurationError, en: ''}
												])));
								} else {
...
var $jfmengels$elm_review$Review$Project$addElmJson = F2(
	function (elmJson_, _v0) {
		var project = _v0;
		var sourceDirectories = $jfmengels$elm_review$Review$Project$sourceDirectoriesForProject(elmJson_.g);
		var modules_ = _Utils_eq(project.cv, sourceDirectories) ? project.al : A2(
			$elm$core$Dict$map,
			F2(
				function (_v1, value) {
					var osAgnosticPath = $jfmengels$elm_review$Review$Project$makePathOSAgnostic(value.ef);
					return _Utils_update(
						value,
						{
							ch: A2(
		...
		return _Utils_update(
			project,
			{
				b3: $elm$core$Maybe$Just(elmJson_),
				al: modules_,
				cv: sourceDirectories
			});
	});
...
var $jfmengels$elm_review$Review$Project$sanitizeModule = function (module_) {
	return _Utils_update(
		module_,
		{
			dB: $jfmengels$elm_review$Review$Project$reorderComments(module_.dB)
		});
};
...
var $stil4m$elm_syntax$Elm$Processing$addDependency = F2(
	function (dep, _v0) {
		var x = _v0;
		return A2($elm$core$Dict$union, dep.cg, x);
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'apL'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<|'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'apR'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|>'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'or'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '||'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'and'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '&&'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 3)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'eq'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '=='),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'neq'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '/='),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'lt'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'gt'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'le'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<='),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 2),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'ge'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>='),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 4)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'append'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '++'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'add'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '+'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 6)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'sub'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '-'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 6)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'mul'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '*'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'fdiv'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '/'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'idiv'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '//'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'pow'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '^'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 8)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'composeL'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<<'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 9)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'composeR'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '>>'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 9)
						})
					])),
				...
				_List_fromArray(
					[
						...
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'cons'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '::'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
						})
					]))
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'keeper'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|='),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'ignorer'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '|.'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 6)
						})
					])),
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 1),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'slash'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '</>'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 7)
						}),
						$stil4m$elm_syntax$Elm$Interface$Operator(
						{
							dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
							dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'questionMark'),
							ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, '<?>'),
							eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 8)
						})
					]))
...
var $stil4m$elm_syntax$Elm$Parser$State$emptyState = {dJ: _List_Nil, aQ: _List_Nil};
var $stil4m$elm_syntax$Elm$Syntax$File$File = F4(
	function (moduleDefinition, imports, declarations, comments) {
		return {dJ: comments, cK: declarations, dW: imports, d0: moduleDefinition};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$getComments = function (_v0) {
	var s = _v0;
	return $elm$core$List$reverse(s.dJ);
};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.f, s.e);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{cI: 1, k: s.k, n: s.n, f: s.f + 1, aD: s.aD + 1, e: s.e}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{cI: s.cI + 1, k: s.k, n: s.n, f: newOffset, aD: s.aD, e: s.e}));
		};
	});
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								a_: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(end),
								be: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(start)
							});
					}),
				A2(
					$stil4m$elm_syntax$Combine$andMap,
	...
	$elm$parser$Parser$variable(
		{
			...
			dc: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			be: $miniBill$elm_unicode$Unicode$isLower
		}));
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.f, s.aD, s.cI, s.e);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.f, s.aD, s.cI, s.e);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $stil4m$elm_syntax$Elm$Parser$State$addComment = F2(
	function (pair, _v0) {
		...
		return _Utils_update(
			s,
			{
				dJ: A2($elm$core$List$cons, pair, s.dJ)
			});
	});
			...
			return $stil4m$elm_syntax$Combine$withLocation(
				function (l) {
					return A2(
						...
						l.ar) ? $stil4m$elm_syntax$Combine$succeed(0) : $stil4m$elm_syntax$Combine$fail(
						'Expected higher indent than ' + $elm$core$String$fromInt(l.ar));
				});
		});
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {cI: s.cI + (newOffset - s.f), k: s.k, n: s.n, f: newOffset, aD: s.aD, e: s.e};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.aD, s.cI - (floatOffset + s.f), invalid, s.k));
		} else {
...
var $elm$parser$Parser$number = function (i) {
	return $elm$parser$Parser$Advanced$number(
		{
			cE: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingBinary, i.cE),
			cQ: $elm$parser$Parser$ExpectingNumber,
			cU: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.cU),
			cY: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.cY),
			c$: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.c$),
			dZ: $elm$parser$Parser$ExpectingNumber,
			c7: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingOctal, i.c7)
		});
};
		...
		return $elm$parser$Parser$number(
			{
				...
				cU: $elm$core$Maybe$Just(floatf),
				cY: $elm$core$Maybe$Just(hexf),
				c$: $elm$core$Maybe$Just(intf),
	...
	$elm$parser$Parser$variable(
		{
			...
			dc: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			be: $miniBill$elm_unicode$Unicode$isUpper
		}));
				...
				if (!_v0.$) {
					...
					return A2(
						...
						function (_v3) {
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dM).aV),
						A2(
							$elm$core$Maybe$map,
							function (_v1) {
								var value = _v1.b;
...
var $stil4m$elm_syntax$Elm$Syntax$Signature$Signature = F2(
	function (name, typeAnnotation) {
		return {aV: name, dt: typeAnnotation};
	});
	...
	function (s) {
		return $stil4m$elm_syntax$Combine$withLocation(
			function (l) {
				...
				return A2($elm$core$List$member, l.ar, known) ? $stil4m$elm_syntax$Combine$succeed(0) : $stil4m$elm_syntax$Combine$succeed(1);
			});
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$popIndent = function (_v0) {
	...
	return _Utils_update(
		s,
		{
			aQ: A2($elm$core$List$drop, 1, s.aQ)
		});
};
var $stil4m$elm_syntax$Elm$Parser$State$pushIndent = F2(
	function (x, _v0) {
		...
		return _Utils_update(
			s,
			{
				aQ: A2($elm$core$List$cons, x, s.aQ)
			});
	});
		...
		function (location) {
			return A2(
				...
				A2(
					...
					p,
					$stil4m$elm_syntax$Combine$modifyState(
						$stil4m$elm_syntax$Elm$Parser$State$pushColumn(location.ar))));
		});
};
					...
					function (s) {
						return $stil4m$elm_syntax$Combine$withLocation(
							function (l) {
								return _Utils_eq(
									$stil4m$elm_syntax$Elm$Parser$State$expectedColumn(s),
									l.ar) ? $stil4m$elm_syntax$Combine$choice(
									_List_fromArray(
										[
											A2(
											$stil4m$elm_syntax$Combine$map,
															...
															F3(
																function (condition, ifTrue, ifFalse) {
																	return A2(
																		$stil4m$elm_syntax$Elm$Syntax$Node$Node,
																		{
																			a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(ifFalse).a_,
																			be: current.be
																		},
										...
										F2(
											function (args, expr) {
												return A2(
													$stil4m$elm_syntax$Elm$Syntax$Node$Node,
													{
														a_: $stil4m$elm_syntax$Elm$Syntax$Node$range(expr).a_,
														be: current.be
													},
													$stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
...
var $stil4m$elm_syntax$Elm$Syntax$Infix$Infix = F4(
	function (direction, precedence, operator, _function) {
		return {dN: direction, dU: _function, ed: operator, eg: precedence};
	});
				...
				return A2(
					...
					$stil4m$elm_syntax$Elm$Syntax$Range$combine(
						_List_fromArray(
							[
								current,
								$stil4m$elm_syntax$Elm$Syntax$Node$range(inf.dU)
							])),
...
var $stil4m$elm_syntax$Elm$Syntax$Type$Type = F4(
	function (documentation, name, generics, constructors) {
		return {dK: constructors, b2: documentation, cV: generics, aV: name};
	});
var $stil4m$elm_syntax$Elm$Syntax$TypeAlias$TypeAlias = F4(
	function (documentation, name, generics, typeAnnotation) {
		return {b2: documentation, cV: generics, aV: name, dt: typeAnnotation};
	});
							...
							return A2(
								...
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
									_List_fromArray(
										[
											start,
											$stil4m$elm_syntax$Elm$Syntax$Node$range(typeAlias.dt)
										])),
								typeAlias);
						},
						A2(
...
var $stil4m$elm_syntax$Elm$Syntax$Import$Import = F3(
	function (moduleName, moduleAlias, exposingList) {
		return {b6: exposingList, d$: moduleAlias, bS: moduleName};
	});
			...
			return A2(
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								a_: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(end),
								be: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(start)
							});
					}),
				p);
		});
	...
	function (start, imp) {
		var allRanges = _List_fromArray(
			[
				...
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.b6),
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.d$)
			]);
		return A2(
			$stil4m$elm_syntax$Elm$Syntax$Node$Node,
			$stil4m$elm_syntax$Elm$Syntax$Range$combine(
	...
	var createEffectModule = F3(
		function (name, whereClauses, exp) {
			return $stil4m$elm_syntax$Elm$Syntax$Module$EffectModule(
				{dI: whereClauses.dI, b6: exp, bS: name, er: whereClauses.er});
		});
	return A2(
		$stil4m$elm_syntax$Combine$andMap,
		$stil4m$elm_syntax$Elm$Parser$Node$parser($stil4m$elm_syntax$Elm$Parser$Expose$exposeDefinition),
...
var $stil4m$elm_syntax$Elm$Syntax$Module$DefaultModuleData = F2(
	function (moduleName, exposingList) {
		return {b6: exposingList, bS: moduleName};
	});
	...
	function (range, comments, previousComments) {
		...
		while (true) {
			if (!comments.b) {
				...
				var _v1 = A2($elm$core$Basics$compare, commentRange.a_.aD + 1, range.be.aD);
				switch (_v1) {
					case 1:
			...
			return {
				cK: A2(
					...
					A2(
						...
						howToUpdate(doc)),
					file.cK),
				M: A2($elm$core$List$cons, previous, file.M),
				R: remaining
			};
		} else {
			return {
				cK: A2($elm$core$List$cons, declaration, file.cK),
				M: A2($elm$core$List$cons, previous, file.M),
				R: remaining
			};
		}
				...
				function (x) {
					return _Utils_Tuple2(
						...
						A2(
							...
							{
								dN: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
								dU: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'todo'),
								ed: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, x),
								eg: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
							},
			...
			return $elm$core$Dict$isEmpty(ops) ? fixExprs(exps) : A2(
				...
				A2(
					...
					function (_v0) {
						...
						return A4(
							$stil4m$elm_syntax$Elm$Syntax$Expression$OperatorApplication,
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.ed),
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.dN),
							A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
				...
				switch (expression.$) {
					...
					case 15:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LetExpression(
							{
								cK: A2($stil4m$elm_syntax$Elm$Processing$visitLetDeclarations, table, letBlock.cK),
...
var $stil4m$elm_syntax$Elm$Processing$attachDocumentationAndFixOperators = F3(
	function (table, declaration, context) {
		...
		switch (_v0.$) {
			...
			case 3:
				return {
					cK: A2($elm$core$List$cons, declaration, context.cK),
					M: context.M,
					R: context.R
				};
			case 4:
...
var $stil4m$elm_syntax$Elm$Processing$buildSingle = F2(
	function (moduleIndex, imp) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, imp.b6);
		if (_v0.$ === 1) {
			return _List_Nil;
		} else {
			if (!_v0.a.$) {
				...
				if (!_v2.$) {
					...
					return A2(
						...
						function (elem) {
							return A2(
								$elm$core$List$member,
								$stil4m$elm_syntax$Elm$Syntax$Node$value(elem.ed),
								importedOperators);
						},
...
var $stil4m$elm_syntax$Elm$RawFile$imports = function (_v0) {
	var file = _v0;
	return A2($elm$core$List$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, file.dW);
};
	...
	function (rawFile, _v0) {
		...
		return $elm$core$Dict$fromList(
			A2(
				...
				function (x) {
					return _Utils_Tuple2(
						$stil4m$elm_syntax$Elm$Syntax$Node$value(x.ed),
						x);
				},
				A2(
					$elm$core$List$concatMap,
...
var $stil4m$elm_syntax$Elm$Processing$process = F2(
	function (processContext, rawFile) {
		...
		var changes = A3(
			...
			{cK: _List_Nil, M: _List_Nil, R: file.dJ},
			file.cK);
		return {
			dJ: $elm$core$List$concat(
				$elm$core$List$reverse(
					A2($elm$core$List$cons, changes.R, changes.M))),
			cK: $elm$core$List$reverse(changes.cK),
			dW: file.dW,
			d0: file.d0
		};
	});
...
var $jfmengels$elm_review$Review$Project$precomputeModuleGraph = function (project) {
	...
	if (!_v0.$) {
		...
		var moduleGraph = $jfmengels$elm_review$Review$Project$Internal$buildModuleGraph(
			$elm$core$Dict$values(p.al));
		return _Utils_update(
			p,
			{
				bQ: $elm$core$Maybe$Just(moduleGraph)
			});
	}
};
	...
	function (path, _v0) {
		...
		return A2(
			...
			_Utils_update(
				project,
				{
					al: A2($elm$core$Dict$remove, path, project.al)
				}));
	});
...
var $jfmengels$elm_review$Review$Project$addReadme = F2(
	function (readme_, _v0) {
		...
		return _Utils_update(
			project,
			{
				cq: $elm$core$Maybe$Just(readme_)
			});
	});
...
var $elm$project_metadata_utils$Elm$Project$ApplicationInfo = F6(
	function (elm, dirs, depsDirect, depsIndirect, testDepsDirect, testDepsIndirect) {
		return {cN: depsDirect, cO: depsIndirect, cP: dirs, bC: elm, dq: testDepsDirect, dr: testDepsIndirect};
	});
...
var $elm$project_metadata_utils$Elm$Project$PackageInfo = F8(
	function (name, summary, license, version, exposed, deps, testDeps, elm) {
		return {cM: deps, bC: elm, cR: exposed, c4: license, aV: name, dm: summary, dp: testDeps, dw: version};
	});
...
var $jfmengels$elm_review$Review$Project$removeDependency = F2(
	function (dependencyName, _v0) {
		...
		return _Utils_update(
			project,
			{
				aI: A2($elm$core$Dict$remove, dependencyName, project.aI)
			});
	});
	...
	if (!project.$) {
		...
		return $elm$core$Set$fromList(
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Elm$Review$Main$getPackageName(application.cN),
						$author$project$Elm$Review$Main$getPackageName(application.cO),
		...
		return $elm$core$Set$fromList(
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Elm$Review$Main$getPackageName(packageInfo.cM),
	...
	function (file, project) {
		if (_Utils_eq(
			...
			return A2(
				...
				{aZ: file.en, ef: file.ef},
				project);
		} else {
			var _v0 = $jfmengels$elm_review$Review$Project$elmJson(project);
			if (!_v0.$) {
				var oldElmJson = _v0.a;
				if (_Utils_eq(file.ef, oldElmJson.ef)) {
					var _v1 = A2($elm$json$Json$Decode$decodeString, $elm$project_metadata_utils$Elm$Project$decoder, file.en);
					if (!_v1.$) {
						...
						return A3(
							...
							A2(
								...
								{ef: file.ef, g: newElmJson, a9: file.en},
								project),
							A2($author$project$Elm$Review$Main$removedDependencies, oldElmJson.g, newElmJson));
					} else {
						return project;
					}
				} else {
...
var $author$project$Elm$Review$Vendor$Serialize$build = F2(
	function (jsonEncoder, jsonDecoder) {
		return {_: jsonDecoder, aR: jsonEncoder};
	});
		...
		var jsonEnc = function (v) {
			return _Utils_Tuple2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$elm$json$Json$Encode$int(am.bm),
						v)));
		};
		var jsonDecoder_ = F2(
			function (tag, orElse) {
				return _Utils_eq(tag, am.bm) ? jsonDecoderPiece : A2(am._, tag, orElse);
			});
		return {
			bm: am.bm + 1,
			_: jsonDecoder_,
...
var $author$project$Elm$Review$Vendor$Serialize$record = function (ctor) {
	return {
		bI: 0,
		_: $elm$json$Json$Decode$succeed(
			$elm$core$Result$Ok(ctor)),
		aR: function (_v0) {
			return _List_Nil;
		}
					...
					$author$project$Elm$Review$Vendor$Serialize$record(
						F4(
							function (startRow, startColumn, endRow, endColumn) {
								return {
									a_: {ar: endColumn, aD: endRow},
									be: {ar: startColumn, aD: startRow}
								};
							})))))));
...
var $stil4m$elm_syntax$Elm$Syntax$Module$EffectModuleData = F4(
	function (moduleName, exposingList, command, subscription) {
		return {dI: command, b6: exposingList, bS: moduleName, er: subscription};
	});
...
var $author$project$Elm$Review$Main$cacheFileRequest = F2(
	function (project, source) {
		var _v0 = A2(
			...
			function (module_) {
				return _Utils_eq(module_.en, source);
			},
			$jfmengels$elm_review$Review$Project$modules(project));
		if (!_v0.$) {
			var ast = _v0.a.dB;
...
var $author$project$Elm$Review$File$decode = A4(
	...
	F3(
		function (path, source, ast) {
			return {dB: ast, ef: path, en: source};
		}),
...
var $elm$project_metadata_utils$Elm$Docs$Binop = F5(
	function (name, comment, tipe, associativity, precedence) {
		return {dA: associativity, aY: comment, aV: name, eg: precedence, cz: tipe};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Union = F4(
	function (name, comment, args, tags) {
		return {dz: args, aY: comment, aV: name, ev: tags};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Value = F3(
	function (name, comment, tipe) {
		return {aY: comment, aV: name, cz: tipe};
	});
...
var $author$project$Elm$Review$Main$elmJsonDecoder = A4(
	...
	F3(
		function (path, raw, project) {
			return {ef: path, g: project, a9: raw};
		}),
	A2($elm$json$Json$Decode$field, 'path', $elm$json$Json$Decode$string),
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'path',
				$author$project$Elm$Review$Main$encodeFilePath(changedFile.ef)),
				_Utils_Tuple2(
				'source',
				$elm$json$Json$Encode$string(source))
			]));
...
var $jfmengels$elm_review$Review$Fix$applyReplace = F3(
	function (range, replacement, lines) {
		var startLine = A2(
			...
			range.be.ar - 1,
			A2($jfmengels$elm_review$Review$Fix$getRowAtLine, lines, range.be.aD - 1));
		var linesBefore = A2($elm$core$List$take, range.be.aD - 1, lines);
		var linesAfter = A2($elm$core$List$drop, range.a_.aD, lines);
		var endLine = A2(
			$jfmengels$elm_review$Unicode$dropLeft,
			range.a_.ar - 1,
			A2($jfmengels$elm_review$Review$Fix$getRowAtLine, lines, range.a_.aD - 1));
		return $elm$core$List$concat(
			_List_fromArray(
				[
					linesBefore,
...
var $jfmengels$elm_review$Review$Fix$comparePosition = F2(
	function (a, b) {
		var _v0 = A2($elm$core$Basics$compare, a.aD, b.aD);
		if (_v0 === 1) {
			return A2($elm$core$Basics$compare, a.ar, b.ar);
		} else {
			var order = _v0;
			return order;
		}
...
var $jfmengels$elm_review$Review$Fix$collide = F2(
	function (a, b) {
		var _v0 = A2($jfmengels$elm_review$Review$Fix$comparePosition, a.a_, b.be);
		switch (_v0) {
			case 0:
				return false;
			case 1:
				return false;
			default:
				var _v1 = A2($jfmengels$elm_review$Review$Fix$comparePosition, b.a_, a.be);
				switch (_v1) {
					case 0:
						return false;
					case 1:
...
var $jfmengels$elm_review$Review$Fix$getFixRange = function (fix_) {
	switch (fix_.$) {
		...
		default:
			var position = fix_.a;
			return {a_: position, be: position};
	}
};
...
var $author$project$Elm$Review$Reporter$hashRange = function (range) {
	return A2(
		...
		A2(
			...
			$elm$core$String$fromInt,
			_List_fromArray(
				[range.be.aD, range.be.ar, range.a_.aD, range.a_.ar])));
};
var $author$project$Elm$Review$Reporter$hashFix = function (_v0) {
	var range = _v0.cp;
	var replacement = _v0.el;
...
var $jfmengels$elm_review$Review$Fix$toRecord = function (fix_) {
	switch (fix_.$) {
		case 1:
			var range = fix_.a;
			var replacement = fix_.b;
			return {cp: range, el: replacement};
		case 0:
			var range = fix_.a;
			return {cp: range, el: ''};
		default:
...
var $author$project$Elm$Review$Main$fixableFilesInProject = function (project) {
	var readme = A2(
		$elm$core$Maybe$withDefault,
		{ef: '$$Not a valid module name$$', en: ''},
		A2(
			$elm$core$Maybe$map,
			function (r) {
				return {ef: r.ef, en: r.aZ};
			},
			$jfmengels$elm_review$Review$Project$readme(project)));
	var moduleFiles = A2(
		$elm$core$List$map,
	...
	var elmJson = A2(
		...
		A2(
			$elm$core$Maybe$map,
			function (r) {
				return {ef: r.ef, en: r.a9};
			},
			$jfmengels$elm_review$Review$Project$elmJson(project)));
	return $elm$core$Dict$fromList(
		A2(
			$elm$core$List$cons,
			_Utils_Tuple2(elmJson.ef, elmJson),
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(readme.ef, readme),
				moduleFiles)));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Elm$Review$Reporter$diff, file.en, fixedSource)
							])),
						_List_fromArray(
						[
							$author$project$Elm$Review$Text$from('\n')
...
var $author$project$Elm$Review$Main$fromReviewError = F2(
	function (links, error) {
		return {
			bA: $jfmengels$elm_review$Review$Rule$errorDetails(error),
			cT: A2(
				$elm$core$Maybe$map,
				$author$project$Elm$Review$Reporter$hashFixes,
				$jfmengels$elm_review$Review$Rule$errorFixes(error)),
			aq: $jfmengels$elm_review$Review$Rule$errorMessage(error),
			cp: $jfmengels$elm_review$Review$Rule$errorRange(error),
			dd: A2($author$project$Elm$Review$Main$linkToRule, links, error),
			cs: $jfmengels$elm_review$Review$Rule$errorRuleName(error)
		};
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'path',
					$author$project$Elm$Review$Main$encodeFilePath(file.ef)),
					_Utils_Tuple2(
					'errors',
					A2(
						$elm$json$Json$Encode$list,
						A3($author$project$Elm$Review$Main$encodeError, links, detailsMode, file.en),
						file.aw))
				]));
	});
...
var $author$project$Elm$Review$Main$groupErrorsByFile = F2(
	function (project, errors) {
		var files = $elm$core$List$concat(
			_List_fromArray(
				[
					...
					$elm$core$List$map,
					function (file) {
						return {ef: file.ef, en: file.en};
					},
					$jfmengels$elm_review$Review$Project$modules(project)),
					_List_fromArray(
					[
						{ef: 'GLOBAL ERROR', en: ''},
						{ef: 'CONFIGURATION ERROR', en: ''}
					]),
					function () {
					var _v0 = $jfmengels$elm_review$Review$Project$elmJson(project);
					if (!_v0.$) {
		...
		return A2(
			$elm$core$List$filter,
			function (file) {
				return !$elm$core$List$isEmpty(file.aw);
			},
			A2(
				$elm$core$List$map,
				function (file) {
					return {
						aw: A2(
							...
							errors),
						ef: (file.ef === 'GLOBAL ERROR') ? $author$project$Elm$Review$Reporter$Global : ((file.ef === 'CONFIGURATION ERROR') ? $author$project$Elm$Review$Reporter$ConfigurationError : $author$project$Elm$Review$Reporter$FilePath(file.ef)),
						en: file.en
					};
				},
				files));
...
var $author$project$Elm$Review$Main$makeReport = F2(
	function (failedFixesDict, model) {
		var errorsByFile = A2($author$project$Elm$Review$Main$groupErrorsByFile, model.g, model.bc);
		return _Utils_Tuple2(
			model,
						...
						[
							...
							function () {
								...
								if (!_v0) {
											...
											A2(
												...
												function (file) {
													return {
														aw: A2(
															$elm$core$List$map,
															$author$project$Elm$Review$Main$fromReviewError(model.aS),
															file.aw),
														ef: file.ef,
														en: file.en
													};
									...
									return A2(
										$elm$json$Json$Encode$list,
										A2($author$project$Elm$Review$Main$encodeErrorByFile, model.aS, model.au),
										errorsByFile);
								}
							}())
						]))));
...
var $author$project$Elm$Review$Main$fixOneByOne = function (model) {
	var _v0 = A4(
		...
		$elm$core$Dict$empty,
		model.ba,
		$author$project$Elm$Review$Main$fixableFilesInProject(model.g),
		model.bc).b;
	if (!_v0.$) {
		var file = _v0.a.b8;
		var error = _v0.a.b4;
		var fixedSource = _v0.a.az;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					av: $author$project$Elm$Review$Main$AwaitingError(error)
				}),
						...
						[
							...
							$author$project$Elm$Review$Main$encodeReport(
								A5(
									...
									model.au,
									{
										ef: $author$project$Elm$Review$Reporter$FilePath(file.ef),
										en: file.en
									},
									A2($author$project$Elm$Review$Main$fromReviewError, model.aS, error),
									fixedSource))),
							_Utils_Tuple2(
							'changedFiles',
							A2(
...
var $author$project$Elm$Review$Main$refuseError = F2(
	function (error, model) {
		return _Utils_update(
			model,
			{
				ba: A2($author$project$Elm$Review$RefusedErrorFixes$insert, error, model.ba)
			});
	});
	...
	function (path, error, remainingErrors, model) {
		var errorsForFile = A2(
			...
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, path, model.ay)));
		return _Utils_update(
			model,
			{
				ay: A3($elm$core$Dict$insert, path, errorsForFile, model.ay),
				ap: A2($author$project$Elm$Review$Progress$fixWasApplied, remainingErrors, model.ap)
			});
	});
	...
	function (oldProject, newProject) {
		...
		if (!_v0.$) {
			...
			if (_Utils_eq(oldElmJson, newElmJson)) {
				...
				var _v2 = _Utils_Tuple2(oldElmJson.g, newElmJson.g);
				_v2$2:
				while (true) {
					if (!_v2.a.$) {
						if (!_v2.b.$) {
							...
							return A2(
								...
								_List_fromArray(
									[
										_Utils_eq(
										$elm$core$Set$fromList(oldApp.cP),
										$elm$core$Set$fromList(newApp.cP)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(0),
										_Utils_eq(
	...
	function (visitedModules, projectModules) {
		...
		while (true) {
			if (!projectModules.b) {
				...
				if (_v1.$ === 1) {
					var $temp$visitedModules = A3($elm$core$Dict$insert, moduleName, projectModule.ef, visitedModules),
...
var $jfmengels$elm_review$Review$Rule$elmReviewGlobalError = function (_v0) {
	...
	var details = _v0.bA;
	return $jfmengels$elm_review$Review$Rule$SpecifiedError(
		{bA: details, b9: 'GLOBAL ERROR', cb: $elm$core$Maybe$Nothing, aq: message, cp: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, cs: '', $7: 3});
};
...
var $jfmengels$elm_review$Review$Rule$duplicateModulesGlobalError = function (duplicate) {
	var paths = $elm$core$String$concat(
		A2(
			...
			$elm$core$List$sort(duplicate.c8)));
	return $jfmengels$elm_review$Review$Rule$errorToReviewError(
		$jfmengels$elm_review$Review$Rule$elmReviewGlobalError(
			{
				bA: _List_fromArray(
					[
						'I found several modules with the name `' + (A2($elm$core$String$join, '.', duplicate.bS) + '`. Depending on how I choose to resolve this, I might give you different reports. Since this is a compiler error anyway, I require this problem to be solved. Please fix this then try running `elm-review` again.'),
				...
				aq: 'Found several modules named `' + (A2($elm$core$String$join, '.', duplicate.bS) + '`')
			}));
};
...
var $jfmengels$elm_review$Review$Rule$parsingError = function (rawFile) {
	return {
		...
		b9: rawFile.ef,
		cb: $elm$core$Maybe$Nothing,
		aq: rawFile.ef + ' is not a correct Elm module',
		cp: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange,
		cs: 'ParsingError',
		$7: 0
	};
...
var $jfmengels$elm_review$Vendor$IntDict$determineBranchRelation = F2(
	function (l, r) {
		...
		var mask = $jfmengels$elm_review$Vendor$IntDict$highestBitSet(
			A2($jfmengels$elm_review$Vendor$IntDict$mostSignificantBranchingBit, lp.aX, rp.aX));
		var modifiedRightPrefix = A3($jfmengels$elm_review$Vendor$IntDict$combineBits, rp.am, ~lp.am, mask);
		var prefix = A2($jfmengels$elm_review$Vendor$IntDict$lcp, lp.am, modifiedRightPrefix);
		var childEdge = F2(
			function (branchPrefix, c) {
				return A2($jfmengels$elm_review$Vendor$IntDict$isBranchingBitSet, branchPrefix, c.l.am) ? 1 : 0;
			});
	...
	function (l, r) {
		...
		while (true) {
			...
			while (true) {
					...
					switch (_v0.a.$) {
						...
						default:
							switch (_v0.b.$) {
								...
								case 1:
									var lr = _v0.b.a;
									var _v3 = A2($jfmengels$elm_review$Vendor$IntDict$get, lr.bp, l);
									if (!_v3.$) {
										var v = _v3.a;
										return A2($jfmengels$elm_review$Vendor$IntDict$leaf, lr.bp, v);
									} else {
										return $jfmengels$elm_review$Vendor$IntDict$Empty;
									}
								default:
									...
									switch (_v4.$) {
										case 0:
											return A3(
												...
												A2($jfmengels$elm_review$Vendor$IntDict$intersect, il.j, ir.j));
										case 1:
											if (!_v4.a) {
												if (_v4.b === 1) {
													var _v5 = _v4.a;
				...
				var ll = _v0.a.a;
				return A2($jfmengels$elm_review$Vendor$IntDict$member, ll.bp, r) ? l : $jfmengels$elm_review$Vendor$IntDict$Empty;
			}
			var _v2 = _v0.b;
			return $jfmengels$elm_review$Vendor$IntDict$Empty;
		}
		...
		while (true) {
			switch (dict.$) {
				...
				default:
					var i = dict.a;
					var $temp$f = f,
						$temp$acc = A3($jfmengels$elm_review$Vendor$IntDict$foldl, f, acc, i.i),
						$temp$dict = i.j;
					f = $temp$f;
					acc = $temp$acc;
					dict = $temp$dict;
		...
		var updateIncomingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						cZ: A3($jfmengels$elm_review$Vendor$IntDict$update, nodeId, upd, node.cZ)
					});
			});
		var flippedFoldl = F3(
			function (f, dict, acc) {
...
var $jfmengels$elm_review$Vendor$Graph$emptyDiff = {cZ: $jfmengels$elm_review$Vendor$IntDict$empty, m: $jfmengels$elm_review$Vendor$IntDict$empty};
	...
	function (old, _new) {
		...
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				...
				var ins = _v0.b.a;
				return {
					cZ: A3(collect, $jfmengels$elm_review$Vendor$Graph$Insert, ins.m, $jfmengels$elm_review$Vendor$IntDict$empty),
					m: A3(collect, $jfmengels$elm_review$Vendor$Graph$Insert, ins.cZ, $jfmengels$elm_review$Vendor$IntDict$empty)
				};
			}
		} else {
			if (_v0.b.$ === 1) {
				...
				var _v3 = _v0.b;
				return {
					cZ: A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.m, $jfmengels$elm_review$Vendor$IntDict$empty),
					m: A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.cZ, $jfmengels$elm_review$Vendor$IntDict$empty)
				};
			} else {
				var rem = _v0.a.a;
				var ins = _v0.b.a;
				return _Utils_eq(rem, ins) ? $jfmengels$elm_review$Vendor$Graph$emptyDiff : {
					...
					m: A3(
						...
						$jfmengels$elm_review$Vendor$Graph$Insert,
						ins.cZ,
						A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.cZ, $jfmengels$elm_review$Vendor$IntDict$empty))
				};
			}
		}
	});
		...
		var wrappedUpdater = function (rep) {
			...
			var filterInvalidEdges = function (ctx) {
				return $jfmengels$elm_review$Vendor$IntDict$filter(
					F2(
						function (id, _v0) {
							return _Utils_eq(id, ctx.c6.bJ) || A2($jfmengels$elm_review$Vendor$IntDict$member, id, rep);
						}));
			};
			var cleanUpEdges = function (ctx) {
				return _Utils_update(
					ctx,
					{
						cZ: A2(filterInvalidEdges, ctx, ctx.cZ),
...
var $jfmengels$elm_review$Vendor$Graph$alongIncomingEdges = function (ctx) {
	return $jfmengels$elm_review$Vendor$IntDict$keys(ctx.cZ);
};
...
var $jfmengels$elm_review$Review$Rule$reachedTarget = F2(
	function (targetNode, path) {
		...
		if (!_v0.$) {
			var node = _v0.a;
			return _Utils_eq(node.c6.bJ, targetNode);
		} else {
			return false;
		}
	});
	...
	function (targetNode, path, distance, acc) {
		if ($elm$core$List$isEmpty(acc)) {
			if (!distance) {
				...
				if (!_v0.$) {
					var head = _v0.a;
					return A2($jfmengels$elm_review$Vendor$IntDict$member, head.c6.bJ, head.cZ) ? _List_fromArray(
						[head.c6]) : acc;
				} else {
					return acc;
				}
		...
		while (true) {
			if (!nodesToVisit.b) {
				...
				var cycle = A5(
					...
					$jfmengels$elm_review$Review$Rule$visitorDiscoverCycle(startingNode.bJ),
					_List_fromArray(
						[startingNode.bJ]),
					_List_Nil,
					graph).a;
...
var $jfmengels$elm_review$Review$Rule$findCycle = F2(
	function (graph, edge) {
		var initialCycle = A5(
			$jfmengels$elm_review$Vendor$Graph$guidedBfs,
			$jfmengels$elm_review$Vendor$Graph$alongIncomingEdges,
			$jfmengels$elm_review$Review$Rule$visitorDiscoverCycle(edge.ew),
			_List_fromArray(
				[edge.dT]),
			_List_Nil,
			graph).a;
					...
					$jfmengels$elm_review$Review$Rule$elmReviewGlobalError(
						{
							...
							aq: 'Your module imports form a cycle'
						})))
			]);
	});
...
var $jfmengels$elm_review$Review$Rule$needsToComputeScope = function (rules) {
	return A2(
		$elm$core$List$any,
		function (_v0) {
			var requestedData = _v0.S;
			var _v1 = requestedData;
			var requestedData_ = _v1;
			return requestedData_.ak;
		},
		rules);
};
var $jfmengels$elm_review$Review$Rule$runRules = F3(
	function (rules, project, nodeContexts) {
		return A3(
			...
			F2(
				function (_v0, _v1) {
					var exceptions = _v0.ax;
					var ruleImplementation = _v0.aE;
					var errors = _v1.a;
...
var $jfmengels$elm_review$Review$Rule$scope_foldProjectContexts = F2(
	function (newContext, previousContext) {
		return {
			...
			al: A2($elm$core$Dict$union, previousContext.al, newContext.al)
		};
	});
...
var $jfmengels$elm_review$Review$Rule$createFakeImport = function (_v0) {
	var moduleName = _v0.bS;
	var moduleAlias = _v0.d$;
	var exposingList = _v0.b6;
	return {
		b6: A2(
			$elm$core$Maybe$map,
		...
		d$: A2(
			...
			A2(
				...
				$stil4m$elm_syntax$Elm$Syntax$Node$Node($stil4m$elm_syntax$Elm$Syntax$Range$emptyRange)),
			moduleAlias),
		bS: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, moduleName)
	};
};
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				b6: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aV: 'List', ec: $elm$core$Maybe$Nothing}),
							$stil4m$elm_syntax$Elm$Syntax$Exposing$InfixExpose('::')
						])),
				d$: $elm$core$Maybe$Nothing,
				bS: _List_fromArray(
				...
				b6: explicit(
					_List_fromArray(
						[
							...
							{
								aV: 'Maybe',
								ec: $elm$core$Maybe$Just($stil4m$elm_syntax$Elm$Syntax$Range$emptyRange)
							})
						])),
				d$: $elm$core$Maybe$Nothing,
				bS: _List_fromArray(
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				b6: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aV: 'String', ec: $elm$core$Maybe$Nothing})
						])),
				d$: $elm$core$Maybe$Nothing,
				bS: _List_fromArray(
					['String'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				b6: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aV: 'Char', ec: $elm$core$Maybe$Nothing})
						])),
				d$: $elm$core$Maybe$Nothing,
				bS: _List_fromArray(
					['Char'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				b6: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aV: 'Program', ec: $elm$core$Maybe$Nothing})
						])),
				d$: $elm$core$Maybe$Nothing,
				bS: _List_fromArray(
					['Platform'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				b6: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aV: 'Cmd', ec: $elm$core$Maybe$Nothing})
						])),
				d$: $elm$core$Maybe$Just('Cmd'),
				bS: _List_fromArray(
					['Platform', 'Cmd'])
			}),
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				b6: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aV: 'Sub', ec: $elm$core$Maybe$Nothing})
						])),
				d$: $elm$core$Maybe$Just('Sub'),
				bS: _List_fromArray(
					['Platform', 'Sub'])
			})
		]);
...
var $jfmengels$elm_review$Review$Rule$registerImportAlias = F2(
	function (import_, innerContext) {
		var _v0 = import_.d$;
		if (_v0.$ === 1) {
			var moduleName = $stil4m$elm_syntax$Elm$Syntax$Node$value(import_.bS);
					...
					aA: A3(
						...
						function (previousValue) {
							return $elm$core$Maybe$Just(
								A2(
									$elm$core$List$cons,
									$stil4m$elm_syntax$Elm$Syntax$Node$value(import_.bS),
									A2($elm$core$Maybe$withDefault, _List_Nil, previousValue)));
						},
						innerContext.aA)
				});
		...
		switch (_v0.$) {
			...
			case 2:
				...
				return A2(
					$elm$core$List$any,
					function (alias) {
						return _Utils_eq(alias.aV, name);
					},
					module_.cB) ? _List_fromArray(
					[name]) : _List_Nil;
			default:
				var name = _v0.a.aV;
				var open = _v0.a.ec;
					...
					return A2(
						...
						A2(
							...
							A2(
								$elm$core$List$filter,
								function (union) {
									return _Utils_eq(union.aV, name);
								},
								module_.du)));
				} else {
					return _List_Nil;
...
var $jfmengels$elm_review$Review$Rule$registerImportExposed = F2(
	function (import_, innerContext) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, import_.b6);
		if (_v0.$ === 1) {
			return innerContext;
		} else {
			var exposing_ = _v0.a;
			...
			var module_ = A2(
				$elm$core$Maybe$withDefault,
				{
					...
					cF: _List_Nil,
					aY: '',
					aV: $jfmengels$elm_review$Review$Rule$joinModuleName(moduleName),
					du: _List_Nil,
					dv: _List_Nil
				},
				function () {
					...
					if (!_v4.$) {
						...
						return A2($elm$core$Dict$get, moduleName, innerContext.al);
					}
				}());
			if (!exposing_.$) {
					...
					$elm$core$List$concat(
						_List_fromArray(
							[
								...
								module_.du),
								A2($elm$core$List$map, nameWithModuleName, module_.dv),
								A2($elm$core$List$map, nameWithModuleName, module_.cB),
								A2($elm$core$List$map, nameWithModuleName, module_.cF)
							])));
				var exposedTypes = $elm$core$Dict$fromList(
					A2(
						$elm$core$List$append,
						A2($elm$core$List$map, nameWithModuleName, module_.du),
						A2($elm$core$List$map, nameWithModuleName, module_.cB)));
				return _Utils_update(
					innerContext,
					{
						aO: A2($elm$core$Dict$union, exposedValues, innerContext.aO),
						aP: A2($elm$core$Dict$union, innerContext.aP, exposedTypes)
					});
			} else {
		...
		return $jfmengels$elm_review$Review$Rule$registerPrelude(
			{
				...
				o: $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$empty,
				al: projectContext.al,
				r: $jfmengels$elm_review$Review$Rule$nonemptyList_fromElement($jfmengels$elm_review$Review$Rule$emptyScope)
			});
	});
var $jfmengels$elm_review$Review$Rule$scope_initialProjectContext = {O: $elm$core$Dict$empty, aU: $elm$core$Dict$empty, al: $elm$core$Dict$empty};
		...
		var dependenciesModules = $elm$core$Dict$fromList(
			A2(
				...
				function (dependencyModule) {
					return _Utils_Tuple2(dependencyModule.aV, dependencyModule);
				},
				A2(
					$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
					$jfmengels$elm_review$Review$Project$Dependency$modules,
		...
		switch (_v0.$) {
			case 15:
				return _Utils_update(
					context,
					{
						r: $jfmengels$elm_review$Review$Rule$nonemptyList_pop(context.r)
					});
			case 16:
				return _Utils_update(
					context,
...
var $jfmengels$elm_review$Review$Rule$moduleNameForValue = F3(
	function (context, valueName, moduleName) {
		if (!moduleName.b) {
			return A2($jfmengels$elm_review$Review$Rule$isInScope, valueName, context.r) ? _List_Nil : A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, valueName, context.aO));
		} else {
			if (!moduleName.b.b) {
				var moduleNameOrAlias = moduleName.a;
				var _v1 = A2($elm$core$Dict$get, moduleNameOrAlias, context.aA);
				if (!_v1.$) {
					if (_v1.a.b && (!_v1.a.b.b)) {
						...
						var _v3 = A2(
							...
							function (aliasedModuleName) {
								var _v4 = A2($elm$core$Dict$get, aliasedModuleName, context.al);
								if (!_v4.$) {
									var module_ = _v4.a;
...
var $jfmengels$elm_review$Review$Rule$moduleNameForType = F3(
	function (context, typeName, moduleName) {
		if (!moduleName.b) {
			return A2($elm$core$Set$member, typeName, context.aT) ? _List_Nil : A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, typeName, context.aP));
		} else {
			if (!moduleName.b.b) {
				var _v1 = A2(
					$elm$core$Dict$get,
		...
		switch (_v0.$) {
			case 0:
				...
				var newScope = _Utils_update(
					...
					{
						aW: $jfmengels$elm_review$Review$Rule$parameters(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dM).cC)
					});
				var newContext = A2(
					$jfmengels$elm_review$Review$Rule$updateScope,
					context,
					A2($jfmengels$elm_review$Review$Rule$nonemptyList_cons, newScope, context.r));
			...
			case 3:
				var signature = _v0.a;
				var moduleNamesFromSignature = A2($jfmengels$elm_review$Review$Rule$collectModuleNamesFromTypeAnnotation, context, signature.dt);
				var lookupTable = A2($jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$addMultiple, moduleNamesFromSignature, context.o);
				return _Utils_update(
					context,
					{o: lookupTable});
			default:
		...
		return A2(
			...
			function (scope) {
				return _Utils_update(
					scope,
					{
						aW: A3($elm$core$Dict$insert, name, variableInfo, scope.aW)
					});
			},
			scopes);
	});
var $jfmengels$elm_review$Review$Rule$addToScope = F2(
	function (variableData, innerContext) {
		var newScopes = A3(
			...
			variableData,
			$stil4m$elm_syntax$Elm$Syntax$Node$value(variableData.c6),
			innerContext.r);
		return _Utils_update(
			innerContext,
			{r: newScopes});
			...
			innerContext,
			{
				bh: A2(
					$elm$core$List$cons,
					{
						...
						aY: '',
						aV: name,
						cz: $elm$project_metadata_utils$Elm$Type$Tuple(_List_Nil)
					},
					innerContext.bh)
			});
	});
	...
	function (innerContext, maybeSignature) {
		if (!maybeSignature.$) {
			...
			return A2(
				...
				innerContext,
				$stil4m$elm_syntax$Elm$Syntax$Node$value(signature).dt);
		} else {
			return $elm$project_metadata_utils$Elm$Type$Tuple(_List_Nil);
		}
	});
			...
			innerContext,
			{
				bj: A2(
					$elm$core$List$cons,
					{
						...
						aV: name,
						cz: A2($jfmengels$elm_review$Review$Rule$convertTypeSignatureToDocsType, innerContext, _function.em)
					},
					innerContext.bj)
			});
	});
var $jfmengels$elm_review$Review$Rule$registerIfExposed = F3(
	function (registerFn, name, innerContext) {
		return (innerContext.bF || A2($elm$core$Dict$member, name, innerContext.bE)) ? A2(registerFn, name, innerContext) : innerContext;
	});
var $jfmengels$elm_review$Review$Rule$scope_registerDeclaration = F2(
	function (declaration, innerContext) {
		...
		switch (_v0.$) {
			case 0:
				var _function = _v0.a;
				var nameNode = $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dM).aV;
				return A3(
			...
			case 1:
				...
				return A3(
					...
					$stil4m$elm_syntax$Elm$Syntax$Node$value(alias.aV),
					function (ctx) {
						var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(alias.dt);
						if (_v1.$ === 4) {
							return A2(
								$jfmengels$elm_review$Review$Rule$addToScope,
								{c6: alias.aV, aG: 0},
					...
					A3(
						...
						F2(
							function (constructor, innerContext_) {
								var constructorName = $stil4m$elm_syntax$Elm$Syntax$Node$value(constructor).aV;
								return A2(
									$jfmengels$elm_review$Review$Rule$addToScope,
									{c6: constructorName, aG: 1},
									innerContext_);
							}),
						_Utils_update(
							innerContext,
			...
			case 3:
				...
				return A3(
					...
					$stil4m$elm_syntax$Elm$Syntax$Node$value(signature.aV),
					A2(
						$jfmengels$elm_review$Review$Rule$addToScope,
						{c6: signature.aV, aG: 5},
						innerContext));
			case 4:
				return innerContext;
			default:
			...
			case 15:
				...
				var newContext = A2(
					...
					A3(
						...
						A2($jfmengels$elm_review$Review$Rule$nonemptyList_cons, $jfmengels$elm_review$Review$Rule$emptyScope, context.r),
						declarations));
				var moduleNames = A2(
					$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
					function (declaration) {
				...
				return _Utils_update(
					newContext,
					{
						o: A2($jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$addMultiple, moduleNames, newContext.o)
					});
			case 16:
				var caseBlock = _v0.a;
				var moduleNames = A2(
				...
				return _Utils_update(
					context,
					{
						o: A2($jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$addMultiple, moduleNames, context.o),
						r: A2(
							$jfmengels$elm_review$Review$Rule$nonemptyList_mapHead,
							function (scope) {
								return _Utils_update(
...
var $stil4m$elm_syntax$Elm$Syntax$Module$exposingList = function (m) {
	switch (m.$) {
		case 0:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.b6);
		case 1:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.b6);
		default:
	...
	function (node, innerContext) {
		...
		if (!_v0.$) {
			...
			return _Utils_update(
				innerContext,
				{
					bE: $jfmengels$elm_review$Review$Rule$exposedElements(list)
				});
		}
	});
...
var $jfmengels$elm_review$Review$Rule$scope_popScopeEnter = F2(
	function (node, context) {
		var currentScope = $jfmengels$elm_review$Review$Rule$nonemptyList_head(context.r);
...
var $jfmengels$elm_review$Review$Rule$scope_popScopeExit = F2(
	function (node, context) {
		var currentScope = $jfmengels$elm_review$Review$Rule$nonemptyList_head(context.r);
		return _Utils_eq(node, currentScope.bz) ? _Utils_update(
			context,
			{
				r: $jfmengels$elm_review$Review$Rule$nonemptyList_pop(context.r)
			}) : context;
...
var $jfmengels$elm_review$Review$Rule$withExpressionExitVisitor = F2(
	function (visitor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				G: A2($elm$core$List$cons, visitor, schema.G)
			});
	});
...
var $jfmengels$elm_review$Review$Rule$withDataExtractor = F2(
	function (dataExtractor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				at: $elm$core$Maybe$Just(dataExtractor)
			});
	});
		...
		return _Utils_update(
			schema,
			{
				aM: $elm$core$Maybe$Just(
					{
						ao: functions.ao,
						aN: $jfmengels$elm_review$Review$Rule$withMetadata(
							$jfmengels$elm_review$Review$Rule$withModuleKey(
								$jfmengels$elm_review$Review$Rule$initContextCreator(
									F3(
				...
				L: $elm$core$Maybe$Just(moduleContextCreator)
			});
	});
var $jfmengels$elm_review$Review$Rule$scopeRule = $jfmengels$elm_review$Review$Rule$fromProjectRuleSchemaToRunnableProjectVisitor(
	A2(
		...
		function (projectContext) {
			return projectContext.aU;
		},
		A2(
			$jfmengels$elm_review$Review$Rule$withModuleContext,
			{ao: $jfmengels$elm_review$Review$Rule$scope_foldProjectContexts, aN: $jfmengels$elm_review$Review$Rule$scope_fromModuleToProject, cd: $jfmengels$elm_review$Review$Rule$scope_fromProjectToModule},
			A2(
				$jfmengels$elm_review$Review$Rule$withModuleVisitor,
	...
	function (project, rules, maybeProjectData, nodeContexts) {
		...
		var scopeResult = function () {
			if ($jfmengels$elm_review$Review$Rule$needsToComputeScope(rules)) {
				...
				return {
					a$: extract,
					bv: $elm$core$Maybe$Just(cache)
				};
			} else {
				return {a$: $elm$core$Maybe$Nothing, bv: $elm$core$Maybe$Nothing};
			}
		}();
		...
		var projectWithLookupTables = _Utils_update(
			p,
			{d1: moduleNameLookupTables});
		var _v0 = A3($jfmengels$elm_review$Review$Rule$runRules, rules, projectWithLookupTables, nodeContexts);
		var errors = _v0.a;
		var newRules = _v0.b;
		return {
			aw: A2($elm$core$List$map, $jfmengels$elm_review$Review$Rule$errorToReviewError, errors),
			bv: scopeResult.bv,
			bw: newRules
		};
	});
var $jfmengels$elm_review$Review$Rule$reviewV2 = F3(
	function (rules, maybeProjectData, project) {
		...
		if (!_v0.$) {
			...
			var errors = _v0.a;
			return {aw: errors, bv: maybeProjectData, bw: rules};
		}
	});
var $author$project$Elm$Review$Main$runReview = function (model) {
	var _v0 = A3($jfmengels$elm_review$Review$Rule$reviewV2, model.bw, model.bv, model.g);
	var errors = _v0.aw;
	var rules = _v0.bw;
	var projectData = _v0.bv;
	return _Utils_update(
		model,
		{av: $author$project$Elm$Review$Main$NotAwaiting, bv: projectData, bc: errors, bw: rules});
};
	...
	function (failedFixesDict, model) {
		...
		while (true) {
			...
			if (!_v0.b.$) {
				...
				var file = _v0.b.a.b8;
				var error = _v0.b.a.b4;
				var fixedSource = _v0.b.a.az;
				var remainingErrors = _v0.b.a.db;
				var newProject = A2(
				...
				if (_Utils_cmp(
					...
					$elm$core$List$length(
						$jfmengels$elm_review$Review$Project$modulesThatFailedToParse(model.g))) > 0) {
					return $elm$core$Maybe$Nothing;
				} else {
					if (!$elm$core$List$isEmpty(
						A2($author$project$Elm$Review$Main$changesToElm, model.g, newProject))) {
						return $elm$core$Maybe$Just(
							{
								b7: newFailedFixesDict,
								cn: A4(
				...
				var _v1 = _v0.b;
				return $elm$core$Maybe$Just(
					{b7: newFailedFixesDict, cn: model});
			}
		}
	});
	...
	function (before, after) {
		...
		var afterReadme = function () {
			...
			if (!_v6.$) {
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(readme.ef, readme.aZ)
					]);
			} else {
				return _List_Nil;
			}
		...
		var afterElmJson = function () {
			...
			if (!_v5.$) {
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(elmJson.ef, elmJson.a9)
					]);
			} else {
				return _List_Nil;
			}
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
						...
						$elm$core$List$map,
						function (mod) {
							return _Utils_Tuple2(mod.ef, mod.en);
						},
		...
		return A6(
			...
			F4(
				function (_v2, beforeModule, fixedSource, acc) {
					return (!_Utils_eq(beforeModule.en, fixedSource)) ? A2(
						$elm$core$List$cons,
						{az: fixedSource, ef: beforeModule.ef, en: beforeModule.en},
						acc) : acc;
				}),
			F3(
		...
		_List_fromArray(
			[
				...
				[
					...
					$author$project$Elm$Review$Text$from(
						A3(
							...
							80,
							'-',
							' ' + $author$project$Elm$Review$Reporter$filePath(file.ef))))
				]),
				A2(
				$elm$core$List$cons,
				...
				A2(
					...
					$elm$core$List$reverse(file.aw))),
				A2($author$project$Elm$Review$Reporter$diff, file.en, file.az)
			]));
};
...
var $author$project$Elm$Review$Main$fixAll = function (model) {
	...
	if (!_v0.$) {
		var failedFixesDict = _v0.a.b7;
		var newModel = _v0.a.cn;
		var _v1 = A2($author$project$Elm$Review$Main$diff, model.g, newModel.g);
		if (!_v1.b) {
			...
			var changedFiles = A2(
				...
				function (_v2) {
					var path = _v2.ef;
					var source = _v2.en;
					var fixedSource = _v2.az;
					return {
						aw: A2(
							$elm$core$Maybe$withDefault,
							_List_Nil,
							A2($elm$core$Dict$get, path, newModel.ay)),
						az: fixedSource,
						ef: (path === 'GLOBAL ERROR') ? $author$project$Elm$Review$Reporter$Global : $author$project$Elm$Review$Reporter$FilePath(path),
						en: source
					};
				},
				diffs);
			...
			return _Utils_Tuple2(
				_Utils_update(
					newModel,
					{av: $author$project$Elm$Review$Main$AwaitingFixAll, ca: newModel.g, g: model.g}),
				$author$project$Elm$Review$Main$askConfirmationToFix(
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
		...
		default:
			...
			return _Utils_Tuple2(
				_Utils_update(
					newModel,
					{
						ap: $author$project$Elm$Review$Progress$reset(newModel.ap)
					}),
				cmd);
	}
};
	...
	function (msg, model) {
		switch (msg.$) {
								...
								$elm$json$Json$Encode$object(
									_List_fromArray(
										[
											_Utils_Tuple2(
											'path',
											$elm$json$Json$Encode$string(rawFile.ef)),
											_Utils_Tuple2(
											'cacheRequest',
											A2($author$project$Elm$Review$Main$cacheFileRequest, project, rawFile.en))
										]))));
					} else {
						var ast = _v2.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									g: A2(
										...
										{dB: ast, ef: rawFile.ef, en: rawFile.en},
										model.g)
								}),
							$author$project$Elm$Review$Main$acknowledgeFileReceipt(
								$elm$json$Json$Encode$object(
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A2($jfmengels$elm_review$Review$Project$removeModule, path, model.g)
						}),
				...
				if (!_v3.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								g: A2($jfmengels$elm_review$Review$Project$addElmJson, elmJson, model.g)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
				...
				if (!_v4.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								g: A2($jfmengels$elm_review$Review$Project$addReadme, readme, model.g)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 4:
				...
				var dependenciesDecoder = model.a2 ? A2(
					$elm$json$Json$Decode$map,
						...
						_Utils_update(
							model,
							{
								g: A3(
									...
									$jfmengels$elm_review$Review$Project$removeDependencies(model.g),
									dependencies)
							}),
						$elm$core$Platform$Cmd$none);
				}
				...
				return $author$project$Elm$Review$Main$reportOrFix(
					$author$project$Elm$Review$Main$runReview(
						_Utils_update(
							...
							{
								ay: $elm$core$Dict$empty,
								g: $jfmengels$elm_review$Review$Project$precomputeModuleGraph(model.g)
							})));
			case 7:
				...
				if (!_v7.$) {
					if (!_v7.a.$) {
						...
						var newProject = A3($elm$core$List$foldl, $author$project$Elm$Review$Main$addUpdatedFileToProject, model.g, rawFiles);
						return (_Utils_cmp(
							$elm$core$List$length(
								$jfmengels$elm_review$Review$Project$modulesThatFailedToParse(newProject)),
							$elm$core$List$length(
								$jfmengels$elm_review$Review$Project$modulesThatFailedToParse(model.g))) > 0) ? _Utils_Tuple2(
							model,
							$author$project$Elm$Review$Main$abort(
								'One file among ' + (A2(
									$elm$core$String$join,
							...
							$author$project$Elm$Review$Main$reportOrFix(
								$author$project$Elm$Review$Main$runReview(
									_Utils_update(
										model,
										{bD: true, ay: $elm$core$Dict$empty, g: newProject}))));
					} else {
						var _v8 = _v7.a;
						var _v9 = model.av;
						switch (_v9.$) {
			...
			default:
				return _Utils_Tuple2(
					...
					$author$project$Elm$Review$Main$fixConfirmationStatus(
						!_Utils_eq(model.av, $author$project$Elm$Review$Main$NotAwaiting)));
		}
	});
var $elm$core$Platform$worker = _Platform_worker;
var $author$project$Elm$Review$Main$main = $elm$core$Platform$worker(
	{
		dY: $author$project$Elm$Review$Main$init,
		es: function (_v0) {
			return $author$project$Elm$Review$Main$subscriptions;
		},
		ey: $author$project$Elm$Review$Main$update
	});
