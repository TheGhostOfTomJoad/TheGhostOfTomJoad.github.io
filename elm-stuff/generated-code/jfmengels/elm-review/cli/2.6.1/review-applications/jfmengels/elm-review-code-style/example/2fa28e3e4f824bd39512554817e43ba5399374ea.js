...
{
	if (region.aY.a9 === region.aJ.a9)
	{
		return 'on line ' + region.aY.a9;
	}
	return 'on lines ' + region.aY.a9 + ' through ' + region.aJ.a9;
}
...
var $jfmengels$elm_review$Review$Rule$error = F2(
	function (_v0, range) {
		...
		return $jfmengels$elm_review$Review$Rule$UnspecifiedError(
			{bi: details, bW: '', bY: $elm$core$Maybe$Nothing, aa: message, b8: range, cb: '', c7: 0});
	});
...
var $jfmengels$elm_review_code_style$NoSimpleLetBody$expressionVisitor = function (node) {
	var _v0 = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
	if (_v0.$ === 15) {
		var declarations = _v0.a.ct;
		var expression = _v0.a.bo;
		var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(expression);
		if ((_v1.$ === 3) && (!_v1.a.b)) {
			var name = _v1.b;
			var declarationData = A3(
				$elm$core$List$foldl,
				F2(
					function (declaration, _v4) {
						var lastEnd = _v4.bu;
						var foundDeclaredWithName = _v4.a4;
						var _v5 = $stil4m$elm_syntax$Elm$Syntax$Node$value(declaration);
						if (!_v5.$) {
							var _function = _v5.a;
							var functionDeclaration = $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dv);
							return {
								a4: foundDeclaredWithName || _Utils_eq(
									$stil4m$elm_syntax$Elm$Syntax$Node$value(functionDeclaration.aE),
									name),
								bt: $elm$core$List$isEmpty(functionDeclaration.cl) ? $elm$core$Maybe$Just(
									{
										dw: $stil4m$elm_syntax$Elm$Syntax$Node$range(declaration),
										a2: $stil4m$elm_syntax$Elm$Syntax$Node$range(functionDeclaration.bo),
										aE: $stil4m$elm_syntax$Elm$Syntax$Node$value(functionDeclaration.aE)
									}) : $elm$core$Maybe$Nothing,
								bu: $elm$core$Maybe$Just(
									$stil4m$elm_syntax$Elm$Syntax$Node$range(functionDeclaration.bo).aJ),
								bF: lastEnd
							};
						} else {
							return {
								a4: foundDeclaredWithName,
								bt: $elm$core$Maybe$Nothing,
								bu: $elm$core$Maybe$Just(
									$stil4m$elm_syntax$Elm$Syntax$Node$range(declaration).aJ),
								bF: lastEnd
							};
						}
					}),
				{a4: false, bt: $elm$core$Maybe$Nothing, bu: $elm$core$Maybe$Nothing, bF: $elm$core$Maybe$Nothing},
				declarations);
			return declarationData.a4 ? _List_fromArray(
				[
					A3(
					$jfmengels$elm_review$Review$Rule$errorWithFix,
					{
						...
						aa: 'The referenced value should be inlined.'
					},
					$stil4m$elm_syntax$Elm$Syntax$Node$range(expression),
					function () {
						var _v2 = declarationData.bt;
						if (!_v2.$) {
							var last = _v2.a;
							if (_Utils_eq(last.aE, name)) {
								var _v3 = declarationData.bF;
								if (_v3.$ === 1) {
									return _List_fromArray(
										[
											...
											{
												aJ: last.a2.aY,
												aY: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).aY
											}),
											$jfmengels$elm_review$Review$Fix$removeRange(
											{
												aJ: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).aJ,
												aY: last.a2.aJ
											})
										]);
								} else {
									var previousEnd = _v3.a;
									var indentation = A2(
										$elm$core$String$repeat,
										$stil4m$elm_syntax$Elm$Syntax$Node$range(node).aY.ab - 1,
										' ');
									return _List_fromArray(
										[
											A2(
											$jfmengels$elm_review$Review$Fix$replaceRangeBy,
											{aJ: last.a2.aY, aY: previousEnd},
											'\n' + (indentation + ('in\n' + indentation))),
											$jfmengels$elm_review$Review$Fix$removeRange(
											{
												aJ: $stil4m$elm_syntax$Elm$Syntax$Node$range(node).aJ,
...
var $jfmengels$elm_review$Review$Rule$functionToExpression = function (_function) {
	return $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dv).bo;
};
			...
			if (!nodesToVisit.b) {
				...
				switch (_v1.$) {
					...
					case 4:
						...
						continue expressionChildrenTCO;
					case 15:
						var expression = _v1.a.bo;
						var declarations = _v1.a.ct;
						var $temp$nodesToVisit = A2(
							$elm$core$List$append,
							A2(
								$elm$core$List$map,
	...
	function (declarationVisitorsOnEnter, declarationVisitorsOnExit, expressionVisitor, node, errorsAndContext) {
		...
		if (!_v0.$) {
			...
			return A3(
				...
				A2(
					expressionVisitor,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dv).bo,
					A3($jfmengels$elm_review$Review$Rule$visitWithListOfVisitors, declarationVisitorsOnEnter, node, errorsAndContext)));
		} else {
...
var $jfmengels$elm_review$Review$Rule$fromModuleRuleSchemaToRunnableModuleVisitor = function (_v0) {
	...
	return {
		Q: $elm$core$List$reverse(schema.Q),
		bN: $jfmengels$elm_review$Review$Rule$createDeclarationAndExpressionVisitor(schema),
		S: $elm$core$List$reverse(schema.S),
		...
		if (_v0.a.$ === 1) {
			...
			if (_v0.b) {
				...
				var dummyAvailableData = {
					bp: $elm$core$Basics$always('dummy'),
					by: $jfmengels$elm_review$Review$Rule$createMetadata(
						{
							b2: true,
							bD: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, _List_Nil)
						}),
					bB: 'dummy',
					V: $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$empty
				};
				...
				var emptyModuleVisitor = {
					...
					m: _List_Nil,
					T: _List_Nil,
					a7: $elm$core$Maybe$Just(initialModuleContext),
					O: _List_Nil,
					P: _List_Nil,
...
var $jfmengels$elm_review$Review$Rule$fromProjectRuleSchemaToRunnableProjectVisitor = function (_v0) {
	...
	return {
		...
		m: $elm$core$List$reverse(schema.m),
		al: schema.al,
		b4: A3($jfmengels$elm_review$Review$Rule$mergeModuleVisitors, schema.al, schema.z, schema.aQ),
		...
		G: function () {
			...
			if (!_v1.$) {
				...
				return {V: false, aX: false};
			}
		}(),
		ap: function () {
			var _v3 = _Utils_Tuple2(schema.bg, schema.av);
			if (!_v3.a) {
				var _v4 = _v3.a;
...
var $stil4m$elm_syntax$Elm$Syntax$Module$moduleName = function (m) {
	switch (m.$) {
		case 0:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.bC);
		case 1:
			var x = m.a;
			return $stil4m$elm_syntax$Elm$Syntax$Node$value(x.bC);
		default:
...
var $jfmengels$elm_review$Review$Rule$getModuleName = function (module_) {
	return $stil4m$elm_syntax$Elm$Syntax$Module$moduleName(
		$stil4m$elm_syntax$Elm$Syntax$Node$value(module_.dk.dM));
};
...
var $jfmengels$elm_review$Vendor$IntDict$prefixMatches = F2(
	function (p, n) {
		return _Utils_eq(
			n & $jfmengels$elm_review$Vendor$IntDict$higherBitMask(p.aG),
			p.X);
	});
	...
	function (key, dict) {
		...
		while (true) {
			switch (dict.$) {
				...
				case 1:
					var l = dict.a;
					return _Utils_eq(l.a8, key) ? $elm$core$Maybe$Just(l.bJ) : $elm$core$Maybe$Nothing;
				default:
					var i = dict.a;
...
var $jfmengels$elm_review$Review$Rule$computeModuleAndCacheResult = F6(
	function (traversalAndFolder, modules, graph, computeModule, _v0, _v1) {
		...
		var _v2 = A2($elm$core$Dict$get, node.b3, modules);
		if (_v2.$ === 1) {
						...
						function (key) {
							return A2(
								...
								function (nodeContext) {
									return A2($elm$core$Dict$get, nodeContext.cR.b3, modules);
								},
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					A2($elm$core$String$slice, 0, range.aJ.ab - 1),
					A2(
						$elm$core$List$take,
						(range.aJ.an - range.aY.an) + 1,
						A2($elm$core$List$drop, range.aY.an - 1, lines)))));
	});
...
var $jfmengels$elm_review$Vendor$Graph$NodeContext = F3(
	function (node, incoming, outgoing) {
		return {cI: incoming, cR: node, h: outgoing};
	});
				...
				return $jfmengels$elm_review$Vendor$IntDict$Inner(
					{
						...
						g: p,
						e: r,
						cd: $jfmengels$elm_review$Vendor$IntDict$size(l) + $jfmengels$elm_review$Vendor$IntDict$size(r)
					});
			}
		}
	});
var $jfmengels$elm_review$Vendor$IntDict$lcp = F2(
	function (x, y) {
		...
		return {aG: branchingBit, X: prefixBits};
	});
			...
			function (edge, rep) {
				var updateOutgoing = function (ctx) {
					return _Utils_update(
						ctx,
						{
							h: A3($jfmengels$elm_review$Vendor$IntDict$insert, edge.eg, edge.b3, ctx.h)
						});
				};
				var updateIncoming = function (ctx) {
					return _Utils_update(
						ctx,
						{
							cI: A3($jfmengels$elm_review$Vendor$IntDict$insert, edge.dD, edge.b3, ctx.cI)
						});
				};
				return A3(
					$jfmengels$elm_review$Vendor$IntDict$update,
...
var $jfmengels$elm_review$Vendor$Graph$Edge = F3(
	function (from, to, label) {
		return {dD: from, b3: label, eg: to};
	});
var $jfmengels$elm_review$Vendor$Graph$Node = F2(
	function (id, label) {
		return {br: id, b3: label};
	});
...
var $jfmengels$elm_review$Review$Project$Internal$moduleGraph = function (_v0) {
	...
	if (!_v1.$) {
		...
		return $jfmengels$elm_review$Review$Project$Internal$buildModuleGraph(
			$elm$core$Dict$values(project.W));
	}
};
...
var $jfmengels$elm_review$Review$Project$modules = function (_v0) {
	var project = _v0;
	return $elm$core$Dict$values(project.W);
};
		...
		var computeModule = F3(
			function (cache, importedModules, module_) {
				...
				var metadata = $jfmengels$elm_review$Review$Rule$createMetadata(
					{
						b2: module_.b2,
						bD: $jfmengels$elm_review$Review$Rule$moduleNameNode(module_.dk.dM)
					});
				var availableData = {
					bp: function () {
						var _v4 = projectVisitor.G;
						var requestedData = _v4;
						return requestedData.aX ? $jfmengels$elm_review$Review$Rule$extractSourceCode(
				...
				var initialModuleContext = function () {
					...
					if (!_v3.$) {
						...
						var foldProjectContexts = _v3.a.Z;
				...
				return {
					f: function () {
						...
						if (!_v2.$) {
							var fromModuleToProject = _v2.a.aw;
	...
	function (projectVisitor, project, maybePreviousCache) {
		...
		var elmJsonCacheEntry = function () {
			var computeElmJson = function (_v9) {
				var _v8 = A3(
					...
					projectVisitor.u,
					elmJsonData,
					_Utils_Tuple2(_List_Nil, projectVisitor.al));
				var errorsForVisitor = _v8.a;
				var contextForVisitor = _v8.b;
				return {f: contextForVisitor, ag: errorsForVisitor, bJ: projectElmJson};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return _Utils_eq(previousCache.bQ.bJ, projectElmJson) ? previousCache.bQ : computeElmJson(0);
			} else {
		...
		var readmeCacheEntry = function () {
			var computeReadme = function (_v6) {
				...
				return {f: contextForVisitor, ag: errorsForVisitor, bJ: readmeData};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return (_Utils_eq(previousCache.bQ.f, elmJsonCacheEntry.f) && _Utils_eq(previousCache.b9.bJ, readmeData)) ? previousCache.b9 : computeReadme(0);
			} else {
		...
		var _v0 = function () {
			...
			var computeDependencies = function (_v3) {
				...
				return {f: contextForVisitor, ag: errorsForVisitor, bJ: dependencies};
			};
			if (!maybePreviousCache.$) {
				var previousCache = maybePreviousCache.a;
				return (_Utils_eq(previousCache.b9.f, readmeCacheEntry.f) && _Utils_eq(previousCache.ar.bJ, dependencies)) ? _Utils_Tuple2(previousCache.ar, false) : _Utils_Tuple2(
		...
		return _Utils_Tuple2(
			{ar: dependenciesCacheEntry, bQ: elmJsonCacheEntry, a3: _List_Nil, ba: $elm$core$Dict$empty, b9: readmeCacheEntry},
			hasAnythingChanged);
	});
	...
	function (projectVisitor, initialContext, contextsPerModule) {
		if ($elm$core$List$isEmpty(projectVisitor.m)) {
			...
			var finalContext = function () {
				...
				if (!_v0.$) {
					var foldProjectContexts = _v0.a.Z;
...
var $jfmengels$elm_review$Review$Rule$runProjectVisitor = F6(
	function (name, projectVisitor, maybePreviousCache, exceptions, project, nodeContexts) {
		...
		var initialContext = cacheWithInitialContext.ar.f;
		...
		var contextsAndErrorsPerModule = A2(
			$elm$core$List$map,
			function (cacheEntry) {
				return _Utils_Tuple2(cacheEntry.ag, cacheEntry.f);
			},
		...
		var newCache = {ar: cacheWithInitialContext.ar, bQ: cacheWithInitialContext.bQ, a3: errorsFromFinalEvaluation, ba: newCachedModuleContexts, b9: cacheWithInitialContext.b9};
		var errors = A3(
			$jfmengels$elm_review$Review$Exceptions$apply,
			exceptions,
			A2(
		...
		return {
			...
			ag: A2(
				...
				errors),
			aK: function () {
				var _v1 = projectVisitor.ad;
				if (!_v1.$) {
					var dataExtractor = _v1.a;
					var contextToAnalyze = function () {
						var _v2 = $jfmengels$elm_review$Review$Rule$getFolderFromTraversal(projectVisitor.ap);
						if (!_v2.$) {
							var foldProjectContexts = _v2.a.Z;
				...
				ao: F3(
					function (newExceptions, newProject, newNodeContexts) {
						var result = A6(
							...
							newProject,
							newNodeContexts);
						return _Utils_Tuple2(result.ag, result.ca);
					})
			}
		};
	});
...
var $jfmengels$elm_review_code_style$NoSimpleLetBody$rule = $jfmengels$elm_review$Review$Rule$fromModuleRuleSchema(
	A2(
		...
		A2($jfmengels$elm_review$Review$Rule$newModuleRuleSchema, 'NoSimpleLetBody', 0)));
...
var $author$project$Elm$Review$Main$DecodedFlags = F8(
	function (fixMode, detailsMode, reportMode, ignoreProblematicDependencies, rulesFilter, ignoredDirs, ignoredFiles, logger) {
		return {ae: detailsMode, aL: fixMode, aN: ignoreProblematicDependencies, b$: ignoredDirs, b0: ignoredFiles, _: logger, aV: reportMode, cc: rulesFilter};
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'start',
				$author$project$Elm$Review$Main$encodePosition(range.aY)),
				_Utils_Tuple2(
				'end',
				$author$project$Elm$Review$Main$encodePosition(range.aJ))
			]));
};
...
var $author$project$Elm$Review$Text$from = function (value) {
	return {dq: $elm$core$Maybe$Nothing, dF: $elm$core$Maybe$Nothing, d9: value};
};
					...
					A2(
						...
						_List_fromArray(
							[
								...
								gutterLength,
								{aJ: end.ab, bv: lineContent, aY: start.ab}),
				...
				A2(
					...
					_List_fromArray(
						[
							...
							gutterLength,
							{
								aJ: $elm$core$List$length(
									$elm$core$String$toList(startLineContent)) + 1,
								bv: startLineContentWithLineNumber,
								aY: start.ab
							}),
							A2(
							$author$project$Elm$Review$Text$join,
							...
							{
								aJ: end.ab,
								bv: endLineContentWithLineNumber,
								aY: $author$project$Elm$Review$Reporter$getIndexOfFirstNonSpace(endLineContent) + 1
							}),
	...
	function (fixProblemDict, mode, error) {
		...
		return _List_fromArray(
			[
				...
				error.cY,
				$author$project$Elm$Review$Text$inRed(
					$author$project$Elm$Review$Text$from(error.cb))),
				$author$project$Elm$Review$Text$from(': ' + error.aa)
			]);
	});
			...
			if (!detailsMode) {
				return A2(
					...
					A2(
						$elm$core$List$intersperse,
						$author$project$Elm$Review$Text$from('\n\n'),
						A2($elm$core$List$map, $author$project$Elm$Review$Text$from, error.bi)));
			} else {
				return _List_Nil;
			}
		}();
		var codeExtract_ = function () {
			var _v0 = A2($author$project$Elm$Review$Reporter$codeExtract, source, error.b8);
			if (!_v0.b) {
				return _List_Nil;
			} else {
	...
	function (previousTexts, lastText, chunks) {
		...
		while (true) {
			if (!chunks.b) {
				...
				if (_Utils_eq(lastText.dq, newLastText.dq) && _Utils_eq(lastText.dF, newLastText.dF)) {
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'rule',
					$elm$json$Json$Encode$string(error.cb)),
					_Utils_Tuple2(
					'message',
					$elm$json$Json$Encode$string(error.aa)),
					_Utils_Tuple2(
					'details',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, error.bi)),
					_Utils_Tuple2(
					'region',
...
var $author$project$Elm$Review$Reporter$fixableErrors = function (files) {
	return A2(
		...
		A2(
			...
			$elm$core$List$filter(
				function (error) {
					return !_Utils_eq(error.cC, $elm$core$Maybe$Nothing);
				})),
		files);
};
...
var $author$project$Elm$Review$Reporter$compareRange = F2(
	function (a, b) {
		return (_Utils_cmp(a.aY.an, b.aY.an) < 0) ? 0 : ((_Utils_cmp(a.aY.an, b.aY.an) > 0) ? 2 : ((_Utils_cmp(a.aY.ab, b.aY.ab) < 0) ? 0 : ((_Utils_cmp(a.aY.ab, b.aY.ab) > 0) ? 2 : ((_Utils_cmp(a.aJ.an, b.aJ.an) < 0) ? 0 : ((_Utils_cmp(a.aJ.an, b.aJ.an) > 0) ? 2 : ((_Utils_cmp(a.aJ.ab, b.aJ.ab) < 0) ? 0 : ((_Utils_cmp(a.aJ.ab, b.aJ.ab) > 0) ? 2 : 1)))))));
	});
var $author$project$Elm$Review$Reporter$compareErrorPositions = F2(
	function (a, b) {
		return A2($author$project$Elm$Review$Reporter$compareRange, a.b8, b.b8);
	});
	...
	function (isFirstError, filePath_, range) {
		var position = function () {
			switch (filePath_.$) {
				case 0:
					var str = filePath_.a;
					return ' ' + (str + (':' + ($elm$core$String$fromInt(range.aY.an) + (':' + $elm$core$String$fromInt(range.aY.ab)))));
				case 1:
					return ' GLOBAL ERROR';
				default:
						...
						return A2(
							...
							_List_fromArray(
								[
									_List_fromArray(
									[
										A3($author$project$Elm$Review$Reporter$header, !index, file.d$, error.b8)
									]),
									A5($author$project$Elm$Review$Reporter$formatErrorWithExtract, fixProblemDict, detailsMode, mode, file.d7, error)
								]));
					}),
				A2($elm$core$List$sortWith, $author$project$Elm$Review$Reporter$compareErrorPositions, file.ag)));
	});
...
var $author$project$Elm$Review$Main$getConfigurationError = function (rule) {
	...
	if (!_v0.$) {
		...
		return $elm$core$Maybe$Just(
			{
				bi: configurationError.bi,
				cC: $elm$core$Maybe$Nothing,
				aa: configurationError.aa,
				b8: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange,
				cY: $elm$core$Maybe$Nothing,
				cb: $jfmengels$elm_review$Review$Rule$ruleName(rule)
			});
	} else {
		return $elm$core$Maybe$Nothing;
	}
...
var $author$project$Elm$Review$Main$unknownRulesFilterMessage = function (_v0) {
	var ruleNames = _v0.cZ;
	var filterNames = _v0.cB;
	var unknownRulesMessage = A2(
		...
		A2(
			...
			filterNames));
	return {aa: 'You requested to only run several rules, but I could not find some of them.\n\n' + unknownRulesMessage, bf: 'UNKNOWN FILTERED RULE(S)'};
};
var $author$project$Elm$Review$Main$init = function (flags) {
	var _v0 = function () {
		...
		if (!_v1.$) {
			...
			var error = _v1.a;
			return _Utils_Tuple2(
				{ae: 1, aL: 0, aN: false, b$: _List_Nil, b0: _List_Nil, _: $author$project$Elm$Review$Progress$dummy, aV: 0, cc: $elm$core$Maybe$Nothing},
				$author$project$Elm$Review$Main$abort(
					'Problem decoding the flags when running the elm-review runner:\n  ' + $elm$json$Json$Decode$errorToString(error)));
		}
	}();
	var fixMode = _v0.a.aL;
	var reportMode = _v0.a.aV;
	var detailsMode = _v0.a.ae;
	var ignoreProblematicDependencies = _v0.a.aN;
	var rulesFilter = _v0.a.cc;
	var ignoredDirs = _v0.a.b$;
	var ignoredFiles = _v0.a.b0;
	var logger = _v0.a._;
	var cmd = _v0.b;
	var _v2 = function () {
		if (!rulesFilter.$) {
	...
	return _Utils_Tuple2(
		{
			ae: detailsMode,
			af: $author$project$Elm$Review$Main$NotAwaiting,
			bl: false,
			ai: $elm$core$Dict$empty,
			bX: $jfmengels$elm_review$Review$Project$new,
			aL: fixMode,
			aN: ignoreProblematicDependencies,
			aB: $elm$core$Dict$empty,
			_: logger,
			c: $jfmengels$elm_review$Review$Project$new,
			bd: $elm$core$Maybe$Nothing,
			aU: $author$project$Elm$Review$RefusedErrorFixes$empty,
			aV: reportMode,
			aW: _List_Nil,
			be: A2(
				$elm$core$List$map,
								...
								if (!reportMode) {
									return $author$project$Elm$Review$Main$encodeReport(
										A4(
											...
											_List_fromArray(
												[
													{ag: configurationErrors, d$: $author$project$Elm$Review$Reporter$ConfigurationError, d7: ''}
												])));
								} else {
...
var $jfmengels$elm_review$Review$Project$addElmJson = F2(
	function (elmJson_, _v0) {
		...
		var modules_ = _Utils_eq(project.ce, sourceDirectories) ? project.W : A2(
			$elm$core$Dict$map,
			F2(
				function (_v1, value) {
		...
		return _Utils_update(
			project,
			{
				bQ: $elm$core$Maybe$Just(elmJson_),
				W: modules_,
				ce: sourceDirectories
			});
	});
...
var $jfmengels$elm_review$Review$Project$sanitizeModule = function (module_) {
	return _Utils_update(
		module_,
		{
			dk: $jfmengels$elm_review$Review$Project$reorderComments(module_.dk)
		});
};
...
var $stil4m$elm_syntax$Elm$Processing$addDependency = F2(
	function (dep, _v0) {
		var x = _v0;
		return A2($elm$core$Dict$union, dep.b1, x);
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$emptyState = {ds: _List_Nil, az: _List_Nil};
var $stil4m$elm_syntax$Elm$Syntax$File$File = F4(
	function (moduleDefinition, imports, declarations, comments) {
		return {ds: comments, ct: declarations, dG: imports, dM: moduleDefinition};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$getComments = function (_v0) {
	var s = _v0;
	return $elm$core$List$reverse(s.ds);
};
...
var $stil4m$elm_syntax$Elm$Syntax$Range$compareLocations = F2(
	function (left, right) {
		return (_Utils_cmp(left.an, right.an) < 0) ? 0 : ((_Utils_cmp(left.an, right.an) > 0) ? 2 : A2($elm$core$Basics$compare, left.ab, right.ab));
	});
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$LetBlock = F2(
	function (declarations, expression) {
		return {ct: declarations, bo: expression};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cr: col, du: contextStack, cU: problem, an: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.an, s.cr, x, s.f));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.an, s.cr, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cr: newCol, f: s.f, i: s.i, b: newOffset, an: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{cr: 1, f: s.f, i: s.i, b: s.b + 1, an: s.an + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{cr: s.cr + 1, f: s.f, i: s.i, b: newOffset, an: s.an, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cr: col, f: s0.f, i: s0.i, b: offset, an: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.an, s.cr, s);
	};
};
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								aJ: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(end),
								aY: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(start)
							});
					}),
				A2(
					$stil4m$elm_syntax$Combine$andMap,
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cr: col, f: context, i: indent, b: offset, an: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.cJ, s.b + 1, s.an + 1, 1, s.a, s.i, s.f) : A7($elm$parser$Parser$Advanced$varHelp, i.cJ, firstOffset, s.an, s.cr + 1, s.a, s.i, s.f);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{cz: $elm$parser$Parser$ExpectingVariable, cJ: i.cJ, cX: i.cX, aY: i.aY});
};
	...
	$elm$parser$Parser$variable(
		{
			...
			aY: $miniBill$elm_unicode$Unicode$isLower
		}));
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.an, s.cr, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.an, s.cr, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $stil4m$elm_syntax$Elm$Parser$State$addComment = F2(
	function (pair, _v0) {
		...
		return _Utils_update(
			s,
			{
				ds: A2($elm$core$List$cons, pair, s.ds)
			});
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {cr: s.cr + (newOffset - s.b), f: s.f, i: s.i, b: newOffset, an: s.an, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.an, s.cr - (floatOffset + s.b), invalid, s.f));
		} else {
...
var $elm$parser$Parser$number = function (i) {
	return $elm$parser$Parser$Advanced$number(
		{
			cn: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingBinary, i.cn),
			cz: $elm$parser$Parser$ExpectingNumber,
			cD: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.cD),
			cH: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.cH),
			cK: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.cK),
		...
		return $elm$parser$Parser$number(
			{
				...
				cH: $elm$core$Maybe$Just(hexf),
				cK: $elm$core$Maybe$Just(intf),
	...
	$elm$parser$Parser$variable(
		{
			...
			cX: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			aY: $miniBill$elm_unicode$Unicode$isUpper
		}));
				...
				if (!_v0.$) {
					...
					return A2(
						...
						function (_v3) {
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dv).aE),
						A2(
							$elm$core$Maybe$map,
							function (_v1) {
								var value = _v1.b;
...
var $stil4m$elm_syntax$Elm$Syntax$Signature$Signature = F2(
	function (name, typeAnnotation) {
		return {aE: name, dc: typeAnnotation};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$popIndent = function (_v0) {
	...
	return _Utils_update(
		s,
		{
			az: A2($elm$core$List$drop, 1, s.az)
		});
};
var $stil4m$elm_syntax$Elm$Parser$State$pushIndent = F2(
	function (x, _v0) {
		...
		return _Utils_update(
			s,
			{
				az: A2($elm$core$List$cons, x, s.az)
			});
	});
					...
					function (s) {
						return $stil4m$elm_syntax$Combine$withLocation(
							function (l) {
								return _Utils_eq(
									$stil4m$elm_syntax$Elm$Parser$State$expectedColumn(s),
									l.ab) ? $stil4m$elm_syntax$Combine$choice(
									_List_fromArray(
										[
											A2(
											$stil4m$elm_syntax$Combine$map,
															...
															F3(
																function (condition, ifTrue, ifFalse) {
																	return A2(
																		$stil4m$elm_syntax$Elm$Syntax$Node$Node,
																		{
																			aJ: $stil4m$elm_syntax$Elm$Syntax$Node$range(ifFalse).aJ,
																			aY: current.aY
																		},
										...
										F2(
											function (args, expr) {
												return A2(
													$stil4m$elm_syntax$Elm$Syntax$Node$Node,
													{
														aJ: $stil4m$elm_syntax$Elm$Syntax$Node$range(expr).aJ,
														aY: current.aY
													},
...
var $stil4m$elm_syntax$Elm$Syntax$Type$Type = F4(
	function (documentation, name, generics, constructors) {
		return {dt: constructors, bP: documentation, cE: generics, aE: name};
	});
var $stil4m$elm_syntax$Elm$Syntax$TypeAlias$TypeAlias = F4(
	function (documentation, name, generics, typeAnnotation) {
		return {bP: documentation, cE: generics, aE: name, dc: typeAnnotation};
	});
...
var $stil4m$elm_syntax$Elm$Syntax$Import$Import = F3(
	function (moduleName, moduleAlias, exposingList) {
		return {bT: exposingList, dL: moduleAlias, bC: moduleName};
	});
			...
			return A2(
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								aJ: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(end),
								aY: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(start)
							});
					}),
				p);
		});
	...
	function (start, imp) {
		var allRanges = _List_fromArray(
			[
				...
				$elm$core$Maybe$Just(
				$stil4m$elm_syntax$Elm$Syntax$Node$range(imp.bC)),
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.bT),
	...
	var createEffectModule = F3(
		function (name, whereClauses, exp) {
			return $stil4m$elm_syntax$Elm$Syntax$Module$EffectModule(
				{dr: whereClauses.dr, bT: exp, bC: name, eb: whereClauses.eb});
		});
	return A2(
		$stil4m$elm_syntax$Combine$andMap,
		$stil4m$elm_syntax$Elm$Parser$Node$parser($stil4m$elm_syntax$Elm$Parser$Expose$exposeDefinition),
...
var $stil4m$elm_syntax$Elm$Syntax$Module$DefaultModuleData = F2(
	function (moduleName, exposingList) {
		return {bT: exposingList, bC: moduleName};
	});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cr: col, cU: problem, an: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.an, p.cr, p.cU);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cr: 1, f: _List_Nil, i: 1, b: 0, an: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (range, comments, previousComments) {
		...
		while (true) {
			if (!comments.b) {
				...
				var _v1 = A2($elm$core$Basics$compare, commentRange.aJ.an + 1, range.aY.an);
				switch (_v1) {
					case 1:
...
var $stil4m$elm_syntax$Elm$Processing$addDocumentation = F3(
	function (howToUpdate, declaration, file) {
		...
		if (!maybeDoc.$) {
			...
			return {
				ct: A2($elm$core$List$cons, declaration, file.ct),
				A: A2($elm$core$List$cons, previous, file.A),
				F: remaining
			};
		}
				...
				switch (expression.$) {
					...
					case 15:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LetExpression(
							{
								ct: A2($stil4m$elm_syntax$Elm$Processing$visitLetDeclarations, table, letBlock.ct),
								bo: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, letBlock.bo)
							});
					case 16:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$CaseExpression(
							{
								$7: A2(
									...
									$elm$core$Tuple$mapSecond(
										$stil4m$elm_syntax$Elm$Processing$visitExpression(table)),
									caseBlock.$7),
								bo: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, caseBlock.bo)
							});
					case 17:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
							_Utils_update(
								lambda,
								{
									bo: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, lambda.bo)
								}));
					case 18:
...
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDecl = F2(
	function (table, _function) {
		...
		return _Utils_update(
			_function,
			{dv: newFunctionDeclaration});
	});
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDeclaration = F2(
	function (table, functionDeclaration) {
		var newExpression = A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, functionDeclaration.bo);
		return _Utils_update(
			functionDeclaration,
			{bo: newExpression});
	});
...
var $stil4m$elm_syntax$Elm$Processing$attachDocumentationAndFixOperators = F3(
	function (table, declaration, context) {
		...
		switch (_v0.$) {
			...
			case 3:
				return {
					ct: A2($elm$core$List$cons, declaration, context.ct),
					A: context.A,
					F: context.F
				};
			case 4:
...
var $stil4m$elm_syntax$Elm$Processing$buildSingle = F2(
	function (moduleIndex, imp) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, imp.bT);
		if (_v0.$ === 1) {
			return _List_Nil;
		} else {
			if (!_v0.a.$) {
				var _v1 = A2(
					$elm$core$Dict$get,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(imp.bC),
					moduleIndex);
				if (!_v1.$) {
					var module_ = _v1.a;
...
var $stil4m$elm_syntax$Elm$Processing$process = F2(
	function (processContext, rawFile) {
		...
		var changes = A3(
			...
			{ct: _List_Nil, A: _List_Nil, F: file.ds},
			file.ct);
		return {
			ds: $elm$core$List$concat(
				$elm$core$List$reverse(
					A2($elm$core$List$cons, changes.F, changes.A))),
			ct: $elm$core$List$reverse(changes.ct),
			dG: file.dG,
			dM: file.dM
		};
	});
...
var $jfmengels$elm_review$Review$Project$precomputeModuleGraph = function (project) {
	...
	if (!_v0.$) {
		...
		var moduleGraph = $jfmengels$elm_review$Review$Project$Internal$buildModuleGraph(
			$elm$core$Dict$values(p.W));
		return _Utils_update(
			p,
			{
				bA: $elm$core$Maybe$Just(moduleGraph)
			});
	}
};
	...
	function (path, _v0) {
		...
		return A2(
			...
			_Utils_update(
				project,
				{
					W: A2($elm$core$Dict$remove, path, project.W)
				}));
	});
...
var $jfmengels$elm_review$Review$Project$addReadme = F2(
	function (readme_, _v0) {
		...
		return _Utils_update(
			project,
			{
				b9: $elm$core$Maybe$Just(readme_)
			});
	});
...
var $elm$project_metadata_utils$Elm$Project$ApplicationInfo = F6(
	function (elm, dirs, depsDirect, depsIndirect, testDepsDirect, testDepsIndirect) {
		return {cw: depsDirect, cx: depsIndirect, cy: dirs, bk: elm, c9: testDepsDirect, da: testDepsIndirect};
	});
...
var $elm$project_metadata_utils$Elm$Project$PackageInfo = F8(
	function (name, summary, license, version, exposed, deps, testDeps, elm) {
		return {cv: deps, bk: elm, cA: exposed, cP: license, aE: name, c5: summary, c8: testDeps, df: version};
	});
	...
	if (!project.$) {
		...
		return $elm$core$Set$fromList(
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Elm$Review$Main$getPackageName(application.cw),
		...
		return $elm$core$Set$fromList(
			$elm$core$List$concat(
				_List_fromArray(
					[
						$author$project$Elm$Review$Main$getPackageName(packageInfo.cv),
						$author$project$Elm$Review$Main$getPackageName(packageInfo.c8)
					])));
	}
};
					...
					if (!_v1.$) {
						...
						return A3(
							...
							A2(
								...
								{d$: file.d$, c: newElmJson, aT: file.d7},
								project),
...
var $author$project$Elm$Review$Vendor$Serialize$build = F2(
	function (jsonEncoder, jsonDecoder) {
		return {N: jsonDecoder, aA: jsonEncoder};
	});
		...
		var jsonEnc = function (v) {
			return _Utils_Tuple2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$elm$json$Json$Encode$int(am.a6),
						v)));
		};
		var jsonDecoder_ = F2(
			function (tag, orElse) {
				return _Utils_eq(tag, am.a6) ? jsonDecoderPiece : A2(am.N, tag, orElse);
			});
		return {
			a6: am.a6 + 1,
			N: jsonDecoder_,
					...
					$author$project$Elm$Review$Vendor$Serialize$record(
						F4(
							function (startRow, startColumn, endRow, endColumn) {
								return {
									aJ: {ab: endColumn, an: endRow},
									aY: {ab: startColumn, an: startRow}
								};
							})))))));
...
var $stil4m$elm_syntax$Elm$Syntax$Module$EffectModuleData = F4(
	function (moduleName, exposingList, command, subscription) {
		return {dr: command, bT: exposingList, bC: moduleName, eb: subscription};
	});
...
var $author$project$Elm$Review$File$decode = A4(
	...
	F3(
		function (path, source, ast) {
			return {dk: ast, d$: path, d7: source};
		}),
...
var $elm$project_metadata_utils$Elm$Type$var = function (isFirst) {
	return $elm$parser$Parser$variable(
		{cJ: $elm$project_metadata_utils$Elm$Type$isInnerVarChar, cX: $elm$core$Set$empty, aY: isFirst});
};
...
var $elm$parser$Parser$Advanced$sequence = function (i) {
	return A2(
		$elm$parser$Parser$Advanced$skip,
		$elm$parser$Parser$Advanced$token(i.aY),
		A2(
			$elm$parser$Parser$Advanced$skip,
			i.c2,
			A5(
	...
	return $elm$parser$Parser$Advanced$sequence(
		{
			...
			c2: i.c2,
			aY: $elm$parser$Parser$toToken(i.aY),
			db: $elm$parser$Parser$toAdvancedTrailing(i.db)
		});
};
...
var $elm$project_metadata_utils$Elm$Docs$Binop = F5(
	function (name, comment, tipe, associativity, precedence) {
		return {dj: associativity, aH: comment, aE: name, d0: precedence, ci: tipe};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Union = F4(
	function (name, comment, args, tags) {
		return {di: args, aH: comment, aE: name, ef: tags};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Value = F3(
	function (name, comment, tipe) {
		return {aH: comment, aE: name, ci: tipe};
	});
...
var $author$project$Elm$Review$Main$elmJsonDecoder = A4(
	...
	F3(
		function (path, raw, project) {
			return {d$: path, c: project, aT: raw};
		}),
	A2($elm$json$Json$Decode$field, 'path', $elm$json$Json$Decode$string),
...
var $jfmengels$elm_review$Review$Fix$applyReplace = F3(
	function (range, replacement, lines) {
		var startLine = A2(
			...
			range.aY.ab - 1,
			A2($jfmengels$elm_review$Review$Fix$getRowAtLine, lines, range.aY.an - 1));
		var linesBefore = A2($elm$core$List$take, range.aY.an - 1, lines);
		var linesAfter = A2($elm$core$List$drop, range.aJ.an, lines);
		var endLine = A2(
			$jfmengels$elm_review$Unicode$dropLeft,
			range.aJ.ab - 1,
			A2($jfmengels$elm_review$Review$Fix$getRowAtLine, lines, range.aJ.an - 1));
		return $elm$core$List$concat(
			_List_fromArray(
				[
					linesBefore,
...
var $jfmengels$elm_review$Review$Fix$comparePosition = F2(
	function (a, b) {
		...
		if (_v0 === 1) {
			return A2($elm$core$Basics$compare, a.ab, b.ab);
		} else {
			var order = _v0;
			return order;
		}
...
var $jfmengels$elm_review$Review$Fix$collide = F2(
	function (a, b) {
		var _v0 = A2($jfmengels$elm_review$Review$Fix$comparePosition, a.aJ, b.aY);
		switch (_v0) {
			case 0:
				return false;
			case 1:
				return false;
			default:
				var _v1 = A2($jfmengels$elm_review$Review$Fix$comparePosition, b.aJ, a.aY);
				switch (_v1) {
					case 0:
						return false;
					case 1:
...
var $jfmengels$elm_review$Review$Fix$getFixRange = function (fix_) {
	switch (fix_.$) {
		...
		default:
			var position = fix_.a;
			return {aJ: position, aY: position};
	}
};
...
var $author$project$Elm$Review$Reporter$hashRange = function (range) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[range.aY.an, range.aY.ab, range.aJ.an, range.aJ.ab])));
};
...
var $jfmengels$elm_review$Review$Fix$toRecord = function (fix_) {
	switch (fix_.$) {
		case 1:
			var range = fix_.a;
			var replacement = fix_.b;
			return {b8: range, d5: replacement};
		case 0:
			var range = fix_.a;
			return {b8: range, d5: ''};
		default:
...
var $author$project$Elm$Review$Main$fromReviewError = F2(
	function (links, error) {
		return {
			bi: $jfmengels$elm_review$Review$Rule$errorDetails(error),
			cC: A2(
				$elm$core$Maybe$map,
				$author$project$Elm$Review$Reporter$hashFixes,
				$jfmengels$elm_review$Review$Rule$errorFixes(error)),
			aa: $jfmengels$elm_review$Review$Rule$errorMessage(error),
			b8: $jfmengels$elm_review$Review$Rule$errorRange(error),
			cY: A2($author$project$Elm$Review$Main$linkToRule, links, error),
			cb: $jfmengels$elm_review$Review$Rule$errorRuleName(error)
		};
	});
...
var $author$project$Elm$Review$Main$groupErrorsByFile = F2(
	function (project, errors) {
		...
		return A2(
			$elm$core$List$filter,
			function (file) {
				return !$elm$core$List$isEmpty(file.ag);
			},
			A2(
				$elm$core$List$map,
				function (file) {
...
var $author$project$Elm$Review$Main$makeReport = F2(
	function (failedFixesDict, model) {
		var errorsByFile = A2($author$project$Elm$Review$Main$groupErrorsByFile, model.c, model.aW);
		return _Utils_Tuple2(
			model,
						...
						[
							...
							function () {
								...
								if (!_v0) {
											...
											A2(
												...
												function (file) {
													return {
														ag: A2(
															$elm$core$List$map,
															$author$project$Elm$Review$Main$fromReviewError(model.aB),
															file.ag),
														d$: file.d$,
														d7: file.d7
													};
									...
									return A2(
										$elm$json$Json$Encode$list,
										A2($author$project$Elm$Review$Main$encodeErrorByFile, model.aB, model.ae),
										errorsByFile);
								}
							}())
						]))));
...
var $author$project$Elm$Review$Main$fixOneByOne = function (model) {
	...
	if (!_v0.$) {
		var file = _v0.a.bV;
		var error = _v0.a.bR;
		var fixedSource = _v0.a.aj;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					af: $author$project$Elm$Review$Main$AwaitingError(error)
				}),
						...
						[
							...
							$author$project$Elm$Review$Main$encodeReport(
								A5(
									...
									A2($author$project$Elm$Review$Main$fromReviewError, model.aB, error),
									fixedSource))),
							_Utils_Tuple2(
							'changedFiles',
							A2(
...
var $author$project$Elm$Review$Main$refuseError = F2(
	function (error, model) {
		return _Utils_update(
			model,
			{
				aU: A2($author$project$Elm$Review$RefusedErrorFixes$insert, error, model.aU)
			});
	});
	...
	function (path, error, remainingErrors, model) {
		var errorsForFile = A2(
			...
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, path, model.ai)));
		return _Utils_update(
			model,
			{
				ai: A3($elm$core$Dict$insert, path, errorsForFile, model.ai),
				_: A2($author$project$Elm$Review$Progress$fixWasApplied, remainingErrors, model._)
			});
	});
						...
						if (!_v2.b.$) {
							...
							return A2(
								...
								_List_fromArray(
									[
										_Utils_eq(
										$elm$core$Set$fromList(oldApp.cy),
										$elm$core$Set$fromList(newApp.cy)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(0),
										_Utils_eq(
...
var $jfmengels$elm_review$Review$Rule$elmReviewGlobalError = function (_v0) {
	...
	var details = _v0.bi;
	return $jfmengels$elm_review$Review$Rule$SpecifiedError(
		{bi: details, bW: 'GLOBAL ERROR', bY: $elm$core$Maybe$Nothing, aa: message, b8: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, cb: '', c7: 3});
};
...
var $jfmengels$elm_review$Review$Rule$duplicateModulesGlobalError = function (duplicate) {
	var paths = $elm$core$String$concat(
		A2(
			...
			$elm$core$List$sort(duplicate.cT)));
	return $jfmengels$elm_review$Review$Rule$errorToReviewError(
		$jfmengels$elm_review$Review$Rule$elmReviewGlobalError(
			{
				bi: _List_fromArray(
					[
						'I found several modules with the name `' + (A2($elm$core$String$join, '.', duplicate.bC) + '`. Depending on how I choose to resolve this, I might give you different reports. Since this is a compiler error anyway, I require this problem to be solved. Please fix this then try running `elm-review` again.'),
				...
				aa: 'Found several modules named `' + (A2($elm$core$String$join, '.', duplicate.bC) + '`')
			}));
};
...
var $jfmengels$elm_review$Review$Rule$parsingError = function (rawFile) {
	return {
		...
		bW: rawFile.d$,
		bY: $elm$core$Maybe$Nothing,
		aa: rawFile.d$ + ' is not a correct Elm module',
		b8: $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange,
		cb: 'ParsingError',
		c7: 0
	};
...
var $jfmengels$elm_review$Vendor$IntDict$determineBranchRelation = F2(
	function (l, r) {
		...
		var mask = $jfmengels$elm_review$Vendor$IntDict$highestBitSet(
			A2($jfmengels$elm_review$Vendor$IntDict$mostSignificantBranchingBit, lp.aG, rp.aG));
		var modifiedRightPrefix = A3($jfmengels$elm_review$Vendor$IntDict$combineBits, rp.X, ~lp.X, mask);
		var prefix = A2($jfmengels$elm_review$Vendor$IntDict$lcp, lp.X, modifiedRightPrefix);
		var childEdge = F2(
			function (branchPrefix, c) {
				return A2($jfmengels$elm_review$Vendor$IntDict$isBranchingBitSet, branchPrefix, c.g.X) ? 1 : 0;
			});
		...
		var updateIncomingEdge = F2(
			function (upd, node) {
				return _Utils_update(
					node,
					{
						cI: A3($jfmengels$elm_review$Vendor$IntDict$update, nodeId, upd, node.cI)
					});
			});
		var flippedFoldl = F3(
			function (f, dict, acc) {
...
var $jfmengels$elm_review$Vendor$Graph$emptyDiff = {cI: $jfmengels$elm_review$Vendor$IntDict$empty, h: $jfmengels$elm_review$Vendor$IntDict$empty};
	...
	function (old, _new) {
		...
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				...
				var ins = _v0.b.a;
				return {
					cI: A3(collect, $jfmengels$elm_review$Vendor$Graph$Insert, ins.h, $jfmengels$elm_review$Vendor$IntDict$empty),
					h: A3(collect, $jfmengels$elm_review$Vendor$Graph$Insert, ins.cI, $jfmengels$elm_review$Vendor$IntDict$empty)
				};
			}
		} else {
			if (_v0.b.$ === 1) {
				...
				var _v3 = _v0.b;
				return {
					cI: A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.h, $jfmengels$elm_review$Vendor$IntDict$empty),
					h: A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.cI, $jfmengels$elm_review$Vendor$IntDict$empty)
				};
			} else {
				var rem = _v0.a.a;
				var ins = _v0.b.a;
				return _Utils_eq(rem, ins) ? $jfmengels$elm_review$Vendor$Graph$emptyDiff : {
					...
					h: A3(
						...
						$jfmengels$elm_review$Vendor$Graph$Insert,
						ins.cI,
						A3(collect, $jfmengels$elm_review$Vendor$Graph$Remove, rem.cI, $jfmengels$elm_review$Vendor$IntDict$empty))
				};
			}
		}
	});
		...
		var wrappedUpdater = function (rep) {
			...
			var filterInvalidEdges = function (ctx) {
				return $jfmengels$elm_review$Vendor$IntDict$filter(
					F2(
						function (id, _v0) {
							return _Utils_eq(id, ctx.cR.br) || A2($jfmengels$elm_review$Vendor$IntDict$member, id, rep);
						}));
			};
			var cleanUpEdges = function (ctx) {
				return _Utils_update(
					ctx,
					{
						cI: A2(filterInvalidEdges, ctx, ctx.cI),
...
var $jfmengels$elm_review$Vendor$Graph$alongIncomingEdges = function (ctx) {
	return $jfmengels$elm_review$Vendor$IntDict$keys(ctx.cI);
};
...
var $jfmengels$elm_review$Review$Rule$reachedTarget = F2(
	function (targetNode, path) {
		...
		if (!_v0.$) {
			var node = _v0.a;
			return _Utils_eq(node.cR.br, targetNode);
		} else {
			return false;
		}
	});
	...
	function (targetNode, path, distance, acc) {
		if ($elm$core$List$isEmpty(acc)) {
			if (!distance) {
				...
				if (!_v0.$) {
					var head = _v0.a;
					return A2($jfmengels$elm_review$Vendor$IntDict$member, head.cR.br, head.cI) ? _List_fromArray(
						[head.cR]) : acc;
				} else {
					return acc;
				}
		...
		while (true) {
			if (!nodesToVisit.b) {
				...
				var cycle = A5(
					...
					$jfmengels$elm_review$Review$Rule$visitorDiscoverCycle(startingNode.br),
					_List_fromArray(
						[startingNode.br]),
					_List_Nil,
					graph).a;
					...
					$jfmengels$elm_review$Review$Rule$elmReviewGlobalError(
						{
							...
							aa: 'Your module imports form a cycle'
						})))
			]);
	});
...
var $jfmengels$elm_review$Review$Rule$newProjectRuleSchema = F2(
	function (name, initialProjectContext) {
		return {ad: $elm$core$Maybe$Nothing, t: _List_Nil, u: _List_Nil, m: _List_Nil, av: $elm$core$Maybe$Nothing, al: initialProjectContext, z: $elm$core$Maybe$Nothing, aQ: _List_Nil, aE: name, x: _List_Nil, bg: 0};
	});
var $jfmengels$elm_review$Review$Rule$scope_foldProjectContexts = F2(
	function (newContext, previousContext) {
		return {
			C: previousContext.C,
			aD: A2($elm$core$Dict$union, newContext.aD, previousContext.aD),
			W: A2($elm$core$Dict$union, previousContext.W, newContext.W)
		};
	});
...
var $jfmengels$elm_review$Review$Rule$createFakeImport = function (_v0) {
	var moduleName = _v0.bC;
	var moduleAlias = _v0.dL;
	var exposingList = _v0.bT;
	return {
		bT: A2(
			$elm$core$Maybe$map,
		...
		dL: A2(
			...
			A2(
				...
				$stil4m$elm_syntax$Elm$Syntax$Node$Node($stil4m$elm_syntax$Elm$Syntax$Range$emptyRange)),
			moduleAlias),
		bC: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, moduleName)
	};
};
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				bT: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aE: 'List', dY: $elm$core$Maybe$Nothing}),
							$stil4m$elm_syntax$Elm$Syntax$Exposing$InfixExpose('::')
						])),
				dL: $elm$core$Maybe$Nothing,
				bC: _List_fromArray(
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				bT: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aE: 'String', dY: $elm$core$Maybe$Nothing})
						])),
				dL: $elm$core$Maybe$Nothing,
				bC: _List_fromArray(
					['String'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				bT: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aE: 'Char', dY: $elm$core$Maybe$Nothing})
						])),
				dL: $elm$core$Maybe$Nothing,
				bC: _List_fromArray(
					['Char'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				bT: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aE: 'Program', dY: $elm$core$Maybe$Nothing})
						])),
				dL: $elm$core$Maybe$Nothing,
				bC: _List_fromArray(
					['Platform'])
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				bT: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aE: 'Cmd', dY: $elm$core$Maybe$Nothing})
						])),
			...
			$jfmengels$elm_review$Review$Rule$createFakeImport(
			{
				bT: explicit(
					_List_fromArray(
						[
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
							{aE: 'Sub', dY: $elm$core$Maybe$Nothing})
						])),
...
var $jfmengels$elm_review$Review$Rule$registerImportAlias = F2(
	function (import_, innerContext) {
		var _v0 = import_.dL;
		if (_v0.$ === 1) {
			var moduleName = $stil4m$elm_syntax$Elm$Syntax$Node$value(import_.bC);
					...
					ak: A3(
						...
						function (previousValue) {
							return $elm$core$Maybe$Just(
								A2(
									$elm$core$List$cons,
									$stil4m$elm_syntax$Elm$Syntax$Node$value(import_.bC),
									A2($elm$core$Maybe$withDefault, _List_Nil, previousValue)));
						},
						innerContext.ak)
				});
		...
		switch (_v0.$) {
			...
			case 2:
				...
				return A2(
					$elm$core$List$any,
					function (alias) {
						return _Utils_eq(alias.aE, name);
					},
					module_.ck) ? _List_fromArray(
					[name]) : _List_Nil;
			default:
				var name = _v0.a.aE;
				var open = _v0.a.dY;
					...
					return A2(
						...
						A2(
							...
							A2(
								$elm$core$List$filter,
								function (union) {
									return _Utils_eq(union.aE, name);
								},
								module_.dd)));
				} else {
					return _List_Nil;
...
var $jfmengels$elm_review$Review$Rule$registerImportExposed = F2(
	function (import_, innerContext) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, import_.bT);
		if (_v0.$ === 1) {
			return innerContext;
		} else {
			var exposing_ = _v0.a;
			...
			var module_ = A2(
				$elm$core$Maybe$withDefault,
				{
					...
					co: _List_Nil,
					aH: '',
					aE: $jfmengels$elm_review$Review$Rule$joinModuleName(moduleName),
					dd: _List_Nil,
					de: _List_Nil
				},
				function () {
					...
					if (!_v4.$) {
						...
						return A2($elm$core$Dict$get, moduleName, innerContext.W);
					}
				}());
			if (!exposing_.$) {
					...
					$elm$core$List$concat(
						_List_fromArray(
							[
								...
								A2($elm$core$List$map, nameWithModuleName, module_.ck),
								A2($elm$core$List$map, nameWithModuleName, module_.co)
							])));
				var exposedTypes = $elm$core$Dict$fromList(
					A2(
						$elm$core$List$append,
						A2($elm$core$List$map, nameWithModuleName, module_.dd),
						A2($elm$core$List$map, nameWithModuleName, module_.ck)));
				return _Utils_update(
					innerContext,
					{
						ax: A2($elm$core$Dict$union, exposedValues, innerContext.ax),
						ay: A2($elm$core$Dict$union, innerContext.ay, exposedTypes)
					});
			} else {
...
var $jfmengels$elm_review$Review$Rule$scope_initialProjectContext = {C: $elm$core$Dict$empty, aD: $elm$core$Dict$empty, W: $elm$core$Dict$empty};
		...
		var dependenciesModules = $elm$core$Dict$fromList(
			A2(
				...
				function (dependencyModule) {
					return _Utils_Tuple2(dependencyModule.aE, dependencyModule);
				},
				A2(
					$jfmengels$elm_review$Vendor$ListExtra$fastConcatMap,
...
var $jfmengels$elm_review$Review$ModuleNameLookupTable$Internal$toRangeLike = function (_v0) {
	...
	var end = _v0.aJ;
	return _Utils_Tuple2(
		_Utils_Tuple2(start.an, start.ab),
		_Utils_Tuple2(end.an, end.ab));
};
	...
	function (context, valueName, moduleName) {
		if (!moduleName.b) {
			return A2($jfmengels$elm_review$Review$Rule$isInScope, valueName, context.l) ? _List_Nil : A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, valueName, context.ax));
		} else {
			if (!moduleName.b.b) {
				var moduleNameOrAlias = moduleName.a;
				var _v1 = A2($elm$core$Dict$get, moduleNameOrAlias, context.ak);
				if (!_v1.$) {
					if (_v1.a.b && (!_v1.a.b.b)) {
						...
						var _v3 = A2(
							...
							function (aliasedModuleName) {
								var _v4 = A2($elm$core$Dict$get, aliasedModuleName, context.W);
								if (!_v4.$) {
									var module_ = _v4.a;
...
var $jfmengels$elm_review$Review$Rule$moduleNameForType = F3(
	function (context, typeName, moduleName) {
		if (!moduleName.b) {
			return A2($elm$core$Set$member, typeName, context.aC) ? _List_Nil : A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Dict$get, typeName, context.ay));
		} else {
			if (!moduleName.b.b) {
				var _v1 = A2(
					$elm$core$Dict$get,
		...
		switch (_v0.$) {
			case 0:
				...
				var newScope = _Utils_update(
					...
					{
						aF: $jfmengels$elm_review$Review$Rule$parameters(
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dv).cl)
					});
				var newContext = A2(
			...
			case 3:
				var signature = _v0.a;
				var moduleNamesFromSignature = A2($jfmengels$elm_review$Review$Rule$collectModuleNamesFromTypeAnnotation, context, signature.dc);
		...
		return A2(
			...
			function (scope) {
				return _Utils_update(
					scope,
					{
						aF: A3($elm$core$Dict$insert, name, variableInfo, scope.aF)
					});
			},
			scopes);
	});
var $jfmengels$elm_review$Review$Rule$addToScope = F2(
	function (variableData, innerContext) {
		var newScopes = A3(
			...
			variableData,
			$stil4m$elm_syntax$Elm$Syntax$Node$value(variableData.cR),
			innerContext.l);
		return _Utils_update(
			innerContext,
			{l: newScopes});
					...
					$elm$core$List$cons,
					{
						...
						ef: A2(
							...
							function (constructor) {
								return _Utils_Tuple2(
									$stil4m$elm_syntax$Elm$Syntax$Node$value(
										$stil4m$elm_syntax$Elm$Syntax$Node$value(constructor).aE),
									_List_Nil);
							},
							constructors)
					},
			...
			innerContext,
			{
				a$: A2(
					$elm$core$List$cons,
					{
						...
						aH: '',
						aE: name,
						ci: $elm$project_metadata_utils$Elm$Type$Tuple(_List_Nil)
					},
					innerContext.a$)
			});
	});
	...
	function (innerContext, maybeSignature) {
		if (!maybeSignature.$) {
			...
			return A2(
				...
				innerContext,
				$stil4m$elm_syntax$Elm$Syntax$Node$value(signature).dc);
		} else {
			return $elm$project_metadata_utils$Elm$Type$Tuple(_List_Nil);
		}
	});
			...
			innerContext,
			{
				a1: A2(
					$elm$core$List$cons,
					{
						...
						aE: name,
						ci: A2($jfmengels$elm_review$Review$Rule$convertTypeSignatureToDocsType, innerContext, _function.d6)
					},
					innerContext.a1)
			});
	});
var $jfmengels$elm_review$Review$Rule$registerIfExposed = F3(
	function (registerFn, name, innerContext) {
		return (innerContext.bn || A2($elm$core$Dict$member, name, innerContext.bm)) ? A2(registerFn, name, innerContext) : innerContext;
	});
var $jfmengels$elm_review$Review$Rule$scope_registerDeclaration = F2(
	function (declaration, innerContext) {
		...
		switch (_v0.$) {
			case 0:
				var _function = _v0.a;
				var nameNode = $stil4m$elm_syntax$Elm$Syntax$Node$value(_function.dv).aE;
				return A3(
			...
			case 1:
				...
				return A3(
					...
					$stil4m$elm_syntax$Elm$Syntax$Node$value(alias.aE),
					function (ctx) {
						var _v1 = $stil4m$elm_syntax$Elm$Syntax$Node$value(alias.dc);
						if (_v1.$ === 4) {
							return A2(
								$jfmengels$elm_review$Review$Rule$addToScope,
								{cR: alias.aE, aq: 0},
					...
					A3(
						...
						F2(
							function (constructor, innerContext_) {
								var constructorName = $stil4m$elm_syntax$Elm$Syntax$Node$value(constructor).aE;
								return A2(
									$jfmengels$elm_review$Review$Rule$addToScope,
									{cR: constructorName, aq: 1},
									innerContext_);
							}),
						_Utils_update(
							innerContext,
	...
	function (node, innerContext) {
		...
		if (!_v0.$) {
			...
			return _Utils_update(
				innerContext,
				{
					bm: $jfmengels$elm_review$Review$Rule$exposedElements(list)
				});
		}
	});
...
var $jfmengels$elm_review$Review$Rule$scope_popScopeExit = F2(
	function (node, context) {
		var currentScope = $jfmengels$elm_review$Review$Rule$nonemptyList_head(context.l);
		return _Utils_eq(node, currentScope.bh) ? _Utils_update(
			context,
			{
				l: $jfmengels$elm_review$Review$Rule$nonemptyList_pop(context.l)
			}) : context;
...
var $jfmengels$elm_review$Review$Rule$withDataExtractor = F2(
	function (dataExtractor, _v0) {
		...
		return _Utils_update(
			schema,
			{
				ad: $elm$core$Maybe$Just(dataExtractor)
			});
	});
		...
		return _Utils_update(
			schema,
			{
				av: $elm$core$Maybe$Just(
					{
						Z: functions.Z,
						aw: $jfmengels$elm_review$Review$Rule$withMetadata(
							$jfmengels$elm_review$Review$Rule$withModuleKey(
								$jfmengels$elm_review$Review$Rule$initContextCreator(
									F3(
...
var $jfmengels$elm_review$Review$Rule$scopeRule = $jfmengels$elm_review$Review$Rule$fromProjectRuleSchemaToRunnableProjectVisitor(
	A2(
		...
		function (projectContext) {
			return projectContext.aD;
		},
		A2(
			$jfmengels$elm_review$Review$Rule$withModuleContext,
			{Z: $jfmengels$elm_review$Review$Rule$scope_foldProjectContexts, aw: $jfmengels$elm_review$Review$Rule$scope_fromModuleToProject, b_: $jfmengels$elm_review$Review$Rule$scope_fromProjectToModule},
			A2(
	...
	function (project, rules, maybeProjectData, nodeContexts) {
		...
		var scopeResult = function () {
			if ($jfmengels$elm_review$Review$Rule$needsToComputeScope(rules)) {
				...
				return {aK: $elm$core$Maybe$Nothing, bd: $elm$core$Maybe$Nothing};
			}
		}();
		...
		var newRules = _v0.b;
		return {
			ag: A2($elm$core$List$map, $jfmengels$elm_review$Review$Rule$errorToReviewError, errors),
			bd: scopeResult.bd,
			be: newRules
		};
	});
var $jfmengels$elm_review$Review$Rule$reviewV2 = F3(
	function (rules, maybeProjectData, project) {
		...
		if (!_v0.$) {
			...
			var errors = _v0.a;
			return {ag: errors, bd: maybeProjectData, be: rules};
		}
	});
var $author$project$Elm$Review$Main$runReview = function (model) {
	...
	return _Utils_update(
		model,
		{af: $author$project$Elm$Review$Main$NotAwaiting, bd: projectData, aW: errors, be: rules});
};
	...
	function (failedFixesDict, model) {
		...
		while (true) {
			...
			if (!_v0.b.$) {
				...
				var file = _v0.b.a.bV;
				var error = _v0.b.a.bR;
				var fixedSource = _v0.b.a.aj;
				var remainingErrors = _v0.b.a.cW;
				var newProject = A2(
				...
				var _v1 = _v0.b;
				return $elm$core$Maybe$Just(
					{bU: newFailedFixesDict, b6: model});
			}
		}
	});
	...
	function (before, after) {
		...
		var afterReadme = function () {
			...
			if (!_v6.$) {
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(readme.d$, readme.aI)
					]);
			} else {
				return _List_Nil;
			}
		...
		var afterElmJson = function () {
			...
			if (!_v5.$) {
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(elmJson.d$, elmJson.aT)
					]);
			} else {
				return _List_Nil;
			}
			...
			F4(
				function (_v2, beforeModule, fixedSource, acc) {
					return (!_Utils_eq(beforeModule.d7, fixedSource)) ? A2(
						$elm$core$List$cons,
						{aj: fixedSource, d$: beforeModule.d$, d7: beforeModule.d7},
						acc) : acc;
				}),
			F3(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$core$List$reverse(file.ag))),
				A2($author$project$Elm$Review$Reporter$diff, file.d7, file.aj)
			]));
};
...
var $author$project$Elm$Review$Main$fixAll = function (model) {
	...
	if (!_v0.$) {
		var failedFixesDict = _v0.a.bU;
		var newModel = _v0.a.b6;
		...
		if (!_v1.b) {
			...
			var changedFiles = A2(
				...
				function (_v2) {
					var path = _v2.d$;
					var source = _v2.d7;
					var fixedSource = _v2.aj;
					return {
						ag: A2(
							$elm$core$Maybe$withDefault,
							_List_Nil,
							A2($elm$core$Dict$get, path, newModel.ai)),
						aj: fixedSource,
			...
			return _Utils_Tuple2(
				_Utils_update(
					newModel,
					{af: $author$project$Elm$Review$Main$AwaitingFixAll, bX: newModel.c, c: model.c}),
				$author$project$Elm$Review$Main$askConfirmationToFix(
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
		...
		default:
			...
			return _Utils_Tuple2(
				_Utils_update(
					newModel,
					{
						_: $author$project$Elm$Review$Progress$reset(newModel._)
					}),
				cmd);
	}
};
	...
	function (msg, model) {
		switch (msg.$) {
							...
							_Utils_update(
								model,
								{
									c: A2(
										...
										{dk: ast, d$: rawFile.d$, d7: rawFile.d7},
										model.c)
								}),
							$author$project$Elm$Review$Main$acknowledgeFileReceipt(
								$elm$json$Json$Encode$object(
			...
			case 4:
				...
				var dependenciesDecoder = model.aN ? A2(
					$elm$json$Json$Decode$map,
						...
						return (_Utils_cmp(
							...
							$author$project$Elm$Review$Main$reportOrFix(
								$author$project$Elm$Review$Main$runReview(
									_Utils_update(
										model,
										{bl: true, ai: $elm$core$Dict$empty, c: newProject}))));
					} else {
						var _v8 = _v7.a;
						var _v9 = model.af;
						switch (_v9.$) {
			...
			default:
				return _Utils_Tuple2(
					...
					$author$project$Elm$Review$Main$fixConfirmationStatus(
						!_Utils_eq(model.af, $author$project$Elm$Review$Main$NotAwaiting)));
		}
	});
