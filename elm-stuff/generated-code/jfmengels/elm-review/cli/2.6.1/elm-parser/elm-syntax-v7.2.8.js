...
var $author$project$ParseMain$parseSource = function (source) {
	return A2(
		$elm$core$Result$map,
		$stil4m$elm_syntax$Elm$Processing$process($author$project$ParseMain$elmProcessContext),
		A2(
			$elm$core$Result$mapError,
			$elm$core$Basics$always(0),
			$stil4m$elm_syntax$Elm$Parser$parse(source)));
};
var $author$project$ParseMain$update = F2(
	function (_v0, _v1) {
		var source = _v0;
		return A2(
			$elm$core$Tuple$pair,
			0,
			$author$project$ParseMain$parseResult(
				A2(
					$elm$core$Result$withDefault,
					$elm$json$Json$Encode$null,
					A2(
						$elm$core$Result$map,
						$author$project$Elm$Review$AstCodec$encode,
						$author$project$ParseMain$parseSource(source)))));
	});
...
var $author$project$ParseMain$main = $elm$core$Platform$worker(
	{
		...
		az: $author$project$ParseMain$update
	});
