...
var $author$project$Main$update = F2(
	function (msg, m) {
		switch (msg.$) {
			...
			case 'Initialize':
				var viewport = msg.a;
				var newWindow = {height: viewport.viewport.height, width: viewport.viewport.width};
				return _Utils_Tuple2(
					_Utils_update(
						m,
						{
