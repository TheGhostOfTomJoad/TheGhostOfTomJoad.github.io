...
{
	if (region.b0.a1 === region.ct.a1)
	{
		return 'on line ' + region.b0.a1;
	}
	return 'on lines ' + region.b0.a1 + ' through ' + region.ct.a1;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { em: 'hidden', d2: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { em: 'mozHidden', d2: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { em: 'msHidden', d2: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { em: 'webkitHidden', d2: 'webkitvisibilitychange' }
		: { em: 'hidden', d2: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cz: fragment, cF: host, cY: path, c_: port_, c5: protocol, c6: query};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{aj: '/* Write your CSS Code in this text field */', ao: ' <!--Write your HTML Code in this text field-->', bw: $elm$core$Maybe$Nothing, ae: true},
...
var $author$project$Main$computeNewWindow = F3(
	function (w, h, m) {
		var newWindow = {Y: h, ag: w};
		return _Utils_Tuple2(
			_Utils_update(
				m,
				{
					bw: $elm$core$Maybe$Just(newWindow)
				}),
...
var $author$project$Main$update = F2(
	function (msg, m) {
		switch (msg.$) {
			...
			case 1:
				var v = msg.a;
				return (!_Utils_eq(m.ao, v)) ? _Utils_Tuple2(
					_Utils_update(
						m,
						{ao: v}),
			...
			case 2:
				var v = msg.a;
				return (!_Utils_eq(m.aj, v)) ? _Utils_Tuple2(
					_Utils_update(
						m,
						{aj: v}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(m, $elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					m,
					A3($elm$file$File$Download$string, 'my_code.html', 'text/html', m.ao));
			case 4:
				return _Utils_Tuple2(
					m,
					A3($elm$file$File$Download$string, 'my_code.css', 'text/css', m.aj));
			case 6:
				var viewport = msg.a;
				return A3($author$project$Main$computeNewWindow, viewport.dt.ag, viewport.dt.Y, m);
			case 7:
				var w = msg.a;
				var h = msg.b;
...
var $author$project$Main$cmCss1 = function (m) {
	...
	return b ? A2(
		...
		$author$project$ComputeRemSpace$computeAvHeightSmall(s.Y),
		$author$project$ComputeRemSpace$computeAvWidthSmall(s.ag)) : A2(
		$author$project$Main$cmCssHelper1,
		$author$project$ComputeRemSpace$computeAvHeightBig(s.Y),
		$author$project$ComputeRemSpace$computeAvWidthBig(s.ag));
};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.ea) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.eI, record.ea, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {cm: charset, eb: finalDeclarations, cH: imports, cS: namespaces};
};
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {aD: charsProcessed, aK: hash, av: seed, aQ: shift};
	});
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$finalize = function (data) {
	var acc = (!(!data.aK)) ? (data.av ^ A2(
		...
		A2(
			...
			15,
			A2($rtfeldman$elm_css$ElmCssVendor$Murmur3$multiplyBy, $rtfeldman$elm_css$ElmCssVendor$Murmur3$c1, data.aK)))) : data.av;
	var h0 = acc ^ data.aD;
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {aD: data.aD + 1, aK: res, av: data.av, aQ: data.aQ + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {cm: charset, eb: declarations, cH: imports, cS: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {cm: $elm$core$Maybe$Nothing, cH: _List_Nil, cS: _List_Nil, dh: snippets};
};
...
var $author$project$Main$cmCss = function (m) {
	...
	var res = m.ae ? x : _Utils_ap(cssEditorStyle, x);
...
var $mdgriffith$elm_ui$Internal$Style$classes = {dz: 'a', bA: 'atv', dB: 'ab', dC: 'cx', dD: 'cy', dE: 'acb', dF: 'accx', dG: 'accy', dH: 'acr', ca: 'al', cb: 'ar', dJ: 'at', bB: 'ah', bC: 'av', dM: 's', dQ: 'bh', dR: 'b', dU: 'w7', dW: 'bd', dX: 'bdt', bc: 'bn', dY: 'bs', be: 'cpe', d3: 'cp', d4: 'cpx', d5: 'cpy', T: 'c', bg: 'ctr', bh: 'cb', bi: 'ccx', U: 'ccy', a_: 'cl', bj: 'cr', d6: 'ct', d8: 'cptr', d9: 'ctxt', ej: 'fcs', cy: 'focus-within', ek: 'fs', el: 'g', bL: 'hbh', bM: 'hc', cC: 'he', bN: 'hf', cD: 'hfp', en: 'hv', eq: 'ic', es: 'fr', bn: 'lbl', eu: 'iml', ev: 'imlf', ew: 'imlp', ex: 'implw', ey: 'it', eA: 'i', cP: 'lnk', aO: 'nb', cT: 'notxt', eJ: 'ol', eK: 'or', as: 'oq', eP: 'oh', cW: 'pg', cX: 'p', eQ: 'ppe', eV: 'ui', dd: 'r', eZ: 'sb', e_: 'sbx', e$: 'sby', e0: 'sbt', e3: 'e', e4: 'cap', e5: 'sev', fc: 'sk', B: 't', ff: 'tc', fg: 'w8', fh: 'w2', fi: 'w9', fj: 'tj', by: 'tja', fk: 'tl', fl: 'w3', fm: 'w5', fn: 'w4', fo: 'tr', fp: 'w6', fq: 'w1', fr: 'tun', dq: 'ts', ay: 'clr', fz: 'u', b4: 'wc', du: 'we', b5: 'wf', dv: 'wfp', b6: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.T);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.el);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cW);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cX);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dd);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e3);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.L)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.e6.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.e6.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.dd) + ('-' + ($elm$core$String$fromInt(pos.cp) + ('-' + ($elm$core$String$fromInt(pos.ag) + ('-' + $elm$core$String$fromInt(pos.Y)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.en, $mdgriffith$elm_ui$Internal$Style$classes.ay)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.en, $mdgriffith$elm_ui$Internal$Style$classes.as)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ej, $mdgriffith$elm_ui$Internal$Style$classes.ay)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ej, $mdgriffith$elm_ui$Internal$Style$classes.as)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.bA, $mdgriffith$elm_ui$Internal$Style$classes.ay)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dM) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dd) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dM) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dM) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dd) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dM) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bg) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {bf: closing, s: _List_Nil, ac: _List_Nil, I: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								s: A2(
									$elm$core$List$cons,
									{bf: '\n}', s: _List_Nil, ac: props, I: '@supports (' + (prop + (':' + (value + (') {' + parent.I))))},
									rendered.s)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.I + ('{' + (renderValues(rule.ac) + (rule.bf + '}')));
		}
	};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.e3;
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.dd) + (' / ' + ($elm$core$String$fromInt(position.dd + position.Y) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cp) + (' / ' + ($elm$core$String$fromInt(position.cp + position.ag) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.dd) + ('-' + ($elm$core$String$fromInt(position.cp) + ('-' + ($elm$core$String$fromInt(position.ag) + ('-' + $elm$core$String$fromInt(position.Y)))))));
	...
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			_Utils_ap(
				...
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.ek, full)));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.e4 + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.B + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.e4 + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.B)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {Y: height / size, bw: size, ds: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.d1, adjustment.dP, adjustment.ec, adjustment.eD]);
	var lineHeight = 1.5;
				...
				return {
					...
					a6: function () {
						...
						if (_v1.$ === 1) {
							...
							var topLevel = _v1.a;
							return A2($elm$core$List$cons, topLevel, rendered.a6);
						}
					}()
				};
			});
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e3))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dM, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.bg, $mdgriffith$elm_ui$Internal$Style$classes.U, $mdgriffith$elm_ui$Internal$Style$classes.dH])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dM, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.bg, $mdgriffith$elm_ui$Internal$Style$classes.U, $mdgriffith$elm_ui$Internal$Style$classes.dF])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dM, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.bg, $mdgriffith$elm_ui$Internal$Style$classes.dG])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dM, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.bg, $mdgriffith$elm_ui$Internal$Style$classes.dE])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.B + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.b4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bM)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.dM + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.B + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.b5 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bN)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.dz]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.dR]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.eK]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.eJ]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.es]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aO, $mdgriffith$elm_ui$Internal$Style$classes.e3, $mdgriffith$elm_ui$Internal$Style$classes.dQ]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.bB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cb);
		default:
...
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.bC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dB);
		default:
	...
	switch (h.$) {
		case 0:
			...
			return _Utils_Tuple3(
				...
				$mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + name),
				_List_fromArray(
					[
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.dM + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.T + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.du + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.dv + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.dM + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dd + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.du + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dv + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 0:
									...
									var name = 'height-px-' + val;
									var $temp$classes = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + (name + (' ' + classes))),
										$temp$node = node,
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								en: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{ej: $elm$core$Maybe$Nothing, en: $elm$core$Maybe$Nothing, eH: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.eV, $mdgriffith$elm_ui$Internal$Style$classes.dM, $mdgriffith$elm_ui$Internal$Style$classes.e3]))),
...
var $author$project$Styles$spotifyColors = {
	cd: A3($mdgriffith$elm_ui$Element$rgb255, 18, 18, 18),
	dS: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
	d0: A3($mdgriffith$elm_ui$Element$rgb255, 40, 40, 40),
	eE: A3($mdgriffith$elm_ui$Element$rgb255, 24, 24, 24),
	bX: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255),
	bZ: A3($mdgriffith$elm_ui$Element$rgb255, 179, 179, 179),
	fy: A3($mdgriffith$elm_ui$Element$rgb255, 64, 64, 64)
};
			...
			$mdgriffith$elm_ui$Element$layoutWith,
			{
				eO: _List_fromArray(
					[
						...
						{
							dO: $elm$core$Maybe$Just($author$project$Styles$spotifyColors.cd),
							dV: $elm$core$Maybe$Just($author$project$Styles$spotifyColors.cd),
...
var $mdgriffith$elm_ui$Element$pointer = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.d8);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bi + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.U + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.e0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cT)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$Styles$buttonstyle = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$spotifyColors.bX),
		$mdgriffith$elm_ui$Element$Border$color($author$project$Styles$spotifyColors.cd),
		$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$spotifyColors.cd),
		...
		return A3(
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Attributes$id(cssid),
					A2(
...
var $author$project$Main$codemirrorCSS = function (m) {
	return A6($author$project$CodeMirror$codemirrorHelper, 2, 0, 6, $author$project$Main$CSSEditorChanged, 'id-csseditor', m.aj);
};
...
var $author$project$Main$codemirrorHTML = function (m) {
	return A6($author$project$CodeMirror$codemirrorHelper, 2, 0, 4, $author$project$Main$HTMLEditorChanged, 'id-htmleditor', m.ao);
};
...
var $mdgriffith$elm_ui$Element$Keyed$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.d6 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a_)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Main$cmCss2 = function (m) {
	var s = $author$project$Main$lookForSize(m);
	var b = m.ae;
	return b ? A2($author$project$Main$cmCssHelper1, s.Y - 70, (s.ag - 90) / 2) : A2($author$project$Main$cmCssHelper1, s.Y - 95, (s.ag - 90) / 2);
};
...
var $rtfeldman$elm_css$Html$Styled$Attributes$srcdoc = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('srcdoc');
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Main$prepareCode, m.ao, m.aj)),
...
var $author$project$Styles$resultStyle = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Border$color($author$project$Styles$spotifyColors.bZ),
		$mdgriffith$elm_ui$Element$Border$width(4),
		$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$spotifyColors.bX),
		$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
		$mdgriffith$elm_ui$Element$padding($author$project$Styles$pad),
		$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
	]);
				...
				$mdgriffith$elm_ui$Element$html(
					$rtfeldman$elm_css$Html$Styled$toUnstyled(
						A2(
							...
							_List_fromArray(
								[
									$author$project$Main$renderCode(m)
								])))))
			]));
};
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.a_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.U)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Main$saveHTMLButton = A2(
	...
	{
		bP: $mdgriffith$elm_ui$Element$text('💾'),
		bU: $elm$core$Maybe$Just($author$project$Main$SaveHTML)
	});
				...
				_List_fromArray(
					[
						...
						A2(
							...
							_List_Nil,
							_List_fromArray(
								[$author$project$Main$saveHTMLButton, $author$project$Main$changeViewButton]))),
						_Utils_Tuple2(
						'htmlEditor',
						A2(
							$mdgriffith$elm_ui$Element$el,
...
var $author$project$Main$saveCSSButton = A2(
	...
	{
		bP: $mdgriffith$elm_ui$Element$text('💾'),
		bU: $elm$core$Maybe$Just($author$project$Main$SaveCSS)
	});
					...
					[
						...
						A2(
							...
							$mdgriffith$elm_ui$Element$html(
								$rtfeldman$elm_css$Html$Styled$toUnstyled(
									$author$project$Main$codemirrorHTML(m))))),
						_Utils_Tuple2('saveCSSButton', $author$project$Main$saveCSSButton),
						_Utils_Tuple2(
						'cssEditor',
						A2(
							$mdgriffith$elm_ui$Element$el,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					m.ae ? A2($author$project$Main$viewHelper, m, $author$project$Main$viewTwoEditors) : A2($author$project$Main$viewHelper, m, $author$project$Main$viewOneEditor))
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{et: $author$project$Main$init, fe: $author$project$Main$subscriptions, fA: $author$project$Main$update, fC: $author$project$Main$view});
