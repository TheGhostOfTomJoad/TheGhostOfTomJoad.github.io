module Styles exposing (buttonstyle, editorColumnStyle, resultStyle, rowStyle, smallEditorstyle, spotifyColors, textColumnStyle)

import Element exposing (Attr, Attribute, Color, fill, height, padding, rgb255, spacing, width)
